-- ============================================================================
-- BASELINE SCHEMA — STORED PROCEDURES
--
...
--
-- Name: sp_insert_gacha_batch(uuid, jsonb); Type: PROCEDURE; Schema: public; Owner: -
--

CREATE PROCEDURE public.sp_insert_gacha_batch(IN p_user_id uuid, IN p_records jsonb)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: sp_sync_user_data(character varying, smallint, character varying, smallint, character varying, character varying, character varying, character varying, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, smallint[]); Type: PROCEDURE; Schema: public; Owner: -
--

CREATE PROCEDURE public.sp_sync_user_data(IN p_uid character varying, IN p_server_id smallint, IN p_nickname character varying, IN p_level smallint, IN p_avatar_id character varying, IN p_secretary character varying, IN p_secretary_skin_id character varying, IN p_resume_id character varying, IN p_operators jsonb, IN p_skills jsonb, IN p_modules jsonb, IN p_items jsonb, IN p_skins jsonb, IN p_status jsonb, IN p_stages jsonb, IN p_roguelike jsonb, IN p_sandbox jsonb, IN p_medals jsonb, IN p_building jsonb, IN p_checkin smallint[])
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_user_id UUID;
...
--
-- Name: sp_sync_user_data(character varying, smallint, character varying, smallint, character varying, character varying, character varying, character varying, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, jsonb, smallint[], jsonb, character varying, jsonb); Type: PROCEDURE; Schema: public; Owner: -
--

CREATE PROCEDURE public.sp_sync_user_data(IN p_uid character varying, IN p_server_id smallint, IN p_nickname character varying, IN p_level smallint, IN p_avatar_id character varying, IN p_secretary character varying, IN p_secretary_skin_id character varying, IN p_resume_id character varying, IN p_operators jsonb, IN p_skills jsonb, IN p_modules jsonb, IN p_items jsonb, IN p_skins jsonb, IN p_status jsonb, IN p_stages jsonb, IN p_roguelike jsonb, IN p_sandbox jsonb, IN p_medals jsonb, IN p_building jsonb, IN p_checkin smallint[], IN p_supports jsonb, IN p_nick_number character varying, IN p_enemies jsonb)
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_user_id UUID;
