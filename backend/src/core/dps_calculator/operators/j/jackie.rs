...
impl Jackie {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut aspd = if self.unit.talent_damage { self.unit.talent1_parameters[1] } else { 0.0 };
        ...
        let mut skilldmg = ((final_atk * self.unit.skill_parameters[0] - defense) as f64).max((final_atk * self.unit.skill_parameters[0] * 0.05) as f64);
