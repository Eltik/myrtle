...
impl Jessica {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        {
            (((self.unit.module_level as f64) as f64) - 1.0) * 0.03
        } else {
            0.0
        };
        if (self.unit.skill_index as f64) < 2.0 {
            ...
            let mut hitdmg_skill = ((final_atk * skill_scale - defense) as f64)
        ...
        if (self.unit.skill_index as f64) == 2.0 {
            final_atk = self.unit.atk
                * (1.0 + self.unit.buff_atk + atkbuff + self.unit.skill_parameters[0])
