...
impl ZuoLe {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        sp_recovery += if self.unit.talent_damage && self.unit.talent2_damage { self.unit.talent2_parameters[2] / (self.unit.attack_interval as f64) * (self.unit.attack_speed+aspd)/ 100.0 } else { self.unit.talent2_parameters[0] / (self.unit.attack_interval as f64) * (self.unit.attack_speed+aspd)/ 100.0 };
        }
        ...
        let mut apply_rate = if self.unit.talent_damage && self.unit.talent2_damage && ((self.unit.elite as f64) as f64) == 2.0 { self.unit.talent2_parameters[2] } else { 0.2 };
