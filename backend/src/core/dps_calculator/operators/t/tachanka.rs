...
impl Tachanka {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut newdef = if self.unit.skill_damage { ((0) as f64).max((defense - self.unit.skill_parameters[2]) as f64) } else { defense };
        ...
        hitdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64);
        critdmg = ((final_atk * self.unit.skill_parameters[2] - defense) as f64).max((final_atk * self.unit.skill_parameters[2] * 0.05) as f64);
        avghit = critdmg * self.unit.skill_parameters[1] + hitdmg * (1.0 -self.unit.skill_parameters[1]);
