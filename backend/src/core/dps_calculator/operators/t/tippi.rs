...
impl Tippi {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut hitdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64) * hits;
        let mut dps = hitdmg / (self.unit.attack_interval as f64) * self.unit.attack_speed / 100.0;
        return dps;
    }
}

impl std::ops::Deref for Tippi {
...
impl std::ops::DerefMut for Tippi {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Tippi {
