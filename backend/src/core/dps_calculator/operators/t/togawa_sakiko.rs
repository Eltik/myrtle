...
impl TogawaSakiko {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atk_scale = 1.0;
        atkbuff = if ((self.unit.skill_index as f64) as f64) == 2.0 && !self.unit.skill_damage { self.unit.skill_parameters[1] } else { 0.0 };
        ...
        resshred = if ((self.unit.module_index as f64) as f64) == 2.0 && ((self.unit.module_level as f64) as f64) > 1.0 { self.unit.talent1_parameters[4] * self.unit.talent1_parameters[1] } else { self.unit.talent1_parameters[4] * self.unit.talent1_parameters[2] };
        defshred = if ((self.unit.module_index as f64) as f64) == 2.0 && ((self.unit.module_level as f64) as f64) > 1.0 { self.unit.talent1_parameters[4] * self.unit.talent1_parameters[0] } else { self.unit.talent1_parameters[4] * self.unit.talent1_parameters[1] };
        }
        ...
        skill_scale = if self.unit.skill_damage { self.unit.skill_parameters[0] } else { self.unit.skill_parameters[7] };
        ...
        dps = hitdmgarts / (self.unit.attack_interval as f64) * (self.unit.attack_speed + aspd + self.unit.skill_parameters[0]) / 100.0;
        } else {
