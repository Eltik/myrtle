...
impl TogawaSakiko {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[
        ("skill", "maxSkillDmg", false, &[1], &[], 0, 0),
        ("skill", "Organ", false, &[], &[], 0, 0),
        ("talent", "maxNotes", false, &[], &[], 1, 0),
        ("talent", "minNotes", true, &[], &[], 1, 0),
        ("talent2", "fever", false, &[1], &[], 0, 0),
        ("module", "vs2+Enemy", false, &[], &[2], 0, 0),
    ];
