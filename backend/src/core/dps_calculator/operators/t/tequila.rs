...
impl Tequila {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("trait", "20Stacks", true, &[], &[], 0, 0), ("skill", "NotCharged", true, &[2], &[], 0, 0)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        if 0.0 /* self.hits - defaults to 0 */ == 0.0 || (self.unit.elite as f64) == 0.0 { return res * 0.0; }
