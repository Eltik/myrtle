...
impl Narantuya {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut stealbuff = if ((self.unit.elite as f64) as f64) > 0.0 && self.unit.talent_damage { self.unit.talent1_parameters[1] } else { 0.0 };
        ...
        skill_scale = if ((self.unit.skill_index as f64) as f64) == 3.0 { self.unit.skill_parameters[0] } else { 1.0 };
        let mut aoe_scale = if ((self.unit.skill_index as f64) as f64) == 3.0 { self.unit.skill_parameters[1] } else { 0.0 };
        final_atk = self.unit.atk * (1.0 + self.unit.buff_atk) + self.unit.buff_atk_flat + stealbuff;
