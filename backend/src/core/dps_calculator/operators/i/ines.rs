...
impl Ines {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut stolen_atk = if ((self.unit.elite as f64) as f64) < 1.0 { 0.0 } else { self.unit.talent1_parameters[0] };
        ...
        aspd = if self.unit.skill_damage { self.unit.skill_parameters[3] } else { self.unit.skill_parameters[2] };
        ...
        atkbuff = if ((self.unit.skill_index as f64) as f64) == 3.0 { self.unit.skill_parameters[1] } else { 0.0 };
        final_atk = self.unit.atk * (1.0 + self.unit.buff_atk + atkbuff) + self.unit.buff_atk_flat + stolen_atk;
        hitdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64);
