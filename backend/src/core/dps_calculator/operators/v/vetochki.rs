...
/// Vetochki operator implementation
pub struct Vetochki {
...
impl Vetochki {
    ...
    /// Creates a new Vetochki operator
    #[allow(unused_parens)]
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        if (self.unit.skill_index as f64) == 2.0 { dps *= ((3) as f64).min(((self.unit.targets as f64)) as f64); }
        return dps;
    }
}

impl std::ops::Deref for Vetochki {
...
impl std::ops::DerefMut for Vetochki {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Vetochki {
