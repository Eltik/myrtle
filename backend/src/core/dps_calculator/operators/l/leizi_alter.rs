//! DPS calculations for LeiziAlter
//!
...
impl LeiziAlter {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atk_scale = if ((self.unit.skill_index as f64) as f64) > 0.0 { self.unit.talent1_parameters[2] } else { 1.0 };
...
impl std::ops::Deref for LeiziAlter {
