...
impl Lemuen {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff = if self.unit.talent2_damage && ((self.unit.elite as f64) as f64) > 1.0 { self.unit.talent2_parameters[1] } else { 0.0 };
        ...
        atk_scale = if ((self.unit.skill_index as f64) as f64) == 1.0 { self.unit.skill_parameters[0] } else { 1.0 };
        ...
        final_atk = self.unit.atk * (1.0 + self.unit.buff_atk + atkbuff) + self.unit.buff_atk_flat;
        let mut ammo = if self.unit.talent2_damage { 5.0 + self.unit.talent2_parameters[2] } else { 5.0 };
        let mut centralhit_dmg = ((final_atk * self.unit.skill_parameters[4] - defense) as f64).max((final_atk * self.unit.skill_parameters[4] * 0.05) as f64) * dmg;
        let mut outerhit_dmg = ((final_atk * self.unit.skill_parameters[6] - defense) as f64).max((final_atk * self.unit.skill_parameters[6] * 0.05) as f64) * dmg;
    ...
    pub fn total_dmg(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut extra_ammo = if ((self.unit.elite as f64) as f64) > 1.0 && self.unit.talent2_damage { self.unit.talent2_parameters[2] } else { 0.0 };
