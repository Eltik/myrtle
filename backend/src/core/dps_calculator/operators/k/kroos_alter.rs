...
impl KroosAlter {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut atk_interval = if ((self.unit.skill_index as f64) as f64) == 2.0 { (self.unit.attack_interval as f64) * (1.0 + self.unit.skill_parameters[0]) } else { (self.unit.attack_interval as f64) };
