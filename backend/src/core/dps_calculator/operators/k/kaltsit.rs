...
impl Kaltsit {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        if (self.unit.skill_index as f64) == 2.0 {
        final_atk = self.unit.drone_atk * (1.0 + self.unit.buff_atk + self.unit.skill_parameters[1] + atkbuff) + self.unit.buff_atk_flat;
        hitdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64);
        ...
        final_atk = self.unit.drone_atk * (1.0 + self.unit.buff_atk + self.unit.skill_parameters[0] * 0.5 + atkbuff) + self.unit.buff_atk_flat;
