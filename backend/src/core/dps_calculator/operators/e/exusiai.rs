...
impl Exusiai {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut newdef = if ((self.unit.module_index as f64) as f64) == 2.0 && ((self.unit.module_level as f64) as f64) > 1.0 && self.unit.talent_damage { ((defense - self.unit.talent1_parameters[1]*self.unit.talent1_parameters[2]) as f64).max((0) as f64) } else { defense };
        ...
        skill_scale = if ((self.unit.skill_index as f64) as f64) > 0.0 { self.unit.skill_parameters[0] } else { 1.0 };
