...
impl ExecutorAlter {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut crit_rate = if ((self.unit.elite as f64) as f64) > 0.0 && ((self.unit.skill_index as f64) as f64) != 0.0 { self.unit.talent1_parameters[0] + self.unit.talent1_parameters[1] * 1.0 /* 1.0 /* self.ammo - needs manual implementation */ - needs manual implementation */ } else { 0.0 };
        ...
        atkbuff = if ((self.unit.skill_index as f64) as f64) > 0.0 { self.unit.skill_parameters[0] } else { 0.0 };
        ...
        atkbuff += 1.0 /* self.ammo - needs manual implementation */ * self.unit.skill_parameters[1];
        critdef = ((0) as f64).max((defense - critdefignore) as f64);
        final_atk = self.unit.atk * (1.0 + atkbuff + self.unit.buff_atk + modatkbuff) + self.unit.buff_atk_flat;
        hitdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64);
        critdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64) + ((final_atk - critdef) as f64).max((final_atk * 0.05) as f64);
