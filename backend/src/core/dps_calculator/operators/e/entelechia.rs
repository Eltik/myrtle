...
impl Entelechia {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut arts_dps = if ((self.unit.elite as f64) as f64) > 0.0 { ((self.unit.talent1_parameters[3] * (1.0 -res/ 100.0)) as f64).max((self.unit.talent1_parameters[3] * 0.05) as f64) * (self.unit.targets as f64) } else { 0.0 };
