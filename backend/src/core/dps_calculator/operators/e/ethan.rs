...
impl Ethan {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        hitdmgarts = ((self.unit.skill_parameters[0] * (1.0 -res/ 100.0)) as f64).max((self.unit.skill_parameters[0] * 0.05) as f64);
        let mut active_ratio = ((1) as f64).min((self.unit.skill_parameters[1]/ ((self.unit.attack_interval as f64) / self.unit.attack_speed * 100.0)) as f64);
        ...
        final_atk = self.unit.atk * (1.0 + self.unit.skill_parameters[0] * (self.unit.skill_index as f64)/ 2.0 + self.unit.buff_atk) + self.unit.buff_atk_flat;
        hitdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64);
