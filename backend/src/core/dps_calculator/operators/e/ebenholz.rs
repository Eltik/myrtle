...
impl Ebenholz {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atk_scale = if self.unit.talent_damage && ((self.unit.elite as f64) as f64) > 0.0 { self.unit.talent1_parameters[0] } else { 1.0 };
        eledmg = 0.0;
        let mut bonus_scale = if (self.unit.targets as f64) == 1.0 && ((self.unit.elite as f64) as f64) == 2.0 { self.unit.talent2_parameters[0] } else { 0.0 };
        ...
        let mut extra_scale = if ((self.unit.module_index as f64) as f64) == 2.0 && ((self.unit.module_level as f64) as f64) > 1.0 { self.unit.talent2_parameters[3] } else { 0.0 };
        if (self.unit.skill_index as f64) < 2.0 {
        skill_scale = if ((self.unit.skill_index as f64) as f64) == 1.0 { self.unit.skill_parameters[1] } else { 1.0 };
        atk_interval = if ((self.unit.skill_index as f64) as f64) == 1.0 { (self.unit.attack_interval as f64) * self.unit.skill_parameters[0] } else { (self.unit.attack_interval as f64) };
