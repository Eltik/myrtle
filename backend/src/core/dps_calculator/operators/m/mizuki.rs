...
impl Mizuki {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        bonusdmg = if ((self.unit.elite as f64) as f64) > 0.0 { self.unit.talent1_parameters[0] } else { 0.0 };
        let mut bonustargets = if ((self.unit.elite as f64) as f64) > 0.0 { self.unit.talent1_parameters[1] } else { 0.0 };
        atkbuff = if self.unit.talent2_damage { self.unit.talent2_parameters[1] } else { 0.0 };
        aspd = if ((self.unit.module_index as f64) as f64) == 3.0 && self.unit.module_damage { 50.0 } else { 0.0 };
        // UNTRANSLATED: if self.module == 3 and self.module_dmg and self.module_lvl > 1: bonustargets += 1
        ...
        let mut talent_scale = if ((self.unit.skill_index as f64) as f64) == 1.0 { self.unit.skill_parameters[1] } else { 1.0 };
