...
/// Mostima operator implementation
pub struct Mostima {
...
impl Mostima {
    ...
    /// Creates a new Mostima operator
    #[allow(unused_parens)]
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        dps = ((final_atk  * skill_scale * (1.0 -res/ 100.0)) as f64).max((final_atk * skill_scale * 0.05) as f64);
        }
        if (self.unit.skill_index as f64) != 2.0 {
...
impl std::ops::Deref for Mostima {
...
impl std::ops::DerefMut for Mostima {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Mostima {
