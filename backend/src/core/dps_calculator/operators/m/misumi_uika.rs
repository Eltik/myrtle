...
impl MisumiUika {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        skill_scale = self.unit.skill_parameters.get(2).copied().unwrap_or(0.0) + self.unit.talent2_parameters.get(1).copied().unwrap_or(0.0);
...
impl DpsCalculator for MisumiUika {
