...
impl Matoimaru {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("module", "afterRevive", false, &[], &[2], 0, 0)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut aspd = if self.unit.module_damage && ((self.unit.module_index as f64) as f64) == 2.0 { 30.0 } else { 0.0 };
...
impl DpsCalculator for Matoimaru {
