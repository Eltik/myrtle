...
/// Beeswax operator implementation
pub struct Beeswax {
...
impl Beeswax {
    ...
    /// Creates a new Beeswax operator
    #[allow(unused_parens)]
...
impl std::ops::Deref for Beeswax {
...
impl std::ops::DerefMut for Beeswax {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Beeswax {
