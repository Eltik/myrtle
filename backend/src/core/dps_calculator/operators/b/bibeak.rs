...
impl Bibeak {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff = if self.unit.talent_damage && ((self.unit.module_index as f64) as f64) == 1.0 && ((self.unit.module_level as f64) as f64) > 1.0 { 0.01 * (((self.unit.module_level as f64) as f64)-1.0) * self.unit.talent1_parameters[1] } else { 0.0 };
        ...
        skillartsdmg = ((final_atk * skill_scale * (1.0 -res/ 100.0)) as f64).max((final_atk * skill_scale * 0.05) as f64) * dmg_multiplier;
        let mut avg_hit = (2.0 * hitdmg * (self.unit.skill_cost as f64) + skillartsdmg * (((self.unit.targets as f64)) as f64).min((self.unit.skill_parameters[0]) as f64)) / (self.unit.skill_cost as f64);
