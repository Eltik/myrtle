...
impl BluePoison {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        hitdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64);
        dps = self.unit.skill_parameters[1] * hitdmg/((self.unit.attack_interval as f64)/((self.unit.attack_speed+ aspd)/ 100.0)) + hitdmg/((self.unit.attack_interval as f64)/((self.unit.attack_speed+ aspd)/ 100.0)) * ((2) as f64).min(((self.unit.targets as f64)-1.0) as f64) + artsdps * ((3) as f64).min(((self.unit.targets as f64)) as f64);
        }
        return dps;
    }
}
