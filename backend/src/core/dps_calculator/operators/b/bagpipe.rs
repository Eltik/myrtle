...
impl Bagpipe {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("module", "lowHpTarget", false, &[], &[2], 0, 0)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        cdmg = if ((self.unit.elite as f64) as f64) > 0.0 { self.unit.talent1_parameters.get(0).copied().unwrap_or(0.0) } else { 1.0 };
