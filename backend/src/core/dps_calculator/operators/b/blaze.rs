...
impl Blaze {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[
        ("talent2", "w/o talent2", true, &[2], &[], 2, 0),
        ("module", "vsBlocked", false, &[], &[1], 0, 0),
        ("module", ">50%hp", false, &[], &[2], 0, 2),
    ];
    ...
    /// if (self.talent2_dmg or self.skill == 2) and self.module == 1 and self.module_lvl > 1:
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        {
            ((0) as f64).max((defense - 150.0) as f64)
        } else {
            defense
        };
        atkbuff = 0.0;
        ...
        if (self.unit.talent2_damage || (self.unit.skill_index as f64) == 2.0)
