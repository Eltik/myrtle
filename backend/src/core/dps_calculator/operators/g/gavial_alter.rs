...
impl GavialAlter {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut block = if ((self.unit.skill_index as f64) as f64) == 3.0 {
            5.0
        } else {
            3.0
        };
        ...
        let mut dmg = if ((self.unit.module_index as f64) as f64) == 2.0 {
            0.95 + ((self.unit.module_level as f64) as f64) * 0.05
        } else {
            1.0
        };
        ...
        let mut aspd = if ((self.unit.skill_index as f64) as f64) == 3.0 {
