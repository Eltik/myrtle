...
impl GavialAlter {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff += self.unit.skill_parameters[0] * (((self.unit.skill_index as f64)) as f64).min((1) as f64);
        let mut final_atk = self.unit.atk * (1.0 + atkbuff + self.unit.buff_atk) + self.unit.buff_atk_flat;
        let mut aspd = if ((self.unit.skill_index as f64) as f64) == 3.0 { self.unit.skill_parameters[1] } else { 0.0 };
