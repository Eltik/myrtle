...
impl GreyyAlter {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut dmg = if ((self.unit.module_index as f64) as f64) == 1.0 && ((self.unit.module_level as f64) as f64) > 1.0 { 1.0 + 0.05 * ((self.unit.module_level as f64) as f64) } else { 1.0 };
        ...
        bonusdmg = ((final_atk * 0.5 - defense) as f64).max((final_atk * 0.5 * 0.05) as f64) * dmg;
        dps = (hitdmg + bonusdmg * bonushits) / (self.unit.attack_interval as f64) * (self.unit.attack_speed + aspd) / 100.0 * (self.unit.targets as f64);
        }
        if (self.unit.skill_index as f64) == 2.0 {
        ...
        dps = (hitdmg + bonusdmg * bonushits) / (self.unit.attack_interval as f64) * (self.unit.attack_speed) / 100.0 * (self.unit.targets as f64);
