...
impl Gracebearer {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff = if self.unit.talent_damage { self.unit.talent1_parameters[0] + self.unit.talent1_parameters[1] } else { self.unit.talent1_parameters[0] };
        }
        ...
        dps += 3.0 * skilldmg/(((self.unit.skill_cost as f64) + 1.2)/(1.0 +(self.unit.sp_boost as f64))) * (((self.unit.targets as f64)) as f64).min((self.unit.skill_parameters[1]) as f64);
        }
        return dps;
    }
}
