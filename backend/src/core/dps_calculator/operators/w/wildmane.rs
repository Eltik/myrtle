...
/// Wildmane operator implementation
pub struct Wildmane {
...
impl Wildmane {
    ...
    /// Creates a new Wildmane operator
...
impl std::ops::Deref for Wildmane {
...
impl std::ops::DerefMut for Wildmane {
