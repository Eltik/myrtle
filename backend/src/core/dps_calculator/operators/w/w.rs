...
impl W {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[
        ("talent2", "vsStun", false, &[], &[], 2, 0),
        ("talent", "noDmgTaken", false, &[], &[2], 0, 2),
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff = if ((self.unit.module_index as f64) as f64) == 2.0 && self.unit.talent2_damage {
            0.1 * (((self.unit.module_level as f64) as f64) - 1.0)
        } else {
            0.0
        };
        ...
        if (self.unit.skill_index as f64) == 3.0 {
            ...
            dps = (hitdmg
                / ((self.unit.attack_interval as f64) / (self.unit.attack_speed / 100.0))
                + skilldmg * ((targets) as f64).min((self.unit.targets as f64) as f64) / sp_cost)
                * (self.unit.targets as f64);
        }
        return dps;
    }
