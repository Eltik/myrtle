...
impl WakabaMutsumi {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        dps = 3.0 * hitdmg / ((self.unit.attack_interval as f64)+self.unit.skill_parameters.get(0).copied().unwrap_or(0.0)) * self.unit.attack_speed / 100.0;
        } else {
...
impl DpsCalculator for WakabaMutsumi {
