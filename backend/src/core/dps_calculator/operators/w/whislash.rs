...
impl Whislash {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut aspd = if ((self.unit.skill_index as f64) as f64) == 2.0 { talent_buff * self.unit.skill_parameters[0] } else { 0.5 * talent_buff * self.unit.skill_parameters[0] * ((self.unit.skill_index as f64) as f64) };
