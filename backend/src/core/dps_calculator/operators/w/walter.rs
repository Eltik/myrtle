...
impl Walter {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut maintargetscale = if ((self.unit.elite as f64) as f64) == 0.0 { 1.0 } else { self.unit.talent1_parameters[0] };
        let mut explosionscale = if ((self.unit.elite as f64) as f64) == 0.0 { 0.0 } else { self.unit.talent1_parameters[2] };
        ...
        atk_scale = if self.unit.skill_damage { self.unit.skill_parameters[2] } else { 1.0 };
        ...
        // UNTRANSLATED: if self.skill_dmg: dps *= 4
