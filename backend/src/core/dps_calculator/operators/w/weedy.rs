...
impl Weedy {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("talent", "+cannon", false, &[], &[1], 1, 2), ("module", "nextToCannon", false, &[], &[1], 0, 2)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        if (self.unit.module_level as f64) == 2.0 { atkbuff += 0.15; }
        if (self.unit.module_level as f64) == 3.0 { atkbuff += 0.2; }
        }
