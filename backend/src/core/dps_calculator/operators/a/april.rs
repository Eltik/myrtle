...
impl April {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("module", "groundEnemies", false, &[], &[2], 0, 0)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        skilldmg = ((final_atk * self.unit.skill_parameters.get(0).copied().unwrap_or(0.0) - defense) as f64).max((final_atk * self.unit.skill_parameters.get(0).copied().unwrap_or(0.0) * 0.05) as f64);
