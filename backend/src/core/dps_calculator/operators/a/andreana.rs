...
impl Andreana {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("module", "atMaxRange", false, &[], &[1], 0, 0)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut dps = hitdmg/(self.unit.attack_interval as f64) * (self.unit.attack_speed + self.unit.talent1_parameters.get(0).copied().unwrap_or(0.0))/ 100.0;
        return dps;
    }
}
