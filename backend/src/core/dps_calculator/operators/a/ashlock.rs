...
impl Ashlock {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut atkbuff = if self.unit.talent_damage { self.unit.talent1_parameters[1] } else { self.unit.talent1_parameters[0] };
        ...
        let mut atk_interval = if ((self.unit.skill_index as f64) as f64) != 2.0 { (self.unit.attack_interval as f64) } else { (self.unit.attack_interval as f64) * (1.0 + self.unit.skill_parameters[1]) };
