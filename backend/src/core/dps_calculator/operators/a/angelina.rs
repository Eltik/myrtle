...
impl Angelina {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        if (self.unit.module_level as f64) == 2.0 { aspd += 3.0; }
        if (self.unit.module_level as f64) == 3.0 { aspd += 5.0; }
        }
        ...
        hitdmg = ((final_atk * (1.0 -res/ 100.0)) as f64).max((final_atk * 0.05) as f64);
        dps = hitdmg/(self.unit.attack_interval as f64) * (self.unit.attack_speed + aspd)/ 100.0 * (((self.unit.targets as f64)) as f64).min((targets) as f64);
        }
        return dps;
    }
}
