...
impl Hoshiguma {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff = if ((self.unit.module_index as f64) as f64) == 2.0 && ((self.unit.module_level as f64) as f64) > 1.0 && self.unit.module_damage { self.unit.talent1_parameters[1] } else { 0.0 };
        let mut targets = if ((self.unit.skill_index as f64) as f64) == 3.0 { (self.unit.targets as f64) } else { 1.0 };
        // UNTRANSLATED: if self.skill == 3: atkbuff += self.skill_params[0]
