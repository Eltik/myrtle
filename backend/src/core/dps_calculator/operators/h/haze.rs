...
impl Haze {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut newres = ((0) as f64).max((res-resignore) as f64) * (1.0 + self.unit.talent1_parameters[1]);
        let mut atkbuff = if ((self.unit.skill_index as f64) as f64) < 2.0 { self.unit.skill_parameters[0] * ((self.unit.skill_index as f64) as f64) } else { self.unit.skill_parameters[1] };
