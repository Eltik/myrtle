...
/// Hellagur operator implementation
pub struct Hellagur {
...
impl Hellagur {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff = if ((self.unit.skill_index as f64) as f64) > 1.0 { self.unit.skill_parameters[0] } else { 0.0 };
...
impl std::ops::Deref for Hellagur {
...
impl std::ops::DerefMut for Hellagur {
