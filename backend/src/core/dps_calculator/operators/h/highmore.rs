...
/// Highmore operator implementation
pub struct Highmore {
...
impl Highmore {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("talent", "in IS3", false, &[], &[], 0, 0)];

    /// Creates a new Highmore operator
    #[allow(unused_parens)]
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        aspd = if self.unit.talent_damage { self.unit.talent2_parameters.get(0).copied().unwrap_or(0.0) } else { 0.0 };
...
impl std::ops::Deref for Highmore {
...
impl std::ops::DerefMut for Highmore {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Highmore {
