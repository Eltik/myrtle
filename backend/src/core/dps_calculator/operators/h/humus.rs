...
impl Humus {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("skill", ">80%Hp", false, &[], &[], 0, 0)];

    /// Creates a new Humus operator
    #[allow(unused_parens)]
...
impl std::ops::DerefMut for Humus {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Humus {
