...
impl Harmonie {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atk_scale = if ((self.unit.elite as f64) as f64) > 0.0 && self.unit.talent_damage || ((self.unit.skill_index as f64) as f64) == 2.0 { self.unit.talent1_parameters[0] } else { 1.0 };
        ...
        let mut extra_dps = ((self.unit.skill_parameters[0] * (1.0 -res/ 100.0)) as f64).max((self.unit.skill_parameters[0] * 0.05) as f64) * (self.unit.targets as f64);
