...
impl Dorothy {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff = if self.unit.talent2_damage { self.unit.talent2_parameters[0] * self.unit.talent2_parameters[1] } else { 0.0 };
        ...
        let mut mine_scale = if self.unit.trait_damage && ((self.unit.skill_index as f64) as f64) > 0.0 { self.unit.skill_parameters[1] } else { 0.0 };
