...
impl Chongyue {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut dmg = if ((self.unit.elite as f64) as f64) > 0.0 { self.unit.talent1_parameters[1] } else { 1.0 };
        let mut duration = if ((self.unit.elite as f64) as f64) > 0.0 { self.unit.talent1_parameters[2] } else { 0.0 };
        ...
        relevant_hits = ((duration/((self.unit.attack_interval as f64) /(self.unit.attack_speed+aspd) as f64).trunc()*100.0)) + 1.0;
        ...
        relevant_hits = ((duration/((self.unit.attack_interval as f64) /(self.unit.attack_speed+aspd) as f64).trunc()*100.0)) * 2.0 + 2.0;
