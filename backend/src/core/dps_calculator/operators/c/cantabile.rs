...
impl Cantabile {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut atkbuff = if self.unit.talent_damage { self.unit.talent1_parameters[1] } else { 0.0 };
        let mut aspd = if !self.unit.talent_damage { self.unit.talent1_parameters[0] } else { 0.0 };
