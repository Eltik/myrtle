...
/// Castle3 operator implementation
pub struct Castle3 {
...
impl Castle3 {
    ...
    /// Creates a new Castle3 operator
    #[allow(unused_parens)]
...
impl std::ops::Deref for Castle3 {
...
impl std::ops::DerefMut for Castle3 {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Castle3 {
