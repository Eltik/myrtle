...
impl CivilightEterna {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("module", "noModBonus", true, &[], &[1], 0, 0)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        hitdmg = ((final_atk * skill_scale - defense) as f64).max((final_atk * skill_scale) as f64);
        dps = hitdmg / 7.0 * 6.0;
        }
        else { dps = res * 0.0; }
        return dps;
...
impl DpsCalculator for CivilightEterna {
