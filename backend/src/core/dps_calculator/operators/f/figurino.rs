...
impl Figurino {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut dmg_scale = if ((self.unit.elite as f64) as f64) > 0.0 && self.unit.talent_damage { self.unit.talent1_parameters[0] } else { 1.0 };
        ...
        dps = hitdmg * (((self.unit.targets as f64)) as f64).min((self.unit.skill_parameters[1]) as f64);
        }
        return dps;
    }
}
