...
impl Siege {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        if (self.unit.module_index as f64) == 1.0 && (self.unit.module_level as f64) > 1.0 { atkbuff += 0.02 + 0.02 * (self.unit.module_level as f64); }
        ...
        hitdmg = ((final_atk - defense) as f64).max((final_atk * 0.05) as f64);
        skilldmg = ((final_atk * skill_scale - defense) as f64).max((final_atk * skill_scale * 0.05) as f64) * (self.unit.targets as f64);
