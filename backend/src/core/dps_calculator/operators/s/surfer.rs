...
/// Surfer operator implementation
pub struct Surfer {
...
impl std::ops::DerefMut for Surfer {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Surfer {
