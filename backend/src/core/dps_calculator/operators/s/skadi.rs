...
impl Skadi {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut atkbuff = self.unit.talent1_parameters[0] + self.unit.skill_parameters[0] * (((self.unit.skill_index as f64)) as f64).min((1) as f64);
        let mut aspd = if ((self.unit.skill_index as f64) as f64) != 1.0 { 0.0 } else { self.unit.skill_parameters[1] };
