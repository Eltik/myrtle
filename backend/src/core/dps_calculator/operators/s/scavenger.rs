//! DPS calculations for Scavenger
//!
...
/// Scavenger operator implementation
...
impl Scavenger {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("talent", "adjacentAlly", true, &[], &[], 1, 0), ("module", "blocking", false, &[], &[1], 0, 0)];

    /// Creates a new Scavenger operator
    #[allow(unused_parens)]
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut atkbuff = if ((self.unit.module_index as f64) as f64) == 1.0 && self.unit.module_damage { 0.08 } else { 0.0 };
...
impl std::ops::Deref for Scavenger {
...
impl std::ops::DerefMut for Scavenger {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Scavenger {
