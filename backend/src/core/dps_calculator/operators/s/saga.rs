...
impl Saga {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("module", "blocking", false, &[], &[1], 0, 0), ("talent", "vsLowHp", false, &[], &[1], 0, 2)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        hitdmg = ((final_atk  - defense) as f64).max((final_atk * 0.05) as f64);
        dps = hitdmg/atk_interval * self.unit.attack_speed/ 100.0 * (((self.unit.targets as f64)) as f64).min((2) as f64);
        }
        return dps * (1.0 +dmg);
    }
}
