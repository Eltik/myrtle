...
impl Qiubai {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        extrascale = if ((self.unit.elite as f64) as f64) > 0.0 { self.unit.talent1_parameters[0] } else { 0.0 };
        ...
        aspd = if self.unit.skill_damage { self.unit.skill_parameters[1] * self.unit.skill_parameters[2] } else { 0.0 };
