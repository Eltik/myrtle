...
impl Utage {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        if (self.unit.skill_index as f64) == 1.0 { return 0.0 * res; }
        aspd = if self.unit.talent_damage { self.unit.talent1_parameters.get(0).copied().unwrap_or(0.0) } else { 0.0 };
        atkbuff = if ((self.unit.module_index as f64) as f64) == 1.0 && ((self.unit.module_level as f64) as f64) > 1.0 && self.unit.talent_damage { 0.01 + 0.01 * ((self.unit.module_level as f64) as f64) } else { 0.0 };
...
impl std::ops::DerefMut for Utage {
    fn deref_mut(&mut self) -> &mut Self::Target {
        &mut self.unit
    }
}

impl DpsCalculator for Utage {
