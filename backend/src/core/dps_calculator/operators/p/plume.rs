...
impl Plume {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut dps = hitdmg / (self.unit.attack_interval as f64) * (self.unit.attack_speed + self.unit.skill_parameters.get(1).copied().unwrap_or(0.0) * (self.unit.skill_index as f64)) / 100.0;
        return dps;
    }
}
