...
impl Pepe {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        dps = hitdmg/((self.unit.attack_interval as f64)/((self.unit.attack_speed+aspd)/ 100.0)) + hitdmgaoe/((self.unit.attack_interval as f64)/((self.unit.attack_speed+aspd)/ 100.0))*((self.unit.targets as f64) - 1.0);
        }
        ...
        hitdmg = ((final_atk * atk_scale - defense) as f64).max((final_atk * atk_scale * 0.05) as f64);
        hitdmgaoe = ((0.5 * final_atk * atk_scale - defense) as f64).max((0.5 * final_atk * atk_scale * 0.05) as f64);
        dps = hitdmg/((self.unit.attack_interval as f64)/(self.unit.attack_speed/ 100.0)) + hitdmgaoe/((self.unit.attack_interval as f64)/(self.unit.attack_speed/ 100.0))*((self.unit.targets as f64) - 1.0);
        }
        return dps;
    }
}
