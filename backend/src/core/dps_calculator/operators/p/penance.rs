...
impl Penance {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atkbuff = if ((self.unit.module_index as f64) as f64) == 2.0 && self.unit.module_damage { 0.08 } else { 0.0 };
        ...
        let mut arts_scale = self.unit.talent2_parameters.get(0).copied().unwrap_or(0.0);
...
impl DpsCalculator for Penance {
