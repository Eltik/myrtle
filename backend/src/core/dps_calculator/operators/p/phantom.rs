...
impl Phantom {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("talent", "with clone", false, &[], &[], 1, 0), ("module", "adjacentAllies", true, &[], &[2], 0, 0)];
    ...
    pub fn new(operator_data: OperatorData, params: OperatorParams) -> Self {
        ...
        if unit.module_index == 2 && unit.module_level == 3 { unit.drone_atk += 60.0; }
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut count = ((self.unit.skill_parameters.get(0).copied().unwrap_or(0.0)) as f64).trunc();
...
impl DpsCalculator for Phantom {
