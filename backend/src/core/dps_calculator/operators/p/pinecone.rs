...
impl Pinecone {
    ...
    pub const CONDITIONALS: &'static [ConditionalTuple] = &[("trait", "maxRange", true, &[1], &[], 0, 0), ("talent", "withSPboost", false, &[1], &[], 0, 0), ("skill", "4thActivation", false, &[], &[], 0, 0)];
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        if self.unit.talent_damage { sp_cost = sp_cost / (1.0 + self.unit.talent1_parameters.get(0).copied().unwrap_or(0.0)); }
        ...
        if self.unit.skill_damage { atkbuff += 0.6; }
