...
impl Ray {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        atk_scale = 1.2;
        let mut dmg_scale = if self.unit.talent_damage && ((self.unit.elite as f64) as f64) > 0.0 { 1.0 + self.unit.talent1_parameters[0] } else { 1.0 };
        atkbuff = if self.unit.talent2_damage && ((self.unit.elite as f64) as f64) == 2.0 { self.unit.talent2_parameters[0] * self.unit.talent2_parameters[1] } else { 0.0 };
