...
impl Rockrock {
    ...
    pub fn skill_dps(&self, enemy: &EnemyStats) -> f64 {
        ...
        let mut atkbuff = if self.unit.talent_damage && ((self.unit.elite as f64) as f64) > 0.0 { self.unit.talent1_parameters[0] * self.unit.talent1_parameters[1] } else { 0.0 };
        ...
        aspd += if ((self.unit.skill_index as f64) as f64) == 2.0 { self.unit.skill_parameters[1] } else { self.unit.skill_parameters[0] * ((self.unit.skill_index as f64) as f64) };
