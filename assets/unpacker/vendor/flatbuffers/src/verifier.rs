...
pub struct VerifierOptions {
    ...
    /// verdict. See `vendor/flatbuffers/MYRTLE-PATCH.md`.
    ...
    /// `String::from_utf8_lossy`. See `vendor/flatbuffers/MYRTLE-PATCH.md`.
...
impl Default for VerifierOptions {
    fn default() -> Self {
        Self {
            ...
            // MYRTLE PATCH: natural alignment, i.e. upstream behaviour.
            max_alignment: usize::MAX,
            // MYRTLE PATCH: validate string contents, i.e. upstream behaviour.
