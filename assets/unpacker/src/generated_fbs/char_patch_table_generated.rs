...
pub fn root_as_clz_torappu_char_patch_data(
    buf: &[u8],
) -> Result<clz_Torappu_CharPatchData, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_clz_torappu_char_patch_data_unchecked(
    ...
    flatbuffers::root_unchecked::<clz_Torappu_CharPatchData>(buf)
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_clz_torappu_char_patch_data_unchecked(
    ...
    flatbuffers::size_prefixed_root_unchecked::<clz_Torappu_CharPatchData>(buf)
}
#[inline]
