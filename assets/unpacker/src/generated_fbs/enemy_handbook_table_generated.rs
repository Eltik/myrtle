...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_ENEMY_HAND_BOOK_DATA_TEXT_FORMAT: [enum__Torappu_EnemyHandBookData_TextFormat; 3] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_EnemyHandBookData_TextFormat {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_EnemyHandBookData_TextFormat variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_ENEMY_HAND_BOOK_DAMAGE_TYPE: [enum__Torappu_EnemyHandBookDamageType; 4] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_EnemyHandBookDamageType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_EnemyHandBookDamageType variant: {s}"
        )))
    }
}
...
impl<'a> clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_EnemyHandbookLevelInfoData_RangePairT {
    let min = self.min();
    let max = self.max();
    clz_Torappu_EnemyHandbookLevelInfoData_RangePairT {
      min,
      max,
    }
  }
  ...
  pub fn min(&self) -> f32 {
    ...
    unsafe { self._tab.get::<f32>(clz_Torappu_EnemyHandbookLevelInfoData_RangePair::VT_MIN, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn max(&self) -> f32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(clz_Torappu_EnemyHandbookLevelInfoData_RangePair::VT_MAX, Some(0.0)).unwrap()}
  }
}
...
impl<'a> Default for clz_Torappu_EnemyHandbookLevelInfoData_RangePairArgs {
  #[inline]
  fn default() -> Self {
    clz_Torappu_EnemyHandbookLevelInfoData_RangePairArgs {
      min: 0.0,
      max: 0.0,
    }
  }
...
pub struct clz_Torappu_EnemyHandbookLevelInfoData_RangePairBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_EnemyHandbookLevelInfoData_RangePairBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_min(&mut self, min: f32) {
    self.fbb_.push_slot::<f32>(clz_Torappu_EnemyHandbookLevelInfoData_RangePair::VT_MIN, min, 0.0);
  }
  #[inline]
  pub fn add_max(&mut self, max: f32) {
    self.fbb_.push_slot::<f32>(clz_Torappu_EnemyHandbookLevelInfoData_RangePair::VT_MAX, max, 0.0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_EnemyHandbookLevelInfoData_RangePairBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
...
impl clz_Torappu_EnemyHandbookLevelInfoData_RangePairT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let min = self.min;
    let max = self.max;
    clz_Torappu_EnemyHandbookLevelInfoData_RangePair::create(_fbb, &clz_Torappu_EnemyHandbookLevelInfoData_RangePairArgs{
      min,
      max,
    })
  }
...
impl<'a> clz_Torappu_EnemyHandbookLevelInfoData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.enemyRes { builder.add_enemyRes(x); }
    if let Some(x) = args.enemyDamageRes { builder.add_enemyDamageRes(x); }
    ...
    if let Some(x) = args.magicRes { builder.add_magicRes(x); }
    if let Some(x) = args.def { builder.add_def(x); }
    if let Some(x) = args.attack { builder.add_attack(x); }
    if let Some(x) = args.classLevel { builder.add_classLevel(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_EnemyHandbookLevelInfoDataT {
    let classLevel = self.classLevel().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let attack = self.attack().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
    let def = self.def().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
    let magicRes = self.magicRes().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
    ...
    let enemyDamageRes = self.enemyDamageRes().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
    let enemyRes = self.enemyRes().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
  ...
  pub fn classLevel(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_CLASSLEVEL, None)}
  }
  #[inline]
  pub fn attack(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_ATTACK, None)}
  }
  #[inline]
  pub fn def(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_DEF, None)}
  }
  #[inline]
  pub fn magicRes(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_MAGICRES, None)}
  }
  #[inline]
  pub fn maxHP(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_MAXHP, None)}
  }
  #[inline]
  pub fn moveSpeed(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_MOVESPEED, None)}
  }
  #[inline]
  pub fn attackSpeed(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_ATTACKSPEED, None)}
  }
  #[inline]
  pub fn enemyDamageRes(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_ENEMYDAMAGERES, None)}
  }
  #[inline]
  pub fn enemyRes(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_ENEMYRES, None)}
  }
}
...
pub struct clz_Torappu_EnemyHandbookLevelInfoDataArgs<'a> {
    ...
    pub attack: Option<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>>>,
    pub def: Option<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>>>,
    pub magicRes: Option<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>>>,
    pub maxHP: Option<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>>>,
    pub moveSpeed: Option<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>>>,
    pub attackSpeed: Option<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>>>,
    pub enemyDamageRes: Option<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>>>,
    pub enemyRes: Option<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_EnemyHandbookLevelInfoDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_classLevel(&mut self, classLevel: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandbookLevelInfoData::VT_CLASSLEVEL, classLevel);
  }
  #[inline]
  pub fn add_attack(&mut self, attack: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'b >>) {
  ...
  #[inline]
  pub fn add_def(&mut self, def: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'b >>) {
  ...
  #[inline]
  pub fn add_magicRes(&mut self, magicRes: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'b >>) {
  ...
  #[inline]
  pub fn add_maxHP(&mut self, maxHP: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'b >>) {
  ...
  #[inline]
  pub fn add_moveSpeed(&mut self, moveSpeed: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'b >>) {
  ...
  #[inline]
  pub fn add_attackSpeed(&mut self, attackSpeed: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'b >>) {
  ...
  #[inline]
  pub fn add_enemyDamageRes(&mut self, enemyDamageRes: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'b >>) {
  ...
  #[inline]
  pub fn add_enemyRes(&mut self, enemyRes: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'b >>) {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_EnemyHandbookLevelInfoDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_EnemyHandbookLevelInfoDataT {
  pub classLevel: Option<alloc::string::String>,
  pub attack: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
  pub def: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
  pub magicRes: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
  pub maxHP: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
  pub moveSpeed: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
  pub attackSpeed: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
  pub enemyDamageRes: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
  pub enemyRes: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
}
...
impl clz_Torappu_EnemyHandbookLevelInfoDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let classLevel = self.classLevel.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let attack = self.attack.as_ref().map(|x|{
      x.pack(_fbb)
    });
    let def = self.def.as_ref().map(|x|{
      x.pack(_fbb)
    });
    let magicRes = self.magicRes.as_ref().map(|x|{
      x.pack(_fbb)
    });
    ...
    let enemyDamageRes = self.enemyDamageRes.as_ref().map(|x|{
      x.pack(_fbb)
    });
    let enemyRes = self.enemyRes.as_ref().map(|x|{
      x.pack(_fbb)
    });
    clz_Torappu_EnemyHandbookLevelInfoData::create(_fbb, &clz_Torappu_EnemyHandbookLevelInfoDataArgs{
      classLevel,
      attack,
      def,
      magicRes,
...
impl<'a> clz_Torappu_EnemyHandBookData_Abilty<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_EnemyHandBookData_AbiltyT {
    ...
    clz_Torappu_EnemyHandBookData_AbiltyT {
      text,
      textFormat,
    }
  }
  ...
  pub fn text(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandBookData_Abilty::VT_TEXT, None)}
  }
  #[inline]
  pub fn textFormat(&self) -> enum__Torappu_EnemyHandBookData_TextFormat {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_EnemyHandBookData_TextFormat>(clz_Torappu_EnemyHandBookData_Abilty::VT_TEXTFORMAT, Some(enum__Torappu_EnemyHandBookData_TextFormat::NORMAL)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_EnemyHandBookData_Abilty<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<enum__Torappu_EnemyHandBookData_TextFormat>("textFormat", Self::VT_TEXTFORMAT, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_EnemyHandBookData_AbiltyBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_text(&mut self, text: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData_Abilty::VT_TEXT, text);
  }
  #[inline]
  pub fn add_textFormat(&mut self, textFormat: enum__Torappu_EnemyHandBookData_TextFormat) {
    self.fbb_.push_slot::<enum__Torappu_EnemyHandBookData_TextFormat>(clz_Torappu_EnemyHandBookData_Abilty::VT_TEXTFORMAT, textFormat, enum__Torappu_EnemyHandBookData_TextFormat::NORMAL);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_EnemyHandBookData_AbiltyBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_EnemyHandBookData_AbiltyT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let textFormat = self.textFormat;
    clz_Torappu_EnemyHandBookData_Abilty::create(_fbb, &clz_Torappu_EnemyHandBookData_AbiltyArgs{
      text,
      textFormat,
    })
  }
...
impl<'a> clz_Torappu_EnemyHandBookData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.damageType { builder.add_damageType(x); }
    if let Some(x) = args.linkEnemies { builder.add_linkEnemies(x); }
    if let Some(x) = args.abilityList { builder.add_abilityList(x); }
    if let Some(x) = args.overrideKillCntInfos { builder.add_overrideKillCntInfos(x); }
    if let Some(x) = args.ability { builder.add_ability(x); }
    if let Some(x) = args.attackType { builder.add_attackType(x); }
    ...
    if let Some(x) = args.enemyIndex { builder.add_enemyIndex(x); }
    if let Some(x) = args.enemyId { builder.add_enemyId(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_EnemyHandBookDataT {
    let enemyId = self.enemyId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let enemyIndex = self.enemyIndex().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    ...
    let attackType = self.attackType().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let ability = self.ability().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let isInvalidKilled = self.isInvalidKilled();
    let overrideKillCntInfos = self.overrideKillCntInfos().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let hideInHandbook = self.hideInHandbook();
    let hideInStage = self.hideInStage();
    let abilityList = self.abilityList().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let linkEnemies = self.linkEnemies().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
    let damageType = self.damageType().map(|x| {
      x.into_iter().collect()
    });
  ...
  pub fn enemyId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandBookData::VT_ENEMYID, None)}
  }
  #[inline]
  pub fn enemyIndex(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandBookData::VT_ENEMYINDEX, None)}
  }
  #[inline]
  pub fn enemyTags(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_EnemyHandBookData::VT_ENEMYTAGS, None)}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_EnemyHandBookData::VT_SORTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandBookData::VT_NAME, None)}
  }
  #[inline]
  pub fn enemyLevel(&self) -> enum__Torappu_EnemyLevelType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_EnemyLevelType>(clz_Torappu_EnemyHandBookData::VT_ENEMYLEVEL, Some(enum__Torappu_EnemyLevelType::NORMAL)).unwrap()}
  }
  #[inline]
  pub fn description(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandBookData::VT_DESCRIPTION, None)}
  }
  #[inline]
  pub fn attackType(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandBookData::VT_ATTACKTYPE, None)}
  }
  #[inline]
  pub fn ability(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandBookData::VT_ABILITY, None)}
  }
  #[inline]
  pub fn isInvalidKilled(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_EnemyHandBookData::VT_ISINVALIDKILLED, Some(false)).unwrap()}
  }
  #[inline]
  pub fn overrideKillCntInfos(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int>>>>(clz_Torappu_EnemyHandBookData::VT_OVERRIDEKILLCNTINFOS, None)}
  }
  #[inline]
  pub fn hideInHandbook(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_EnemyHandBookData::VT_HIDEINHANDBOOK, Some(false)).unwrap()}
  }
  #[inline]
  pub fn hideInStage(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_EnemyHandBookData::VT_HIDEINSTAGE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn abilityList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandBookData_Abilty<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandBookData_Abilty>>>>(clz_Torappu_EnemyHandBookData::VT_ABILITYLIST, None)}
  }
  #[inline]
  pub fn linkEnemies(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_EnemyHandBookData::VT_LINKENEMIES, None)}
  }
  #[inline]
  pub fn damageType(&self) -> Option<::flatbuffers::Vector<'a, enum__Torappu_EnemyHandBookDamageType>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, enum__Torappu_EnemyHandBookDamageType>>>(clz_Torappu_EnemyHandBookData::VT_DAMAGETYPE, None)}
  }
  #[inline]
  pub fn invisibleDetail(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_EnemyHandBookData::VT_INVISIBLEDETAIL, Some(false)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_EnemyHandBookData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("enemyIndex", Self::VT_ENEMYINDEX, false)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("attackType", Self::VT_ATTACKTYPE, false)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__int>>>>("overrideKillCntInfos", Self::VT_OVERRIDEKILLCNTINFOS, false)?
     .visit_field::<bool>("hideInHandbook", Self::VT_HIDEINHANDBOOK, false)?
     .visit_field::<bool>("hideInStage", Self::VT_HIDEINSTAGE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandBookData_Abilty>>>>("abilityList", Self::VT_ABILITYLIST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("linkEnemies", Self::VT_LINKENEMIES, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, enum__Torappu_EnemyHandBookDamageType>>>("damageType", Self::VT_DAMAGETYPE, false)?
...
pub struct clz_Torappu_EnemyHandBookDataArgs<'a> {
    ...
    pub overrideKillCntInfos: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int<'a>>>>>,
    pub hideInHandbook: bool,
    pub hideInStage: bool,
    pub abilityList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandBookData_Abilty<'a>>>>>,
    pub linkEnemies: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
    pub damageType: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, enum__Torappu_EnemyHandBookDamageType>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_EnemyHandBookDataBuilder<'a, 'b, A> {
  ...
  pub fn add_enemyId(&mut self, enemyId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_ENEMYID, enemyId);
  }
  #[inline]
  pub fn add_enemyIndex(&mut self, enemyIndex: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_ENEMYINDEX, enemyIndex);
  }
  #[inline]
  pub fn add_enemyTags(&mut self, enemyTags: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_ENEMYTAGS, enemyTags);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_EnemyHandBookData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_NAME, name);
  }
  #[inline]
  pub fn add_enemyLevel(&mut self, enemyLevel: enum__Torappu_EnemyLevelType) {
    self.fbb_.push_slot::<enum__Torappu_EnemyLevelType>(clz_Torappu_EnemyHandBookData::VT_ENEMYLEVEL, enemyLevel, enum__Torappu_EnemyLevelType::NORMAL);
  }
  #[inline]
  pub fn add_description(&mut self, description: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_DESCRIPTION, description);
  }
  #[inline]
  pub fn add_attackType(&mut self, attackType: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_ATTACKTYPE, attackType);
  }
  #[inline]
  pub fn add_ability(&mut self, ability: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_ABILITY, ability);
  }
  #[inline]
  pub fn add_isInvalidKilled(&mut self, isInvalidKilled: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_EnemyHandBookData::VT_ISINVALIDKILLED, isInvalidKilled, false);
  }
  #[inline]
  pub fn add_overrideKillCntInfos(&mut self, overrideKillCntInfos: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__int<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_OVERRIDEKILLCNTINFOS, overrideKillCntInfos);
  }
  #[inline]
  pub fn add_hideInHandbook(&mut self, hideInHandbook: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_EnemyHandBookData::VT_HIDEINHANDBOOK, hideInHandbook, false);
  }
  #[inline]
  pub fn add_hideInStage(&mut self, hideInStage: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_EnemyHandBookData::VT_HIDEINSTAGE, hideInStage, false);
  }
  #[inline]
  pub fn add_abilityList(&mut self, abilityList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandBookData_Abilty<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_ABILITYLIST, abilityList);
  }
  #[inline]
  pub fn add_linkEnemies(&mut self, linkEnemies: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_LINKENEMIES, linkEnemies);
  }
  #[inline]
  pub fn add_damageType(&mut self, damageType: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , enum__Torappu_EnemyHandBookDamageType>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookData::VT_DAMAGETYPE, damageType);
  }
  #[inline]
  pub fn add_invisibleDetail(&mut self, invisibleDetail: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_EnemyHandBookData::VT_INVISIBLEDETAIL, invisibleDetail, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_EnemyHandBookDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_EnemyHandBookDataT {
  pub enemyId: Option<alloc::string::String>,
  pub enemyIndex: Option<alloc::string::String>,
  pub enemyTags: Option<alloc::vec::Vec<alloc::string::String>>,
  pub sortId: i32,
  pub name: Option<alloc::string::String>,
  pub enemyLevel: enum__Torappu_EnemyLevelType,
  pub description: Option<alloc::string::String>,
  pub attackType: Option<alloc::string::String>,
  pub ability: Option<alloc::string::String>,
  pub isInvalidKilled: bool,
  pub overrideKillCntInfos: Option<alloc::vec::Vec<dict__string__intT>>,
  pub hideInHandbook: bool,
  pub hideInStage: bool,
  pub abilityList: Option<alloc::vec::Vec<clz_Torappu_EnemyHandBookData_AbiltyT>>,
  pub linkEnemies: Option<alloc::vec::Vec<alloc::string::String>>,
  pub damageType: Option<alloc::vec::Vec<enum__Torappu_EnemyHandBookDamageType>>,
  pub invisibleDetail: bool,
}
...
impl clz_Torappu_EnemyHandBookDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let enemyId = self.enemyId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let enemyIndex = self.enemyIndex.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    ...
    let attackType = self.attackType.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let ability = self.ability.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let isInvalidKilled = self.isInvalidKilled;
    ...
    let damageType = self.damageType.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    let invisibleDetail = self.invisibleDetail;
    clz_Torappu_EnemyHandBookData::create(_fbb, &clz_Torappu_EnemyHandBookDataArgs{
      enemyId,
      enemyIndex,
      enemyTags,
      sortId,
...
impl<'a> dict__string__clz_Torappu_EnemyHandBookData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_EnemyHandBookDataT {
    ...
    dict__string__clz_Torappu_EnemyHandBookDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_EnemyHandBookData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_EnemyHandBookData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandBookData>>(dict__string__clz_Torappu_EnemyHandBookData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_EnemyHandBookData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandBookData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_EnemyHandBookDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_EnemyHandBookDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_EnemyHandBookData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandBookData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandBookData>>(dict__string__clz_Torappu_EnemyHandBookData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_EnemyHandBookDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_EnemyHandBookData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_EnemyHandBookData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_EnemyHandBookDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_EnemyHandBookDataT>>,
}
...
impl dict__string__clz_Torappu_EnemyHandBookDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_EnemyHandBookData::create(_fbb, &dict__string__clz_Torappu_EnemyHandBookDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_EnemyHandbookRaceData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_sortId(args.sortId);
    if let Some(x) = args.raceName { builder.add_raceName(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_EnemyHandbookRaceDataT {
    ...
    let raceName = self.raceName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let sortId = self.sortId();
  ...
  pub fn id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandbookRaceData::VT_ID, None)}
  }
  #[inline]
  pub fn raceName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_EnemyHandbookRaceData::VT_RACENAME, None)}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_EnemyHandbookRaceData::VT_SORTID, Some(0)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_EnemyHandbookRaceData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("raceName", Self::VT_RACENAME, false)?
     .visit_field::<i32>("sortId", Self::VT_SORTID, false)?
     .finish();
    Ok(())
  }
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_EnemyHandbookRaceDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandbookRaceData::VT_ID, id);
  }
  #[inline]
  pub fn add_raceName(&mut self, raceName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandbookRaceData::VT_RACENAME, raceName);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_EnemyHandbookRaceData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_EnemyHandbookRaceDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_EnemyHandbookRaceDataT {
  ...
  pub raceName: Option<alloc::string::String>,
  pub sortId: i32,
}
...
impl clz_Torappu_EnemyHandbookRaceDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let raceName = self.raceName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let sortId = self.sortId;
    clz_Torappu_EnemyHandbookRaceData::create(_fbb, &clz_Torappu_EnemyHandbookRaceDataArgs{
      id,
      raceName,
      sortId,
    })
...
impl<'a> dict__string__clz_Torappu_EnemyHandbookRaceData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_EnemyHandbookRaceDataT {
    ...
    dict__string__clz_Torappu_EnemyHandbookRaceDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_EnemyHandbookRaceData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_EnemyHandbookRaceData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_EnemyHandbookRaceData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookRaceData>>(dict__string__clz_Torappu_EnemyHandbookRaceData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_EnemyHandbookRaceData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookRaceData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_EnemyHandbookRaceDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_EnemyHandbookRaceDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_EnemyHandbookRaceData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookRaceData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_EnemyHandbookRaceData>>(dict__string__clz_Torappu_EnemyHandbookRaceData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_EnemyHandbookRaceDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_EnemyHandbookRaceData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_EnemyHandbookRaceData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_EnemyHandbookRaceDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookRaceDataT>>,
}
...
impl dict__string__clz_Torappu_EnemyHandbookRaceDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_EnemyHandbookRaceData::create(_fbb, &dict__string__clz_Torappu_EnemyHandbookRaceDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_EnemyHandBookDataGroup<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.raceData { builder.add_raceData(x); }
    if let Some(x) = args.enemyData { builder.add_enemyData(x); }
    if let Some(x) = args.levelInfoList { builder.add_levelInfoList(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_EnemyHandBookDataGroupT {
    let levelInfoList = self.levelInfoList().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let enemyData = self.enemyData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let raceData = self.raceData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  #[inline]
  pub fn levelInfoList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData>>>>(clz_Torappu_EnemyHandBookDataGroup::VT_LEVELINFOLIST, None)}
  }
  #[inline]
  pub fn enemyData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandBookData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandBookData>>>>(clz_Torappu_EnemyHandBookDataGroup::VT_ENEMYDATA, None)}
  }
  #[inline]
  pub fn raceData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandbookRaceData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandbookRaceData>>>>(clz_Torappu_EnemyHandBookDataGroup::VT_RACEDATA, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_EnemyHandBookDataGroup<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData>>>>("levelInfoList", Self::VT_LEVELINFOLIST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandBookData>>>>("enemyData", Self::VT_ENEMYDATA, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandbookRaceData>>>>("raceData", Self::VT_RACEDATA, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_EnemyHandBookDataGroupArgs<'a> {
    pub levelInfoList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData<'a>>>>>,
    pub enemyData: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandBookData<'a>>>>>,
    pub raceData: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandbookRaceData<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_EnemyHandBookDataGroupBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_levelInfoList(&mut self, levelInfoList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_EnemyHandbookLevelInfoData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookDataGroup::VT_LEVELINFOLIST, levelInfoList);
  }
  #[inline]
  pub fn add_enemyData(&mut self, enemyData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandBookData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookDataGroup::VT_ENEMYDATA, enemyData);
  }
  #[inline]
  pub fn add_raceData(&mut self, raceData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_EnemyHandbookRaceData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_EnemyHandBookDataGroup::VT_RACEDATA, raceData);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_EnemyHandBookDataGroupBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_EnemyHandBookDataGroupT {
  pub levelInfoList: Option<alloc::vec::Vec<clz_Torappu_EnemyHandbookLevelInfoDataT>>,
  pub enemyData: Option<alloc::vec::Vec<dict__string__clz_Torappu_EnemyHandBookDataT>>,
  pub raceData: Option<alloc::vec::Vec<dict__string__clz_Torappu_EnemyHandbookRaceDataT>>,
}
...
impl clz_Torappu_EnemyHandBookDataGroupT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_EnemyHandBookDataGroup::create(_fbb, &clz_Torappu_EnemyHandBookDataGroupArgs{
      levelInfoList,
      enemyData,
      raceData,
    })
...
pub fn root_as_clz_torappu_enemy_hand_book_data_group(buf: &[u8]) -> Result<clz_Torappu_EnemyHandBookDataGroup<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clz_torappu_enemy_hand_book_data_group(buf: &[u8]) -> Result<clz_Torappu_EnemyHandBookDataGroup<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_clz_torappu_enemy_hand_book_data_group_unchecked(buf: &[u8]) -> clz_Torappu_EnemyHandBookDataGroup<'_> {
...
pub unsafe fn size_prefixed_root_as_clz_torappu_enemy_hand_book_data_group_unchecked(buf: &[u8]) -> clz_Torappu_EnemyHandBookDataGroup<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<clz_Torappu_EnemyHandBookDataGroup>(buf) }
}
#[inline]
pub fn finish_clz_torappu_enemy_hand_book_data_group_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
...
#[inline]
pub fn finish_size_prefixed_clz_torappu_enemy_hand_book_data_group_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandBookDataGroup<'a>>) {
