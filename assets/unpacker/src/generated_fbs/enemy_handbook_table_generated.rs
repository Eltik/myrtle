...
impl<'a> clz_Torappu_EnemyHandbookLevelInfoData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_EnemyHandbookLevelInfoDataT {
        ...
        let attack = self.attack().map(|x| alloc::boxed::Box::new(x.unpack()));
        let def = self.def().map(|x| alloc::boxed::Box::new(x.unpack()));
        let magicRes = self.magicRes().map(|x| alloc::boxed::Box::new(x.unpack()));
        ...
        let enemyDamageRes = self
            .enemyDamageRes()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let enemyRes = self.enemyRes().map(|x| alloc::boxed::Box::new(x.unpack()));
    ...
    pub fn attack(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
        ...
        unsafe {
            ...
            >>(clz_Torappu_EnemyHandbookLevelInfoData::VT_ATTACK, None)
        }
    }
    #[inline]
    #[must_use]
    pub fn def(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                clz_Torappu_EnemyHandbookLevelInfoData_RangePair,
            >>(clz_Torappu_EnemyHandbookLevelInfoData::VT_DEF, None)
        }
    }
    #[inline]
    #[must_use]
    pub fn magicRes(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                clz_Torappu_EnemyHandbookLevelInfoData_RangePair,
            >>(clz_Torappu_EnemyHandbookLevelInfoData::VT_MAGICRES, None)
        }
    }
    #[inline]
    #[must_use]
    pub fn maxHP(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                clz_Torappu_EnemyHandbookLevelInfoData_RangePair,
            >>(clz_Torappu_EnemyHandbookLevelInfoData::VT_MAXHP, None)
        }
    }
    #[inline]
    #[must_use]
    pub fn moveSpeed(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                clz_Torappu_EnemyHandbookLevelInfoData_RangePair,
            >>(clz_Torappu_EnemyHandbookLevelInfoData::VT_MOVESPEED, None)
        }
    }
    #[inline]
    #[must_use]
    pub fn attackSpeed(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                clz_Torappu_EnemyHandbookLevelInfoData_RangePair,
            >>(clz_Torappu_EnemyHandbookLevelInfoData::VT_ATTACKSPEED, None)
        }
    }
    #[inline]
    #[must_use]
    pub fn enemyDamageRes(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                clz_Torappu_EnemyHandbookLevelInfoData_RangePair,
            >>(
                clz_Torappu_EnemyHandbookLevelInfoData::VT_ENEMYDAMAGERES,
                None,
            )
        }
    }
    ...
    pub fn enemyRes(&self) -> Option<clz_Torappu_EnemyHandbookLevelInfoData_RangePair<'a>> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                clz_Torappu_EnemyHandbookLevelInfoData_RangePair,
            >>(clz_Torappu_EnemyHandbookLevelInfoData::VT_ENEMYRES, None)
        }
    }
}
...
pub struct clz_Torappu_EnemyHandbookLevelInfoDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
pub struct clz_Torappu_EnemyHandbookLevelInfoDataT {
    ...
    pub enemyDamageRes:
        Option<alloc::boxed::Box<clz_Torappu_EnemyHandbookLevelInfoData_RangePairT>>,
    ...
    dict__string__clz_Torappu_EnemyHandBookDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_value(
        &mut self,
        value: ::flatbuffers::WIPOffset<clz_Torappu_EnemyHandBookData<'b>>,
    ) {
        self.fbb_
