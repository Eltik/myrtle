...
impl<'a> clz_Torappu_MonthlyDailyBonusGroup<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_MonthlyDailyBonusGroupT {
        ...
        let backId = self.backId().map(|x| alloc::string::ToString::to_string(x));
    ...
    pub groups: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<
                    dict__string__clz_Torappu_MonthlySignInGroupData<'a>,
                >,
            >,
        >,
    >,
    ...
    pub fn add_groups(
        ...
        groups: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<
                    dict__string__clz_Torappu_MonthlySignInGroupData<'b>,
                >,
            >,
        >,
    ) {
...
pub struct clz_Torappu_CheckInTableT {
    ...
    pub monthlySubItem:
        Option<alloc::vec::Vec<dict__string__list_clz_Torappu_MonthlyDailyBonusGroupT>>,
...
pub fn root_as_clz_torappu_check_in_table(
    buf: &[u8],
) -> Result<clz_Torappu_CheckInTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
