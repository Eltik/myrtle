...
impl<'a> clz_Torappu_StoryReviewInfoClientData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_StoryReviewInfoClientDataT {
        ...
        let storyTxt = self
            .storyTxt()
            .map(|x| alloc::string::ToString::to_string(x));
        let avgTag = self.avgTag().map(|x| alloc::string::ToString::to_string(x));
...
pub struct clz_Torappu_StoryReviewInfoClientDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl<'a> clz_Torappu_StoryReviewGroupClientData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_StoryReviewGroupClientDataT {
        ...
        let storyEntryPicId = self
            .storyEntryPicId()
            .map(|x| alloc::string::ToString::to_string(x));
        let storyPicId = self
            .storyPicId()
            .map(|x| alloc::string::ToString::to_string(x));
        let storyMainColor = self
            .storyMainColor()
            .map(|x| alloc::string::ToString::to_string(x));
...
pub struct clz_Torappu_StoryReviewGroupClientDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
pub struct clz_Torappu_SimpleKVTable_clz_Torappu_StoryReviewGroupClientDataT {
    pub story_reviews:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_StoryReviewGroupClientDataT>>,
}
