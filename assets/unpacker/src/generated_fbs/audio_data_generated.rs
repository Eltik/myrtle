...
impl<'a> clz_Torappu_Audio_Middleware_Data_SoundFXBank<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_Audio_Middleware_Data_SoundFXBankT {
        ...
        let name = self.name().map(|x| alloc::string::ToString::to_string(x));
        let mixerDesc = self.mixerDesc().map(|x| alloc::boxed::Box::new(x.unpack()));
...
impl ::flatbuffers::Verifiable
    for dict__string__list_dict__enum__Torappu_VoiceLangType__string<'_>
{
    #[inline]
    fn run_verifier(
        v: &mut ::flatbuffers::Verifier,
...
pub struct dict__string__list_dict__string__list_dict__enum__Torappu_VoiceLangType__stringT {
    pub key: alloc::string::String,
    pub value:
        Option<alloc::vec::Vec<dict__string__list_dict__enum__Torappu_VoiceLangType__stringT>>,
}
    ...
    pub soundFXCtrlBanks: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<
                    clz_Torappu_Audio_Middleware_Data_SoundFXCtrlBank<'a>,
                >,
            >,
        >,
    >,
    ...
    pub fn add_soundFXCtrlBanks(
        ...
        soundFXCtrlBanks: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<
                    clz_Torappu_Audio_Middleware_Data_SoundFXCtrlBank<'b>,
                >,
            >,
        >,
    ) {
...
pub struct clz_Torappu_Audio_Middleware_Data_TorappuAudioDataT {
    ...
    pub soundFXCtrlBanks:
        Option<alloc::vec::Vec<clz_Torappu_Audio_Middleware_Data_SoundFXCtrlBankT>>,
...
{
    ::flatbuffers::root_with_opts::<clz_Torappu_Audio_Middleware_Data_TorappuAudioData<'b>>(
        opts, buf,
    )
}
#[inline]
