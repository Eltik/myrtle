...
impl<'de> serde::Deserialize<'de> for enum__Torappu_ItemClassifyType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_ItemClassifyType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_ItemClassifyType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_BUILDING_DATA_ROOM_TYPE: [enum__Torappu_BuildingData_RoomType; 16] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_BuildingData_RoomType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_BuildingData_RoomType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_BuildingData_RoomType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_ItemDropShopType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_ItemDropShopType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_ItemDropShopType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_VoucherDisplayType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_VoucherDisplayType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_VoucherDisplayType variant: {s}"
        )))
    }
}
...
impl<'a> clz_Torappu_ItemData_StageDropInfo<'a> {
  ...
  pub fn stageId(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData_StageDropInfo::VT_STAGEID, None)}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ItemData_StageDropInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_stageId(&mut self, stageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData_StageDropInfo::VT_STAGEID, stageId);
  }
  #[inline]
...
impl<'a> clz_Torappu_ItemData_BuildingProductInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.formulaId { builder.add_formulaId(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_ItemData_BuildingProductInfoT {
    ...
    let formulaId = self.formulaId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn roomType(&self) -> enum__Torappu_BuildingData_RoomType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_BuildingData_RoomType>(clz_Torappu_ItemData_BuildingProductInfo::VT_ROOMTYPE, Some(enum__Torappu_BuildingData_RoomType::NONE)).unwrap()}
  }
  #[inline]
  pub fn formulaId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData_BuildingProductInfo::VT_FORMULAID, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ItemData_BuildingProductInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<enum__Torappu_BuildingData_RoomType>("roomType", Self::VT_ROOMTYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("formulaId", Self::VT_FORMULAID, false)?
     .finish();
    Ok(())
  }
}
...
pub struct clz_Torappu_ItemData_BuildingProductInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ItemData_BuildingProductInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_roomType(&mut self, roomType: enum__Torappu_BuildingData_RoomType) {
    self.fbb_.push_slot::<enum__Torappu_BuildingData_RoomType>(clz_Torappu_ItemData_BuildingProductInfo::VT_ROOMTYPE, roomType, enum__Torappu_BuildingData_RoomType::NONE);
  }
  #[inline]
  pub fn add_formulaId(&mut self, formulaId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData_BuildingProductInfo::VT_FORMULAID, formulaId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ItemData_BuildingProductInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ItemData_BuildingProductInfoT {
  pub roomType: enum__Torappu_BuildingData_RoomType,
  pub formulaId: Option<alloc::string::String>,
}
...
impl clz_Torappu_ItemData_BuildingProductInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let roomType = self.roomType;
    let formulaId = self.formulaId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_ItemData_BuildingProductInfo::create(_fbb, &clz_Torappu_ItemData_BuildingProductInfoArgs{
      roomType,
      formulaId,
    })
  }
...
impl<'a> clz_Torappu_ItemData_VoucherRelateInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.voucherId { builder.add_voucherId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_ItemData_VoucherRelateInfoT {
    let voucherId = self.voucherId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn voucherId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData_VoucherRelateInfo::VT_VOUCHERID, None)}
  }
  #[inline]
  pub fn voucherItemType(&self) -> enum__Torappu_ItemType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_ItemType>(clz_Torappu_ItemData_VoucherRelateInfo::VT_VOUCHERITEMTYPE, Some(enum__Torappu_ItemType::NONE)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ItemData_VoucherRelateInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("voucherId", Self::VT_VOUCHERID, false)?
     .visit_field::<enum__Torappu_ItemType>("voucherItemType", Self::VT_VOUCHERITEMTYPE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ItemData_VoucherRelateInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_voucherId(&mut self, voucherId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData_VoucherRelateInfo::VT_VOUCHERID, voucherId);
  }
  #[inline]
  pub fn add_voucherItemType(&mut self, voucherItemType: enum__Torappu_ItemType) {
    self.fbb_.push_slot::<enum__Torappu_ItemType>(clz_Torappu_ItemData_VoucherRelateInfo::VT_VOUCHERITEMTYPE, voucherItemType, enum__Torappu_ItemType::NONE);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ItemData_VoucherRelateInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ItemData_VoucherRelateInfoT {
  pub voucherId: Option<alloc::string::String>,
  pub voucherItemType: enum__Torappu_ItemType,
}
...
impl clz_Torappu_ItemData_VoucherRelateInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let voucherId = self.voucherId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let voucherItemType = self.voucherItemType;
    clz_Torappu_ItemData_VoucherRelateInfo::create(_fbb, &clz_Torappu_ItemData_VoucherRelateInfoArgs{
      voucherId,
      voucherItemType,
    })
  }
...
impl<'a> clz_Torappu_ItemData_ShopRelateInfo<'a> {
  ...
  pub fn shopType(&self) -> enum__Torappu_ItemDropShopType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_ItemDropShopType>(clz_Torappu_ItemData_ShopRelateInfo::VT_SHOPTYPE, Some(enum__Torappu_ItemDropShopType::HGGSHD_SHOP)).unwrap()}
  }
  #[inline]
  pub fn shopGroup(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_ItemData_ShopRelateInfo::VT_SHOPGROUP, Some(0)).unwrap()}
  }
  #[inline]
  pub fn startTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_ItemData_ShopRelateInfo::VT_STARTTS, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ItemData_ShopRelateInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_shopType(&mut self, shopType: enum__Torappu_ItemDropShopType) {
    self.fbb_.push_slot::<enum__Torappu_ItemDropShopType>(clz_Torappu_ItemData_ShopRelateInfo::VT_SHOPTYPE, shopType, enum__Torappu_ItemDropShopType::HGGSHD_SHOP);
  }
  #[inline]
  pub fn add_shopGroup(&mut self, shopGroup: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_ItemData_ShopRelateInfo::VT_SHOPGROUP, shopGroup, 0);
  }
  #[inline]
  pub fn add_startTs(&mut self, startTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_ItemData_ShopRelateInfo::VT_STARTTS, startTs, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ItemData_ShopRelateInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_ItemData_ShopRelateInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let shopGroup = self.shopGroup;
    let startTs = self.startTs;
    clz_Torappu_ItemData_ShopRelateInfo::create(_fbb, &clz_Torappu_ItemData_ShopRelateInfoArgs{
      shopType,
      shopGroup,
      startTs,
    })
...
impl<'a> clz_Torappu_ItemData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.shopRelateInfoList { builder.add_shopRelateInfoList(x); }
    if let Some(x) = args.voucherRelateList { builder.add_voucherRelateList(x); }
    if let Some(x) = args.buildingProductList { builder.add_buildingProductList(x); }
    if let Some(x) = args.stageDropList { builder.add_stageDropList(x); }
    ...
    builder.add_sortId(args.sortId);
    if let Some(x) = args.stackIconId { builder.add_stackIconId(x); }
    if let Some(x) = args.overrideBkg { builder.add_overrideBkg(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_ItemDataT {
    ...
    let overrideBkg = self.overrideBkg().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let stackIconId = self.stackIconId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let sortId = self.sortId();
    ...
    let stageDropList = self.stageDropList().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let buildingProductList = self.buildingProductList().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let voucherRelateList = self.voucherRelateList().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let shopRelateInfoList = self.shopRelateInfoList().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  pub fn itemId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData::VT_ITEMID, None)}
  }
  #[inline]
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData::VT_NAME, None)}
  }
  #[inline]
  pub fn description(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData::VT_DESCRIPTION, None)}
  }
  #[inline]
  pub fn rarity(&self) -> enum__Torappu_ItemRarity {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_ItemRarity>(clz_Torappu_ItemData::VT_RARITY, Some(enum__Torappu_ItemRarity::TIER_1)).unwrap()}
  }
  #[inline]
  pub fn iconId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData::VT_ICONID, None)}
  }
  #[inline]
  pub fn overrideBkg(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData::VT_OVERRIDEBKG, None)}
  }
  #[inline]
  pub fn stackIconId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData::VT_STACKICONID, None)}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_ItemData::VT_SORTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn usage(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData::VT_USAGE, None)}
  }
  #[inline]
  pub fn obtainApproach(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemData::VT_OBTAINAPPROACH, None)}
  }
  #[inline]
  pub fn hideInItemGet(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_ItemData::VT_HIDEINITEMGET, Some(false)).unwrap()}
  }
  #[inline]
  pub fn classifyType(&self) -> enum__Torappu_ItemClassifyType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_ItemClassifyType>(clz_Torappu_ItemData::VT_CLASSIFYTYPE, Some(enum__Torappu_ItemClassifyType::NONE)).unwrap()}
  }
  #[inline]
  pub fn itemType(&self) -> enum__Torappu_ItemType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_ItemType>(clz_Torappu_ItemData::VT_ITEMTYPE, Some(enum__Torappu_ItemType::NONE)).unwrap()}
  }
  #[inline]
  pub fn stageDropList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_StageDropInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_StageDropInfo>>>>(clz_Torappu_ItemData::VT_STAGEDROPLIST, None)}
  }
  #[inline]
  pub fn buildingProductList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_BuildingProductInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_BuildingProductInfo>>>>(clz_Torappu_ItemData::VT_BUILDINGPRODUCTLIST, None)}
  }
  #[inline]
  pub fn voucherRelateList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_VoucherRelateInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_VoucherRelateInfo>>>>(clz_Torappu_ItemData::VT_VOUCHERRELATELIST, None)}
  }
  #[inline]
  pub fn shopRelateInfoList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_ShopRelateInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_ShopRelateInfo>>>>(clz_Torappu_ItemData::VT_SHOPRELATEINFOLIST, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ItemData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("overrideBkg", Self::VT_OVERRIDEBKG, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("stackIconId", Self::VT_STACKICONID, false)?
     .visit_field::<i32>("sortId", Self::VT_SORTID, false)?
     ...
     .visit_field::<enum__Torappu_ItemClassifyType>("classifyType", Self::VT_CLASSIFYTYPE, false)?
     .visit_field::<enum__Torappu_ItemType>("itemType", Self::VT_ITEMTYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_StageDropInfo>>>>("stageDropList", Self::VT_STAGEDROPLIST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_BuildingProductInfo>>>>("buildingProductList", Self::VT_BUILDINGPRODUCTLIST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_VoucherRelateInfo>>>>("voucherRelateList", Self::VT_VOUCHERRELATELIST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_ShopRelateInfo>>>>("shopRelateInfoList", Self::VT_SHOPRELATEINFOLIST, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_ItemDataArgs<'a> {
    ...
    pub stageDropList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_StageDropInfo<'a>>>>>,
    pub buildingProductList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_BuildingProductInfo<'a>>>>>,
    pub voucherRelateList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_VoucherRelateInfo<'a>>>>>,
    pub shopRelateInfoList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_ShopRelateInfo<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ItemDataBuilder<'a, 'b, A> {
  ...
  pub fn add_itemId(&mut self, itemId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_ITEMID, itemId);
  }
  #[inline]
  pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_NAME, name);
  }
  #[inline]
  pub fn add_description(&mut self, description: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_DESCRIPTION, description);
  }
  #[inline]
  pub fn add_rarity(&mut self, rarity: enum__Torappu_ItemRarity) {
    self.fbb_.push_slot::<enum__Torappu_ItemRarity>(clz_Torappu_ItemData::VT_RARITY, rarity, enum__Torappu_ItemRarity::TIER_1);
  }
  #[inline]
  pub fn add_iconId(&mut self, iconId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_ICONID, iconId);
  }
  #[inline]
  pub fn add_overrideBkg(&mut self, overrideBkg: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_OVERRIDEBKG, overrideBkg);
  }
  #[inline]
  pub fn add_stackIconId(&mut self, stackIconId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_STACKICONID, stackIconId);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_ItemData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn add_usage(&mut self, usage: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_USAGE, usage);
  }
  #[inline]
  pub fn add_obtainApproach(&mut self, obtainApproach: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_OBTAINAPPROACH, obtainApproach);
  }
  #[inline]
  pub fn add_hideInItemGet(&mut self, hideInItemGet: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_ItemData::VT_HIDEINITEMGET, hideInItemGet, false);
  }
  #[inline]
  pub fn add_classifyType(&mut self, classifyType: enum__Torappu_ItemClassifyType) {
    self.fbb_.push_slot::<enum__Torappu_ItemClassifyType>(clz_Torappu_ItemData::VT_CLASSIFYTYPE, classifyType, enum__Torappu_ItemClassifyType::NONE);
  }
  #[inline]
  pub fn add_itemType(&mut self, itemType: enum__Torappu_ItemType) {
    self.fbb_.push_slot::<enum__Torappu_ItemType>(clz_Torappu_ItemData::VT_ITEMTYPE, itemType, enum__Torappu_ItemType::NONE);
  }
  #[inline]
  pub fn add_stageDropList(&mut self, stageDropList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_StageDropInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_STAGEDROPLIST, stageDropList);
  }
  #[inline]
  pub fn add_buildingProductList(&mut self, buildingProductList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_BuildingProductInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_BUILDINGPRODUCTLIST, buildingProductList);
  }
  #[inline]
  pub fn add_voucherRelateList(&mut self, voucherRelateList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_VoucherRelateInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_VOUCHERRELATELIST, voucherRelateList);
  }
  #[inline]
  pub fn add_shopRelateInfoList(&mut self, shopRelateInfoList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData_ShopRelateInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemData::VT_SHOPRELATEINFOLIST, shopRelateInfoList);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ItemDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ItemDataT {
  ...
  pub overrideBkg: Option<alloc::string::String>,
  pub stackIconId: Option<alloc::string::String>,
  pub sortId: i32,
  ...
  pub classifyType: enum__Torappu_ItemClassifyType,
  pub itemType: enum__Torappu_ItemType,
  pub stageDropList: Option<alloc::vec::Vec<clz_Torappu_ItemData_StageDropInfoT>>,
  pub buildingProductList: Option<alloc::vec::Vec<clz_Torappu_ItemData_BuildingProductInfoT>>,
  pub voucherRelateList: Option<alloc::vec::Vec<clz_Torappu_ItemData_VoucherRelateInfoT>>,
  pub shopRelateInfoList: Option<alloc::vec::Vec<clz_Torappu_ItemData_ShopRelateInfoT>>,
}
...
impl clz_Torappu_ItemDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let overrideBkg = self.overrideBkg.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let stackIconId = self.stackIconId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let sortId = self.sortId;
    ...
    clz_Torappu_ItemData::create(_fbb, &clz_Torappu_ItemDataArgs{
      itemId,
      name,
      description,
      rarity,
...
impl<'a> dict__string__clz_Torappu_ItemData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ItemDataT {
    ...
    dict__string__clz_Torappu_ItemDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ItemData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ItemData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData>>(dict__string__clz_Torappu_ItemData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ItemData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ItemData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ItemDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ItemData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ItemData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ItemData>>(dict__string__clz_Torappu_ItemData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ItemDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ItemData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ItemData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ItemDataT {
  ...
  pub value: Option<alloc::boxed::Box<clz_Torappu_ItemDataT>>,
}
...
impl dict__string__clz_Torappu_ItemDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ItemData::create(_fbb, &dict__string__clz_Torappu_ItemDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ExpItemFeature<'a> {
  ...
  pub fn id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ExpItemFeature::VT_ID, None)}
  }
  #[inline]
  pub fn gainExp(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_ExpItemFeature::VT_GAINEXP, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ExpItemFeatureBuilder<'a, 'b, A> {
  ...
  pub fn add_id(&mut self, id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ExpItemFeature::VT_ID, id);
  }
  #[inline]
  pub fn add_gainExp(&mut self, gainExp: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_ExpItemFeature::VT_GAINEXP, gainExp, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ExpItemFeatureBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_ExpItemFeatureT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let gainExp = self.gainExp;
    clz_Torappu_ExpItemFeature::create(_fbb, &clz_Torappu_ExpItemFeatureArgs{
      id,
      gainExp,
    })
  }
...
impl<'a> dict__string__clz_Torappu_ExpItemFeature<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ExpItemFeatureT {
    ...
    dict__string__clz_Torappu_ExpItemFeatureT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ExpItemFeature::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ExpItemFeature<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ExpItemFeature>>(dict__string__clz_Torappu_ExpItemFeature::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ExpItemFeature<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ExpItemFeature>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ExpItemFeatureBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ExpItemFeatureBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ExpItemFeature::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ExpItemFeature<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ExpItemFeature>>(dict__string__clz_Torappu_ExpItemFeature::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ExpItemFeatureBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ExpItemFeature<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ExpItemFeature::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ExpItemFeatureT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ExpItemFeatureT>>,
}
...
impl dict__string__clz_Torappu_ExpItemFeatureT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ExpItemFeature::create(_fbb, &dict__string__clz_Torappu_ExpItemFeatureArgs{
      key,
      value,
    })
  }
...
impl<'a> dict__int__list_dict__string__string<'a> {
  ...
  pub fn unpack(&self) -> dict__int__list_dict__string__stringT {
    ...
    dict__int__list_dict__string__stringT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(dict__int__list_dict__string__string::VT_KEY, Some(0)).unwrap()}
  }
  #[inline]
  ...
  #[inline]
  pub fn value(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__string<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__string>>>>(dict__int__list_dict__string__string::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__int__list_dict__string__string<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__string>>>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
pub struct dict__int__list_dict__string__stringArgs<'a> {
    pub key: i32,
    pub value: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__string<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__int__list_dict__string__stringBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: i32) {
    self.fbb_.push_slot::<i32>(dict__int__list_dict__string__string::VT_KEY, key, 0);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__string<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__int__list_dict__string__string::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__int__list_dict__string__stringBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct dict__int__list_dict__string__stringT {
  pub key: i32,
  pub value: Option<alloc::vec::Vec<dict__string__stringT>>,
}
...
impl dict__int__list_dict__string__stringT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__int__list_dict__string__string::create(_fbb, &dict__int__list_dict__string__stringArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ApSupplyFeature<'a> {
  ...
  pub fn id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ApSupplyFeature::VT_ID, None)}
  }
  #[inline]
  pub fn ap(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_ApSupplyFeature::VT_AP, Some(0)).unwrap()}
  }
  #[inline]
  pub fn hasTs(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_ApSupplyFeature::VT_HASTS, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ApSupplyFeatureBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ApSupplyFeature::VT_ID, id);
  }
  #[inline]
  pub fn add_ap(&mut self, ap: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_ApSupplyFeature::VT_AP, ap, 0);
  }
  #[inline]
  pub fn add_hasTs(&mut self, hasTs: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_ApSupplyFeature::VT_HASTS, hasTs, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ApSupplyFeatureBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_ApSupplyFeatureT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let ap = self.ap;
    let hasTs = self.hasTs;
    clz_Torappu_ApSupplyFeature::create(_fbb, &clz_Torappu_ApSupplyFeatureArgs{
      id,
      ap,
      hasTs,
    })
...
impl<'a> dict__string__clz_Torappu_ApSupplyFeature<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ApSupplyFeatureT {
    ...
    dict__string__clz_Torappu_ApSupplyFeatureT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ApSupplyFeature::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ApSupplyFeature<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ApSupplyFeature>>(dict__string__clz_Torappu_ApSupplyFeature::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ApSupplyFeature<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ApSupplyFeature>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ApSupplyFeatureBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ApSupplyFeatureBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ApSupplyFeature::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ApSupplyFeature<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ApSupplyFeature>>(dict__string__clz_Torappu_ApSupplyFeature::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ApSupplyFeatureBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ApSupplyFeature<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ApSupplyFeature::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ApSupplyFeatureT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ApSupplyFeatureT>>,
}
...
impl dict__string__clz_Torappu_ApSupplyFeatureT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ApSupplyFeature::create(_fbb, &dict__string__clz_Torappu_ApSupplyFeatureArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_CharVoucherItemFeature<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_CharVoucherItemFeatureT {
    ...
    clz_Torappu_CharVoucherItemFeatureT {
      id,
      displayType,
    }
  }
  ...
  pub fn id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharVoucherItemFeature::VT_ID, None)}
  }
  #[inline]
  pub fn displayType(&self) -> enum__Torappu_VoucherDisplayType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoucherDisplayType>(clz_Torappu_CharVoucherItemFeature::VT_DISPLAYTYPE, Some(enum__Torappu_VoucherDisplayType::NONE)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_CharVoucherItemFeature<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("id", Self::VT_ID, false)?
     .visit_field::<enum__Torappu_VoucherDisplayType>("displayType", Self::VT_DISPLAYTYPE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CharVoucherItemFeatureBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharVoucherItemFeature::VT_ID, id);
  }
  #[inline]
  pub fn add_displayType(&mut self, displayType: enum__Torappu_VoucherDisplayType) {
    self.fbb_.push_slot::<enum__Torappu_VoucherDisplayType>(clz_Torappu_CharVoucherItemFeature::VT_DISPLAYTYPE, displayType, enum__Torappu_VoucherDisplayType::NONE);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CharVoucherItemFeatureBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_CharVoucherItemFeatureT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let displayType = self.displayType;
    clz_Torappu_CharVoucherItemFeature::create(_fbb, &clz_Torappu_CharVoucherItemFeatureArgs{
      id,
      displayType,
    })
  }
...
impl<'a> dict__string__clz_Torappu_CharVoucherItemFeature<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_CharVoucherItemFeatureT {
    ...
    dict__string__clz_Torappu_CharVoucherItemFeatureT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_CharVoucherItemFeature::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_CharVoucherItemFeature) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_CharVoucherItemFeature<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_CharVoucherItemFeature>>(dict__string__clz_Torappu_CharVoucherItemFeature::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_CharVoucherItemFeature<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_CharVoucherItemFeature>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_CharVoucherItemFeatureBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_CharVoucherItemFeatureBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_CharVoucherItemFeature::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_CharVoucherItemFeature<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_CharVoucherItemFeature>>(dict__string__clz_Torappu_CharVoucherItemFeature::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_CharVoucherItemFeatureBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_CharVoucherItemFeature<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_CharVoucherItemFeature::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_CharVoucherItemFeatureT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_CharVoucherItemFeatureT>>,
}
...
impl dict__string__clz_Torappu_CharVoucherItemFeatureT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_CharVoucherItemFeature::create(_fbb, &dict__string__clz_Torappu_CharVoucherItemFeatureArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_UniCollectionInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.uniqueItem { builder.add_uniqueItem(x); }
    if let Some(x) = args.uniCollectionItemId { builder.add_uniCollectionItemId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_UniCollectionInfoT {
    let uniCollectionItemId = self.uniCollectionItemId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let uniqueItem = self.uniqueItem().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  pub fn uniCollectionItemId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_UniCollectionInfo::VT_UNICOLLECTIONITEMID, None)}
  }
  #[inline]
  pub fn uniqueItem(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle>>>>(clz_Torappu_UniCollectionInfo::VT_UNIQUEITEM, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_UniCollectionInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("uniCollectionItemId", Self::VT_UNICOLLECTIONITEMID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle>>>>("uniqueItem", Self::VT_UNIQUEITEM, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_UniCollectionInfoArgs<'a> {
    ...
    pub uniqueItem: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_UniCollectionInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_uniCollectionItemId(&mut self, uniCollectionItemId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_UniCollectionInfo::VT_UNICOLLECTIONITEMID, uniCollectionItemId);
  }
  #[inline]
  pub fn add_uniqueItem(&mut self, uniqueItem: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_UniCollectionInfo::VT_UNIQUEITEM, uniqueItem);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_UniCollectionInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_UniCollectionInfoT {
  pub uniCollectionItemId: Option<alloc::string::String>,
  pub uniqueItem: Option<alloc::vec::Vec<clz_Torappu_ItemBundleT>>,
}
...
impl clz_Torappu_UniCollectionInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let uniCollectionItemId = self.uniCollectionItemId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let uniqueItem = self.uniqueItem.as_ref().map(|x|{
      let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();_fbb.create_vector(&w)
    });
    clz_Torappu_UniCollectionInfo::create(_fbb, &clz_Torappu_UniCollectionInfoArgs{
      uniCollectionItemId,
      uniqueItem,
    })
  }
...
impl<'a> dict__string__clz_Torappu_UniCollectionInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_UniCollectionInfoT {
    ...
    dict__string__clz_Torappu_UniCollectionInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_UniCollectionInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_UniCollectionInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_UniCollectionInfo>>(dict__string__clz_Torappu_UniCollectionInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_UniCollectionInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_UniCollectionInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_UniCollectionInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_UniCollectionInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_UniCollectionInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_UniCollectionInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_UniCollectionInfo>>(dict__string__clz_Torappu_UniCollectionInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_UniCollectionInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_UniCollectionInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_UniCollectionInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_UniCollectionInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_UniCollectionInfoT>>,
}
...
impl dict__string__clz_Torappu_UniCollectionInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_UniCollectionInfo::create(_fbb, &dict__string__clz_Torappu_UniCollectionInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ItemPackInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.packId { builder.add_packId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_ItemPackInfoT {
    let packId = self.packId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let content = self.content().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    clz_Torappu_ItemPackInfoT {
      packId,
      content,
    }
  }
  ...
  pub fn packId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ItemPackInfo::VT_PACKID, None)}
  }
  #[inline]
  pub fn content(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle>>>>(clz_Torappu_ItemPackInfo::VT_CONTENT, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ItemPackInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle>>>>("content", Self::VT_CONTENT, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_ItemPackInfoArgs<'a> {
    ...
    pub content: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ItemPackInfoBuilder<'a, 'b, A> {
  ...
  pub fn add_packId(&mut self, packId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemPackInfo::VT_PACKID, packId);
  }
  #[inline]
  pub fn add_content(&mut self, content: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ItemPackInfo::VT_CONTENT, content);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ItemPackInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ItemPackInfoT {
  pub packId: Option<alloc::string::String>,
  pub content: Option<alloc::vec::Vec<clz_Torappu_ItemBundleT>>,
}
...
impl clz_Torappu_ItemPackInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let packId = self.packId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let content = self.content.as_ref().map(|x|{
      let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();_fbb.create_vector(&w)
    });
    clz_Torappu_ItemPackInfo::create(_fbb, &clz_Torappu_ItemPackInfoArgs{
      packId,
      content,
    })
  }
...
impl<'a> dict__string__clz_Torappu_ItemPackInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ItemPackInfoT {
    ...
    dict__string__clz_Torappu_ItemPackInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ItemPackInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ItemPackInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ItemPackInfo>>(dict__string__clz_Torappu_ItemPackInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ItemPackInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ItemPackInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ItemPackInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ItemPackInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ItemPackInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ItemPackInfo>>(dict__string__clz_Torappu_ItemPackInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ItemPackInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ItemPackInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ItemPackInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ItemPackInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ItemPackInfoT>>,
}
...
impl dict__string__clz_Torappu_ItemPackInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ItemPackInfo::create(_fbb, &dict__string__clz_Torappu_ItemPackInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_FullPotentialCharacterInfo<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_FullPotentialCharacterInfoT {
    ...
    let ts = self.ts();
    clz_Torappu_FullPotentialCharacterInfoT {
      itemId,
      ts,
    }
  }
  ...
  pub fn itemId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_FullPotentialCharacterInfo::VT_ITEMID, None)}
  }
  #[inline]
  pub fn ts(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_FullPotentialCharacterInfo::VT_TS, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_FullPotentialCharacterInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_itemId(&mut self, itemId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_FullPotentialCharacterInfo::VT_ITEMID, itemId);
  }
  #[inline]
  pub fn add_ts(&mut self, ts: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_FullPotentialCharacterInfo::VT_TS, ts, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_FullPotentialCharacterInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_FullPotentialCharacterInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let ts = self.ts;
    clz_Torappu_FullPotentialCharacterInfo::create(_fbb, &clz_Torappu_FullPotentialCharacterInfoArgs{
      itemId,
      ts,
    })
  }
...
impl<'a> dict__string__clz_Torappu_FullPotentialCharacterInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_FullPotentialCharacterInfoT {
    ...
    dict__string__clz_Torappu_FullPotentialCharacterInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_FullPotentialCharacterInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_FullPotentialCharacterInfo) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_FullPotentialCharacterInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_FullPotentialCharacterInfo>>(dict__string__clz_Torappu_FullPotentialCharacterInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_FullPotentialCharacterInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_FullPotentialCharacterInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_FullPotentialCharacterInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_FullPotentialCharacterInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_FullPotentialCharacterInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_FullPotentialCharacterInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_FullPotentialCharacterInfo>>(dict__string__clz_Torappu_FullPotentialCharacterInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_FullPotentialCharacterInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_FullPotentialCharacterInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_FullPotentialCharacterInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_FullPotentialCharacterInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_FullPotentialCharacterInfoT>>,
}
...
impl dict__string__clz_Torappu_FullPotentialCharacterInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_FullPotentialCharacterInfo::create(_fbb, &dict__string__clz_Torappu_FullPotentialCharacterInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ActivityPotentialCharacterInfo<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_ActivityPotentialCharacterInfoT {
    ...
    clz_Torappu_ActivityPotentialCharacterInfoT {
      charId,
    }
  }
  ...
  pub fn charId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ActivityPotentialCharacterInfo::VT_CHARID, None)}
  }
}
...
impl<'a> Default for clz_Torappu_ActivityPotentialCharacterInfoArgs<'a> {
  #[inline]
  fn default() -> Self {
    clz_Torappu_ActivityPotentialCharacterInfoArgs {
      charId: None,
    }
  }
}
...
pub struct clz_Torappu_ActivityPotentialCharacterInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ActivityPotentialCharacterInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_charId(&mut self, charId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ActivityPotentialCharacterInfo::VT_CHARID, charId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ActivityPotentialCharacterInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_ActivityPotentialCharacterInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_ActivityPotentialCharacterInfo::create(_fbb, &clz_Torappu_ActivityPotentialCharacterInfoArgs{
      charId,
    })
  }
}
...
impl<'a> dict__string__clz_Torappu_ActivityPotentialCharacterInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    let mut builder = dict__string__clz_Torappu_ActivityPotentialCharacterInfoBuilder::new(_fbb);
    if let Some(x) = args.value { builder.add_value(x); }
    if let Some(x) = args.key { builder.add_key(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ActivityPotentialCharacterInfoT {
    ...
    dict__string__clz_Torappu_ActivityPotentialCharacterInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ActivityPotentialCharacterInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_ActivityPotentialCharacterInfo) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_ActivityPotentialCharacterInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ActivityPotentialCharacterInfo>>(dict__string__clz_Torappu_ActivityPotentialCharacterInfo::VT_VALUE, None)}
  }
}
...
pub struct dict__string__clz_Torappu_ActivityPotentialCharacterInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ActivityPotentialCharacterInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ActivityPotentialCharacterInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ActivityPotentialCharacterInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ActivityPotentialCharacterInfo>>(dict__string__clz_Torappu_ActivityPotentialCharacterInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ActivityPotentialCharacterInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ActivityPotentialCharacterInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ActivityPotentialCharacterInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ActivityPotentialCharacterInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ActivityPotentialCharacterInfoT>>,
}
...
impl dict__string__clz_Torappu_ActivityPotentialCharacterInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ActivityPotentialCharacterInfo::create(_fbb, &dict__string__clz_Torappu_ActivityPotentialCharacterInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_FavorCharacterInfo<'a> {
  ...
  pub fn itemId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_FavorCharacterInfo::VT_ITEMID, None)}
  }
  #[inline]
  pub fn charId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_FavorCharacterInfo::VT_CHARID, None)}
  }
  #[inline]
  pub fn favorAddAmt(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_FavorCharacterInfo::VT_FAVORADDAMT, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_FavorCharacterInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_itemId(&mut self, itemId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_FavorCharacterInfo::VT_ITEMID, itemId);
  }
  #[inline]
  pub fn add_charId(&mut self, charId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_FavorCharacterInfo::VT_CHARID, charId);
  }
  #[inline]
  pub fn add_favorAddAmt(&mut self, favorAddAmt: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_FavorCharacterInfo::VT_FAVORADDAMT, favorAddAmt, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_FavorCharacterInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_FavorCharacterInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let favorAddAmt = self.favorAddAmt;
    clz_Torappu_FavorCharacterInfo::create(_fbb, &clz_Torappu_FavorCharacterInfoArgs{
      itemId,
      charId,
      favorAddAmt,
    })
...
impl<'a> dict__string__clz_Torappu_FavorCharacterInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_FavorCharacterInfoT {
    ...
    dict__string__clz_Torappu_FavorCharacterInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_FavorCharacterInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_FavorCharacterInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_FavorCharacterInfo>>(dict__string__clz_Torappu_FavorCharacterInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_FavorCharacterInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_FavorCharacterInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_FavorCharacterInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_FavorCharacterInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_FavorCharacterInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_FavorCharacterInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_FavorCharacterInfo>>(dict__string__clz_Torappu_FavorCharacterInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_FavorCharacterInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_FavorCharacterInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_FavorCharacterInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_FavorCharacterInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_FavorCharacterInfoT>>,
}
...
impl dict__string__clz_Torappu_FavorCharacterInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_FavorCharacterInfo::create(_fbb, &dict__string__clz_Torappu_FavorCharacterInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_InventoryData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.itemShopNameDict { builder.add_itemShopNameDict(x); }
    if let Some(x) = args.favorCharacters { builder.add_favorCharacters(x); }
    if let Some(x) = args.activityPotentialCharacters { builder.add_activityPotentialCharacters(x); }
    if let Some(x) = args.fullPotentialCharacters { builder.add_fullPotentialCharacters(x); }
    if let Some(x) = args.itemPackInfos { builder.add_itemPackInfos(x); }
    if let Some(x) = args.uniCollectionInfo { builder.add_uniCollectionInfo(x); }
    if let Some(x) = args.itemTimeLimit { builder.add_itemTimeLimit(x); }
    if let Some(x) = args.uniqueInfo { builder.add_uniqueInfo(x); }
    if let Some(x) = args.charVoucherItems { builder.add_charVoucherItems(x); }
    if let Some(x) = args.apSupplies { builder.add_apSupplies(x); }
    if let Some(x) = args.potentialItems { builder.add_potentialItems(x); }
    if let Some(x) = args.expItems { builder.add_expItems(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_InventoryDataT {
    ...
    let expItems = self.expItems().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let potentialItems = self.potentialItems().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let apSupplies = self.apSupplies().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let charVoucherItems = self.charVoucherItems().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let uniqueInfo = self.uniqueInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let itemTimeLimit = self.itemTimeLimit().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let uniCollectionInfo = self.uniCollectionInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let itemPackInfos = self.itemPackInfos().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let fullPotentialCharacters = self.fullPotentialCharacters().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let activityPotentialCharacters = self.activityPotentialCharacters().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let favorCharacters = self.favorCharacters().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let itemShopNameDict = self.itemShopNameDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  #[inline]
  pub fn items(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemData>>>>(clz_Torappu_InventoryData::VT_ITEMS, None)}
  }
  #[inline]
  pub fn expItems(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExpItemFeature<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExpItemFeature>>>>(clz_Torappu_InventoryData::VT_EXPITEMS, None)}
  }
  #[inline]
  pub fn potentialItems(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__int__list_dict__string__string<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__int__list_dict__string__string>>>>(clz_Torappu_InventoryData::VT_POTENTIALITEMS, None)}
  }
  #[inline]
  pub fn apSupplies(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ApSupplyFeature<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ApSupplyFeature>>>>(clz_Torappu_InventoryData::VT_APSUPPLIES, None)}
  }
  #[inline]
  pub fn charVoucherItems(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharVoucherItemFeature<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharVoucherItemFeature>>>>(clz_Torappu_InventoryData::VT_CHARVOUCHERITEMS, None)}
  }
  #[inline]
  pub fn uniqueInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int>>>>(clz_Torappu_InventoryData::VT_UNIQUEINFO, None)}
  }
  #[inline]
  pub fn itemTimeLimit(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int>>>>(clz_Torappu_InventoryData::VT_ITEMTIMELIMIT, None)}
  }
  #[inline]
  pub fn uniCollectionInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_UniCollectionInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_UniCollectionInfo>>>>(clz_Torappu_InventoryData::VT_UNICOLLECTIONINFO, None)}
  }
  #[inline]
  pub fn itemPackInfos(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemPackInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemPackInfo>>>>(clz_Torappu_InventoryData::VT_ITEMPACKINFOS, None)}
  }
  #[inline]
  pub fn fullPotentialCharacters(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FullPotentialCharacterInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FullPotentialCharacterInfo>>>>(clz_Torappu_InventoryData::VT_FULLPOTENTIALCHARACTERS, None)}
  }
  #[inline]
  pub fn activityPotentialCharacters(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ActivityPotentialCharacterInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ActivityPotentialCharacterInfo>>>>(clz_Torappu_InventoryData::VT_ACTIVITYPOTENTIALCHARACTERS, None)}
  }
  #[inline]
  pub fn favorCharacters(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FavorCharacterInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FavorCharacterInfo>>>>(clz_Torappu_InventoryData::VT_FAVORCHARACTERS, None)}
  }
  #[inline]
  pub fn itemShopNameDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__string<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__string>>>>(clz_Torappu_InventoryData::VT_ITEMSHOPNAMEDICT, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_InventoryData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemData>>>>("items", Self::VT_ITEMS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExpItemFeature>>>>("expItems", Self::VT_EXPITEMS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__int__list_dict__string__string>>>>("potentialItems", Self::VT_POTENTIALITEMS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ApSupplyFeature>>>>("apSupplies", Self::VT_APSUPPLIES, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharVoucherItemFeature>>>>("charVoucherItems", Self::VT_CHARVOUCHERITEMS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__int>>>>("uniqueInfo", Self::VT_UNIQUEINFO, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__int>>>>("itemTimeLimit", Self::VT_ITEMTIMELIMIT, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_UniCollectionInfo>>>>("uniCollectionInfo", Self::VT_UNICOLLECTIONINFO, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemPackInfo>>>>("itemPackInfos", Self::VT_ITEMPACKINFOS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FullPotentialCharacterInfo>>>>("fullPotentialCharacters", Self::VT_FULLPOTENTIALCHARACTERS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ActivityPotentialCharacterInfo>>>>("activityPotentialCharacters", Self::VT_ACTIVITYPOTENTIALCHARACTERS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FavorCharacterInfo>>>>("favorCharacters", Self::VT_FAVORCHARACTERS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__string>>>>("itemShopNameDict", Self::VT_ITEMSHOPNAMEDICT, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_InventoryDataArgs<'a> {
    pub items: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemData<'a>>>>>,
    pub expItems: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExpItemFeature<'a>>>>>,
    pub potentialItems: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__int__list_dict__string__string<'a>>>>>,
    pub apSupplies: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ApSupplyFeature<'a>>>>>,
    pub charVoucherItems: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharVoucherItemFeature<'a>>>>>,
    pub uniqueInfo: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int<'a>>>>>,
    pub itemTimeLimit: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__int<'a>>>>>,
    pub uniCollectionInfo: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_UniCollectionInfo<'a>>>>>,
    pub itemPackInfos: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemPackInfo<'a>>>>>,
    pub fullPotentialCharacters: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FullPotentialCharacterInfo<'a>>>>>,
    pub activityPotentialCharacters: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ActivityPotentialCharacterInfo<'a>>>>>,
    pub favorCharacters: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FavorCharacterInfo<'a>>>>>,
    pub itemShopNameDict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__string<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_InventoryDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_items(&mut self, items: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_ITEMS, items);
  }
  #[inline]
  pub fn add_expItems(&mut self, expItems: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExpItemFeature<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_EXPITEMS, expItems);
  }
  #[inline]
  pub fn add_potentialItems(&mut self, potentialItems: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__int__list_dict__string__string<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_POTENTIALITEMS, potentialItems);
  }
  #[inline]
  pub fn add_apSupplies(&mut self, apSupplies: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ApSupplyFeature<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_APSUPPLIES, apSupplies);
  }
  #[inline]
  pub fn add_charVoucherItems(&mut self, charVoucherItems: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharVoucherItemFeature<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_CHARVOUCHERITEMS, charVoucherItems);
  }
  #[inline]
  pub fn add_uniqueInfo(&mut self, uniqueInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__int<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_UNIQUEINFO, uniqueInfo);
  }
  #[inline]
  pub fn add_itemTimeLimit(&mut self, itemTimeLimit: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__int<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_ITEMTIMELIMIT, itemTimeLimit);
  }
  #[inline]
  pub fn add_uniCollectionInfo(&mut self, uniCollectionInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_UniCollectionInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_UNICOLLECTIONINFO, uniCollectionInfo);
  }
  #[inline]
  pub fn add_itemPackInfos(&mut self, itemPackInfos: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ItemPackInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_ITEMPACKINFOS, itemPackInfos);
  }
  #[inline]
  pub fn add_fullPotentialCharacters(&mut self, fullPotentialCharacters: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FullPotentialCharacterInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_FULLPOTENTIALCHARACTERS, fullPotentialCharacters);
  }
  #[inline]
  pub fn add_activityPotentialCharacters(&mut self, activityPotentialCharacters: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ActivityPotentialCharacterInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_ACTIVITYPOTENTIALCHARACTERS, activityPotentialCharacters);
  }
  #[inline]
  pub fn add_favorCharacters(&mut self, favorCharacters: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FavorCharacterInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_FAVORCHARACTERS, favorCharacters);
  }
  #[inline]
  pub fn add_itemShopNameDict(&mut self, itemShopNameDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__string<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_InventoryData::VT_ITEMSHOPNAMEDICT, itemShopNameDict);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_InventoryDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl ::core::fmt::Debug for clz_Torappu_InventoryData<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("clz_Torappu_InventoryData");
      ...
      ds.field("activityPotentialCharacters", &self.activityPotentialCharacters());
...
pub struct clz_Torappu_InventoryDataT {
  pub items: Option<alloc::vec::Vec<dict__string__clz_Torappu_ItemDataT>>,
  pub expItems: Option<alloc::vec::Vec<dict__string__clz_Torappu_ExpItemFeatureT>>,
  pub potentialItems: Option<alloc::vec::Vec<dict__int__list_dict__string__stringT>>,
  pub apSupplies: Option<alloc::vec::Vec<dict__string__clz_Torappu_ApSupplyFeatureT>>,
  pub charVoucherItems: Option<alloc::vec::Vec<dict__string__clz_Torappu_CharVoucherItemFeatureT>>,
  pub uniqueInfo: Option<alloc::vec::Vec<dict__string__intT>>,
  pub itemTimeLimit: Option<alloc::vec::Vec<dict__string__intT>>,
  pub uniCollectionInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_UniCollectionInfoT>>,
  pub itemPackInfos: Option<alloc::vec::Vec<dict__string__clz_Torappu_ItemPackInfoT>>,
  pub fullPotentialCharacters: Option<alloc::vec::Vec<dict__string__clz_Torappu_FullPotentialCharacterInfoT>>,
  pub activityPotentialCharacters: Option<alloc::vec::Vec<dict__string__clz_Torappu_ActivityPotentialCharacterInfoT>>,
  pub favorCharacters: Option<alloc::vec::Vec<dict__string__clz_Torappu_FavorCharacterInfoT>>,
  pub itemShopNameDict: Option<alloc::vec::Vec<dict__string__stringT>>,
}
...
impl clz_Torappu_InventoryDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_InventoryData::create(_fbb, &clz_Torappu_InventoryDataArgs{
      items,
      expItems,
      potentialItems,
      apSupplies,
...
pub fn root_as_clz_torappu_inventory_data(buf: &[u8]) -> Result<clz_Torappu_InventoryData<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clz_torappu_inventory_data(buf: &[u8]) -> Result<clz_Torappu_InventoryData<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_clz_torappu_inventory_data_unchecked(buf: &[u8]) -> clz_Torappu_InventoryData<'_> {
...
pub unsafe fn size_prefixed_root_as_clz_torappu_inventory_data_unchecked(buf: &[u8]) -> clz_Torappu_InventoryData<'_> {
...
#[inline]
pub fn finish_size_prefixed_clz_torappu_inventory_data_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<clz_Torappu_InventoryData<'a>>) {
