...
pub const ENUM_MAX_ENUM__TORAPPU_NAME_CARD_V_2_SKIN_TYPE: i32 = 3;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_NAME_CARD_V_2_SKIN_TYPE: [enum__Torappu_NameCardV2SkinType; 4] = [
    enum__Torappu_NameCardV2SkinType::NONE,
    enum__Torappu_NameCardV2SkinType::BASE,
    enum__Torappu_NameCardV2SkinType::SPECIAL,
    enum__Torappu_NameCardV2SkinType::DYNAMIC,
];
...
impl enum__Torappu_NameCardV2SkinType {
    ...
    pub const ENUM_VALUES: &'static [Self] =
        &[Self::NONE, Self::BASE, Self::SPECIAL, Self::DYNAMIC];
    /// Returns the variant's name or "" if unknown.
    #[must_use]
    pub const fn variant_name(self) -> Option<&'static str> {
        match self {
...
pub const ENUM_MAX_ENUM__TORAPPU_UIGUIDE_TARGET: i32 = 53;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_UIGUIDE_TARGET: [enum__Torappu_UIGuideTarget; 52] = [
    ...
    enum__Torappu_UIGuideTarget::ACT_FOOTBALL,
];
...
impl enum__Torappu_UIGuideTarget {
    ...
    pub const ACT_FOOTBALL: Self = Self(53);
    ...
    pub const fn variant_name(self) -> Option<&'static str> {
        match self {
            ...
            Self::ACT_FOOTBALL => Some("ACT_FOOTBALL"),
            _ => None,
        }
    }
}
...
pub const ENUM_MAX_ENUM__TORAPPU_ACTIVITY_TYPE: i32 = 63;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_ACTIVITY_TYPE: [enum__Torappu_ActivityType; 64] = [
    ...
    enum__Torappu_ActivityType::ACT_FOOTBALL,
...
impl enum__Torappu_ActivityType {
    ...
    pub const ACT_FOOTBALL: Self = Self(62);
    pub const ENUM: Self = Self(63);
...
impl Default for clz_Torappu_PlayerAvatarLimitDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_PlayerAvatarPerData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_PlayerAvatarPerDataT {
        ...
        let avatarIdDesc = self
            .avatarIdDesc()
            .map(|x| alloc::string::ToString::to_string(x));
        let avatarItemName = self
            .avatarItemName()
            .map(|x| alloc::string::ToString::to_string(x));
        let avatarItemDesc = self
            .avatarItemDesc()
            .map(|x| alloc::string::ToString::to_string(x));
        let avatarItemUsage = self
            .avatarItemUsage()
            .map(|x| alloc::string::ToString::to_string(x));
        let obtainApproach = self
            .obtainApproach()
            .map(|x| alloc::string::ToString::to_string(x));
        let dynAvatarId = self
            .dynAvatarId()
            .map(|x| alloc::string::ToString::to_string(x));
        let limitDatas = self
            .limitDatas()
...
impl Default for clz_Torappu_PlayerAvatarPerDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_PlayerAvatarGroupDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default
    for dict__enum__Torappu_PlayerAvatarGroupType__clz_Torappu_PlayerAvatarGroupDataArgs<'_>
{
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_AvatarConstDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_PlayerAvatarDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_HomeBackgroundMultiFormDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_HomeBackgroundSingleData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_HomeBackgroundSingleDataT {
        let bgId = self.bgId().map(|x| alloc::string::ToString::to_string(x));
        let bgType = self.bgType().map(|x| alloc::string::ToString::to_string(x));
        let bgSortId = self.bgSortId();
        let bgStartTime = self.bgStartTime();
        let isSecret = self.isSecret();
        let bgName = self.bgName().map(|x| alloc::string::ToString::to_string(x));
        let bgDes = self.bgDes().map(|x| alloc::string::ToString::to_string(x));
        let bgUsage = self
            .bgUsage()
            .map(|x| alloc::string::ToString::to_string(x));
...
impl Default for clz_Torappu_HomeBackgroundSingleDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_ArtGalleryItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_ArtGalleryGroupData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ArtGalleryGroupDataT {
        let type_ = self.type_().map(|x| alloc::string::ToString::to_string(x));
...
impl Default for clz_Torappu_ArtGalleryGroupDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_HomeThemeMultiFormDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_HomeThemeDisplayData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_HomeThemeDisplayDataT {
        ...
        let isSecret = self.isSecret();
        let tmName = self.tmName().map(|x| alloc::string::ToString::to_string(x));
        let tmDes = self.tmDes().map(|x| alloc::string::ToString::to_string(x));
        let tmUsage = self
            .tmUsage()
            .map(|x| alloc::string::ToString::to_string(x));
        let isMultiForm = self.isMultiForm();
...
impl Default for clz_Torappu_HomeThemeDisplayDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_HomeBackgroundLimitInfoDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_HomeBackgroundLimitDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_HomeBackgroundLimitDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_HomeThemeLimitInfoDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_HomeThemeLimitDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_HomeThemeLimitDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    dict__string__clz_Torappu_HomeThemeLimitDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_value(
        &mut self,
        value: ::flatbuffers::WIPOffset<clz_Torappu_HomeThemeLimitData<'b>>,
    ) {
        self.fbb_
...
impl<'a> clz_Torappu_HomeMultiFormInfoData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_HomeMultiFormInfoDataT {
        let changeRule = self.changeRule();
        let bgDesc = self.bgDesc().map(|x| alloc::string::ToString::to_string(x));
        let tmDesc = self.tmDesc().map(|x| alloc::string::ToString::to_string(x));
...
impl Default for clz_Torappu_HomeMultiFormInfoDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_HomeMultiFormTimeRuleDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_HomeMultiFormTimeRuleDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl<'a> ::flatbuffers::Follow<'a>
    for dict__string__list_clz_Torappu_HomeMultiFormTimeRuleData<'a>
{
    type Inner = Self;
    #[inline]
    unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
...
impl Default for dict__string__list_clz_Torappu_HomeMultiFormTimeRuleDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    pub backgroundLimitData: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<
                    dict__string__clz_Torappu_HomeBackgroundLimitData<'a>,
                >,
            >,
        >,
    >,
...
impl Default for clz_Torappu_HomeBackgroundDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    pub fn add_backgroundLimitData(
        ...
        backgroundLimitData: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<
                    dict__string__clz_Torappu_HomeBackgroundLimitData<'b>,
                >,
            >,
        >,
    ) {
...
pub struct clz_Torappu_HomeBackgroundDataT {
    ...
    pub backgroundLimitData:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_HomeBackgroundLimitDataT>>,
    ...
    pub timeRuleData:
        Option<alloc::vec::Vec<dict__string__list_clz_Torappu_HomeMultiFormTimeRuleDataT>>,
...
impl Default for clz_Torappu_NameCardV2ModuleDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_NameCardV2ModuleDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_NameCardV2RemovableModuleDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_NameCardV2RemovableModuleDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_NameCardV2TimeLimitInfoArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_NameCardV2TimeLimitInfoArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_NameCardV2SkinDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_NameCardV2SkinDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    dict__string__clz_Torappu_NameCardV2SkinDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_value(
        &mut self,
        value: ::flatbuffers::WIPOffset<clz_Torappu_NameCardV2SkinData<'b>>,
    ) {
        self.fbb_
...
impl Default for clz_Torappu_NameCardV2ConstsArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_NameCardV2DataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_NameCardV2DataBuilder<'a, 'b, A> {
    ...
    pub fn add_consts(
        &mut self,
        consts: ::flatbuffers::WIPOffset<clz_Torappu_NameCardV2Consts<'b>>,
    ) {
        self.fbb_
...
pub struct clz_Torappu_NameCardV2DataT {
    ...
    pub removableModuleData:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_NameCardV2RemovableModuleDataT>>,
...
impl Default for clz_Torappu_MailArchiveItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_MailArchiveItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_MailArchiveDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_MailArchiveDataT {
    pub mailArchiveInfoDict:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_MailArchiveItemDataT>>,
...
impl Default for clz_Torappu_MailSenderSingleInfoArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_MailSenderSingleInfoArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_MailSenderDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_EmoticonData_EmojiDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_EmoticonData_EmojiDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    pub emojiDataDict: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<
                    dict__string__clz_Torappu_EmoticonData_EmojiData<'a>,
                >,
            >,
        >,
    >,
...
impl Default for clz_Torappu_EmoticonDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    pub fn add_emojiDataDict(
        ...
        emojiDataDict: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<
                    dict__string__clz_Torappu_EmoticonData_EmojiData<'b>,
                >,
            >,
        >,
    ) {
...
impl Default for clz_Torappu_StoryVariantDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_StoryVariantDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    dict__string__clz_Torappu_StoryVariantDataBuilder<'a, 'b, A>
{
    ...
    pub fn finish(
        self,
    ) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StoryVariantData<'a>> {
        let o = self.fbb_.end_table(self.start_);
        self.fbb_
...
impl Default for clz_Torappu_GuidebookConfigDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_GuidebookGroupDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_GuidebookGroupDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    dict__string__clz_Torappu_GuidebookGroupDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_value(
        &mut self,
        value: ::flatbuffers::WIPOffset<clz_Torappu_GuidebookGroupData<'b>>,
    ) {
        self.fbb_
...
impl<'a> clz_Torappu_KeyItem<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_KeyItemT {
        let keyId = self.keyId().map(|x| alloc::string::ToString::to_string(x));
        let keyName = self
            .keyName()
            .map(|x| alloc::string::ToString::to_string(x));
...
impl Default for clz_Torappu_KeyItemArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_KeyItemBuilder<'a, 'b, A> {
    ...
    pub fn add_keyCodes(
        &mut self,
        keyCodes: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, i32>>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_KeyItem::VT_KEYCODES,
            keyCodes,
...
impl Default for dict__string__clz_Torappu_KeyItemArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_KeySettingItemData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_KeySettingItemDataT {
        let funcId = self.funcId().map(|x| alloc::string::ToString::to_string(x));
        let funcName = self
            .funcName()
            .map(|x| alloc::string::ToString::to_string(x));
        let canBeSet = self.canBeSet();
        let defaultKeyId = self
            .defaultKeyId()
            .map(|x| alloc::string::ToString::to_string(x));
        let sortId = self.sortId();
...
impl Default for clz_Torappu_KeySettingItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_KeySettingGroupDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_KeySettingGroupDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_PCKeyConstDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_PCKeyConstDataBuilder<'a, 'b, A> {
    #[inline]
    pub fn add_cannotSetKeyNotice(
        &mut self,
        cannotSetKeyNotice: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_PCKeyConstData::VT_CANNOTSETKEYNOTICE,
            cannotSetKeyNotice,
...
impl Default for clz_Torappu_PCKeyDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_ResolutionSettingItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_ResolutionSettingItemDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl Default for clz_Torappu_ArtGalleryCollectItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_ArtGalleryCollectItemDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl Default for clz_Torappu_ArtGalleryCollectSetMissionDataArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    clz_Torappu_ArtGalleryCollectSetMissionDataBuilder<'a, 'b, A>
{
    ...
    pub fn finish(
        self,
    ) -> ::flatbuffers::WIPOffset<clz_Torappu_ArtGalleryCollectSetMissionData<'a>> {
        let o = self.fbb_.end_table(self.start_);
        ::flatbuffers::WIPOffset::new(o.value())
    }
}
...
impl<'a> ::flatbuffers::Follow<'a>
    for dict__string__clz_Torappu_ArtGalleryCollectSetMissionData<'a>
{
    type Inner = Self;
    #[inline]
    unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
...
impl Default for dict__string__clz_Torappu_ArtGalleryCollectSetMissionDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_ArtGalleryCollectSetData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ArtGalleryCollectSetDataT {
        let setId = self.setId().map(|x| alloc::string::ToString::to_string(x));
        let setName = self
            .setName()
            .map(|x| alloc::string::ToString::to_string(x));
...
impl Default for clz_Torappu_ArtGalleryCollectSetDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_ArtGalleryCollectSetDataT {
    ...
    pub displayMaxCount: i32,
    pub missionList:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_ArtGalleryCollectSetMissionDataT>>,
}
...
impl Default for dict__string__clz_Torappu_ArtGalleryCollectSetDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_ArtGalleryCollectTypeDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_ArtGalleryCollectTypeDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl Default for dict__string__clz_Torappu_ArtGalleryCollectTypeDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_ArtGalleryCollectConstDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_ArtGalleryCollectConstDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl Default for clz_Torappu_ArtGalleryCollectDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_ArtGalleryCollectDataT {
    pub collectionSets:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_ArtGalleryCollectSetDataT>>,
    pub collectionTypes:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_ArtGalleryCollectTypeDataT>>,
...
impl<'a> clz_Torappu_MagazineLeafItemData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_MagazineLeafItemDataT {
        let leafId = self.leafId().map(|x| alloc::string::ToString::to_string(x));
        let leafType = self.leafType();
        let sortId = self.sortId();
        let startTime = self.startTime();
        let name = self.name().map(|x| alloc::string::ToString::to_string(x));
        let desc = self.desc().map(|x| alloc::string::ToString::to_string(x));
        let usage = self.usage().map(|x| alloc::string::ToString::to_string(x));
        let approach = self
            .approach()
            .map(|x| alloc::string::ToString::to_string(x));
        let rarity = self.rarity();
        ...
        let templateColor = self
            .templateColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let skinDefaultPos = self
            .skinDefaultPos()
...
impl Default for clz_Torappu_MagazineLeafItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_MagazineLeafItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_MagazineLeafDecorTypeData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_MagazineLeafDecorTypeDataT {
        ...
        let engName = self
            .engName()
            .map(|x| alloc::string::ToString::to_string(x));
        let smallIconId = self
            .smallIconId()
            .map(|x| alloc::string::ToString::to_string(x));
        let bigIconId = self
            .bigIconId()
            .map(|x| alloc::string::ToString::to_string(x));
        let templateUseCardPosBias = self
...
impl Default for clz_Torappu_MagazineLeafDecorTypeDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_MagazineLeafDecorTypeDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl Default for dict__string__clz_Torappu_MagazineLeafDecorTypeDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_MagazineLeafTypeDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_MagazineLeafTypeDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_ArtMagazineLeafElementDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_ArtMagazineLeafElementDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl<'a> clz_Torappu_ArtMagazineLeafData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ArtMagazineLeafDataT {
        ...
        let decorList = self
            .decorList()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        let charSkin = self.charSkin().map(|x| alloc::boxed::Box::new(x.unpack()));
...
impl Default for clz_Torappu_ArtMagazineLeafDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_ArtMagazineLeafDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_MagazineLeafConstArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__list_dict__string__intArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_MagazineLeafDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_MagazineLeafDataT {
    ...
    pub leafDecorTypeMap:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_MagazineLeafDecorTypeDataT>>,
...
impl<'a> clz_Torappu_StickerItemData<'a> {
    ...
    pub fn id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                clz_Torappu_StickerItemData::VT_ID,
                None,
            )
        }
    }
...
impl Default for clz_Torappu_StickerItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_StickerItemDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_StickerDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_AVGDialogPresetDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_AVGDialogSettingDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_DisplayMetaData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_DisplayMetaDataT {
        let playerAvatarData = self
            .playerAvatarData()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let homeBackgroundData = self
            .homeBackgroundData()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let nameCardV2Data = self
            .nameCardV2Data()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let mailArchiveData = self
            .mailArchiveData()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let mailSenderData = self
            .mailSenderData()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let emoticonData = self
            .emoticonData()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        ...
        let guidebookGroupDatas = self
            .guidebookGroupDatas()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        let pcKeyData = self.pcKeyData().map(|x| alloc::boxed::Box::new(x.unpack()));
        let resolutionSettingList = self
            .resolutionSettingList()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        let artGalleryCollectData = self
            .artGalleryCollectData()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let magazineLeafData = self
            .magazineLeafData()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let stickerData = self
            .stickerData()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let avgDialogSettingData = self
...
pub struct clz_Torappu_DisplayMetaDataArgs<'a> {
    ...
    pub avgDialogSettingData:
        Option<::flatbuffers::WIPOffset<clz_Torappu_AVGDialogSettingData<'a>>>,
}
impl Default for clz_Torappu_DisplayMetaDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_DisplayMetaDataBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_pcKeyData(
        &mut self,
        pcKeyData: ::flatbuffers::WIPOffset<clz_Torappu_PCKeyData<'b>>,
    ) {
        self.fbb_
