...
impl<'de> serde::Deserialize<'de> for enum__Torappu_FogType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_FogType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_FogType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_STAGE_BUTTON_IN_FOG_RENDER_TYPE: [enum__Torappu_StageButtonInFogRenderType; 2] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_StageButtonInFogRenderType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_StageButtonInFogRenderType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_StageButtonInFogRenderType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_EvolvePhase {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_EvolvePhase variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_OverrideGameMode {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_OverrideGameMode::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_OverrideGameMode variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_StorylineType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_StorylineType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_StorylineType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_STORYLINE_LOCATION_TYPE: [enum__Torappu_StorylineLocationType; 4] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_StorylineLocationType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_StorylineLocationType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_StorylineLocationType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_STORYLINE_STORY_SET_TYPE: [enum__Torappu_StorylineStorySetType; 3] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_StorylineStorySetType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_StorylineStorySetType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_StorylineStorySetType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_CGGalleryCGSource {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_CGGalleryCGSource::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_CGGalleryCGSource variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_CGGALLERY_CGCOMPOSITE_TYPE: [enum__Torappu_CGGalleryCGCompositeType; 4] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_CGGalleryCGCompositeType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_CGGalleryCGCompositeType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_CGGalleryCGCompositeType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_SIX_STAR_MILESTONE_REWARD_TYPE: [enum__Torappu_SixStarMilestoneRewardType; 2] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_SixStarMilestoneRewardType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_SixStarMilestoneRewardType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_SixStarMilestoneRewardType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_SIX_STAR_STAGE_COMPATIBLE_DROP_TYPE: [enum__Torappu_SixStarStageCompatibleDropType; 1] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_SixStarStageCompatibleDropType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        let s = String::deserialize(deserializer)?;
        for item in enum__Torappu_SixStarStageCompatibleDropType::ENUM_VALUES {
            if let Some(item_name) = item.variant_name() {
                if item_name == s {
                    return Ok(item.clone());
                }
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_SixStarStageCompatibleDropType variant: {s}"
        )))
    }
}
...
impl<'a> clz_Torappu_RuneStageGroupData_RuneStageInst<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.activePackedRuneIds { builder.add_activePackedRuneIds(x); }
    if let Some(x) = args.stageId { builder.add_stageId(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> clz_Torappu_RuneStageGroupData_RuneStageInstT {
    ...
    let activePackedRuneIds = self.activePackedRuneIds().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
  ...
  pub fn stageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_RuneStageGroupData_RuneStageInst::VT_STAGEID, None)}
  }
  #[inline]
  pub fn activePackedRuneIds(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_RuneStageGroupData_RuneStageInst::VT_ACTIVEPACKEDRUNEIDS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_RuneStageGroupData_RuneStageInst<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("stageId", Self::VT_STAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("activePackedRuneIds", Self::VT_ACTIVEPACKEDRUNEIDS, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_RuneStageGroupData_RuneStageInstArgs<'a> {
    pub stageId: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub activePackedRuneIds: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
}
...
pub struct clz_Torappu_RuneStageGroupData_RuneStageInstBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_RuneStageGroupData_RuneStageInstBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_stageId(&mut self, stageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RuneStageGroupData_RuneStageInst::VT_STAGEID, stageId);
  }
  #[inline]
  pub fn add_activePackedRuneIds(&mut self, activePackedRuneIds: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RuneStageGroupData_RuneStageInst::VT_ACTIVEPACKEDRUNEIDS, activePackedRuneIds);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_RuneStageGroupData_RuneStageInstBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<clz_Torappu_RuneStageGroupData_RuneStageInst<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct clz_Torappu_RuneStageGroupData_RuneStageInstT {
  pub stageId: Option<alloc::string::String>,
  pub activePackedRuneIds: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
impl clz_Torappu_RuneStageGroupData_RuneStageInstT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_RuneStageGroupData_RuneStageInst::create(_fbb, &clz_Torappu_RuneStageGroupData_RuneStageInstArgs{
      stageId,
      activePackedRuneIds,
    })
  }
...
impl<'a> clz_Torappu_RuneStageGroupData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.activeRuneStages { builder.add_activeRuneStages(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_RuneStageGroupDataT {
    ...
    let activeRuneStages = self.activeRuneStages().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  pub fn groupId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_RuneStageGroupData::VT_GROUPID, None)}
  }
  #[inline]
  pub fn activeRuneStages(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_RuneStageGroupData_RuneStageInst<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_RuneStageGroupData_RuneStageInst>>>>(clz_Torappu_RuneStageGroupData::VT_ACTIVERUNESTAGES, None)}
  }
  #[inline]
  pub fn startTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_RuneStageGroupData::VT_STARTTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn endTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_RuneStageGroupData::VT_ENDTS, Some(0)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_RuneStageGroupData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_RuneStageGroupData_RuneStageInst>>>>("activeRuneStages", Self::VT_ACTIVERUNESTAGES, false)?
...
pub struct clz_Torappu_RuneStageGroupDataArgs<'a> {
    ...
    pub activeRuneStages: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_RuneStageGroupData_RuneStageInst<'a>>>>>,
    pub startTs: i64,
    pub endTs: i64,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_RuneStageGroupDataBuilder<'a, 'b, A> {
  ...
  pub fn add_groupId(&mut self, groupId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RuneStageGroupData::VT_GROUPID, groupId);
  }
  #[inline]
  pub fn add_activeRuneStages(&mut self, activeRuneStages: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_RuneStageGroupData_RuneStageInst<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RuneStageGroupData::VT_ACTIVERUNESTAGES, activeRuneStages);
  }
  #[inline]
  pub fn add_startTs(&mut self, startTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_RuneStageGroupData::VT_STARTTS, startTs, 0);
  }
  #[inline]
  pub fn add_endTs(&mut self, endTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_RuneStageGroupData::VT_ENDTS, endTs, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_RuneStageGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_RuneStageGroupDataT {
  ...
  pub activeRuneStages: Option<alloc::vec::Vec<clz_Torappu_RuneStageGroupData_RuneStageInstT>>,
  pub startTs: i64,
  pub endTs: i64,
}
...
impl clz_Torappu_RuneStageGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let startTs = self.startTs;
    let endTs = self.endTs;
    clz_Torappu_RuneStageGroupData::create(_fbb, &clz_Torappu_RuneStageGroupDataArgs{
      groupId,
      activeRuneStages,
      startTs,
      endTs,
...
impl<'a> dict__string__clz_Torappu_RuneStageGroupData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_RuneStageGroupDataT {
    ...
    dict__string__clz_Torappu_RuneStageGroupDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_RuneStageGroupData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_RuneStageGroupData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_RuneStageGroupData>>(dict__string__clz_Torappu_RuneStageGroupData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_RuneStageGroupData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_RuneStageGroupData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_RuneStageGroupDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_RuneStageGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_RuneStageGroupData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_RuneStageGroupData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_RuneStageGroupData>>(dict__string__clz_Torappu_RuneStageGroupData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_RuneStageGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_RuneStageGroupData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_RuneStageGroupData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_RuneStageGroupDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_RuneStageGroupDataT>>,
}
...
impl dict__string__clz_Torappu_RuneStageGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_RuneStageGroupData::create(_fbb, &dict__string__clz_Torappu_RuneStageGroupDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_MapThemeData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.emissionColor { builder.add_emissionColor(x); }
    if let Some(x) = args.trapTintColor { builder.add_trapTintColor(x); }
    if let Some(x) = args.themeType { builder.add_themeType(x); }
    if let Some(x) = args.buildableColor { builder.add_buildableColor(x); }
    if let Some(x) = args.unitColor { builder.add_unitColor(x); }
    if let Some(x) = args.themeId { builder.add_themeId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_MapThemeDataT {
    let themeId = self.themeId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let unitColor = self.unitColor().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let buildableColor = self.buildableColor().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let themeType = self.themeType().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let trapTintColor = self.trapTintColor().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let emissionColor = self.emissionColor().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn themeId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MapThemeData::VT_THEMEID, None)}
  }
  #[inline]
  pub fn unitColor(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MapThemeData::VT_UNITCOLOR, None)}
  }
  #[inline]
  pub fn buildableColor(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MapThemeData::VT_BUILDABLECOLOR, None)}
  }
  #[inline]
  pub fn themeType(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MapThemeData::VT_THEMETYPE, None)}
  }
  #[inline]
  pub fn trapTintColor(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MapThemeData::VT_TRAPTINTCOLOR, None)}
  }
  #[inline]
  pub fn emissionColor(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MapThemeData::VT_EMISSIONCOLOR, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_MapThemeData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("unitColor", Self::VT_UNITCOLOR, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("buildableColor", Self::VT_BUILDABLECOLOR, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("themeType", Self::VT_THEMETYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("trapTintColor", Self::VT_TRAPTINTCOLOR, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("emissionColor", Self::VT_EMISSIONCOLOR, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_MapThemeDataBuilder<'a, 'b, A> {
  ...
  pub fn add_themeId(&mut self, themeId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MapThemeData::VT_THEMEID, themeId);
  }
  #[inline]
  pub fn add_unitColor(&mut self, unitColor: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MapThemeData::VT_UNITCOLOR, unitColor);
  }
  #[inline]
  pub fn add_buildableColor(&mut self, buildableColor: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MapThemeData::VT_BUILDABLECOLOR, buildableColor);
  }
  #[inline]
  pub fn add_themeType(&mut self, themeType: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MapThemeData::VT_THEMETYPE, themeType);
  }
  #[inline]
  pub fn add_trapTintColor(&mut self, trapTintColor: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MapThemeData::VT_TRAPTINTCOLOR, trapTintColor);
  }
  #[inline]
  pub fn add_emissionColor(&mut self, emissionColor: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MapThemeData::VT_EMISSIONCOLOR, emissionColor);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_MapThemeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_MapThemeDataT {
  pub themeId: Option<alloc::string::String>,
  pub unitColor: Option<alloc::string::String>,
  pub buildableColor: Option<alloc::string::String>,
  pub themeType: Option<alloc::string::String>,
  pub trapTintColor: Option<alloc::string::String>,
  pub emissionColor: Option<alloc::string::String>,
}
...
impl clz_Torappu_MapThemeDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let themeId = self.themeId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let unitColor = self.unitColor.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let buildableColor = self.buildableColor.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let themeType = self.themeType.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let trapTintColor = self.trapTintColor.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let emissionColor = self.emissionColor.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_MapThemeData::create(_fbb, &clz_Torappu_MapThemeDataArgs{
      themeId,
      unitColor,
      buildableColor,
      themeType,
...
impl<'a> dict__string__clz_Torappu_MapThemeData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_MapThemeDataT {
    ...
    dict__string__clz_Torappu_MapThemeDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_MapThemeData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_MapThemeData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_MapThemeData>>(dict__string__clz_Torappu_MapThemeData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_MapThemeData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_MapThemeData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_MapThemeDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_MapThemeData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_MapThemeData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_MapThemeData>>(dict__string__clz_Torappu_MapThemeData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_MapThemeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_MapThemeData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_MapThemeData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_MapThemeDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_MapThemeDataT>>,
}
...
impl dict__string__clz_Torappu_MapThemeDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_MapThemeData::create(_fbb, &dict__string__clz_Torappu_MapThemeDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_TileAppendInfo<'a> {
  ...
  pub fn tileKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TileAppendInfo::VT_TILEKEY, None)}
  }
  #[inline]
  pub fn name(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TileAppendInfo::VT_NAME, None)}
  }
  #[inline]
  pub fn description(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TileAppendInfo::VT_DESCRIPTION, None)}
  }
  #[inline]
  pub fn isFunctional(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_TileAppendInfo::VT_ISFUNCTIONAL, Some(false)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_TileAppendInfoBuilder<'a, 'b, A> {
  ...
  pub fn add_tileKey(&mut self, tileKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TileAppendInfo::VT_TILEKEY, tileKey);
  }
  #[inline]
  pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TileAppendInfo::VT_NAME, name);
  }
  #[inline]
  pub fn add_description(&mut self, description: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TileAppendInfo::VT_DESCRIPTION, description);
  }
  #[inline]
  pub fn add_isFunctional(&mut self, isFunctional: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_TileAppendInfo::VT_ISFUNCTIONAL, isFunctional, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_TileAppendInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_TileAppendInfoT {
  pub tileKey: Option<alloc::string::String>,
  pub name: Option<alloc::string::String>,
  pub description: Option<alloc::string::String>,
  pub isFunctional: bool,
}
...
impl clz_Torappu_TileAppendInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let tileKey = self.tileKey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let name = self.name.as_ref().map(|x|{
      _fbb.create_string(x)
    ...
    let isFunctional = self.isFunctional;
    clz_Torappu_TileAppendInfo::create(_fbb, &clz_Torappu_TileAppendInfoArgs{
      tileKey,
      name,
      description,
      isFunctional,
...
impl<'a> dict__string__clz_Torappu_TileAppendInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_TileAppendInfoT {
    ...
    dict__string__clz_Torappu_TileAppendInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_TileAppendInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_TileAppendInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_TileAppendInfo>>(dict__string__clz_Torappu_TileAppendInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_TileAppendInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_TileAppendInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_TileAppendInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_TileAppendInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_TileAppendInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_TileAppendInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_TileAppendInfo>>(dict__string__clz_Torappu_TileAppendInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_TileAppendInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_TileAppendInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_TileAppendInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_TileAppendInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_TileAppendInfoT>>,
}
...
impl dict__string__clz_Torappu_TileAppendInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_TileAppendInfo::create(_fbb, &dict__string__clz_Torappu_TileAppendInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_WeeklyForceOpenTable<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.forceOpenList { builder.add_forceOpenList(x); }
    if let Some(x) = args.id { builder.add_id(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> clz_Torappu_WeeklyForceOpenTableT {
    ...
    let forceOpenList = self.forceOpenList().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
  ...
  pub fn id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_WeeklyForceOpenTable::VT_ID, None)}
  }
  #[inline]
  pub fn startTime(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_WeeklyForceOpenTable::VT_STARTTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn endTime(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_WeeklyForceOpenTable::VT_ENDTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn forceOpenList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_WeeklyForceOpenTable::VT_FORCEOPENLIST, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_WeeklyForceOpenTable<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("forceOpenList", Self::VT_FORCEOPENLIST, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_WeeklyForceOpenTableArgs<'a> {
    ...
    pub startTime: i64,
    pub endTime: i64,
    pub forceOpenList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_WeeklyForceOpenTableBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_WeeklyForceOpenTable::VT_ID, id);
  }
  #[inline]
  pub fn add_startTime(&mut self, startTime: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_WeeklyForceOpenTable::VT_STARTTIME, startTime, 0);
  }
  #[inline]
  pub fn add_endTime(&mut self, endTime: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_WeeklyForceOpenTable::VT_ENDTIME, endTime, 0);
  }
  #[inline]
  pub fn add_forceOpenList(&mut self, forceOpenList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_WeeklyForceOpenTable::VT_FORCEOPENLIST, forceOpenList);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_WeeklyForceOpenTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_WeeklyForceOpenTableT {
  ...
  pub startTime: i64,
  pub endTime: i64,
  pub forceOpenList: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
impl clz_Torappu_WeeklyForceOpenTableT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_WeeklyForceOpenTable::create(_fbb, &clz_Torappu_WeeklyForceOpenTableArgs{
      id,
      startTime,
      endTime,
      forceOpenList,
...
impl<'a> dict__string__clz_Torappu_WeeklyForceOpenTable<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_WeeklyForceOpenTableT {
    ...
    dict__string__clz_Torappu_WeeklyForceOpenTableT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_WeeklyForceOpenTable::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_WeeklyForceOpenTable) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_WeeklyForceOpenTable<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_WeeklyForceOpenTable>>(dict__string__clz_Torappu_WeeklyForceOpenTable::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_WeeklyForceOpenTable<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_WeeklyForceOpenTable>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_WeeklyForceOpenTableBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_WeeklyForceOpenTableBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_WeeklyForceOpenTable::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_WeeklyForceOpenTable<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_WeeklyForceOpenTable>>(dict__string__clz_Torappu_WeeklyForceOpenTable::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_WeeklyForceOpenTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_WeeklyForceOpenTable<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_WeeklyForceOpenTable::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_WeeklyForceOpenTableT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_WeeklyForceOpenTableT>>,
}
...
impl dict__string__clz_Torappu_WeeklyForceOpenTableT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_WeeklyForceOpenTable::create(_fbb, &dict__string__clz_Torappu_WeeklyForceOpenTableArgs{
      key,
      value,
    })
  }
...
impl<'a> dict__string__long<'a> {
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__long::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(dict__string__long::VT_VALUE, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__longBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__long::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: i64) {
    self.fbb_.push_slot::<i64>(dict__string__long::VT_VALUE, value, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__longBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl dict__string__longT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let value = self.value;
    dict__string__long::create(_fbb, &dict__string__longArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_TimelyDropTimeInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_endTs(args.endTs);
    builder.add_startTs(args.startTs);
    if let Some(x) = args.apSupplyOutOfDateDict { builder.add_apSupplyOutOfDateDict(x); }
    if let Some(x) = args.weeklyPicId { builder.add_weeklyPicId(x); }
    if let Some(x) = args.timelyGroupId { builder.add_timelyGroupId(x); }
    if let Some(x) = args.entranceUpPicId { builder.add_entranceUpPicId(x); }
    if let Some(x) = args.entranceDownPicId { builder.add_entranceDownPicId(x); }
    if let Some(x) = args.stageUnlock { builder.add_stageUnlock(x); }
    if let Some(x) = args.dropPicId { builder.add_dropPicId(x); }
    if let Some(x) = args.stagePic { builder.add_stagePic(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_TimelyDropTimeInfoT {
    let startTs = self.startTs();
    let endTs = self.endTs();
    let stagePic = self.stagePic().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let dropPicId = self.dropPicId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let stageUnlock = self.stageUnlock().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let entranceDownPicId = self.entranceDownPicId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let entranceUpPicId = self.entranceUpPicId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let timelyGroupId = self.timelyGroupId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let weeklyPicId = self.weeklyPicId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let isReplace = self.isReplace();
    let apSupplyOutOfDateDict = self.apSupplyOutOfDateDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  pub fn startTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_TimelyDropTimeInfo::VT_STARTTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn endTs(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_TimelyDropTimeInfo::VT_ENDTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn stagePic(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TimelyDropTimeInfo::VT_STAGEPIC, None)}
  }
  #[inline]
  pub fn dropPicId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TimelyDropTimeInfo::VT_DROPPICID, None)}
  }
  #[inline]
  pub fn stageUnlock(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TimelyDropTimeInfo::VT_STAGEUNLOCK, None)}
  }
  #[inline]
  pub fn entranceDownPicId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TimelyDropTimeInfo::VT_ENTRANCEDOWNPICID, None)}
  }
  #[inline]
  pub fn entranceUpPicId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TimelyDropTimeInfo::VT_ENTRANCEUPPICID, None)}
  }
  #[inline]
  pub fn timelyGroupId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TimelyDropTimeInfo::VT_TIMELYGROUPID, None)}
  }
  #[inline]
  pub fn weeklyPicId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_TimelyDropTimeInfo::VT_WEEKLYPICID, None)}
  }
  #[inline]
  pub fn isReplace(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_TimelyDropTimeInfo::VT_ISREPLACE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn apSupplyOutOfDateDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__long<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__long>>>>(clz_Torappu_TimelyDropTimeInfo::VT_APSUPPLYOUTOFDATEDICT, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_TimelyDropTimeInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<i64>("startTs", Self::VT_STARTTS, false)?
     .visit_field::<i64>("endTs", Self::VT_ENDTS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("stagePic", Self::VT_STAGEPIC, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("dropPicId", Self::VT_DROPPICID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("stageUnlock", Self::VT_STAGEUNLOCK, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("entranceDownPicId", Self::VT_ENTRANCEDOWNPICID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("entranceUpPicId", Self::VT_ENTRANCEUPPICID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("timelyGroupId", Self::VT_TIMELYGROUPID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("weeklyPicId", Self::VT_WEEKLYPICID, false)?
     .visit_field::<bool>("isReplace", Self::VT_ISREPLACE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__long>>>>("apSupplyOutOfDateDict", Self::VT_APSUPPLYOUTOFDATEDICT, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_TimelyDropTimeInfoArgs<'a> {
    ...
    pub isReplace: bool,
    pub apSupplyOutOfDateDict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__long<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_TimelyDropTimeInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_startTs(&mut self, startTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_TimelyDropTimeInfo::VT_STARTTS, startTs, 0);
  }
  #[inline]
  pub fn add_endTs(&mut self, endTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_TimelyDropTimeInfo::VT_ENDTS, endTs, 0);
  }
  #[inline]
  pub fn add_stagePic(&mut self, stagePic: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropTimeInfo::VT_STAGEPIC, stagePic);
  }
  #[inline]
  pub fn add_dropPicId(&mut self, dropPicId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropTimeInfo::VT_DROPPICID, dropPicId);
  }
  #[inline]
  pub fn add_stageUnlock(&mut self, stageUnlock: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropTimeInfo::VT_STAGEUNLOCK, stageUnlock);
  }
  #[inline]
  pub fn add_entranceDownPicId(&mut self, entranceDownPicId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropTimeInfo::VT_ENTRANCEDOWNPICID, entranceDownPicId);
  }
  #[inline]
  pub fn add_entranceUpPicId(&mut self, entranceUpPicId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropTimeInfo::VT_ENTRANCEUPPICID, entranceUpPicId);
  }
  #[inline]
  pub fn add_timelyGroupId(&mut self, timelyGroupId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropTimeInfo::VT_TIMELYGROUPID, timelyGroupId);
  }
  #[inline]
  pub fn add_weeklyPicId(&mut self, weeklyPicId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropTimeInfo::VT_WEEKLYPICID, weeklyPicId);
  }
  #[inline]
  pub fn add_isReplace(&mut self, isReplace: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_TimelyDropTimeInfo::VT_ISREPLACE, isReplace, false);
  }
  #[inline]
  pub fn add_apSupplyOutOfDateDict(&mut self, apSupplyOutOfDateDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__long<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropTimeInfo::VT_APSUPPLYOUTOFDATEDICT, apSupplyOutOfDateDict);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_TimelyDropTimeInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_TimelyDropTimeInfoT {
  pub startTs: i64,
  pub endTs: i64,
  pub stagePic: Option<alloc::string::String>,
  pub dropPicId: Option<alloc::string::String>,
  pub stageUnlock: Option<alloc::string::String>,
  pub entranceDownPicId: Option<alloc::string::String>,
  pub entranceUpPicId: Option<alloc::string::String>,
  pub timelyGroupId: Option<alloc::string::String>,
  pub weeklyPicId: Option<alloc::string::String>,
  pub isReplace: bool,
  pub apSupplyOutOfDateDict: Option<alloc::vec::Vec<dict__string__longT>>,
}
...
impl clz_Torappu_TimelyDropTimeInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let startTs = self.startTs;
    let endTs = self.endTs;
    let stagePic = self.stagePic.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let dropPicId = self.dropPicId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let stageUnlock = self.stageUnlock.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let entranceDownPicId = self.entranceDownPicId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let entranceUpPicId = self.entranceUpPicId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let timelyGroupId = self.timelyGroupId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let weeklyPicId = self.weeklyPicId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let isReplace = self.isReplace;
    ...
    clz_Torappu_TimelyDropTimeInfo::create(_fbb, &clz_Torappu_TimelyDropTimeInfoArgs{
      startTs,
      endTs,
      stagePic,
      dropPicId,
...
impl<'a> dict__string__clz_Torappu_TimelyDropTimeInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_TimelyDropTimeInfoT {
    ...
    dict__string__clz_Torappu_TimelyDropTimeInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_TimelyDropTimeInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_TimelyDropTimeInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_TimelyDropTimeInfo>>(dict__string__clz_Torappu_TimelyDropTimeInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_TimelyDropTimeInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_TimelyDropTimeInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_TimelyDropTimeInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_TimelyDropTimeInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_TimelyDropTimeInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_TimelyDropTimeInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_TimelyDropTimeInfo>>(dict__string__clz_Torappu_TimelyDropTimeInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_TimelyDropTimeInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_TimelyDropTimeInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_TimelyDropTimeInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_TimelyDropTimeInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_TimelyDropTimeInfoT>>,
}
...
impl dict__string__clz_Torappu_TimelyDropTimeInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_TimelyDropTimeInfo::create(_fbb, &dict__string__clz_Torappu_TimelyDropTimeInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> dict__string__clz_Torappu_StageData_StageDropInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_StageData_StageDropInfoT {
    ...
    dict__string__clz_Torappu_StageData_StageDropInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_StageData_StageDropInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_StageData_StageDropInfo) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_StageData_StageDropInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StageData_StageDropInfo>>(dict__string__clz_Torappu_StageData_StageDropInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_StageData_StageDropInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StageData_StageDropInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_StageData_StageDropInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_StageData_StageDropInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_StageData_StageDropInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StageData_StageDropInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StageData_StageDropInfo>>(dict__string__clz_Torappu_StageData_StageDropInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_StageData_StageDropInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StageData_StageDropInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_StageData_StageDropInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_StageData_StageDropInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StageData_StageDropInfoT>>,
}
...
impl dict__string__clz_Torappu_StageData_StageDropInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_StageData_StageDropInfo::create(_fbb, &dict__string__clz_Torappu_StageData_StageDropInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_OverrideDropInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.dropTypeDesc { builder.add_dropTypeDesc(x); }
    if let Some(x) = args.dropTag { builder.add_dropTag(x); }
    if let Some(x) = args.desc3 { builder.add_desc3(x); }
    if let Some(x) = args.desc2 { builder.add_desc2(x); }
    if let Some(x) = args.desc1 { builder.add_desc1(x); }
    if let Some(x) = args.egName { builder.add_egName(x); }
    if let Some(x) = args.name { builder.add_name(x); }
    builder.add_times(args.times);
    if let Some(x) = args.zoneRange { builder.add_zoneRange(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_OverrideDropInfoT {
    ...
    let startTs = self.startTs();
    let endTs = self.endTs();
    let zoneRange = self.zoneRange().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    ...
    let egName = self.egName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let desc1 = self.desc1().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let desc2 = self.desc2().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let desc3 = self.desc3().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let dropTag = self.dropTag().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let dropTypeDesc = self.dropTypeDesc().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn itemId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_ITEMID, None)}
  }
  #[inline]
  pub fn startTs(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_OverrideDropInfo::VT_STARTTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn endTs(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_OverrideDropInfo::VT_ENDTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn zoneRange(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_ZONERANGE, None)}
  }
  #[inline]
  pub fn times(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_OverrideDropInfo::VT_TIMES, Some(0)).unwrap()}
  }
  #[inline]
  pub fn name(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_NAME, None)}
  }
  #[inline]
  pub fn egName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_EGNAME, None)}
  }
  #[inline]
  pub fn desc1(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_DESC1, None)}
  }
  #[inline]
  pub fn desc2(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_DESC2, None)}
  }
  #[inline]
  pub fn desc3(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_DESC3, None)}
  }
  #[inline]
  pub fn dropTag(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_DROPTAG, None)}
  }
  #[inline]
  pub fn dropTypeDesc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideDropInfo::VT_DROPTYPEDESC, None)}
  }
  #[inline]
  pub fn dropInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData_StageDropInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData_StageDropInfo>>>>(clz_Torappu_OverrideDropInfo::VT_DROPINFO, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_OverrideDropInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i64>("startTs", Self::VT_STARTTS, false)?
     .visit_field::<i64>("endTs", Self::VT_ENDTS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneRange", Self::VT_ZONERANGE, false)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("dropTypeDesc", Self::VT_DROPTYPEDESC, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData_StageDropInfo>>>>("dropInfo", Self::VT_DROPINFO, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_OverrideDropInfoArgs<'a> {
    ...
    pub dropInfo: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData_StageDropInfo<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_OverrideDropInfoBuilder<'a, 'b, A> {
  ...
  pub fn add_itemId(&mut self, itemId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_ITEMID, itemId);
  }
  #[inline]
  pub fn add_startTs(&mut self, startTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_OverrideDropInfo::VT_STARTTS, startTs, 0);
  }
  #[inline]
  pub fn add_endTs(&mut self, endTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_OverrideDropInfo::VT_ENDTS, endTs, 0);
  }
  #[inline]
  pub fn add_zoneRange(&mut self, zoneRange: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_ZONERANGE, zoneRange);
  }
  #[inline]
  pub fn add_times(&mut self, times: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_OverrideDropInfo::VT_TIMES, times, 0);
  }
  #[inline]
  pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_NAME, name);
  }
  #[inline]
  pub fn add_egName(&mut self, egName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_EGNAME, egName);
  }
  #[inline]
  pub fn add_desc1(&mut self, desc1: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_DESC1, desc1);
  }
  #[inline]
  pub fn add_desc2(&mut self, desc2: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_DESC2, desc2);
  }
  #[inline]
  pub fn add_desc3(&mut self, desc3: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_DESC3, desc3);
  }
  #[inline]
  pub fn add_dropTag(&mut self, dropTag: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_DROPTAG, dropTag);
  }
  #[inline]
  pub fn add_dropTypeDesc(&mut self, dropTypeDesc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_DROPTYPEDESC, dropTypeDesc);
  }
  #[inline]
  pub fn add_dropInfo(&mut self, dropInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData_StageDropInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideDropInfo::VT_DROPINFO, dropInfo);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_OverrideDropInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_OverrideDropInfoT {
  ...
  pub startTs: i64,
  pub endTs: i64,
  pub zoneRange: Option<alloc::string::String>,
  pub times: i32,
  pub name: Option<alloc::string::String>,
  pub egName: Option<alloc::string::String>,
  pub desc1: Option<alloc::string::String>,
  pub desc2: Option<alloc::string::String>,
  pub desc3: Option<alloc::string::String>,
  pub dropTag: Option<alloc::string::String>,
  pub dropTypeDesc: Option<alloc::string::String>,
  pub dropInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_StageData_StageDropInfoT>>,
}
...
impl clz_Torappu_OverrideDropInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let startTs = self.startTs;
    let endTs = self.endTs;
    let zoneRange = self.zoneRange.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let times = self.times;
    let name = self.name.as_ref().map(|x|{
    ...
    let egName = self.egName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let desc1 = self.desc1.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let desc2 = self.desc2.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let desc3 = self.desc3.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let dropTag = self.dropTag.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let dropTypeDesc = self.dropTypeDesc.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let dropInfo = self.dropInfo.as_ref().map(|x|{
      let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();_fbb.create_vector(&w)
    });
    clz_Torappu_OverrideDropInfo::create(_fbb, &clz_Torappu_OverrideDropInfoArgs{
      itemId,
      startTs,
      endTs,
      zoneRange,
...
impl<'a> dict__string__clz_Torappu_OverrideDropInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_OverrideDropInfoT {
    ...
    dict__string__clz_Torappu_OverrideDropInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_OverrideDropInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_OverrideDropInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_OverrideDropInfo>>(dict__string__clz_Torappu_OverrideDropInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_OverrideDropInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_OverrideDropInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_OverrideDropInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_OverrideDropInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_OverrideDropInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_OverrideDropInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_OverrideDropInfo>>(dict__string__clz_Torappu_OverrideDropInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_OverrideDropInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_OverrideDropInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_OverrideDropInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_OverrideDropInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_OverrideDropInfoT>>,
}
...
impl dict__string__clz_Torappu_OverrideDropInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_OverrideDropInfo::create(_fbb, &dict__string__clz_Torappu_OverrideDropInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> dict__string__list_clz_Torappu_StageData_ConditionDesc<'a> {
  ...
  pub fn unpack(&self) -> dict__string__list_clz_Torappu_StageData_ConditionDescT {
    ...
    dict__string__list_clz_Torappu_StageData_ConditionDescT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__list_clz_Torappu_StageData_ConditionDesc::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__list_clz_Torappu_StageData_ConditionDesc) -> bool {
    self.key() < o.key()
  }
  ...
  #[inline]
  pub fn value(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_StageData_ConditionDesc<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_StageData_ConditionDesc>>>>(dict__string__list_clz_Torappu_StageData_ConditionDesc::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__list_clz_Torappu_StageData_ConditionDesc<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_StageData_ConditionDesc>>>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
pub struct dict__string__list_clz_Torappu_StageData_ConditionDescArgs<'a> {
    pub key: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub value: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_StageData_ConditionDesc<'a>>>>>,
}
...
pub struct dict__string__list_clz_Torappu_StageData_ConditionDescBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__list_clz_Torappu_StageData_ConditionDescBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__list_clz_Torappu_StageData_ConditionDesc::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_StageData_ConditionDesc<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__list_clz_Torappu_StageData_ConditionDesc::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__list_clz_Torappu_StageData_ConditionDescBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__list_clz_Torappu_StageData_ConditionDesc<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__list_clz_Torappu_StageData_ConditionDesc::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__list_clz_Torappu_StageData_ConditionDescT {
  pub key: alloc::string::String,
  pub value: Option<alloc::vec::Vec<clz_Torappu_StageData_ConditionDescT>>,
}
...
impl dict__string__list_clz_Torappu_StageData_ConditionDescT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__list_clz_Torappu_StageData_ConditionDesc::create(_fbb, &dict__string__list_clz_Torappu_StageData_ConditionDescArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_OverrideUnlockInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_endTime(args.endTime);
    builder.add_startTime(args.startTime);
    if let Some(x) = args.unlockDict { builder.add_unlockDict(x); }
    if let Some(x) = args.groupId { builder.add_groupId(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> clz_Torappu_OverrideUnlockInfoT {
    ...
    let startTime = self.startTime();
    let endTime = self.endTime();
    let unlockDict = self.unlockDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  pub fn groupId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_OverrideUnlockInfo::VT_GROUPID, None)}
  }
  #[inline]
  pub fn startTime(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_OverrideUnlockInfo::VT_STARTTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn endTime(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_OverrideUnlockInfo::VT_ENDTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn unlockDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_clz_Torappu_StageData_ConditionDesc<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_clz_Torappu_StageData_ConditionDesc>>>>(clz_Torappu_OverrideUnlockInfo::VT_UNLOCKDICT, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_OverrideUnlockInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i64>("startTime", Self::VT_STARTTIME, false)?
     .visit_field::<i64>("endTime", Self::VT_ENDTIME, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__list_clz_Torappu_StageData_ConditionDesc>>>>("unlockDict", Self::VT_UNLOCKDICT, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_OverrideUnlockInfoArgs<'a> {
    ...
    pub startTime: i64,
    pub endTime: i64,
    pub unlockDict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_clz_Torappu_StageData_ConditionDesc<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_OverrideUnlockInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_groupId(&mut self, groupId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideUnlockInfo::VT_GROUPID, groupId);
  }
  #[inline]
  pub fn add_startTime(&mut self, startTime: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_OverrideUnlockInfo::VT_STARTTIME, startTime, 0);
  }
  #[inline]
  pub fn add_endTime(&mut self, endTime: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_OverrideUnlockInfo::VT_ENDTIME, endTime, 0);
  }
  #[inline]
  pub fn add_unlockDict(&mut self, unlockDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__list_clz_Torappu_StageData_ConditionDesc<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_OverrideUnlockInfo::VT_UNLOCKDICT, unlockDict);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_OverrideUnlockInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_OverrideUnlockInfoT {
  ...
  pub startTime: i64,
  pub endTime: i64,
  pub unlockDict: Option<alloc::vec::Vec<dict__string__list_clz_Torappu_StageData_ConditionDescT>>,
}
...
impl clz_Torappu_OverrideUnlockInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_OverrideUnlockInfo::create(_fbb, &clz_Torappu_OverrideUnlockInfoArgs{
      groupId,
      startTime,
      endTime,
      unlockDict,
...
impl<'a> dict__string__clz_Torappu_OverrideUnlockInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_OverrideUnlockInfoT {
    ...
    dict__string__clz_Torappu_OverrideUnlockInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_OverrideUnlockInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_OverrideUnlockInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_OverrideUnlockInfo>>(dict__string__clz_Torappu_OverrideUnlockInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_OverrideUnlockInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_OverrideUnlockInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_OverrideUnlockInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_OverrideUnlockInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_OverrideUnlockInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_OverrideUnlockInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_OverrideUnlockInfo>>(dict__string__clz_Torappu_OverrideUnlockInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_OverrideUnlockInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_OverrideUnlockInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_OverrideUnlockInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_OverrideUnlockInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_OverrideUnlockInfoT>>,
}
...
impl dict__string__clz_Torappu_OverrideUnlockInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_OverrideUnlockInfo::create(_fbb, &dict__string__clz_Torappu_OverrideUnlockInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_TimelyDropInfo<'a> {
  ...
  pub fn dropInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData_StageDropInfo<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData_StageDropInfo>>>>(clz_Torappu_TimelyDropInfo::VT_DROPINFO, None)}
  }
}
...
impl<'a> Default for clz_Torappu_TimelyDropInfoArgs<'a> {
  #[inline]
  fn default() -> Self {
    clz_Torappu_TimelyDropInfoArgs {
      dropInfo: None,
    }
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_TimelyDropInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_dropInfo(&mut self, dropInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData_StageDropInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TimelyDropInfo::VT_DROPINFO, dropInfo);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_TimelyDropInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_TimelyDropInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_TimelyDropInfo::create(_fbb, &clz_Torappu_TimelyDropInfoArgs{
      dropInfo,
    })
  }
}
...
impl<'a> dict__string__clz_Torappu_TimelyDropInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_TimelyDropInfoT {
    ...
    dict__string__clz_Torappu_TimelyDropInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_TimelyDropInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_TimelyDropInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_TimelyDropInfo>>(dict__string__clz_Torappu_TimelyDropInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_TimelyDropInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_TimelyDropInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_TimelyDropInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_TimelyDropInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_TimelyDropInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_TimelyDropInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_TimelyDropInfo>>(dict__string__clz_Torappu_TimelyDropInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_TimelyDropInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_TimelyDropInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_TimelyDropInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_TimelyDropInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_TimelyDropInfoT>>,
}
...
impl dict__string__clz_Torappu_TimelyDropInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_TimelyDropInfo::create(_fbb, &dict__string__clz_Torappu_TimelyDropInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StageFogInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.preposedLockId { builder.add_preposedLockId(x); }
    if let Some(x) = args.preposedStageId { builder.add_preposedStageId(x); }
    builder.add_unlockItemNum(args.unlockItemNum);
    builder.add_unlockItemType(args.unlockItemType);
    if let Some(x) = args.unlockItemId { builder.add_unlockItemId(x); }
    if let Some(x) = args.lockDesc { builder.add_lockDesc(x); }
    if let Some(x) = args.lockName { builder.add_lockName(x); }
    if let Some(x) = args.stageId { builder.add_stageId(x); }
    builder.add_stageButtonInFogRenderType(args.stageButtonInFogRenderType);
    builder.add_fogType(args.fogType);
    if let Some(x) = args.lockId { builder.add_lockId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_StageFogInfoT {
    let lockId = self.lockId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    ...
    let lockName = self.lockName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let lockDesc = self.lockDesc().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let unlockItemId = self.unlockItemId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let unlockItemType = self.unlockItemType();
    let unlockItemNum = self.unlockItemNum();
    let preposedStageId = self.preposedStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let preposedLockId = self.preposedLockId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn lockId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageFogInfo::VT_LOCKID, None)}
  }
  #[inline]
  pub fn fogType(&self) -> enum__Torappu_FogType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_FogType>(clz_Torappu_StageFogInfo::VT_FOGTYPE, Some(enum__Torappu_FogType::ZONE)).unwrap()}
  }
  #[inline]
  pub fn stageButtonInFogRenderType(&self) -> enum__Torappu_StageButtonInFogRenderType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_StageButtonInFogRenderType>(clz_Torappu_StageFogInfo::VT_STAGEBUTTONINFOGRENDERTYPE, Some(enum__Torappu_StageButtonInFogRenderType::HIDE)).unwrap()}
  }
  #[inline]
  pub fn stageId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageFogInfo::VT_STAGEID, None)}
  }
  #[inline]
  pub fn lockName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageFogInfo::VT_LOCKNAME, None)}
  }
  #[inline]
  pub fn lockDesc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageFogInfo::VT_LOCKDESC, None)}
  }
  #[inline]
  pub fn unlockItemId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageFogInfo::VT_UNLOCKITEMID, None)}
  }
  #[inline]
  pub fn unlockItemType(&self) -> enum__Torappu_ItemType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_ItemType>(clz_Torappu_StageFogInfo::VT_UNLOCKITEMTYPE, Some(enum__Torappu_ItemType::NONE)).unwrap()}
  }
  #[inline]
  pub fn unlockItemNum(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_StageFogInfo::VT_UNLOCKITEMNUM, Some(0)).unwrap()}
  }
  #[inline]
  pub fn preposedStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageFogInfo::VT_PREPOSEDSTAGEID, None)}
  }
  #[inline]
  pub fn preposedLockId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageFogInfo::VT_PREPOSEDLOCKID, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StageFogInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<enum__Torappu_StageButtonInFogRenderType>("stageButtonInFogRenderType", Self::VT_STAGEBUTTONINFOGRENDERTYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("stageId", Self::VT_STAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("lockName", Self::VT_LOCKNAME, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("lockDesc", Self::VT_LOCKDESC, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("unlockItemId", Self::VT_UNLOCKITEMID, false)?
     .visit_field::<enum__Torappu_ItemType>("unlockItemType", Self::VT_UNLOCKITEMTYPE, false)?
     .visit_field::<i32>("unlockItemNum", Self::VT_UNLOCKITEMNUM, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("preposedStageId", Self::VT_PREPOSEDSTAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("preposedLockId", Self::VT_PREPOSEDLOCKID, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StageFogInfoBuilder<'a, 'b, A> {
  ...
  pub fn add_lockId(&mut self, lockId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageFogInfo::VT_LOCKID, lockId);
  }
  #[inline]
  pub fn add_fogType(&mut self, fogType: enum__Torappu_FogType) {
    self.fbb_.push_slot::<enum__Torappu_FogType>(clz_Torappu_StageFogInfo::VT_FOGTYPE, fogType, enum__Torappu_FogType::ZONE);
  }
  #[inline]
  pub fn add_stageButtonInFogRenderType(&mut self, stageButtonInFogRenderType: enum__Torappu_StageButtonInFogRenderType) {
    self.fbb_.push_slot::<enum__Torappu_StageButtonInFogRenderType>(clz_Torappu_StageFogInfo::VT_STAGEBUTTONINFOGRENDERTYPE, stageButtonInFogRenderType, enum__Torappu_StageButtonInFogRenderType::HIDE);
  }
  #[inline]
  pub fn add_stageId(&mut self, stageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageFogInfo::VT_STAGEID, stageId);
  }
  #[inline]
  pub fn add_lockName(&mut self, lockName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageFogInfo::VT_LOCKNAME, lockName);
  }
  #[inline]
  pub fn add_lockDesc(&mut self, lockDesc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageFogInfo::VT_LOCKDESC, lockDesc);
  }
  #[inline]
  pub fn add_unlockItemId(&mut self, unlockItemId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageFogInfo::VT_UNLOCKITEMID, unlockItemId);
  }
  #[inline]
  pub fn add_unlockItemType(&mut self, unlockItemType: enum__Torappu_ItemType) {
    self.fbb_.push_slot::<enum__Torappu_ItemType>(clz_Torappu_StageFogInfo::VT_UNLOCKITEMTYPE, unlockItemType, enum__Torappu_ItemType::NONE);
  }
  #[inline]
  pub fn add_unlockItemNum(&mut self, unlockItemNum: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_StageFogInfo::VT_UNLOCKITEMNUM, unlockItemNum, 0);
  }
  #[inline]
  pub fn add_preposedStageId(&mut self, preposedStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageFogInfo::VT_PREPOSEDSTAGEID, preposedStageId);
  }
  #[inline]
  pub fn add_preposedLockId(&mut self, preposedLockId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageFogInfo::VT_PREPOSEDLOCKID, preposedLockId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StageFogInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl ::core::fmt::Debug for clz_Torappu_StageFogInfo<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("clz_Torappu_StageFogInfo");
      ...
      ds.field("stageButtonInFogRenderType", &self.stageButtonInFogRenderType());
      ds.field("stageId", &self.stageId());
...
pub struct clz_Torappu_StageFogInfoT {
  pub lockId: Option<alloc::string::String>,
  pub fogType: enum__Torappu_FogType,
  pub stageButtonInFogRenderType: enum__Torappu_StageButtonInFogRenderType,
  pub stageId: Option<alloc::string::String>,
  pub lockName: Option<alloc::string::String>,
  pub lockDesc: Option<alloc::string::String>,
  pub unlockItemId: Option<alloc::string::String>,
  pub unlockItemType: enum__Torappu_ItemType,
  pub unlockItemNum: i32,
  pub preposedStageId: Option<alloc::string::String>,
  pub preposedLockId: Option<alloc::string::String>,
}
...
impl clz_Torappu_StageFogInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let lockId = self.lockId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let fogType = self.fogType;
    let stageButtonInFogRenderType = self.stageButtonInFogRenderType;
    ...
    let lockName = self.lockName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let lockDesc = self.lockDesc.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let unlockItemId = self.unlockItemId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let unlockItemType = self.unlockItemType;
    let unlockItemNum = self.unlockItemNum;
    let preposedStageId = self.preposedStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let preposedLockId = self.preposedLockId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_StageFogInfo::create(_fbb, &clz_Torappu_StageFogInfoArgs{
      lockId,
      fogType,
      stageButtonInFogRenderType,
      stageId,
...
impl<'a> dict__string__clz_Torappu_StageFogInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_StageFogInfoT {
    ...
    dict__string__clz_Torappu_StageFogInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_StageFogInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_StageFogInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StageFogInfo>>(dict__string__clz_Torappu_StageFogInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_StageFogInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StageFogInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_StageFogInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_StageFogInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StageFogInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StageFogInfo>>(dict__string__clz_Torappu_StageFogInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_StageFogInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StageFogInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_StageFogInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_StageFogInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StageFogInfoT>>,
}
...
impl dict__string__clz_Torappu_StageFogInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_StageFogInfo::create(_fbb, &dict__string__clz_Torappu_StageFogInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StageStartCond_RequireChar<'a> {
  ...
  pub fn charId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageStartCond_RequireChar::VT_CHARID, None)}
  }
  #[inline]
  pub fn evolvePhase(&self) -> enum__Torappu_EvolvePhase {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_EvolvePhase>(clz_Torappu_StageStartCond_RequireChar::VT_EVOLVEPHASE, Some(enum__Torappu_EvolvePhase::PHASE_0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StageStartCond_RequireCharBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_charId(&mut self, charId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageStartCond_RequireChar::VT_CHARID, charId);
  }
  #[inline]
  pub fn add_evolvePhase(&mut self, evolvePhase: enum__Torappu_EvolvePhase) {
    self.fbb_.push_slot::<enum__Torappu_EvolvePhase>(clz_Torappu_StageStartCond_RequireChar::VT_EVOLVEPHASE, evolvePhase, enum__Torappu_EvolvePhase::PHASE_0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StageStartCond_RequireCharBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_StageStartCond_RequireCharT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let evolvePhase = self.evolvePhase;
    clz_Torappu_StageStartCond_RequireChar::create(_fbb, &clz_Torappu_StageStartCond_RequireCharArgs{
      charId,
      evolvePhase,
    })
  }
...
impl<'a> clz_Torappu_StageStartCond<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.excludeAssists { builder.add_excludeAssists(x); }
    if let Some(x) = args.requireChars { builder.add_requireChars(x); }
    builder.add_isNotPass(args.isNotPass);
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_StageStartCondT {
    let requireChars = self.requireChars().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let excludeAssists = self.excludeAssists().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
  ...
  #[inline]
  pub fn requireChars(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_StageStartCond_RequireChar<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_StageStartCond_RequireChar>>>>(clz_Torappu_StageStartCond::VT_REQUIRECHARS, None)}
  }
  #[inline]
  pub fn excludeAssists(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_StageStartCond::VT_EXCLUDEASSISTS, None)}
  }
  #[inline]
  pub fn isNotPass(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_StageStartCond::VT_ISNOTPASS, Some(false)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StageStartCond<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_StageStartCond_RequireChar>>>>("requireChars", Self::VT_REQUIRECHARS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("excludeAssists", Self::VT_EXCLUDEASSISTS, false)?
...
pub struct clz_Torappu_StageStartCondArgs<'a> {
    pub requireChars: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_StageStartCond_RequireChar<'a>>>>>,
    pub excludeAssists: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
    pub isNotPass: bool,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StageStartCondBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_requireChars(&mut self, requireChars: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_StageStartCond_RequireChar<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageStartCond::VT_REQUIRECHARS, requireChars);
  }
  #[inline]
  pub fn add_excludeAssists(&mut self, excludeAssists: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageStartCond::VT_EXCLUDEASSISTS, excludeAssists);
  }
  #[inline]
  pub fn add_isNotPass(&mut self, isNotPass: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_StageStartCond::VT_ISNOTPASS, isNotPass, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StageStartCondBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StageStartCondT {
  pub requireChars: Option<alloc::vec::Vec<clz_Torappu_StageStartCond_RequireCharT>>,
  pub excludeAssists: Option<alloc::vec::Vec<alloc::string::String>>,
  pub isNotPass: bool,
}
...
impl clz_Torappu_StageStartCondT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let isNotPass = self.isNotPass;
    clz_Torappu_StageStartCond::create(_fbb, &clz_Torappu_StageStartCondArgs{
      requireChars,
      excludeAssists,
      isNotPass,
    })
...
impl<'a> dict__string__clz_Torappu_StageStartCond<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_StageStartCondT {
    ...
    dict__string__clz_Torappu_StageStartCondT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_StageStartCond::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_StageStartCond<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StageStartCond>>(dict__string__clz_Torappu_StageStartCond::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_StageStartCond<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StageStartCond>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_StageStartCondBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_StageStartCondBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_StageStartCond::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StageStartCond<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StageStartCond>>(dict__string__clz_Torappu_StageStartCond::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_StageStartCondBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StageStartCond<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_StageStartCond::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_StageStartCondT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StageStartCondT>>,
}
...
impl dict__string__clz_Torappu_StageStartCondT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_StageStartCond::create(_fbb, &dict__string__clz_Torappu_StageStartCondArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StageDiffGroupTable<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.easyId { builder.add_easyId(x); }
    if let Some(x) = args.toughId { builder.add_toughId(x); }
    if let Some(x) = args.normalId { builder.add_normalId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_StageDiffGroupTableT {
    let normalId = self.normalId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let toughId = self.toughId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let easyId = self.easyId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn normalId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageDiffGroupTable::VT_NORMALID, None)}
  }
  #[inline]
  pub fn toughId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageDiffGroupTable::VT_TOUGHID, None)}
  }
  #[inline]
  pub fn easyId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StageDiffGroupTable::VT_EASYID, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StageDiffGroupTable<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("normalId", Self::VT_NORMALID, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StageDiffGroupTableBuilder<'a, 'b, A> {
  ...
  pub fn add_normalId(&mut self, normalId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageDiffGroupTable::VT_NORMALID, normalId);
  }
  #[inline]
  pub fn add_toughId(&mut self, toughId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageDiffGroupTable::VT_TOUGHID, toughId);
  }
  #[inline]
  pub fn add_easyId(&mut self, easyId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageDiffGroupTable::VT_EASYID, easyId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StageDiffGroupTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StageDiffGroupTableT {
  pub normalId: Option<alloc::string::String>,
  pub toughId: Option<alloc::string::String>,
  pub easyId: Option<alloc::string::String>,
}
...
impl clz_Torappu_StageDiffGroupTableT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let normalId = self.normalId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let toughId = self.toughId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let easyId = self.easyId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_StageDiffGroupTable::create(_fbb, &clz_Torappu_StageDiffGroupTableArgs{
      normalId,
      toughId,
      easyId,
    })
...
impl<'a> dict__string__clz_Torappu_StageDiffGroupTable<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_StageDiffGroupTableT {
    ...
    dict__string__clz_Torappu_StageDiffGroupTableT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_StageDiffGroupTable::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_StageDiffGroupTable<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StageDiffGroupTable>>(dict__string__clz_Torappu_StageDiffGroupTable::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_StageDiffGroupTable<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StageDiffGroupTable>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_StageDiffGroupTableBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_StageDiffGroupTableBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_StageDiffGroupTable::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StageDiffGroupTable<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StageDiffGroupTable>>(dict__string__clz_Torappu_StageDiffGroupTable::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_StageDiffGroupTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StageDiffGroupTable<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_StageDiffGroupTable::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_StageDiffGroupTableT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StageDiffGroupTableT>>,
}
...
impl dict__string__clz_Torappu_StageDiffGroupTableT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_StageDiffGroupTable::create(_fbb, &dict__string__clz_Torappu_StageDiffGroupTableArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StoryStageShowGroup<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_diffGroup(args.diffGroup);
    if let Some(x) = args.accordingStageId { builder.add_accordingStageId(x); }
    if let Some(x) = args.stageId { builder.add_stageId(x); }
    if let Some(x) = args.displayRecordId { builder.add_displayRecordId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_StoryStageShowGroupT {
    let displayRecordId = self.displayRecordId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let stageId = self.stageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let accordingStageId = self.accordingStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let diffGroup = self.diffGroup();
  ...
  pub fn displayRecordId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StoryStageShowGroup::VT_DISPLAYRECORDID, None)}
  }
  #[inline]
  pub fn stageId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StoryStageShowGroup::VT_STAGEID, None)}
  }
  #[inline]
  pub fn accordingStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StoryStageShowGroup::VT_ACCORDINGSTAGEID, None)}
  }
  #[inline]
  pub fn diffGroup(&self) -> enum__Torappu_StageDiffGroup {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_StageDiffGroup>(clz_Torappu_StoryStageShowGroup::VT_DIFFGROUP, Some(enum__Torappu_StageDiffGroup::NONE)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StoryStageShowGroup<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("displayRecordId", Self::VT_DISPLAYRECORDID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("stageId", Self::VT_STAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("accordingStageId", Self::VT_ACCORDINGSTAGEID, false)?
     .visit_field::<enum__Torappu_StageDiffGroup>("diffGroup", Self::VT_DIFFGROUP, false)?
     .finish();
    Ok(())
  }
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StoryStageShowGroupBuilder<'a, 'b, A> {
  ...
  pub fn add_displayRecordId(&mut self, displayRecordId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StoryStageShowGroup::VT_DISPLAYRECORDID, displayRecordId);
  }
  #[inline]
  pub fn add_stageId(&mut self, stageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StoryStageShowGroup::VT_STAGEID, stageId);
  }
  #[inline]
  pub fn add_accordingStageId(&mut self, accordingStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StoryStageShowGroup::VT_ACCORDINGSTAGEID, accordingStageId);
  }
  #[inline]
  pub fn add_diffGroup(&mut self, diffGroup: enum__Torappu_StageDiffGroup) {
    self.fbb_.push_slot::<enum__Torappu_StageDiffGroup>(clz_Torappu_StoryStageShowGroup::VT_DIFFGROUP, diffGroup, enum__Torappu_StageDiffGroup::NONE);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StoryStageShowGroupBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StoryStageShowGroupT {
  pub displayRecordId: Option<alloc::string::String>,
  pub stageId: Option<alloc::string::String>,
  pub accordingStageId: Option<alloc::string::String>,
  pub diffGroup: enum__Torappu_StageDiffGroup,
}
...
impl clz_Torappu_StoryStageShowGroupT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let displayRecordId = self.displayRecordId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let stageId = self.stageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let accordingStageId = self.accordingStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let diffGroup = self.diffGroup;
    clz_Torappu_StoryStageShowGroup::create(_fbb, &clz_Torappu_StoryStageShowGroupArgs{
      displayRecordId,
      stageId,
      accordingStageId,
      diffGroup,
...
impl<'a> ::flatbuffers::Follow<'a> for dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a> {
...
impl<'a> dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a> {
  ...
  ) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'bldr>> {
    let mut builder = dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupBuilder::new(_fbb);
    if let Some(x) = args.value { builder.add_value(x); }
    builder.add_key(args.key);
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT {
    ...
    dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> enum__Torappu_StageDiffGroup {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_StageDiffGroup>(dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup::VT_KEY, Some(enum__Torappu_StageDiffGroup::NONE)).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup) -> bool {
    self.key() < o.key()
  }

  #[inline]
  pub fn key_compare_with_value(&self, val: enum__Torappu_StageDiffGroup) -> ::core::cmp::Ordering {
    let key = self.key();
    key.cmp(&val)
  }
  #[inline]
  pub fn value(&self) -> Option<clz_Torappu_StoryStageShowGroup<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StoryStageShowGroup>>(dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup::VT_VALUE, None)}
  }
}

impl ::flatbuffers::Verifiable for dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'_> {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StoryStageShowGroup>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: enum__Torappu_StageDiffGroup) {
    self.fbb_.push_slot::<enum__Torappu_StageDiffGroup>(dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup::VT_KEY, key, enum__Torappu_StageDiffGroup::NONE);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StoryStageShowGroup<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StoryStageShowGroup>>(dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl ::core::fmt::Debug for dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup");
      ds.field("key", &self.key());
      ds.field("value", &self.value());
      ds.finish()
  }
...
pub struct dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT {
  pub key: enum__Torappu_StageDiffGroup,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StoryStageShowGroupT>>,
}
...
impl dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut ::flatbuffers::FlatBufferBuilder<'b, A>
  ) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'b>> {
    let key = self.key;
    let value = self.value.as_ref().map(|x|{
      x.pack(_fbb)
    });
    dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup::create(_fbb, &dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupArgs{
      key,
      value,
    })
  }
...
pub struct dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a> {
  pub _tab: ::flatbuffers::Table<'a>,
}

impl<'a> ::flatbuffers::Follow<'a> for dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a> {
  type Inner = dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a>;
  #[inline]
  unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    Self { _tab: unsafe { ::flatbuffers::Table::new(buf, loc) } }
  }
...
impl<'a> dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a> {
  pub const VT_KEY: ::flatbuffers::VOffsetT = 4;
  pub const VT_VALUE: ::flatbuffers::VOffsetT = 6;

  #[inline]
  pub unsafe fn init_from_table(table: ::flatbuffers::Table<'a>) -> Self {
    dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup { _tab: table }
  }
  #[allow(unused_mut)]
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupArgs<'args>
  ) -> ::flatbuffers::WIPOffset<dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'bldr>> {
  ...
  pub fn unpack(&self) -> dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT {
    let key = {
      let x = self.key();
      alloc::string::ToString::to_string(x)
    };
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup) -> bool {
    self.key() < o.key()
  }
  ...
  #[inline]
  pub fn value(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup>>>>(dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup::VT_VALUE, None)}
  }
}

impl ::flatbuffers::Verifiable for dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'_> {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup>>>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
pub struct dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupArgs<'a> {
    pub key: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub value: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a>>>>>,
}
impl<'a> Default for dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
  ...
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'b >>>>) {
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a>> {
    let o = self.fbb_.end_table(self.start_);
...
impl ::core::fmt::Debug for dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
pub struct dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT {
  pub key: alloc::string::String,
  pub value: Option<alloc::vec::Vec<dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT>>,
}
impl Default for dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT {
  fn default() -> Self {
    Self {
      key: alloc::string::ToString::to_string(""),
      value: None,
...
impl dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut ::flatbuffers::FlatBufferBuilder<'b, A>
  ) -> ::flatbuffers::WIPOffset<dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'b>> {
    let key = Some({
      let x = &self.key;
      _fbb.create_string(x)
    });
...
impl<'a> clz_Torappu_SpecialBattleFinishStageData<'a> {
  ...
  pub fn stageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SpecialBattleFinishStageData::VT_STAGEID, None)}
  }
  #[inline]
  pub fn skipAccomplishPerform(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_SpecialBattleFinishStageData::VT_SKIPACCOMPLISHPERFORM, Some(false)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_SpecialBattleFinishStageData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("stageId", Self::VT_STAGEID, false)?
     .visit_field::<bool>("skipAccomplishPerform", Self::VT_SKIPACCOMPLISHPERFORM, false)?
     .finish();
    Ok(())
  }
}
...
pub struct clz_Torappu_SpecialBattleFinishStageDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_SpecialBattleFinishStageDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_stageId(&mut self, stageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SpecialBattleFinishStageData::VT_STAGEID, stageId);
  }
  #[inline]
  pub fn add_skipAccomplishPerform(&mut self, skipAccomplishPerform: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_SpecialBattleFinishStageData::VT_SKIPACCOMPLISHPERFORM, skipAccomplishPerform, false);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_SpecialBattleFinishStageDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_SpecialBattleFinishStageDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let skipAccomplishPerform = self.skipAccomplishPerform;
    clz_Torappu_SpecialBattleFinishStageData::create(_fbb, &clz_Torappu_SpecialBattleFinishStageDataArgs{
      stageId,
      skipAccomplishPerform,
    })
  }
...
impl<'a> dict__string__clz_Torappu_SpecialBattleFinishStageData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_SpecialBattleFinishStageDataT {
    ...
    dict__string__clz_Torappu_SpecialBattleFinishStageDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_SpecialBattleFinishStageData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_SpecialBattleFinishStageData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_SpecialBattleFinishStageData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_SpecialBattleFinishStageData>>(dict__string__clz_Torappu_SpecialBattleFinishStageData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_SpecialBattleFinishStageData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_SpecialBattleFinishStageData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_SpecialBattleFinishStageDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_SpecialBattleFinishStageDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_SpecialBattleFinishStageData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_SpecialBattleFinishStageData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_SpecialBattleFinishStageData>>(dict__string__clz_Torappu_SpecialBattleFinishStageData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_SpecialBattleFinishStageDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_SpecialBattleFinishStageData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_SpecialBattleFinishStageData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_SpecialBattleFinishStageDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_SpecialBattleFinishStageDataT>>,
}
...
impl dict__string__clz_Torappu_SpecialBattleFinishStageDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_SpecialBattleFinishStageData::create(_fbb, &dict__string__clz_Torappu_SpecialBattleFinishStageDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_RecordRewardServerData<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_RecordRewardServerDataT {
    ...
    clz_Torappu_RecordRewardServerDataT {
      stageId,
      rewards,
    }
  }
  ...
  pub fn stageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_RecordRewardServerData::VT_STAGEID, None)}
  }
  #[inline]
  pub fn rewards(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle>>>>(clz_Torappu_RecordRewardServerData::VT_REWARDS, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_RecordRewardServerDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_stageId(&mut self, stageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RecordRewardServerData::VT_STAGEID, stageId);
  }
  #[inline]
  pub fn add_rewards(&mut self, rewards: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RecordRewardServerData::VT_REWARDS, rewards);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_RecordRewardServerDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_RecordRewardServerDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_RecordRewardServerData::create(_fbb, &clz_Torappu_RecordRewardServerDataArgs{
      stageId,
      rewards,
    })
  }
...
impl<'a> dict__string__clz_Torappu_RecordRewardServerData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_RecordRewardServerDataT {
    ...
    dict__string__clz_Torappu_RecordRewardServerDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_RecordRewardServerData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_RecordRewardServerData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_RecordRewardServerData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardServerData>>(dict__string__clz_Torappu_RecordRewardServerData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_RecordRewardServerData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardServerData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_RecordRewardServerDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_RecordRewardServerDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_RecordRewardServerData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_RecordRewardServerData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_RecordRewardServerData>>(dict__string__clz_Torappu_RecordRewardServerData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_RecordRewardServerDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_RecordRewardServerData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_RecordRewardServerData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_RecordRewardServerDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_RecordRewardServerDataT>>,
}
...
impl dict__string__clz_Torappu_RecordRewardServerDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_RecordRewardServerData::create(_fbb, &dict__string__clz_Torappu_RecordRewardServerDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ApProtectZoneInfo_TimeRange<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_ApProtectZoneInfo_TimeRangeT {
    let startTs = self.startTs();
    let endTs = self.endTs();
    clz_Torappu_ApProtectZoneInfo_TimeRangeT {
      startTs,
      endTs,
    }
  }
  ...
  pub fn startTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_ApProtectZoneInfo_TimeRange::VT_STARTTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn endTs(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_ApProtectZoneInfo_TimeRange::VT_ENDTS, Some(0)).unwrap()}
  }
}
...
pub struct clz_Torappu_ApProtectZoneInfo_TimeRangeBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ApProtectZoneInfo_TimeRangeBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_startTs(&mut self, startTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_ApProtectZoneInfo_TimeRange::VT_STARTTS, startTs, 0);
  }
  #[inline]
  pub fn add_endTs(&mut self, endTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_ApProtectZoneInfo_TimeRange::VT_ENDTS, endTs, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ApProtectZoneInfo_TimeRangeBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_ApProtectZoneInfo_TimeRangeT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let startTs = self.startTs;
    let endTs = self.endTs;
    clz_Torappu_ApProtectZoneInfo_TimeRange::create(_fbb, &clz_Torappu_ApProtectZoneInfo_TimeRangeArgs{
      startTs,
      endTs,
    })
  }
...
impl<'a> clz_Torappu_ApProtectZoneInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.timeRanges { builder.add_timeRanges(x); }
    if let Some(x) = args.zoneId { builder.add_zoneId(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> clz_Torappu_ApProtectZoneInfoT {
    ...
    let timeRanges = self.timeRanges().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    clz_Torappu_ApProtectZoneInfoT {
      zoneId,
      timeRanges,
    }
  }
  ...
  pub fn zoneId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ApProtectZoneInfo::VT_ZONEID, None)}
  }
  #[inline]
  pub fn timeRanges(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ApProtectZoneInfo_TimeRange<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ApProtectZoneInfo_TimeRange>>>>(clz_Torappu_ApProtectZoneInfo::VT_TIMERANGES, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ApProtectZoneInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneId", Self::VT_ZONEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ApProtectZoneInfo_TimeRange>>>>("timeRanges", Self::VT_TIMERANGES, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_ApProtectZoneInfoArgs<'a> {
    pub zoneId: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub timeRanges: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ApProtectZoneInfo_TimeRange<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ApProtectZoneInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_zoneId(&mut self, zoneId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ApProtectZoneInfo::VT_ZONEID, zoneId);
  }
  #[inline]
  pub fn add_timeRanges(&mut self, timeRanges: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ApProtectZoneInfo_TimeRange<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ApProtectZoneInfo::VT_TIMERANGES, timeRanges);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ApProtectZoneInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ApProtectZoneInfoT {
  pub zoneId: Option<alloc::string::String>,
  pub timeRanges: Option<alloc::vec::Vec<clz_Torappu_ApProtectZoneInfo_TimeRangeT>>,
}
...
impl clz_Torappu_ApProtectZoneInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_ApProtectZoneInfo::create(_fbb, &clz_Torappu_ApProtectZoneInfoArgs{
      zoneId,
      timeRanges,
    })
  }
...
impl<'a> dict__string__clz_Torappu_ApProtectZoneInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ApProtectZoneInfoT {
    ...
    dict__string__clz_Torappu_ApProtectZoneInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ApProtectZoneInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ApProtectZoneInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ApProtectZoneInfo>>(dict__string__clz_Torappu_ApProtectZoneInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ApProtectZoneInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ApProtectZoneInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ApProtectZoneInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ApProtectZoneInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ApProtectZoneInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ApProtectZoneInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ApProtectZoneInfo>>(dict__string__clz_Torappu_ApProtectZoneInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ApProtectZoneInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ApProtectZoneInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ApProtectZoneInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ApProtectZoneInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ApProtectZoneInfoT>>,
}
...
impl dict__string__clz_Torappu_ApProtectZoneInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ApProtectZoneInfo::create(_fbb, &dict__string__clz_Torappu_ApProtectZoneInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> dict__string__list_string<'a> {
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__list_string::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(dict__string__list_string::VT_VALUE, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__list_stringBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__list_string::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__list_string::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__list_stringBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__list_string<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__list_string::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__list_stringT {
  pub key: alloc::string::String,
  pub value: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
impl dict__string__list_stringT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__list_string::create(_fbb, &dict__string__list_stringArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ActCustomStageData<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_ActCustomStageDataT {
    ...
    clz_Torappu_ActCustomStageDataT {
      overrideGameMode,
    }
  }
  ...
  pub fn overrideGameMode(&self) -> enum__Torappu_OverrideGameMode {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_OverrideGameMode>(clz_Torappu_ActCustomStageData::VT_OVERRIDEGAMEMODE, Some(enum__Torappu_OverrideGameMode::NONE)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ActCustomStageData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<enum__Torappu_OverrideGameMode>("overrideGameMode", Self::VT_OVERRIDEGAMEMODE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ActCustomStageDataBuilder<'a, 'b, A> {
  ...
  pub fn add_overrideGameMode(&mut self, overrideGameMode: enum__Torappu_OverrideGameMode) {
    self.fbb_.push_slot::<enum__Torappu_OverrideGameMode>(clz_Torappu_ActCustomStageData::VT_OVERRIDEGAMEMODE, overrideGameMode, enum__Torappu_OverrideGameMode::NONE);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ActCustomStageDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_ActCustomStageDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let overrideGameMode = self.overrideGameMode;
    clz_Torappu_ActCustomStageData::create(_fbb, &clz_Torappu_ActCustomStageDataArgs{
      overrideGameMode,
    })
  }
}
...
impl<'a> dict__string__clz_Torappu_ActCustomStageData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ActCustomStageDataT {
    ...
    dict__string__clz_Torappu_ActCustomStageDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ActCustomStageData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ActCustomStageData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ActCustomStageData>>(dict__string__clz_Torappu_ActCustomStageData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ActCustomStageData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ActCustomStageData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ActCustomStageDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ActCustomStageDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ActCustomStageData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ActCustomStageData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ActCustomStageData>>(dict__string__clz_Torappu_ActCustomStageData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ActCustomStageDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ActCustomStageData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ActCustomStageData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ActCustomStageDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ActCustomStageDataT>>,
}
...
impl dict__string__clz_Torappu_ActCustomStageDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ActCustomStageData::create(_fbb, &dict__string__clz_Torappu_ActCustomStageDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StorylineMainlineSplitData<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_StorylineMainlineSplitDataT {
    ...
    clz_Torappu_StorylineMainlineSplitDataT {
      iconId,
      subName,
    }
  }
  ...
  pub fn iconId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineMainlineSplitData::VT_ICONID, None)}
  }
  #[inline]
  pub fn subName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineMainlineSplitData::VT_SUBNAME, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineMainlineSplitDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_iconId(&mut self, iconId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineMainlineSplitData::VT_ICONID, iconId);
  }
  #[inline]
  pub fn add_subName(&mut self, subName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineMainlineSplitData::VT_SUBNAME, subName);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineMainlineSplitDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_StorylineMainlineSplitDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_StorylineMainlineSplitData::create(_fbb, &clz_Torappu_StorylineMainlineSplitDataArgs{
      iconId,
      subName,
    })
  }
...
impl<'a> clz_Torappu_StorylineLocationData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_startTime(args.startTime);
    if let Some(x) = args.mainlineSplitData { builder.add_mainlineSplitData(x); }
    if let Some(x) = args.relevantStorySetId { builder.add_relevantStorySetId(x); }
    if let Some(x) = args.unlockStageId { builder.add_unlockStageId(x); }
    if let Some(x) = args.presentStageId { builder.add_presentStageId(x); }
    builder.add_sortId(args.sortId);
    builder.add_locationType(args.locationType);
    if let Some(x) = args.locationId { builder.add_locationId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_StorylineLocationDataT {
    let locationId = self.locationId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let locationType = self.locationType();
    let sortId = self.sortId();
    let startTime = self.startTime();
    let presentStageId = self.presentStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let unlockStageId = self.unlockStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let relevantStorySetId = self.relevantStorySetId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let mainlineSplitData = self.mainlineSplitData().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
  ...
  pub fn locationId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineLocationData::VT_LOCATIONID, None)}
  }
  #[inline]
  pub fn locationType(&self) -> enum__Torappu_StorylineLocationType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_StorylineLocationType>(clz_Torappu_StorylineLocationData::VT_LOCATIONTYPE, Some(enum__Torappu_StorylineLocationType::STORY_SET)).unwrap()}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_StorylineLocationData::VT_SORTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn startTime(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_StorylineLocationData::VT_STARTTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn presentStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineLocationData::VT_PRESENTSTAGEID, None)}
  }
  #[inline]
  pub fn unlockStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineLocationData::VT_UNLOCKSTAGEID, None)}
  }
  #[inline]
  pub fn relevantStorySetId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineLocationData::VT_RELEVANTSTORYSETID, None)}
  }
  #[inline]
  pub fn mainlineSplitData(&self) -> Option<clz_Torappu_StorylineMainlineSplitData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineMainlineSplitData>>(clz_Torappu_StorylineLocationData::VT_MAINLINESPLITDATA, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StorylineLocationData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("locationId", Self::VT_LOCATIONID, false)?
     .visit_field::<enum__Torappu_StorylineLocationType>("locationType", Self::VT_LOCATIONTYPE, false)?
     .visit_field::<i32>("sortId", Self::VT_SORTID, false)?
     .visit_field::<i64>("startTime", Self::VT_STARTTIME, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("presentStageId", Self::VT_PRESENTSTAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("unlockStageId", Self::VT_UNLOCKSTAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("relevantStorySetId", Self::VT_RELEVANTSTORYSETID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineMainlineSplitData>>("mainlineSplitData", Self::VT_MAINLINESPLITDATA, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_StorylineLocationDataArgs<'a> {
    ...
    pub mainlineSplitData: Option<::flatbuffers::WIPOffset<clz_Torappu_StorylineMainlineSplitData<'a>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineLocationDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_locationId(&mut self, locationId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineLocationData::VT_LOCATIONID, locationId);
  }
  #[inline]
  pub fn add_locationType(&mut self, locationType: enum__Torappu_StorylineLocationType) {
    self.fbb_.push_slot::<enum__Torappu_StorylineLocationType>(clz_Torappu_StorylineLocationData::VT_LOCATIONTYPE, locationType, enum__Torappu_StorylineLocationType::STORY_SET);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_StorylineLocationData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn add_startTime(&mut self, startTime: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_StorylineLocationData::VT_STARTTIME, startTime, 0);
  }
  #[inline]
  pub fn add_presentStageId(&mut self, presentStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineLocationData::VT_PRESENTSTAGEID, presentStageId);
  }
  #[inline]
  pub fn add_unlockStageId(&mut self, unlockStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineLocationData::VT_UNLOCKSTAGEID, unlockStageId);
  }
  #[inline]
  pub fn add_relevantStorySetId(&mut self, relevantStorySetId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineLocationData::VT_RELEVANTSTORYSETID, relevantStorySetId);
  }
  #[inline]
  pub fn add_mainlineSplitData(&mut self, mainlineSplitData: ::flatbuffers::WIPOffset<clz_Torappu_StorylineMainlineSplitData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineMainlineSplitData>>(clz_Torappu_StorylineLocationData::VT_MAINLINESPLITDATA, mainlineSplitData);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineLocationDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StorylineLocationDataT {
  pub locationId: Option<alloc::string::String>,
  pub locationType: enum__Torappu_StorylineLocationType,
  pub sortId: i32,
  pub startTime: i64,
  pub presentStageId: Option<alloc::string::String>,
  pub unlockStageId: Option<alloc::string::String>,
  pub relevantStorySetId: Option<alloc::string::String>,
  pub mainlineSplitData: Option<alloc::boxed::Box<clz_Torappu_StorylineMainlineSplitDataT>>,
}
...
impl clz_Torappu_StorylineLocationDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let locationId = self.locationId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let locationType = self.locationType;
    let sortId = self.sortId;
    let startTime = self.startTime;
    let presentStageId = self.presentStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let unlockStageId = self.unlockStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let relevantStorySetId = self.relevantStorySetId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let mainlineSplitData = self.mainlineSplitData.as_ref().map(|x|{
      x.pack(_fbb)
    });
    clz_Torappu_StorylineLocationData::create(_fbb, &clz_Torappu_StorylineLocationDataArgs{
      locationId,
      locationType,
      sortId,
      startTime,
...
impl<'a> dict__string__clz_Torappu_StorylineLocationData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_StorylineLocationDataT {
    ...
    dict__string__clz_Torappu_StorylineLocationDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_StorylineLocationData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_StorylineLocationData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_StorylineLocationData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineLocationData>>(dict__string__clz_Torappu_StorylineLocationData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_StorylineLocationData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineLocationData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_StorylineLocationDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_StorylineLocationDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_StorylineLocationData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StorylineLocationData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineLocationData>>(dict__string__clz_Torappu_StorylineLocationData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_StorylineLocationDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StorylineLocationData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_StorylineLocationData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_StorylineLocationDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StorylineLocationDataT>>,
}
...
impl dict__string__clz_Torappu_StorylineLocationDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_StorylineLocationData::create(_fbb, &dict__string__clz_Torappu_StorylineLocationDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StorylineData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.backgroundId { builder.add_backgroundId(x); }
    if let Some(x) = args.storylineLogoId { builder.add_storylineLogoId(x); }
    if let Some(x) = args.storylineIconId { builder.add_storylineIconId(x); }
    if let Some(x) = args.storylineName { builder.add_storylineName(x); }
    builder.add_sortId(args.sortId);
    builder.add_storylineType(args.storylineType);
    if let Some(x) = args.storylineId { builder.add_storylineId(x); }
    builder.add_hasVideoToPlay(args.hasVideoToPlay);
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_StorylineDataT {
    let storylineId = self.storylineId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let storylineType = self.storylineType();
    let sortId = self.sortId();
    let storylineName = self.storylineName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let storylineIconId = self.storylineIconId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let storylineLogoId = self.storylineLogoId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let backgroundId = self.backgroundId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let hasVideoToPlay = self.hasVideoToPlay();
    let startTs = self.startTs();
    let locations = self.locations().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  pub fn storylineId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineData::VT_STORYLINEID, None)}
  }
  #[inline]
  pub fn storylineType(&self) -> enum__Torappu_StorylineType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_StorylineType>(clz_Torappu_StorylineData::VT_STORYLINETYPE, Some(enum__Torappu_StorylineType::CONTINUE)).unwrap()}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_StorylineData::VT_SORTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn storylineName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineData::VT_STORYLINENAME, None)}
  }
  #[inline]
  pub fn storylineIconId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineData::VT_STORYLINEICONID, None)}
  }
  #[inline]
  pub fn storylineLogoId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineData::VT_STORYLINELOGOID, None)}
  }
  #[inline]
  pub fn backgroundId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineData::VT_BACKGROUNDID, None)}
  }
  #[inline]
  pub fn hasVideoToPlay(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_StorylineData::VT_HASVIDEOTOPLAY, Some(false)).unwrap()}
  }
  #[inline]
  pub fn startTs(&self) -> i64 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_StorylineData::VT_STARTTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn locations(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineLocationData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineLocationData>>>>(clz_Torappu_StorylineData::VT_LOCATIONS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StorylineData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("storylineId", Self::VT_STORYLINEID, false)?
     .visit_field::<enum__Torappu_StorylineType>("storylineType", Self::VT_STORYLINETYPE, false)?
     .visit_field::<i32>("sortId", Self::VT_SORTID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("storylineName", Self::VT_STORYLINENAME, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("storylineIconId", Self::VT_STORYLINEICONID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("storylineLogoId", Self::VT_STORYLINELOGOID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("backgroundId", Self::VT_BACKGROUNDID, false)?
     .visit_field::<bool>("hasVideoToPlay", Self::VT_HASVIDEOTOPLAY, false)?
     .visit_field::<i64>("startTs", Self::VT_STARTTS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineLocationData>>>>("locations", Self::VT_LOCATIONS, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_StorylineDataArgs<'a> {
    ...
    pub startTs: i64,
    pub locations: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineLocationData<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineDataBuilder<'a, 'b, A> {
  ...
  pub fn add_storylineId(&mut self, storylineId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineData::VT_STORYLINEID, storylineId);
  }
  #[inline]
  pub fn add_storylineType(&mut self, storylineType: enum__Torappu_StorylineType) {
    self.fbb_.push_slot::<enum__Torappu_StorylineType>(clz_Torappu_StorylineData::VT_STORYLINETYPE, storylineType, enum__Torappu_StorylineType::CONTINUE);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_StorylineData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn add_storylineName(&mut self, storylineName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineData::VT_STORYLINENAME, storylineName);
  }
  #[inline]
  pub fn add_storylineIconId(&mut self, storylineIconId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineData::VT_STORYLINEICONID, storylineIconId);
  }
  #[inline]
  pub fn add_storylineLogoId(&mut self, storylineLogoId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineData::VT_STORYLINELOGOID, storylineLogoId);
  }
  #[inline]
  pub fn add_backgroundId(&mut self, backgroundId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineData::VT_BACKGROUNDID, backgroundId);
  }
  #[inline]
  pub fn add_hasVideoToPlay(&mut self, hasVideoToPlay: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_StorylineData::VT_HASVIDEOTOPLAY, hasVideoToPlay, false);
  }
  #[inline]
  pub fn add_startTs(&mut self, startTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_StorylineData::VT_STARTTS, startTs, 0);
  }
  #[inline]
  pub fn add_locations(&mut self, locations: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineLocationData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineData::VT_LOCATIONS, locations);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StorylineDataT {
  pub storylineId: Option<alloc::string::String>,
  pub storylineType: enum__Torappu_StorylineType,
  pub sortId: i32,
  pub storylineName: Option<alloc::string::String>,
  pub storylineIconId: Option<alloc::string::String>,
  pub storylineLogoId: Option<alloc::string::String>,
  pub backgroundId: Option<alloc::string::String>,
  pub hasVideoToPlay: bool,
  pub startTs: i64,
  pub locations: Option<alloc::vec::Vec<dict__string__clz_Torappu_StorylineLocationDataT>>,
}
...
impl clz_Torappu_StorylineDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let storylineId = self.storylineId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let storylineType = self.storylineType;
    let sortId = self.sortId;
    let storylineName = self.storylineName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let storylineIconId = self.storylineIconId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let storylineLogoId = self.storylineLogoId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let backgroundId = self.backgroundId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let hasVideoToPlay = self.hasVideoToPlay;
    let startTs = self.startTs;
    ...
    clz_Torappu_StorylineData::create(_fbb, &clz_Torappu_StorylineDataArgs{
      storylineId,
      storylineType,
      sortId,
      storylineName,
...
impl<'a> dict__string__clz_Torappu_StorylineData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_StorylineDataT {
    ...
    dict__string__clz_Torappu_StorylineDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_StorylineData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_StorylineData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineData>>(dict__string__clz_Torappu_StorylineData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_StorylineData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_StorylineDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_StorylineDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_StorylineData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StorylineData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineData>>(dict__string__clz_Torappu_StorylineData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_StorylineDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StorylineData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_StorylineData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_StorylineDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StorylineDataT>>,
}
...
impl dict__string__clz_Torappu_StorylineDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_StorylineData::create(_fbb, &dict__string__clz_Torappu_StorylineDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StorylineMainlineData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.decoImageId { builder.add_decoImageId(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_StorylineMainlineDataT {
    ...
    let decoImageId = self.decoImageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn zoneId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineMainlineData::VT_ZONEID, None)}
  }
  #[inline]
  pub fn retroId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineMainlineData::VT_RETROID, None)}
  }
  #[inline]
  pub fn decoImageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineMainlineData::VT_DECOIMAGEID, None)}
  }
  #[inline]
  pub fn desc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineMainlineData::VT_DESC, None)}
  }
  #[inline]
  pub fn backgroundId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineMainlineData::VT_BACKGROUNDID, None)}
  }
  #[inline]
  pub fn tags(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_StorylineMainlineData::VT_TAGS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StorylineMainlineData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("decoImageId", Self::VT_DECOIMAGEID, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineMainlineDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_zoneId(&mut self, zoneId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineMainlineData::VT_ZONEID, zoneId);
  }
  #[inline]
  pub fn add_retroId(&mut self, retroId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineMainlineData::VT_RETROID, retroId);
  }
  #[inline]
  pub fn add_decoImageId(&mut self, decoImageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineMainlineData::VT_DECOIMAGEID, decoImageId);
  }
  #[inline]
  pub fn add_desc(&mut self, desc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineMainlineData::VT_DESC, desc);
  }
  #[inline]
  pub fn add_backgroundId(&mut self, backgroundId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineMainlineData::VT_BACKGROUNDID, backgroundId);
  }
  #[inline]
  pub fn add_tags(&mut self, tags: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineMainlineData::VT_TAGS, tags);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineMainlineDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StorylineMainlineDataT {
  ...
  pub decoImageId: Option<alloc::string::String>,
...
impl clz_Torappu_StorylineMainlineDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let decoImageId = self.decoImageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    ...
    clz_Torappu_StorylineMainlineData::create(_fbb, &clz_Torappu_StorylineMainlineDataArgs{
      zoneId,
      retroId,
      decoImageId,
      desc,
...
impl<'a> clz_Torappu_StorylineSSData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.overrideStageList { builder.add_overrideStageList(x); }
    if let Some(x) = args.recommendHideStageId { builder.add_recommendHideStageId(x); }
    if let Some(x) = args.retroActivityId { builder.add_retroActivityId(x); }
    if let Some(x) = args.reopenActivityId { builder.add_reopenActivityId(x); }
    if let Some(x) = args.tags { builder.add_tags(x); }
    if let Some(x) = args.backgroundId { builder.add_backgroundId(x); }
    if let Some(x) = args.desc { builder.add_desc(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_StorylineSSDataT {
    ...
    let reopenActivityId = self.reopenActivityId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let retroActivityId = self.retroActivityId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let isRecommended = self.isRecommended();
    let recommendHideStageId = self.recommendHideStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let overrideStageList = self.overrideStageList().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
  ...
  pub fn desc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineSSData::VT_DESC, None)}
  }
  #[inline]
  pub fn backgroundId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineSSData::VT_BACKGROUNDID, None)}
  }
  #[inline]
  pub fn tags(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_StorylineSSData::VT_TAGS, None)}
  }
  #[inline]
  pub fn reopenActivityId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineSSData::VT_REOPENACTIVITYID, None)}
  }
  #[inline]
  pub fn retroActivityId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineSSData::VT_RETROACTIVITYID, None)}
  }
  #[inline]
  pub fn isRecommended(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_StorylineSSData::VT_ISRECOMMENDED, Some(false)).unwrap()}
  }
  #[inline]
  pub fn recommendHideStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineSSData::VT_RECOMMENDHIDESTAGEID, None)}
  }
  #[inline]
  pub fn overrideStageList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_StorylineSSData::VT_OVERRIDESTAGELIST, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StorylineSSData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("backgroundId", Self::VT_BACKGROUNDID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("tags", Self::VT_TAGS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("reopenActivityId", Self::VT_REOPENACTIVITYID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("retroActivityId", Self::VT_RETROACTIVITYID, false)?
     .visit_field::<bool>("isRecommended", Self::VT_ISRECOMMENDED, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("recommendHideStageId", Self::VT_RECOMMENDHIDESTAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("overrideStageList", Self::VT_OVERRIDESTAGELIST, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_StorylineSSDataArgs<'a> {
    ...
    pub overrideStageList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineSSDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_desc(&mut self, desc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineSSData::VT_DESC, desc);
  }
  #[inline]
  pub fn add_backgroundId(&mut self, backgroundId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineSSData::VT_BACKGROUNDID, backgroundId);
  }
  #[inline]
  pub fn add_tags(&mut self, tags: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineSSData::VT_TAGS, tags);
  }
  #[inline]
  pub fn add_reopenActivityId(&mut self, reopenActivityId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineSSData::VT_REOPENACTIVITYID, reopenActivityId);
  }
  #[inline]
  pub fn add_retroActivityId(&mut self, retroActivityId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineSSData::VT_RETROACTIVITYID, retroActivityId);
  }
  #[inline]
  pub fn add_isRecommended(&mut self, isRecommended: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_StorylineSSData::VT_ISRECOMMENDED, isRecommended, false);
  }
  #[inline]
  pub fn add_recommendHideStageId(&mut self, recommendHideStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineSSData::VT_RECOMMENDHIDESTAGEID, recommendHideStageId);
  }
  #[inline]
  pub fn add_overrideStageList(&mut self, overrideStageList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineSSData::VT_OVERRIDESTAGELIST, overrideStageList);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineSSDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StorylineSSDataT {
  ...
  pub backgroundId: Option<alloc::string::String>,
  pub tags: Option<alloc::vec::Vec<alloc::string::String>>,
  pub reopenActivityId: Option<alloc::string::String>,
  pub retroActivityId: Option<alloc::string::String>,
  pub isRecommended: bool,
  pub recommendHideStageId: Option<alloc::string::String>,
  pub overrideStageList: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
impl clz_Torappu_StorylineSSDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let reopenActivityId = self.reopenActivityId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let retroActivityId = self.retroActivityId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let isRecommended = self.isRecommended;
    let recommendHideStageId = self.recommendHideStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let overrideStageList = self.overrideStageList.as_ref().map(|x|{
      let w: alloc::vec::Vec<_> = x.iter().map(|s| _fbb.create_string(s)).collect();_fbb.create_vector(&w)
    });
    clz_Torappu_StorylineSSData::create(_fbb, &clz_Torappu_StorylineSSDataArgs{
      desc,
      backgroundId,
      tags,
      reopenActivityId,
...
impl<'a> clz_Torappu_StorylineCollectData<'a> {
  ...
  pub fn desc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineCollectData::VT_DESC, None)}
  }
  #[inline]
  pub fn backgroundId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineCollectData::VT_BACKGROUNDID, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineCollectDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_desc(&mut self, desc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineCollectData::VT_DESC, desc);
  }
  #[inline]
  pub fn add_backgroundId(&mut self, backgroundId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineCollectData::VT_BACKGROUNDID, backgroundId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineCollectDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_StorylineCollectDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_StorylineCollectData::create(_fbb, &clz_Torappu_StorylineCollectDataArgs{
      desc,
      backgroundId,
    })
  }
...
impl<'a> clz_Torappu_StorylineStorySetData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.collectData { builder.add_collectData(x); }
    if let Some(x) = args.ssData { builder.add_ssData(x); }
    if let Some(x) = args.mainlineData { builder.add_mainlineData(x); }
    if let Some(x) = args.relevantActivityId { builder.add_relevantActivityId(x); }
    if let Some(x) = args.coreRewardId { builder.add_coreRewardId(x); }
    builder.add_coreRewardType(args.coreRewardType);
    if let Some(x) = args.gameMusicId { builder.add_gameMusicId(x); }
    if let Some(x) = args.backgroundId { builder.add_backgroundId(x); }
    if let Some(x) = args.titleImageId { builder.add_titleImageId(x); }
    if let Some(x) = args.kvImageId { builder.add_kvImageId(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_StorylineStorySetDataT {
    ...
    let gameMusicId = self.gameMusicId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let coreRewardType = self.coreRewardType();
    let coreRewardId = self.coreRewardId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let relevantActivityId = self.relevantActivityId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let mainlineData = self.mainlineData().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
    let ssData = self.ssData().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
    let collectData = self.collectData().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
  ...
  pub fn storySetId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineStorySetData::VT_STORYSETID, None)}
  }
  #[inline]
  pub fn storySetType(&self) -> enum__Torappu_StorylineStorySetType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_StorylineStorySetType>(clz_Torappu_StorylineStorySetData::VT_STORYSETTYPE, Some(enum__Torappu_StorylineStorySetType::MAINLINE)).unwrap()}
  }
  #[inline]
  pub fn sortByYear(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_StorylineStorySetData::VT_SORTBYYEAR, Some(0)).unwrap()}
  }
  #[inline]
  pub fn sortWithinYear(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_StorylineStorySetData::VT_SORTWITHINYEAR, Some(0)).unwrap()}
  }
  #[inline]
  pub fn kvImageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineStorySetData::VT_KVIMAGEID, None)}
  }
  #[inline]
  pub fn titleImageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineStorySetData::VT_TITLEIMAGEID, None)}
  }
  #[inline]
  pub fn haveVideoToPlay(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_StorylineStorySetData::VT_HAVEVIDEOTOPLAY, Some(false)).unwrap()}
  }
  #[inline]
  pub fn backgroundId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineStorySetData::VT_BACKGROUNDID, None)}
  }
  #[inline]
  pub fn gameMusicId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineStorySetData::VT_GAMEMUSICID, None)}
  }
  #[inline]
  pub fn coreRewardType(&self) -> enum__Torappu_ItemType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_ItemType>(clz_Torappu_StorylineStorySetData::VT_COREREWARDTYPE, Some(enum__Torappu_ItemType::NONE)).unwrap()}
  }
  #[inline]
  pub fn coreRewardId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineStorySetData::VT_COREREWARDID, None)}
  }
  #[inline]
  pub fn relevantActivityId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineStorySetData::VT_RELEVANTACTIVITYID, None)}
  }
  #[inline]
  pub fn mainlineData(&self) -> Option<clz_Torappu_StorylineMainlineData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineMainlineData>>(clz_Torappu_StorylineStorySetData::VT_MAINLINEDATA, None)}
  }
  #[inline]
  pub fn ssData(&self) -> Option<clz_Torappu_StorylineSSData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineSSData>>(clz_Torappu_StorylineStorySetData::VT_SSDATA, None)}
  }
  #[inline]
  pub fn collectData(&self) -> Option<clz_Torappu_StorylineCollectData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineCollectData>>(clz_Torappu_StorylineStorySetData::VT_COLLECTDATA, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StorylineStorySetData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("storySetId", Self::VT_STORYSETID, false)?
     .visit_field::<enum__Torappu_StorylineStorySetType>("storySetType", Self::VT_STORYSETTYPE, false)?
     .visit_field::<i32>("sortByYear", Self::VT_SORTBYYEAR, false)?
     .visit_field::<i32>("sortWithinYear", Self::VT_SORTWITHINYEAR, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("kvImageId", Self::VT_KVIMAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("titleImageId", Self::VT_TITLEIMAGEID, false)?
     ...
     .visit_field::<enum__Torappu_ItemType>("coreRewardType", Self::VT_COREREWARDTYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("coreRewardId", Self::VT_COREREWARDID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("relevantActivityId", Self::VT_RELEVANTACTIVITYID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineMainlineData>>("mainlineData", Self::VT_MAINLINEDATA, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineSSData>>("ssData", Self::VT_SSDATA, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineCollectData>>("collectData", Self::VT_COLLECTDATA, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineStorySetDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_storySetId(&mut self, storySetId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineStorySetData::VT_STORYSETID, storySetId);
  }
  #[inline]
  pub fn add_storySetType(&mut self, storySetType: enum__Torappu_StorylineStorySetType) {
    self.fbb_.push_slot::<enum__Torappu_StorylineStorySetType>(clz_Torappu_StorylineStorySetData::VT_STORYSETTYPE, storySetType, enum__Torappu_StorylineStorySetType::MAINLINE);
  }
  #[inline]
  pub fn add_sortByYear(&mut self, sortByYear: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_StorylineStorySetData::VT_SORTBYYEAR, sortByYear, 0);
  }
  #[inline]
  pub fn add_sortWithinYear(&mut self, sortWithinYear: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_StorylineStorySetData::VT_SORTWITHINYEAR, sortWithinYear, 0);
  }
  #[inline]
  pub fn add_kvImageId(&mut self, kvImageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineStorySetData::VT_KVIMAGEID, kvImageId);
  }
  #[inline]
  pub fn add_titleImageId(&mut self, titleImageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineStorySetData::VT_TITLEIMAGEID, titleImageId);
  }
  #[inline]
  pub fn add_haveVideoToPlay(&mut self, haveVideoToPlay: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_StorylineStorySetData::VT_HAVEVIDEOTOPLAY, haveVideoToPlay, false);
  }
  #[inline]
  pub fn add_backgroundId(&mut self, backgroundId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineStorySetData::VT_BACKGROUNDID, backgroundId);
  }
  #[inline]
  pub fn add_gameMusicId(&mut self, gameMusicId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineStorySetData::VT_GAMEMUSICID, gameMusicId);
  }
  #[inline]
  pub fn add_coreRewardType(&mut self, coreRewardType: enum__Torappu_ItemType) {
    self.fbb_.push_slot::<enum__Torappu_ItemType>(clz_Torappu_StorylineStorySetData::VT_COREREWARDTYPE, coreRewardType, enum__Torappu_ItemType::NONE);
  }
  #[inline]
  pub fn add_coreRewardId(&mut self, coreRewardId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineStorySetData::VT_COREREWARDID, coreRewardId);
  }
  #[inline]
  pub fn add_relevantActivityId(&mut self, relevantActivityId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineStorySetData::VT_RELEVANTACTIVITYID, relevantActivityId);
  }
  #[inline]
  pub fn add_mainlineData(&mut self, mainlineData: ::flatbuffers::WIPOffset<clz_Torappu_StorylineMainlineData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineMainlineData>>(clz_Torappu_StorylineStorySetData::VT_MAINLINEDATA, mainlineData);
  }
  #[inline]
  pub fn add_ssData(&mut self, ssData: ::flatbuffers::WIPOffset<clz_Torappu_StorylineSSData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineSSData>>(clz_Torappu_StorylineStorySetData::VT_SSDATA, ssData);
  }
  #[inline]
  pub fn add_collectData(&mut self, collectData: ::flatbuffers::WIPOffset<clz_Torappu_StorylineCollectData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineCollectData>>(clz_Torappu_StorylineStorySetData::VT_COLLECTDATA, collectData);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineStorySetDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StorylineStorySetDataT {
  pub storySetId: Option<alloc::string::String>,
  pub storySetType: enum__Torappu_StorylineStorySetType,
  pub sortByYear: i32,
  pub sortWithinYear: i32,
  pub kvImageId: Option<alloc::string::String>,
  pub titleImageId: Option<alloc::string::String>,
  pub haveVideoToPlay: bool,
  pub backgroundId: Option<alloc::string::String>,
  pub gameMusicId: Option<alloc::string::String>,
  pub coreRewardType: enum__Torappu_ItemType,
  pub coreRewardId: Option<alloc::string::String>,
  pub relevantActivityId: Option<alloc::string::String>,
  pub mainlineData: Option<alloc::boxed::Box<clz_Torappu_StorylineMainlineDataT>>,
  pub ssData: Option<alloc::boxed::Box<clz_Torappu_StorylineSSDataT>>,
  pub collectData: Option<alloc::boxed::Box<clz_Torappu_StorylineCollectDataT>>,
}
...
impl clz_Torappu_StorylineStorySetDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let storySetId = self.storySetId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let storySetType = self.storySetType;
    let sortByYear = self.sortByYear;
    let sortWithinYear = self.sortWithinYear;
    let kvImageId = self.kvImageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let titleImageId = self.titleImageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let haveVideoToPlay = self.haveVideoToPlay;
    let backgroundId = self.backgroundId.as_ref().map(|x|{
    ...
    let gameMusicId = self.gameMusicId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let coreRewardType = self.coreRewardType;
    let coreRewardId = self.coreRewardId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let relevantActivityId = self.relevantActivityId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let mainlineData = self.mainlineData.as_ref().map(|x|{
      x.pack(_fbb)
    });
    let ssData = self.ssData.as_ref().map(|x|{
      x.pack(_fbb)
    });
    let collectData = self.collectData.as_ref().map(|x|{
      x.pack(_fbb)
    });
    clz_Torappu_StorylineStorySetData::create(_fbb, &clz_Torappu_StorylineStorySetDataArgs{
      storySetId,
      storySetType,
      sortByYear,
      sortWithinYear,
...
impl<'a> dict__string__clz_Torappu_StorylineStorySetData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_StorylineStorySetDataT {
    ...
    dict__string__clz_Torappu_StorylineStorySetDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_StorylineStorySetData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_StorylineStorySetData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_StorylineStorySetData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineStorySetData>>(dict__string__clz_Torappu_StorylineStorySetData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_StorylineStorySetData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineStorySetData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_StorylineStorySetDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_StorylineStorySetDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_StorylineStorySetData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StorylineStorySetData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineStorySetData>>(dict__string__clz_Torappu_StorylineStorySetData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_StorylineStorySetDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StorylineStorySetData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_StorylineStorySetData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_StorylineStorySetDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StorylineStorySetDataT>>,
}
...
impl dict__string__clz_Torappu_StorylineStorySetDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_StorylineStorySetData::create(_fbb, &dict__string__clz_Torappu_StorylineStorySetDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StorylineTagData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.bkgColor { builder.add_bkgColor(x); }
    if let Some(x) = args.textColor { builder.add_textColor(x); }
    if let Some(x) = args.tagDesc { builder.add_tagDesc(x); }
    builder.add_sortId(args.sortId);
    if let Some(x) = args.tagId { builder.add_tagId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_StorylineTagDataT {
    let tagId = self.tagId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let sortId = self.sortId();
    let tagDesc = self.tagDesc().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let textColor = self.textColor().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let bkgColor = self.bkgColor().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn tagId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineTagData::VT_TAGID, None)}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_StorylineTagData::VT_SORTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn tagDesc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineTagData::VT_TAGDESC, None)}
  }
  #[inline]
  pub fn textColor(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineTagData::VT_TEXTCOLOR, None)}
  }
  #[inline]
  pub fn bkgColor(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineTagData::VT_BKGCOLOR, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StorylineTagData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("textColor", Self::VT_TEXTCOLOR, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("bkgColor", Self::VT_BKGCOLOR, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineTagDataBuilder<'a, 'b, A> {
  ...
  pub fn add_tagId(&mut self, tagId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineTagData::VT_TAGID, tagId);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_StorylineTagData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn add_tagDesc(&mut self, tagDesc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineTagData::VT_TAGDESC, tagDesc);
  }
  #[inline]
  pub fn add_textColor(&mut self, textColor: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineTagData::VT_TEXTCOLOR, textColor);
  }
  #[inline]
  pub fn add_bkgColor(&mut self, bkgColor: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineTagData::VT_BKGCOLOR, bkgColor);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineTagDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_StorylineTagDataT {
  pub tagId: Option<alloc::string::String>,
  pub sortId: i32,
  pub tagDesc: Option<alloc::string::String>,
  pub textColor: Option<alloc::string::String>,
  pub bkgColor: Option<alloc::string::String>,
}
...
impl clz_Torappu_StorylineTagDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let tagId = self.tagId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let sortId = self.sortId;
    let tagDesc = self.tagDesc.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let textColor = self.textColor.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let bkgColor = self.bkgColor.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_StorylineTagData::create(_fbb, &clz_Torappu_StorylineTagDataArgs{
      tagId,
      sortId,
      tagDesc,
      textColor,
...
impl<'a> dict__string__clz_Torappu_StorylineTagData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_StorylineTagDataT {
    ...
    dict__string__clz_Torappu_StorylineTagDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_StorylineTagData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_StorylineTagData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineTagData>>(dict__string__clz_Torappu_StorylineTagData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_StorylineTagData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineTagData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_StorylineTagDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_StorylineTagDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_StorylineTagData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_StorylineTagData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineTagData>>(dict__string__clz_Torappu_StorylineTagData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_StorylineTagDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_StorylineTagData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_StorylineTagData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_StorylineTagDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_StorylineTagDataT>>,
}
...
impl dict__string__clz_Torappu_StorylineTagDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_StorylineTagData::create(_fbb, &dict__string__clz_Torappu_StorylineTagDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StorylineConstData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.mainlineStorylineId { builder.add_mainlineStorylineId(x); }
    if let Some(x) = args.tutorialSelectStorylineId { builder.add_tutorialSelectStorylineId(x); }
    if let Some(x) = args.recommendHideGuideGroupId { builder.add_recommendHideGuideGroupId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_StorylineConstDataT {
    let recommendHideGuideGroupId = self.recommendHideGuideGroupId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let tutorialSelectStorylineId = self.tutorialSelectStorylineId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let mainlineStorylineId = self.mainlineStorylineId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn recommendHideGuideGroupId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineConstData::VT_RECOMMENDHIDEGUIDEGROUPID, None)}
  }
  #[inline]
  pub fn tutorialSelectStorylineId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineConstData::VT_TUTORIALSELECTSTORYLINEID, None)}
  }
  #[inline]
  pub fn mainlineStorylineId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_StorylineConstData::VT_MAINLINESTORYLINEID, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_StorylineConstData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("recommendHideGuideGroupId", Self::VT_RECOMMENDHIDEGUIDEGROUPID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("tutorialSelectStorylineId", Self::VT_TUTORIALSELECTSTORYLINEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("mainlineStorylineId", Self::VT_MAINLINESTORYLINEID, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StorylineConstDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_recommendHideGuideGroupId(&mut self, recommendHideGuideGroupId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineConstData::VT_RECOMMENDHIDEGUIDEGROUPID, recommendHideGuideGroupId);
  }
  #[inline]
  pub fn add_tutorialSelectStorylineId(&mut self, tutorialSelectStorylineId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineConstData::VT_TUTORIALSELECTSTORYLINEID, tutorialSelectStorylineId);
  }
  #[inline]
  pub fn add_mainlineStorylineId(&mut self, mainlineStorylineId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StorylineConstData::VT_MAINLINESTORYLINEID, mainlineStorylineId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StorylineConstDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl ::core::fmt::Debug for clz_Torappu_StorylineConstData<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("clz_Torappu_StorylineConstData");
      ds.field("recommendHideGuideGroupId", &self.recommendHideGuideGroupId());
      ds.field("tutorialSelectStorylineId", &self.tutorialSelectStorylineId());
...
pub struct clz_Torappu_StorylineConstDataT {
  pub recommendHideGuideGroupId: Option<alloc::string::String>,
  pub tutorialSelectStorylineId: Option<alloc::string::String>,
  pub mainlineStorylineId: Option<alloc::string::String>,
}
...
impl clz_Torappu_StorylineConstDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let recommendHideGuideGroupId = self.recommendHideGuideGroupId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let tutorialSelectStorylineId = self.tutorialSelectStorylineId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let mainlineStorylineId = self.mainlineStorylineId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_StorylineConstData::create(_fbb, &clz_Torappu_StorylineConstDataArgs{
      recommendHideGuideGroupId,
      tutorialSelectStorylineId,
      mainlineStorylineId,
    })
...
impl<'a> clz_Torappu_CGGalleryDisplayData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.relatedStageId { builder.add_relatedStageId(x); }
    if let Some(x) = args.relatedStoryId { builder.add_relatedStoryId(x); }
    builder.add_sortId(args.sortId);
    if let Some(x) = args.storySetId { builder.add_storySetId(x); }
    if let Some(x) = args.displayDesc { builder.add_displayDesc(x); }
    if let Some(x) = args.displayName { builder.add_displayName(x); }
    builder.add_cgSource(args.cgSource);
    if let Some(x) = args.cgList { builder.add_cgList(x); }
    if let Some(x) = args.displayId { builder.add_displayId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_CGGalleryDisplayDataT {
    let displayId = self.displayId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let cgList = self.cgList().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
    let cgSource = self.cgSource();
    let displayName = self.displayName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let displayDesc = self.displayDesc().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let storySetId = self.storySetId().map(|x| {
      alloc::string::ToString::to_string(x)
    ...
    let sortId = self.sortId();
    let relatedStoryId = self.relatedStoryId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let relatedStageId = self.relatedStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn displayId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryDisplayData::VT_DISPLAYID, None)}
  }
  #[inline]
  pub fn cgList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_CGGalleryDisplayData::VT_CGLIST, None)}
  }
  #[inline]
  pub fn cgSource(&self) -> enum__Torappu_CGGalleryCGSource {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_CGGalleryCGSource>(clz_Torappu_CGGalleryDisplayData::VT_CGSOURCE, Some(enum__Torappu_CGGalleryCGSource::IMAGE)).unwrap()}
  }
  #[inline]
  pub fn displayName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryDisplayData::VT_DISPLAYNAME, None)}
  }
  #[inline]
  pub fn displayDesc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryDisplayData::VT_DISPLAYDESC, None)}
  }
  #[inline]
  pub fn storySetId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryDisplayData::VT_STORYSETID, None)}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_CGGalleryDisplayData::VT_SORTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn relatedStoryId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryDisplayData::VT_RELATEDSTORYID, None)}
  }
  #[inline]
  pub fn relatedStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryDisplayData::VT_RELATEDSTAGEID, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_CGGalleryDisplayData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("displayId", Self::VT_DISPLAYID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("cgList", Self::VT_CGLIST, false)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("displayDesc", Self::VT_DISPLAYDESC, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("storySetId", Self::VT_STORYSETID, false)?
     .visit_field::<i32>("sortId", Self::VT_SORTID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("relatedStoryId", Self::VT_RELATEDSTORYID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("relatedStageId", Self::VT_RELATEDSTAGEID, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_CGGalleryDisplayDataArgs<'a> {
    ...
    pub cgList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CGGalleryDisplayDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_displayId(&mut self, displayId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryDisplayData::VT_DISPLAYID, displayId);
  }
  #[inline]
  pub fn add_cgList(&mut self, cgList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryDisplayData::VT_CGLIST, cgList);
  }
  #[inline]
  pub fn add_cgSource(&mut self, cgSource: enum__Torappu_CGGalleryCGSource) {
    self.fbb_.push_slot::<enum__Torappu_CGGalleryCGSource>(clz_Torappu_CGGalleryDisplayData::VT_CGSOURCE, cgSource, enum__Torappu_CGGalleryCGSource::IMAGE);
  }
  #[inline]
  pub fn add_displayName(&mut self, displayName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryDisplayData::VT_DISPLAYNAME, displayName);
  }
  #[inline]
  pub fn add_displayDesc(&mut self, displayDesc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryDisplayData::VT_DISPLAYDESC, displayDesc);
  }
  #[inline]
  pub fn add_storySetId(&mut self, storySetId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryDisplayData::VT_STORYSETID, storySetId);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_CGGalleryDisplayData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn add_relatedStoryId(&mut self, relatedStoryId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryDisplayData::VT_RELATEDSTORYID, relatedStoryId);
  }
  #[inline]
  pub fn add_relatedStageId(&mut self, relatedStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryDisplayData::VT_RELATEDSTAGEID, relatedStageId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CGGalleryDisplayDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_CGGalleryDisplayDataT {
  pub displayId: Option<alloc::string::String>,
  pub cgList: Option<alloc::vec::Vec<alloc::string::String>>,
  pub cgSource: enum__Torappu_CGGalleryCGSource,
  pub displayName: Option<alloc::string::String>,
  pub displayDesc: Option<alloc::string::String>,
  pub storySetId: Option<alloc::string::String>,
  pub sortId: i32,
  pub relatedStoryId: Option<alloc::string::String>,
  pub relatedStageId: Option<alloc::string::String>,
}
...
impl clz_Torappu_CGGalleryDisplayDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let displayId = self.displayId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    ...
    let cgSource = self.cgSource;
    let displayName = self.displayName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let displayDesc = self.displayDesc.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let storySetId = self.storySetId.as_ref().map(|x|{
      _fbb.create_string(x)
    ...
    let sortId = self.sortId;
    let relatedStoryId = self.relatedStoryId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let relatedStageId = self.relatedStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_CGGalleryDisplayData::create(_fbb, &clz_Torappu_CGGalleryDisplayDataArgs{
      displayId,
      cgList,
      cgSource,
      displayName,
...
impl<'a> dict__string__clz_Torappu_CGGalleryDisplayData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_CGGalleryDisplayDataT {
    ...
    dict__string__clz_Torappu_CGGalleryDisplayDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_CGGalleryDisplayData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_CGGalleryDisplayData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_CGGalleryDisplayData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryDisplayData>>(dict__string__clz_Torappu_CGGalleryDisplayData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_CGGalleryDisplayData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryDisplayData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_CGGalleryDisplayDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_CGGalleryDisplayDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_CGGalleryDisplayData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_CGGalleryDisplayData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_CGGalleryDisplayData>>(dict__string__clz_Torappu_CGGalleryDisplayData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_CGGalleryDisplayDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_CGGalleryDisplayData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_CGGalleryDisplayData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_CGGalleryDisplayDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_CGGalleryDisplayDataT>>,
}
...
impl dict__string__clz_Torappu_CGGalleryDisplayDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_CGGalleryDisplayData::create(_fbb, &dict__string__clz_Torappu_CGGalleryDisplayDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_CGGalleryGroupData<'a> {
  ...
  pub fn storySetId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryGroupData::VT_STORYSETID, None)}
  }
  #[inline]
  pub fn storylineId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryGroupData::VT_STORYLINEID, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CGGalleryGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_storySetId(&mut self, storySetId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryGroupData::VT_STORYSETID, storySetId);
  }
  #[inline]
  pub fn add_storylineId(&mut self, storylineId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryGroupData::VT_STORYLINEID, storylineId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CGGalleryGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_CGGalleryGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_CGGalleryGroupData::create(_fbb, &clz_Torappu_CGGalleryGroupDataArgs{
      storySetId,
      storylineId,
    })
  }
...
impl<'a> dict__string__clz_Torappu_CGGalleryGroupData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_CGGalleryGroupDataT {
    ...
    dict__string__clz_Torappu_CGGalleryGroupDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_CGGalleryGroupData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_CGGalleryGroupData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryGroupData>>(dict__string__clz_Torappu_CGGalleryGroupData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_CGGalleryGroupData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryGroupData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_CGGalleryGroupDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_CGGalleryGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_CGGalleryGroupData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_CGGalleryGroupData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_CGGalleryGroupData>>(dict__string__clz_Torappu_CGGalleryGroupData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_CGGalleryGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_CGGalleryGroupData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_CGGalleryGroupData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_CGGalleryGroupDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_CGGalleryGroupDataT>>,
}
...
impl dict__string__clz_Torappu_CGGalleryGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_CGGalleryGroupData::create(_fbb, &dict__string__clz_Torappu_CGGalleryGroupDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_CGGalleryCGCompositeData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.cgId { builder.add_cgId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_CGGalleryCGCompositeDataT {
    let cgId = self.cgId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn cgId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryCGCompositeData::VT_CGID, None)}
  }
  #[inline]
  pub fn width(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_CGGalleryCGCompositeData::VT_WIDTH, Some(0)).unwrap()}
  }
  #[inline]
  pub fn height(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_CGGalleryCGCompositeData::VT_HEIGHT, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CGGalleryCGCompositeDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_cgId(&mut self, cgId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryCGCompositeData::VT_CGID, cgId);
  }
  #[inline]
  pub fn add_width(&mut self, width: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_CGGalleryCGCompositeData::VT_WIDTH, width, 0);
  }
  #[inline]
  pub fn add_height(&mut self, height: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_CGGalleryCGCompositeData::VT_HEIGHT, height, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CGGalleryCGCompositeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_CGGalleryCGCompositeDataT {
  pub cgId: Option<alloc::string::String>,
  pub width: i32,
  pub height: i32,
}
...
impl clz_Torappu_CGGalleryCGCompositeDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let cgId = self.cgId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let width = self.width;
    let height = self.height;
    clz_Torappu_CGGalleryCGCompositeData::create(_fbb, &clz_Torappu_CGGalleryCGCompositeDataArgs{
      cgId,
      width,
      height,
    })
...
impl<'a> clz_Torappu_CGGalleryCGData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.storySetId { builder.add_storySetId(x); }
    if let Some(x) = args.compositeList { builder.add_compositeList(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_CGGalleryCGDataT {
    ...
    let compositeList = self.compositeList().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let storySetId = self.storySetId().map(|x| {
      alloc::string::ToString::to_string(x)
  ...
  pub fn cgId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryCGData::VT_CGID, None)}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_CGGalleryCGData::VT_SORTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn compositeType(&self) -> enum__Torappu_CGGalleryCGCompositeType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_CGGalleryCGCompositeType>(clz_Torappu_CGGalleryCGData::VT_COMPOSITETYPE, Some(enum__Torappu_CGGalleryCGCompositeType::NONE)).unwrap()}
  }
  #[inline]
  pub fn compositeList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryCGCompositeData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryCGCompositeData>>>>(clz_Torappu_CGGalleryCGData::VT_COMPOSITELIST, None)}
  }
  #[inline]
  pub fn storySetId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CGGalleryCGData::VT_STORYSETID, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_CGGalleryCGData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("cgId", Self::VT_CGID, false)?
     .visit_field::<i32>("sortId", Self::VT_SORTID, false)?
     .visit_field::<enum__Torappu_CGGalleryCGCompositeType>("compositeType", Self::VT_COMPOSITETYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryCGCompositeData>>>>("compositeList", Self::VT_COMPOSITELIST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("storySetId", Self::VT_STORYSETID, false)?
     .finish();
    Ok(())
  }
...
pub struct clz_Torappu_CGGalleryCGDataArgs<'a> {
    ...
    pub compositeList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryCGCompositeData<'a>>>>>,
    pub storySetId: Option<::flatbuffers::WIPOffset<&'a str>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CGGalleryCGDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_cgId(&mut self, cgId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryCGData::VT_CGID, cgId);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_CGGalleryCGData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn add_compositeType(&mut self, compositeType: enum__Torappu_CGGalleryCGCompositeType) {
    self.fbb_.push_slot::<enum__Torappu_CGGalleryCGCompositeType>(clz_Torappu_CGGalleryCGData::VT_COMPOSITETYPE, compositeType, enum__Torappu_CGGalleryCGCompositeType::NONE);
  }
  #[inline]
  pub fn add_compositeList(&mut self, compositeList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryCGCompositeData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryCGData::VT_COMPOSITELIST, compositeList);
  }
  #[inline]
  pub fn add_storySetId(&mut self, storySetId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CGGalleryCGData::VT_STORYSETID, storySetId);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CGGalleryCGDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_CGGalleryCGDataT {
  ...
  pub sortId: i32,
  pub compositeType: enum__Torappu_CGGalleryCGCompositeType,
  pub compositeList: Option<alloc::vec::Vec<clz_Torappu_CGGalleryCGCompositeDataT>>,
  pub storySetId: Option<alloc::string::String>,
}
...
impl clz_Torappu_CGGalleryCGDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_CGGalleryCGData::create(_fbb, &clz_Torappu_CGGalleryCGDataArgs{
      cgId,
      sortId,
      compositeType,
      compositeList,
...
impl<'a> dict__string__clz_Torappu_CGGalleryCGData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_CGGalleryCGDataT {
    ...
    dict__string__clz_Torappu_CGGalleryCGDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_CGGalleryCGData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_CGGalleryCGData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryCGData>>(dict__string__clz_Torappu_CGGalleryCGData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_CGGalleryCGData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_CGGalleryCGData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_CGGalleryCGDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_CGGalleryCGDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_CGGalleryCGData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_CGGalleryCGData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_CGGalleryCGData>>(dict__string__clz_Torappu_CGGalleryCGData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_CGGalleryCGDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_CGGalleryCGData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_CGGalleryCGData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_CGGalleryCGDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_CGGalleryCGDataT>>,
}
...
impl dict__string__clz_Torappu_CGGalleryCGDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_CGGalleryCGData::create(_fbb, &dict__string__clz_Torappu_CGGalleryCGDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_SixStarRuneData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.runeKey { builder.add_runeKey(x); }
    if let Some(x) = args.runeDesc { builder.add_runeDesc(x); }
    if let Some(x) = args.runeId { builder.add_runeId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_SixStarRuneDataT {
    let runeId = self.runeId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let runeDesc = self.runeDesc().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let runeKey = self.runeKey().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn runeId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarRuneData::VT_RUNEID, None)}
  }
  #[inline]
  pub fn runeDesc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarRuneData::VT_RUNEDESC, None)}
  }
  #[inline]
  pub fn runeKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarRuneData::VT_RUNEKEY, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_SixStarRuneData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("runeDesc", Self::VT_RUNEDESC, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_SixStarRuneDataBuilder<'a, 'b, A> {
  ...
  pub fn add_runeId(&mut self, runeId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarRuneData::VT_RUNEID, runeId);
  }
  #[inline]
  pub fn add_runeDesc(&mut self, runeDesc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarRuneData::VT_RUNEDESC, runeDesc);
  }
  #[inline]
  pub fn add_runeKey(&mut self, runeKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarRuneData::VT_RUNEKEY, runeKey);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_SixStarRuneDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_SixStarRuneDataT {
  pub runeId: Option<alloc::string::String>,
  pub runeDesc: Option<alloc::string::String>,
  pub runeKey: Option<alloc::string::String>,
}
...
impl clz_Torappu_SixStarRuneDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let runeId = self.runeId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let runeDesc = self.runeDesc.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let runeKey = self.runeKey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_SixStarRuneData::create(_fbb, &clz_Torappu_SixStarRuneDataArgs{
      runeId,
      runeDesc,
      runeKey,
    })
...
impl<'a> dict__string__clz_Torappu_SixStarRuneData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_SixStarRuneDataT {
    ...
    dict__string__clz_Torappu_SixStarRuneDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_SixStarRuneData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_SixStarRuneData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarRuneData>>(dict__string__clz_Torappu_SixStarRuneData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_SixStarRuneData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarRuneData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_SixStarRuneDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_SixStarRuneDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_SixStarRuneData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_SixStarRuneData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_SixStarRuneData>>(dict__string__clz_Torappu_SixStarRuneData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_SixStarRuneDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_SixStarRuneData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_SixStarRuneData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_SixStarRuneDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_SixStarRuneDataT>>,
}
...
impl dict__string__clz_Torappu_SixStarRuneDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_SixStarRuneData::create(_fbb, &dict__string__clz_Torappu_SixStarRuneDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_SixStarMilestoneItemData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.unlockStageName { builder.add_unlockStageName(x); }
    if let Some(x) = args.unlockStageId { builder.add_unlockStageId(x); }
    if let Some(x) = args.unlockStageFog { builder.add_unlockStageFog(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_SixStarMilestoneItemDataT {
    ...
    let unlockStageFog = self.unlockStageFog().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let unlockStageId = self.unlockStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let unlockStageName = self.unlockStageName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn id(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarMilestoneItemData::VT_ID, None)}
  }
  #[inline]
  pub fn sortId(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_SixStarMilestoneItemData::VT_SORTID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn nodePoint(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_SixStarMilestoneItemData::VT_NODEPOINT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn rewardType(&self) -> enum__Torappu_SixStarMilestoneRewardType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_SixStarMilestoneRewardType>(clz_Torappu_SixStarMilestoneItemData::VT_REWARDTYPE, Some(enum__Torappu_SixStarMilestoneRewardType::UNLOCK_STAGE)).unwrap()}
  }
  #[inline]
  pub fn unlockStageFog(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarMilestoneItemData::VT_UNLOCKSTAGEFOG, None)}
  }
  #[inline]
  pub fn unlockStageId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarMilestoneItemData::VT_UNLOCKSTAGEID, None)}
  }
  #[inline]
  pub fn unlockStageName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarMilestoneItemData::VT_UNLOCKSTAGENAME, None)}
  }
  #[inline]
  pub fn rewardList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle>>>>(clz_Torappu_SixStarMilestoneItemData::VT_REWARDLIST, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_SixStarMilestoneItemData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<enum__Torappu_SixStarMilestoneRewardType>("rewardType", Self::VT_REWARDTYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("unlockStageFog", Self::VT_UNLOCKSTAGEFOG, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("unlockStageId", Self::VT_UNLOCKSTAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("unlockStageName", Self::VT_UNLOCKSTAGENAME, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_SixStarMilestoneItemDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_id(&mut self, id: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarMilestoneItemData::VT_ID, id);
  }
  #[inline]
  pub fn add_sortId(&mut self, sortId: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_SixStarMilestoneItemData::VT_SORTID, sortId, 0);
  }
  #[inline]
  pub fn add_nodePoint(&mut self, nodePoint: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_SixStarMilestoneItemData::VT_NODEPOINT, nodePoint, 0);
  }
  #[inline]
  pub fn add_rewardType(&mut self, rewardType: enum__Torappu_SixStarMilestoneRewardType) {
    self.fbb_.push_slot::<enum__Torappu_SixStarMilestoneRewardType>(clz_Torappu_SixStarMilestoneItemData::VT_REWARDTYPE, rewardType, enum__Torappu_SixStarMilestoneRewardType::UNLOCK_STAGE);
  }
  #[inline]
  pub fn add_unlockStageFog(&mut self, unlockStageFog: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarMilestoneItemData::VT_UNLOCKSTAGEFOG, unlockStageFog);
  }
  #[inline]
  pub fn add_unlockStageId(&mut self, unlockStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarMilestoneItemData::VT_UNLOCKSTAGEID, unlockStageId);
  }
  #[inline]
  pub fn add_unlockStageName(&mut self, unlockStageName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarMilestoneItemData::VT_UNLOCKSTAGENAME, unlockStageName);
  }
  #[inline]
  pub fn add_rewardList(&mut self, rewardList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarMilestoneItemData::VT_REWARDLIST, rewardList);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_SixStarMilestoneItemDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_SixStarMilestoneItemDataT {
  ...
  pub nodePoint: i32,
  pub rewardType: enum__Torappu_SixStarMilestoneRewardType,
  pub unlockStageFog: Option<alloc::string::String>,
  pub unlockStageId: Option<alloc::string::String>,
  pub unlockStageName: Option<alloc::string::String>,
...
impl clz_Torappu_SixStarMilestoneItemDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let nodePoint = self.nodePoint;
    let rewardType = self.rewardType;
    let unlockStageFog = self.unlockStageFog.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let unlockStageId = self.unlockStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let unlockStageName = self.unlockStageName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let rewardList = self.rewardList.as_ref().map(|x|{
      let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();_fbb.create_vector(&w)
    });
    clz_Torappu_SixStarMilestoneItemData::create(_fbb, &clz_Torappu_SixStarMilestoneItemDataArgs{
      id,
      sortId,
      nodePoint,
      rewardType,
...
impl<'a> clz_Torappu_SixStarMilestoneGroupData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.milestoneDataList { builder.add_milestoneDataList(x); }
    if let Some(x) = args.stageIdList { builder.add_stageIdList(x); }
    if let Some(x) = args.groupId { builder.add_groupId(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> clz_Torappu_SixStarMilestoneGroupDataT {
    ...
    let milestoneDataList = self.milestoneDataList().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  pub fn groupId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarMilestoneGroupData::VT_GROUPID, None)}
  }
  #[inline]
  pub fn stageIdList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_SixStarMilestoneGroupData::VT_STAGEIDLIST, None)}
  }
  #[inline]
  pub fn milestoneDataList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarMilestoneItemData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarMilestoneItemData>>>>(clz_Torappu_SixStarMilestoneGroupData::VT_MILESTONEDATALIST, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_SixStarMilestoneGroupData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("groupId", Self::VT_GROUPID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("stageIdList", Self::VT_STAGEIDLIST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarMilestoneItemData>>>>("milestoneDataList", Self::VT_MILESTONEDATALIST, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_SixStarMilestoneGroupDataArgs<'a> {
    pub groupId: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub stageIdList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
    pub milestoneDataList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarMilestoneItemData<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_SixStarMilestoneGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_groupId(&mut self, groupId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarMilestoneGroupData::VT_GROUPID, groupId);
  }
  #[inline]
  pub fn add_stageIdList(&mut self, stageIdList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarMilestoneGroupData::VT_STAGEIDLIST, stageIdList);
  }
  #[inline]
  pub fn add_milestoneDataList(&mut self, milestoneDataList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarMilestoneItemData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarMilestoneGroupData::VT_MILESTONEDATALIST, milestoneDataList);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_SixStarMilestoneGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_SixStarMilestoneGroupDataT {
  pub groupId: Option<alloc::string::String>,
  pub stageIdList: Option<alloc::vec::Vec<alloc::string::String>>,
  pub milestoneDataList: Option<alloc::vec::Vec<clz_Torappu_SixStarMilestoneItemDataT>>,
}
...
impl clz_Torappu_SixStarMilestoneGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_SixStarMilestoneGroupData::create(_fbb, &clz_Torappu_SixStarMilestoneGroupDataArgs{
      groupId,
      stageIdList,
      milestoneDataList,
    })
...
impl<'a> dict__string__clz_Torappu_SixStarMilestoneGroupData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_SixStarMilestoneGroupDataT {
    ...
    dict__string__clz_Torappu_SixStarMilestoneGroupDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_SixStarMilestoneGroupData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_SixStarMilestoneGroupData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_SixStarMilestoneGroupData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarMilestoneGroupData>>(dict__string__clz_Torappu_SixStarMilestoneGroupData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_SixStarMilestoneGroupData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarMilestoneGroupData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_SixStarMilestoneGroupDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_SixStarMilestoneGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_SixStarMilestoneGroupData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_SixStarMilestoneGroupData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_SixStarMilestoneGroupData>>(dict__string__clz_Torappu_SixStarMilestoneGroupData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_SixStarMilestoneGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_SixStarMilestoneGroupData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_SixStarMilestoneGroupData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_SixStarMilestoneGroupDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_SixStarMilestoneGroupDataT>>,
}
...
impl dict__string__clz_Torappu_SixStarMilestoneGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_SixStarMilestoneGroupData::create(_fbb, &dict__string__clz_Torappu_SixStarMilestoneGroupDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_SixStarLinkedStageCompatibleInfo<'a> {
  ...
  pub fn stageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_STAGEID, None)}
  }
  #[inline]
  pub fn apCost(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_APCOST, Some(0)).unwrap()}
  }
  #[inline]
  pub fn apFailReturn(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_APFAILRETURN, Some(0)).unwrap()}
  }
  #[inline]
  pub fn dropType(&self) -> enum__Torappu_SixStarStageCompatibleDropType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_SixStarStageCompatibleDropType>(clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_DROPTYPE, Some(enum__Torappu_SixStarStageCompatibleDropType::COMPLETE_ONLY)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_SixStarLinkedStageCompatibleInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<i32>("apCost", Self::VT_APCOST, false)?
     .visit_field::<i32>("apFailReturn", Self::VT_APFAILRETURN, false)?
     .visit_field::<enum__Torappu_SixStarStageCompatibleDropType>("dropType", Self::VT_DROPTYPE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct clz_Torappu_SixStarLinkedStageCompatibleInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_SixStarLinkedStageCompatibleInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_stageId(&mut self, stageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_STAGEID, stageId);
  }
  #[inline]
  pub fn add_apCost(&mut self, apCost: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_APCOST, apCost, 0);
  }
  #[inline]
  pub fn add_apFailReturn(&mut self, apFailReturn: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_APFAILRETURN, apFailReturn, 0);
  }
  #[inline]
  pub fn add_dropType(&mut self, dropType: enum__Torappu_SixStarStageCompatibleDropType) {
    self.fbb_.push_slot::<enum__Torappu_SixStarStageCompatibleDropType>(clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_DROPTYPE, dropType, enum__Torappu_SixStarStageCompatibleDropType::COMPLETE_ONLY);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_SixStarLinkedStageCompatibleInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<clz_Torappu_SixStarLinkedStageCompatibleInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl clz_Torappu_SixStarLinkedStageCompatibleInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let apFailReturn = self.apFailReturn;
    let dropType = self.dropType;
    clz_Torappu_SixStarLinkedStageCompatibleInfo::create(_fbb, &clz_Torappu_SixStarLinkedStageCompatibleInfoArgs{
      stageId,
      apCost,
      apFailReturn,
      dropType,
...
impl<'a> ::flatbuffers::Follow<'a> for dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo<'a> {
...
impl<'a> dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    let mut builder = dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoBuilder::new(_fbb);
    if let Some(x) = args.value { builder.add_value(x); }
    if let Some(x) = args.key { builder.add_key(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoT {
    ...
    dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_SixStarLinkedStageCompatibleInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_SixStarLinkedStageCompatibleInfo>>(dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_VALUE, None)}
  }
}
...
pub struct dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_SixStarLinkedStageCompatibleInfo<'b >>) {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_SixStarLinkedStageCompatibleInfoT>>,
}
...
impl dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo::create(_fbb, &dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ConditionalDropInfo<'a> {
  ...
  pub fn template(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ConditionalDropInfo::VT_TEMPLATE, None)}
  }
  #[inline]
  pub fn param(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_ConditionalDropInfo::VT_PARAM, None)}
  }
  #[inline]
  pub fn countLimit(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_ConditionalDropInfo::VT_COUNTLIMIT, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ConditionalDropInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_template(&mut self, template: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ConditionalDropInfo::VT_TEMPLATE, template);
  }
  #[inline]
  pub fn add_param(&mut self, param: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ConditionalDropInfo::VT_PARAM, param);
  }
  #[inline]
  pub fn add_countLimit(&mut self, countLimit: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_ConditionalDropInfo::VT_COUNTLIMIT, countLimit, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ConditionalDropInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_ConditionalDropInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let countLimit = self.countLimit;
    clz_Torappu_ConditionalDropInfo::create(_fbb, &clz_Torappu_ConditionalDropInfoArgs{
      template,
      param,
      countLimit,
    })
...
impl<'a> dict__string__clz_Torappu_ConditionalDropInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ConditionalDropInfoT {
    ...
    dict__string__clz_Torappu_ConditionalDropInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ConditionalDropInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ConditionalDropInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ConditionalDropInfo>>(dict__string__clz_Torappu_ConditionalDropInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ConditionalDropInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ConditionalDropInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ConditionalDropInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ConditionalDropInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ConditionalDropInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ConditionalDropInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ConditionalDropInfo>>(dict__string__clz_Torappu_ConditionalDropInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ConditionalDropInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ConditionalDropInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ConditionalDropInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ConditionalDropInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ConditionalDropInfoT>>,
}
...
impl dict__string__clz_Torappu_ConditionalDropInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ConditionalDropInfo::create(_fbb, &dict__string__clz_Torappu_ConditionalDropInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_StageTable<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.conditionalDropInfo { builder.add_conditionalDropInfo(x); }
    if let Some(x) = args.sixStarCompatibleInfo { builder.add_sixStarCompatibleInfo(x); }
    if let Some(x) = args.sixStarMilestoneInfo { builder.add_sixStarMilestoneInfo(x); }
    if let Some(x) = args.sixStarRuneData { builder.add_sixStarRuneData(x); }
    if let Some(x) = args.cgGalleryCgs { builder.add_cgGalleryCgs(x); }
    if let Some(x) = args.cgGalleryGroups { builder.add_cgGalleryGroups(x); }
    if let Some(x) = args.cgGalleryDisplays { builder.add_cgGalleryDisplays(x); }
    if let Some(x) = args.storylineConst { builder.add_storylineConst(x); }
    if let Some(x) = args.storylineTags { builder.add_storylineTags(x); }
    if let Some(x) = args.storylineStorySets { builder.add_storylineStorySets(x); }
    if let Some(x) = args.storylines { builder.add_storylines(x); }
    if let Some(x) = args.spNormalStageIdFor4StarList { builder.add_spNormalStageIdFor4StarList(x); }
    if let Some(x) = args.actCustomStageDatas { builder.add_actCustomStageDatas(x); }
    if let Some(x) = args.antiSpoilerDict { builder.add_antiSpoilerDict(x); }
    if let Some(x) = args.apProtectZoneInfo { builder.add_apProtectZoneInfo(x); }
    if let Some(x) = args.recordRewardData { builder.add_recordRewardData(x); }
    if let Some(x) = args.specialBattleFinishStageData { builder.add_specialBattleFinishStageData(x); }
    if let Some(x) = args.storyStageShowGroup { builder.add_storyStageShowGroup(x); }
    if let Some(x) = args.diffGroupTable { builder.add_diffGroupTable(x); }
    if let Some(x) = args.stageStartConds { builder.add_stageStartConds(x); }
    if let Some(x) = args.stageFogInfo { builder.add_stageFogInfo(x); }
    if let Some(x) = args.stageValidInfo { builder.add_stageValidInfo(x); }
    if let Some(x) = args.timelyTable { builder.add_timelyTable(x); }
    if let Some(x) = args.overrideUnlockInfo { builder.add_overrideUnlockInfo(x); }
    if let Some(x) = args.overrideDropInfo { builder.add_overrideDropInfo(x); }
    if let Some(x) = args.timelyStageDropInfo { builder.add_timelyStageDropInfo(x); }
    if let Some(x) = args.forceOpenTable { builder.add_forceOpenTable(x); }
    if let Some(x) = args.tileInfo { builder.add_tileInfo(x); }
    if let Some(x) = args.mapThemes { builder.add_mapThemes(x); }
    if let Some(x) = args.runeStageGroups { builder.add_runeStageGroups(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_StageTableT {
    ...
    let runeStageGroups = self.runeStageGroups().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let mapThemes = self.mapThemes().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let tileInfo = self.tileInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let forceOpenTable = self.forceOpenTable().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let timelyStageDropInfo = self.timelyStageDropInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let overrideDropInfo = self.overrideDropInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let overrideUnlockInfo = self.overrideUnlockInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let timelyTable = self.timelyTable().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let stageValidInfo = self.stageValidInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let stageFogInfo = self.stageFogInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let stageStartConds = self.stageStartConds().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let diffGroupTable = self.diffGroupTable().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let storyStageShowGroup = self.storyStageShowGroup().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let specialBattleFinishStageData = self.specialBattleFinishStageData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let recordRewardData = self.recordRewardData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let apProtectZoneInfo = self.apProtectZoneInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let antiSpoilerDict = self.antiSpoilerDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let actCustomStageDatas = self.actCustomStageDatas().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let spNormalStageIdFor4StarList = self.spNormalStageIdFor4StarList().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
    let storylines = self.storylines().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let storylineStorySets = self.storylineStorySets().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let storylineTags = self.storylineTags().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let storylineConst = self.storylineConst().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
    let cgGalleryDisplays = self.cgGalleryDisplays().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let cgGalleryGroups = self.cgGalleryGroups().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let cgGalleryCgs = self.cgGalleryCgs().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let sixStarRuneData = self.sixStarRuneData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let sixStarMilestoneInfo = self.sixStarMilestoneInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let sixStarCompatibleInfo = self.sixStarCompatibleInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let conditionalDropInfo = self.conditionalDropInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  #[inline]
  pub fn stages(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData>>>>(clz_Torappu_StageTable::VT_STAGES, None)}
  }
  #[inline]
  pub fn runeStageGroups(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_RuneStageGroupData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_RuneStageGroupData>>>>(clz_Torappu_StageTable::VT_RUNESTAGEGROUPS, None)}
  }
  #[inline]
  pub fn mapThemes(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_MapThemeData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_MapThemeData>>>>(clz_Torappu_StageTable::VT_MAPTHEMES, None)}
  }
  #[inline]
  pub fn tileInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TileAppendInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TileAppendInfo>>>>(clz_Torappu_StageTable::VT_TILEINFO, None)}
  }
  #[inline]
  pub fn forceOpenTable(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_WeeklyForceOpenTable<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_WeeklyForceOpenTable>>>>(clz_Torappu_StageTable::VT_FORCEOPENTABLE, None)}
  }
  #[inline]
  pub fn timelyStageDropInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TimelyDropTimeInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TimelyDropTimeInfo>>>>(clz_Torappu_StageTable::VT_TIMELYSTAGEDROPINFO, None)}
  }
  #[inline]
  pub fn overrideDropInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_OverrideDropInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_OverrideDropInfo>>>>(clz_Torappu_StageTable::VT_OVERRIDEDROPINFO, None)}
  }
  #[inline]
  pub fn overrideUnlockInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_OverrideUnlockInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_OverrideUnlockInfo>>>>(clz_Torappu_StageTable::VT_OVERRIDEUNLOCKINFO, None)}
  }
  #[inline]
  pub fn timelyTable(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TimelyDropInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TimelyDropInfo>>>>(clz_Torappu_StageTable::VT_TIMELYTABLE, None)}
  }
  #[inline]
  pub fn stageValidInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageValidInfo<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageValidInfo>>>>(clz_Torappu_StageTable::VT_STAGEVALIDINFO, None)}
  }
  #[inline]
  pub fn stageFogInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageFogInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageFogInfo>>>>(clz_Torappu_StageTable::VT_STAGEFOGINFO, None)}
  }
  #[inline]
  pub fn stageStartConds(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageStartCond<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageStartCond>>>>(clz_Torappu_StageTable::VT_STAGESTARTCONDS, None)}
  }
  #[inline]
  pub fn diffGroupTable(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageDiffGroupTable<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageDiffGroupTable>>>>(clz_Torappu_StageTable::VT_DIFFGROUPTABLE, None)}
  }
  #[inline]
  pub fn storyStageShowGroup(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup>>>>(clz_Torappu_StageTable::VT_STORYSTAGESHOWGROUP, None)}
  }
  #[inline]
  pub fn specialBattleFinishStageData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SpecialBattleFinishStageData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SpecialBattleFinishStageData>>>>(clz_Torappu_StageTable::VT_SPECIALBATTLEFINISHSTAGEDATA, None)}
  }
  #[inline]
  pub fn recordRewardData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_RecordRewardServerData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_RecordRewardServerData>>>>(clz_Torappu_StageTable::VT_RECORDREWARDDATA, None)}
  }
  #[inline]
  pub fn apProtectZoneInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ApProtectZoneInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ApProtectZoneInfo>>>>(clz_Torappu_StageTable::VT_APPROTECTZONEINFO, None)}
  }
  #[inline]
  pub fn antiSpoilerDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_string<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_string>>>>(clz_Torappu_StageTable::VT_ANTISPOILERDICT, None)}
  }
  #[inline]
  pub fn actCustomStageDatas(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ActCustomStageData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ActCustomStageData>>>>(clz_Torappu_StageTable::VT_ACTCUSTOMSTAGEDATAS, None)}
  }
  #[inline]
  pub fn spNormalStageIdFor4StarList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_StageTable::VT_SPNORMALSTAGEIDFOR4STARLIST, None)}
  }
  #[inline]
  pub fn storylines(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineData>>>>(clz_Torappu_StageTable::VT_STORYLINES, None)}
  }
  #[inline]
  pub fn storylineStorySets(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineStorySetData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineStorySetData>>>>(clz_Torappu_StageTable::VT_STORYLINESTORYSETS, None)}
  }
  #[inline]
  pub fn storylineTags(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineTagData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineTagData>>>>(clz_Torappu_StageTable::VT_STORYLINETAGS, None)}
  }
  #[inline]
  pub fn storylineConst(&self) -> Option<clz_Torappu_StorylineConstData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_StorylineConstData>>(clz_Torappu_StageTable::VT_STORYLINECONST, None)}
  }
  #[inline]
  pub fn cgGalleryDisplays(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryDisplayData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryDisplayData>>>>(clz_Torappu_StageTable::VT_CGGALLERYDISPLAYS, None)}
  }
  #[inline]
  pub fn cgGalleryGroups(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryGroupData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryGroupData>>>>(clz_Torappu_StageTable::VT_CGGALLERYGROUPS, None)}
  }
  #[inline]
  pub fn cgGalleryCgs(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryCGData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryCGData>>>>(clz_Torappu_StageTable::VT_CGGALLERYCGS, None)}
  }
  #[inline]
  pub fn sixStarRuneData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarRuneData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarRuneData>>>>(clz_Torappu_StageTable::VT_SIXSTARRUNEDATA, None)}
  }
  #[inline]
  pub fn sixStarMilestoneInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarMilestoneGroupData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarMilestoneGroupData>>>>(clz_Torappu_StageTable::VT_SIXSTARMILESTONEINFO, None)}
  }
  #[inline]
  pub fn sixStarCompatibleInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo>>>>(clz_Torappu_StageTable::VT_SIXSTARCOMPATIBLEINFO, None)}
  }
  #[inline]
  pub fn conditionalDropInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ConditionalDropInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ConditionalDropInfo>>>>(clz_Torappu_StageTable::VT_CONDITIONALDROPINFO, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_StageTableBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_stages(&mut self, stages: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_STAGES, stages);
  }
  #[inline]
  pub fn add_runeStageGroups(&mut self, runeStageGroups: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_RuneStageGroupData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_RUNESTAGEGROUPS, runeStageGroups);
  }
  #[inline]
  pub fn add_mapThemes(&mut self, mapThemes: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_MapThemeData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_MAPTHEMES, mapThemes);
  }
  #[inline]
  pub fn add_tileInfo(&mut self, tileInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TileAppendInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_TILEINFO, tileInfo);
  }
  #[inline]
  pub fn add_forceOpenTable(&mut self, forceOpenTable: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_WeeklyForceOpenTable<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_FORCEOPENTABLE, forceOpenTable);
  }
  #[inline]
  pub fn add_timelyStageDropInfo(&mut self, timelyStageDropInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TimelyDropTimeInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_TIMELYSTAGEDROPINFO, timelyStageDropInfo);
  }
  #[inline]
  pub fn add_overrideDropInfo(&mut self, overrideDropInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_OverrideDropInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_OVERRIDEDROPINFO, overrideDropInfo);
  }
  #[inline]
  pub fn add_overrideUnlockInfo(&mut self, overrideUnlockInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_OverrideUnlockInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_OVERRIDEUNLOCKINFO, overrideUnlockInfo);
  }
  #[inline]
  pub fn add_timelyTable(&mut self, timelyTable: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_TimelyDropInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_TIMELYTABLE, timelyTable);
  }
  #[inline]
  pub fn add_stageValidInfo(&mut self, stageValidInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageValidInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_STAGEVALIDINFO, stageValidInfo);
  }
  #[inline]
  pub fn add_stageFogInfo(&mut self, stageFogInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageFogInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_STAGEFOGINFO, stageFogInfo);
  }
  #[inline]
  pub fn add_stageStartConds(&mut self, stageStartConds: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageStartCond<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_STAGESTARTCONDS, stageStartConds);
  }
  #[inline]
  pub fn add_diffGroupTable(&mut self, diffGroupTable: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StageDiffGroupTable<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_DIFFGROUPTABLE, diffGroupTable);
  }
  #[inline]
  pub fn add_storyStageShowGroup(&mut self, storyStageShowGroup: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroup<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_STORYSTAGESHOWGROUP, storyStageShowGroup);
  }
  #[inline]
  pub fn add_specialBattleFinishStageData(&mut self, specialBattleFinishStageData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SpecialBattleFinishStageData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_SPECIALBATTLEFINISHSTAGEDATA, specialBattleFinishStageData);
  }
  #[inline]
  pub fn add_recordRewardData(&mut self, recordRewardData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_RecordRewardServerData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_RECORDREWARDDATA, recordRewardData);
  }
  #[inline]
  pub fn add_apProtectZoneInfo(&mut self, apProtectZoneInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ApProtectZoneInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_APPROTECTZONEINFO, apProtectZoneInfo);
  }
  #[inline]
  pub fn add_antiSpoilerDict(&mut self, antiSpoilerDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__list_string<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_ANTISPOILERDICT, antiSpoilerDict);
  }
  #[inline]
  pub fn add_actCustomStageDatas(&mut self, actCustomStageDatas: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ActCustomStageData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_ACTCUSTOMSTAGEDATAS, actCustomStageDatas);
  }
  #[inline]
  pub fn add_spNormalStageIdFor4StarList(&mut self, spNormalStageIdFor4StarList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_SPNORMALSTAGEIDFOR4STARLIST, spNormalStageIdFor4StarList);
  }
  #[inline]
  pub fn add_storylines(&mut self, storylines: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_STORYLINES, storylines);
  }
  #[inline]
  pub fn add_storylineStorySets(&mut self, storylineStorySets: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineStorySetData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_STORYLINESTORYSETS, storylineStorySets);
  }
  #[inline]
  pub fn add_storylineTags(&mut self, storylineTags: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_StorylineTagData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_STORYLINETAGS, storylineTags);
  }
  #[inline]
  pub fn add_storylineConst(&mut self, storylineConst: ::flatbuffers::WIPOffset<clz_Torappu_StorylineConstData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_StorylineConstData>>(clz_Torappu_StageTable::VT_STORYLINECONST, storylineConst);
  }
  #[inline]
  pub fn add_cgGalleryDisplays(&mut self, cgGalleryDisplays: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryDisplayData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_CGGALLERYDISPLAYS, cgGalleryDisplays);
  }
  #[inline]
  pub fn add_cgGalleryGroups(&mut self, cgGalleryGroups: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryGroupData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_CGGALLERYGROUPS, cgGalleryGroups);
  }
  #[inline]
  pub fn add_cgGalleryCgs(&mut self, cgGalleryCgs: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CGGalleryCGData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_CGGALLERYCGS, cgGalleryCgs);
  }
  #[inline]
  pub fn add_sixStarRuneData(&mut self, sixStarRuneData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarRuneData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_SIXSTARRUNEDATA, sixStarRuneData);
  }
  #[inline]
  pub fn add_sixStarMilestoneInfo(&mut self, sixStarMilestoneInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarMilestoneGroupData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_SIXSTARMILESTONEINFO, sixStarMilestoneInfo);
  }
  #[inline]
  pub fn add_sixStarCompatibleInfo(&mut self, sixStarCompatibleInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_SIXSTARCOMPATIBLEINFO, sixStarCompatibleInfo);
  }
  #[inline]
  pub fn add_conditionalDropInfo(&mut self, conditionalDropInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ConditionalDropInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_StageTable::VT_CONDITIONALDROPINFO, conditionalDropInfo);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_StageTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl ::core::fmt::Debug for clz_Torappu_StageTable<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("clz_Torappu_StageTable");
      ...
      ds.field("specialBattleFinishStageData", &self.specialBattleFinishStageData());
      ...
      ds.field("spNormalStageIdFor4StarList", &self.spNormalStageIdFor4StarList());
...
pub struct clz_Torappu_StageTableT {
  pub stages: Option<alloc::vec::Vec<dict__string__clz_Torappu_StageDataT>>,
  pub runeStageGroups: Option<alloc::vec::Vec<dict__string__clz_Torappu_RuneStageGroupDataT>>,
  pub mapThemes: Option<alloc::vec::Vec<dict__string__clz_Torappu_MapThemeDataT>>,
  pub tileInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_TileAppendInfoT>>,
  pub forceOpenTable: Option<alloc::vec::Vec<dict__string__clz_Torappu_WeeklyForceOpenTableT>>,
  pub timelyStageDropInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_TimelyDropTimeInfoT>>,
  pub overrideDropInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_OverrideDropInfoT>>,
  pub overrideUnlockInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_OverrideUnlockInfoT>>,
  pub timelyTable: Option<alloc::vec::Vec<dict__string__clz_Torappu_TimelyDropInfoT>>,
  pub stageValidInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_StageValidInfoT>>,
  pub stageFogInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_StageFogInfoT>>,
  pub stageStartConds: Option<alloc::vec::Vec<dict__string__clz_Torappu_StageStartCondT>>,
  pub diffGroupTable: Option<alloc::vec::Vec<dict__string__clz_Torappu_StageDiffGroupTableT>>,
  pub storyStageShowGroup: Option<alloc::vec::Vec<dict__string__list_dict__enum__Torappu_StageDiffGroup__clz_Torappu_StoryStageShowGroupT>>,
  pub specialBattleFinishStageData: Option<alloc::vec::Vec<dict__string__clz_Torappu_SpecialBattleFinishStageDataT>>,
  pub recordRewardData: Option<alloc::vec::Vec<dict__string__clz_Torappu_RecordRewardServerDataT>>,
  pub apProtectZoneInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_ApProtectZoneInfoT>>,
  pub antiSpoilerDict: Option<alloc::vec::Vec<dict__string__list_stringT>>,
  pub actCustomStageDatas: Option<alloc::vec::Vec<dict__string__clz_Torappu_ActCustomStageDataT>>,
  pub spNormalStageIdFor4StarList: Option<alloc::vec::Vec<alloc::string::String>>,
  pub storylines: Option<alloc::vec::Vec<dict__string__clz_Torappu_StorylineDataT>>,
  pub storylineStorySets: Option<alloc::vec::Vec<dict__string__clz_Torappu_StorylineStorySetDataT>>,
  pub storylineTags: Option<alloc::vec::Vec<dict__string__clz_Torappu_StorylineTagDataT>>,
  pub storylineConst: Option<alloc::boxed::Box<clz_Torappu_StorylineConstDataT>>,
  pub cgGalleryDisplays: Option<alloc::vec::Vec<dict__string__clz_Torappu_CGGalleryDisplayDataT>>,
  pub cgGalleryGroups: Option<alloc::vec::Vec<dict__string__clz_Torappu_CGGalleryGroupDataT>>,
  pub cgGalleryCgs: Option<alloc::vec::Vec<dict__string__clz_Torappu_CGGalleryCGDataT>>,
  pub sixStarRuneData: Option<alloc::vec::Vec<dict__string__clz_Torappu_SixStarRuneDataT>>,
  pub sixStarMilestoneInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_SixStarMilestoneGroupDataT>>,
  pub sixStarCompatibleInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_SixStarLinkedStageCompatibleInfoT>>,
  pub conditionalDropInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_ConditionalDropInfoT>>,
}
...
impl clz_Torappu_StageTableT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let storylineConst = self.storylineConst.as_ref().map(|x|{
      x.pack(_fbb)
    });
    ...
    clz_Torappu_StageTable::create(_fbb, &clz_Torappu_StageTableArgs{
      stages,
      runeStageGroups,
      mapThemes,
      tileInfo,
...
pub fn root_as_clz_torappu_stage_table(buf: &[u8]) -> Result<clz_Torappu_StageTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clz_torappu_stage_table(buf: &[u8]) -> Result<clz_Torappu_StageTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_clz_torappu_stage_table_unchecked(buf: &[u8]) -> clz_Torappu_StageTable<'_> {
...
#[inline]
pub fn finish_size_prefixed_clz_torappu_stage_table_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<clz_Torappu_StageTable<'a>>) {
