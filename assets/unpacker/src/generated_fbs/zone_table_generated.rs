...
impl<'de> serde::Deserialize<'de> for enum__Torappu_ZoneType {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_ZoneType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_WeeklyType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_WeeklyType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_MAINLINE_ZONE_DATA_ZONE_REPLAY_BTN_TYPE: [enum__Torappu_MainlineZoneData_ZoneReplayBtnType; 3] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_MainlineZoneData_ZoneReplayBtnType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_MainlineZoneData_ZoneReplayBtnType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_RECORD_REWARD_STAGE_DIFF: [enum__Torappu_RecordRewardStageDiff; 6] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_RecordRewardStageDiff {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_RecordRewardStageDiff variant: {s}"
        )))
    }
}
...
impl<'a> clz_Torappu_ZoneData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.antiSpoilerId { builder.add_antiSpoilerId(x); }
    if let Some(x) = args.lockedText { builder.add_lockedText(x); }
    if let Some(x) = args.zoneNameThird { builder.add_zoneNameThird(x); }
    if let Some(x) = args.zoneNameTitleEx { builder.add_zoneNameTitleEx(x); }
    if let Some(x) = args.zoneNameTitleUnCurrent { builder.add_zoneNameTitleUnCurrent(x); }
    if let Some(x) = args.zoneNameTitleCurrent { builder.add_zoneNameTitleCurrent(x); }
    if let Some(x) = args.zoneNameSecond { builder.add_zoneNameSecond(x); }
    if let Some(x) = args.zoneNameFirst { builder.add_zoneNameFirst(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_ZoneDataT {
    ...
    let zoneNameFirst = self.zoneNameFirst().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let zoneNameSecond = self.zoneNameSecond().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let zoneNameTitleCurrent = self.zoneNameTitleCurrent().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let zoneNameTitleUnCurrent = self.zoneNameTitleUnCurrent().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let zoneNameTitleEx = self.zoneNameTitleEx().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let zoneNameThird = self.zoneNameThird().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let lockedText = self.lockedText().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let antiSpoilerId = self.antiSpoilerId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let canPreview = self.canPreview();
    let hasAdditionalPanel = self.hasAdditionalPanel();
    let sixStarMilestoneGroupId = self.sixStarMilestoneGroupId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let bindMainlineZoneId = self.bindMainlineZoneId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn zoneID(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_ZONEID, None)}
  }
  #[inline]
  pub fn zoneIndex(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_ZoneData::VT_ZONEINDEX, Some(0)).unwrap()}
  }
  #[inline]
  pub fn type_(&self) -> enum__Torappu_ZoneType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_ZoneType>(clz_Torappu_ZoneData::VT_TYPE_, Some(enum__Torappu_ZoneType::NONE)).unwrap()}
  }
  #[inline]
  pub fn zoneNameFirst(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_ZONENAMEFIRST, None)}
  }
  #[inline]
  pub fn zoneNameSecond(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_ZONENAMESECOND, None)}
  }
  #[inline]
  pub fn zoneNameTitleCurrent(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_ZONENAMETITLECURRENT, None)}
  }
  #[inline]
  pub fn zoneNameTitleUnCurrent(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_ZONENAMETITLEUNCURRENT, None)}
  }
  #[inline]
  pub fn zoneNameTitleEx(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_ZONENAMETITLEEX, None)}
  }
  #[inline]
  pub fn zoneNameThird(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_ZONENAMETHIRD, None)}
  }
  #[inline]
  pub fn lockedText(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_LOCKEDTEXT, None)}
  }
  #[inline]
  pub fn antiSpoilerId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_ANTISPOILERID, None)}
  }
  #[inline]
  pub fn canPreview(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_ZoneData::VT_CANPREVIEW, Some(false)).unwrap()}
  }
  #[inline]
  pub fn hasAdditionalPanel(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_ZoneData::VT_HASADDITIONALPANEL, Some(false)).unwrap()}
  }
  #[inline]
  pub fn sixStarMilestoneGroupId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_SIXSTARMILESTONEGROUPID, None)}
  }
  #[inline]
  pub fn bindMainlineZoneId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneData::VT_BINDMAINLINEZONEID, None)}
  }
  #[inline]
...
impl ::flatbuffers::Verifiable for clz_Torappu_ZoneData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneNameFirst", Self::VT_ZONENAMEFIRST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneNameSecond", Self::VT_ZONENAMESECOND, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneNameTitleCurrent", Self::VT_ZONENAMETITLECURRENT, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneNameTitleUnCurrent", Self::VT_ZONENAMETITLEUNCURRENT, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneNameTitleEx", Self::VT_ZONENAMETITLEEX, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneNameThird", Self::VT_ZONENAMETHIRD, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("lockedText", Self::VT_LOCKEDTEXT, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("antiSpoilerId", Self::VT_ANTISPOILERID, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneDataBuilder<'a, 'b, A> {
  ...
  pub fn add_zoneID(&mut self, zoneID: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_ZONEID, zoneID);
  }
  #[inline]
  pub fn add_zoneIndex(&mut self, zoneIndex: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_ZoneData::VT_ZONEINDEX, zoneIndex, 0);
  }
  #[inline]
  pub fn add_type_(&mut self, type_: enum__Torappu_ZoneType) {
    self.fbb_.push_slot::<enum__Torappu_ZoneType>(clz_Torappu_ZoneData::VT_TYPE_, type_, enum__Torappu_ZoneType::NONE);
  }
  #[inline]
  pub fn add_zoneNameFirst(&mut self, zoneNameFirst: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_ZONENAMEFIRST, zoneNameFirst);
  }
  #[inline]
  pub fn add_zoneNameSecond(&mut self, zoneNameSecond: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_ZONENAMESECOND, zoneNameSecond);
  }
  #[inline]
  pub fn add_zoneNameTitleCurrent(&mut self, zoneNameTitleCurrent: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_ZONENAMETITLECURRENT, zoneNameTitleCurrent);
  }
  #[inline]
  pub fn add_zoneNameTitleUnCurrent(&mut self, zoneNameTitleUnCurrent: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_ZONENAMETITLEUNCURRENT, zoneNameTitleUnCurrent);
  }
  #[inline]
  pub fn add_zoneNameTitleEx(&mut self, zoneNameTitleEx: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_ZONENAMETITLEEX, zoneNameTitleEx);
  }
  #[inline]
  pub fn add_zoneNameThird(&mut self, zoneNameThird: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_ZONENAMETHIRD, zoneNameThird);
  }
  #[inline]
  pub fn add_lockedText(&mut self, lockedText: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_LOCKEDTEXT, lockedText);
  }
  #[inline]
  pub fn add_antiSpoilerId(&mut self, antiSpoilerId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_ANTISPOILERID, antiSpoilerId);
  }
  #[inline]
  pub fn add_canPreview(&mut self, canPreview: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_ZoneData::VT_CANPREVIEW, canPreview, false);
  }
  #[inline]
  pub fn add_hasAdditionalPanel(&mut self, hasAdditionalPanel: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_ZoneData::VT_HASADDITIONALPANEL, hasAdditionalPanel, false);
  }
  #[inline]
  pub fn add_sixStarMilestoneGroupId(&mut self, sixStarMilestoneGroupId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_SIXSTARMILESTONEGROUPID, sixStarMilestoneGroupId);
  }
  #[inline]
  pub fn add_bindMainlineZoneId(&mut self, bindMainlineZoneId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneData::VT_BINDMAINLINEZONEID, bindMainlineZoneId);
  }
  #[inline]
  pub fn add_bindMainlineRetroZoneId(&mut self, bindMainlineRetroZoneId: ::flatbuffers::WIPOffset<&'b  str>) {
...
pub struct clz_Torappu_ZoneDataT {
  ...
  pub zoneIndex: i32,
  pub type_: enum__Torappu_ZoneType,
  pub zoneNameFirst: Option<alloc::string::String>,
  pub zoneNameSecond: Option<alloc::string::String>,
  pub zoneNameTitleCurrent: Option<alloc::string::String>,
  pub zoneNameTitleUnCurrent: Option<alloc::string::String>,
  pub zoneNameTitleEx: Option<alloc::string::String>,
  pub zoneNameThird: Option<alloc::string::String>,
  pub lockedText: Option<alloc::string::String>,
  pub antiSpoilerId: Option<alloc::string::String>,
  pub canPreview: bool,
  pub hasAdditionalPanel: bool,
...
impl clz_Torappu_ZoneDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let zoneIndex = self.zoneIndex;
    let type_ = self.type_;
    let zoneNameFirst = self.zoneNameFirst.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let zoneNameSecond = self.zoneNameSecond.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let zoneNameTitleCurrent = self.zoneNameTitleCurrent.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let zoneNameTitleUnCurrent = self.zoneNameTitleUnCurrent.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let zoneNameTitleEx = self.zoneNameTitleEx.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let zoneNameThird = self.zoneNameThird.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let lockedText = self.lockedText.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let antiSpoilerId = self.antiSpoilerId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let canPreview = self.canPreview;
    let hasAdditionalPanel = self.hasAdditionalPanel;
    let sixStarMilestoneGroupId = self.sixStarMilestoneGroupId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let bindMainlineZoneId = self.bindMainlineZoneId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
...
impl<'a> dict__string__clz_Torappu_ZoneData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ZoneDataT {
    ...
    dict__string__clz_Torappu_ZoneDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ZoneData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ZoneData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneData>>(dict__string__clz_Torappu_ZoneData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ZoneData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ZoneDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ZoneData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ZoneData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ZoneData>>(dict__string__clz_Torappu_ZoneData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ZoneDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ZoneData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ZoneData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ZoneDataT {
  ...
  pub value: Option<alloc::boxed::Box<clz_Torappu_ZoneDataT>>,
}
...
impl dict__string__clz_Torappu_ZoneDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ZoneData::create(_fbb, &dict__string__clz_Torappu_ZoneDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_WeeklyZoneData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_type_(args.type_);
    if let Some(x) = args.daysOfWeek { builder.add_daysOfWeek(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_WeeklyZoneDataT {
    let daysOfWeek = self.daysOfWeek().map(|x| {
      x.into_iter().collect()
    });
    let type_ = self.type_();
    clz_Torappu_WeeklyZoneDataT {
      daysOfWeek,
      type_,
    }
  }
  ...
  pub fn daysOfWeek(&self) -> Option<::flatbuffers::Vector<'a, i32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(clz_Torappu_WeeklyZoneData::VT_DAYSOFWEEK, None)}
  }
  #[inline]
  pub fn type_(&self) -> enum__Torappu_WeeklyType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_WeeklyType>(clz_Torappu_WeeklyZoneData::VT_TYPE_, Some(enum__Torappu_WeeklyType::NONE)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_WeeklyZoneData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>("daysOfWeek", Self::VT_DAYSOFWEEK, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_WeeklyZoneDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_daysOfWeek(&mut self, daysOfWeek: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_WeeklyZoneData::VT_DAYSOFWEEK, daysOfWeek);
  }
  #[inline]
  pub fn add_type_(&mut self, type_: enum__Torappu_WeeklyType) {
    self.fbb_.push_slot::<enum__Torappu_WeeklyType>(clz_Torappu_WeeklyZoneData::VT_TYPE_, type_, enum__Torappu_WeeklyType::NONE);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_WeeklyZoneDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_WeeklyZoneDataT {
  pub daysOfWeek: Option<alloc::vec::Vec<i32>>,
  pub type_: enum__Torappu_WeeklyType,
}
...
impl clz_Torappu_WeeklyZoneDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let daysOfWeek = self.daysOfWeek.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    let type_ = self.type_;
    clz_Torappu_WeeklyZoneData::create(_fbb, &clz_Torappu_WeeklyZoneDataArgs{
      daysOfWeek,
      type_,
    })
  }
...
impl<'a> dict__string__clz_Torappu_WeeklyZoneData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_WeeklyZoneDataT {
    ...
    dict__string__clz_Torappu_WeeklyZoneDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_WeeklyZoneData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_WeeklyZoneData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_WeeklyZoneData>>(dict__string__clz_Torappu_WeeklyZoneData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_WeeklyZoneData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_WeeklyZoneData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_WeeklyZoneDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_WeeklyZoneDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_WeeklyZoneData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_WeeklyZoneData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_WeeklyZoneData>>(dict__string__clz_Torappu_WeeklyZoneData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_WeeklyZoneDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_WeeklyZoneData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_WeeklyZoneData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_WeeklyZoneDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_WeeklyZoneDataT>>,
}
...
impl dict__string__clz_Torappu_WeeklyZoneDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_WeeklyZoneData::create(_fbb, &dict__string__clz_Torappu_WeeklyZoneDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ZoneValidInfo<'a> {
  ...
  pub fn startTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_ZoneValidInfo::VT_STARTTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn endTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_ZoneValidInfo::VT_ENDTS, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneValidInfoBuilder<'a, 'b, A> {
  ...
  pub fn add_startTs(&mut self, startTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_ZoneValidInfo::VT_STARTTS, startTs, 0);
  }
  #[inline]
  pub fn add_endTs(&mut self, endTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_ZoneValidInfo::VT_ENDTS, endTs, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ZoneValidInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_ZoneValidInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let startTs = self.startTs;
    let endTs = self.endTs;
    clz_Torappu_ZoneValidInfo::create(_fbb, &clz_Torappu_ZoneValidInfoArgs{
      startTs,
      endTs,
    })
  }
...
impl<'a> dict__string__clz_Torappu_ZoneValidInfo<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ZoneValidInfoT {
    ...
    dict__string__clz_Torappu_ZoneValidInfoT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ZoneValidInfo::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ZoneValidInfo<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneValidInfo>>(dict__string__clz_Torappu_ZoneValidInfo::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ZoneValidInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneValidInfo>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ZoneValidInfoBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ZoneValidInfoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ZoneValidInfo::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ZoneValidInfo<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ZoneValidInfo>>(dict__string__clz_Torappu_ZoneValidInfo::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ZoneValidInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ZoneValidInfo<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ZoneValidInfo::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ZoneValidInfoT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ZoneValidInfoT>>,
}
...
impl dict__string__clz_Torappu_ZoneValidInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ZoneValidInfo::create(_fbb, &dict__string__clz_Torappu_ZoneValidInfoArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_MainlineZoneData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.diffGroup { builder.add_diffGroup(x); }
    builder.add_buttonStyle(args.buttonStyle);
    if let Some(x) = args.buttonName { builder.add_buttonName(x); }
    if let Some(x) = args.recapPreStageId { builder.add_recapPreStageId(x); }
    if let Some(x) = args.recapId { builder.add_recapId(x); }
    if let Some(x) = args.gameMusicId { builder.add_gameMusicId(x); }
    if let Some(x) = args.endStageId { builder.add_endStageId(x); }
    if let Some(x) = args.startStageId { builder.add_startStageId(x); }
    builder.add_zoneIndex(args.zoneIndex);
    if let Some(x) = args.preposedZoneId { builder.add_preposedZoneId(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_MainlineZoneDataT {
    ...
    let preposedZoneId = self.preposedZoneId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let zoneIndex = self.zoneIndex();
    let startStageId = self.startStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let endStageId = self.endStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let gameMusicId = self.gameMusicId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let recapId = self.recapId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let recapPreStageId = self.recapPreStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    ...
    let diffGroup = self.diffGroup().map(|x| {
      x.into_iter().collect()
    });
  ...
  pub fn zoneId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_ZONEID, None)}
  }
  #[inline]
  pub fn chapterId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_CHAPTERID, None)}
  }
  #[inline]
  pub fn preposedZoneId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_PREPOSEDZONEID, None)}
  }
  #[inline]
  pub fn zoneIndex(&self) -> i32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_MainlineZoneData::VT_ZONEINDEX, Some(0)).unwrap()}
  }
  #[inline]
  pub fn startStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_STARTSTAGEID, None)}
  }
  #[inline]
  pub fn endStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_ENDSTAGEID, None)}
  }
  #[inline]
  pub fn gameMusicId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_GAMEMUSICID, None)}
  }
  #[inline]
  pub fn recapId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_RECAPID, None)}
  }
  #[inline]
  pub fn recapPreStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_RECAPPRESTAGEID, None)}
  }
  #[inline]
  pub fn buttonName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_MainlineZoneData::VT_BUTTONNAME, None)}
  }
  #[inline]
  pub fn buttonStyle(&self) -> enum__Torappu_MainlineZoneData_ZoneReplayBtnType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_MainlineZoneData_ZoneReplayBtnType>(clz_Torappu_MainlineZoneData::VT_BUTTONSTYLE, Some(enum__Torappu_MainlineZoneData_ZoneReplayBtnType::NONE)).unwrap()}
  }
  #[inline]
  pub fn spoilAlert(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_MainlineZoneData::VT_SPOILALERT, Some(false)).unwrap()}
  }
  #[inline]
  pub fn zoneOpenTime(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_MainlineZoneData::VT_ZONEOPENTIME, Some(0)).unwrap()}
  }
  #[inline]
  pub fn diffGroup(&self) -> Option<::flatbuffers::Vector<'a, enum__Torappu_StageDiffGroup>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, enum__Torappu_StageDiffGroup>>>(clz_Torappu_MainlineZoneData::VT_DIFFGROUP, None)}
  }
}
...
pub struct clz_Torappu_MainlineZoneDataArgs<'a> {
    ...
    pub diffGroup: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, enum__Torappu_StageDiffGroup>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_MainlineZoneDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_zoneId(&mut self, zoneId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_ZONEID, zoneId);
  }
  #[inline]
  pub fn add_chapterId(&mut self, chapterId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_CHAPTERID, chapterId);
  }
  #[inline]
  pub fn add_preposedZoneId(&mut self, preposedZoneId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_PREPOSEDZONEID, preposedZoneId);
  }
  #[inline]
  pub fn add_zoneIndex(&mut self, zoneIndex: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_MainlineZoneData::VT_ZONEINDEX, zoneIndex, 0);
  }
  #[inline]
  pub fn add_startStageId(&mut self, startStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_STARTSTAGEID, startStageId);
  }
  #[inline]
  pub fn add_endStageId(&mut self, endStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_ENDSTAGEID, endStageId);
  }
  #[inline]
  pub fn add_gameMusicId(&mut self, gameMusicId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_GAMEMUSICID, gameMusicId);
  }
  #[inline]
  pub fn add_recapId(&mut self, recapId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_RECAPID, recapId);
  }
  #[inline]
  pub fn add_recapPreStageId(&mut self, recapPreStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_RECAPPRESTAGEID, recapPreStageId);
  }
  #[inline]
  pub fn add_buttonName(&mut self, buttonName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_BUTTONNAME, buttonName);
  }
  #[inline]
  pub fn add_buttonStyle(&mut self, buttonStyle: enum__Torappu_MainlineZoneData_ZoneReplayBtnType) {
    self.fbb_.push_slot::<enum__Torappu_MainlineZoneData_ZoneReplayBtnType>(clz_Torappu_MainlineZoneData::VT_BUTTONSTYLE, buttonStyle, enum__Torappu_MainlineZoneData_ZoneReplayBtnType::NONE);
  }
  #[inline]
  pub fn add_spoilAlert(&mut self, spoilAlert: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_MainlineZoneData::VT_SPOILALERT, spoilAlert, false);
  }
  #[inline]
  pub fn add_zoneOpenTime(&mut self, zoneOpenTime: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_MainlineZoneData::VT_ZONEOPENTIME, zoneOpenTime, 0);
  }
  #[inline]
  pub fn add_diffGroup(&mut self, diffGroup: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , enum__Torappu_StageDiffGroup>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_MainlineZoneData::VT_DIFFGROUP, diffGroup);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_MainlineZoneDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_MainlineZoneDataT {
  ...
  pub preposedZoneId: Option<alloc::string::String>,
  pub zoneIndex: i32,
  pub startStageId: Option<alloc::string::String>,
  pub endStageId: Option<alloc::string::String>,
  pub gameMusicId: Option<alloc::string::String>,
  pub recapId: Option<alloc::string::String>,
  pub recapPreStageId: Option<alloc::string::String>,
  pub buttonName: Option<alloc::string::String>,
  pub buttonStyle: enum__Torappu_MainlineZoneData_ZoneReplayBtnType,
  pub spoilAlert: bool,
  pub zoneOpenTime: i64,
  pub diffGroup: Option<alloc::vec::Vec<enum__Torappu_StageDiffGroup>>,
}
...
impl clz_Torappu_MainlineZoneDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let preposedZoneId = self.preposedZoneId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let zoneIndex = self.zoneIndex;
    let startStageId = self.startStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let endStageId = self.endStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let gameMusicId = self.gameMusicId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let recapId = self.recapId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let recapPreStageId = self.recapPreStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    ...
    let spoilAlert = self.spoilAlert;
    let zoneOpenTime = self.zoneOpenTime;
    let diffGroup = self.diffGroup.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    clz_Torappu_MainlineZoneData::create(_fbb, &clz_Torappu_MainlineZoneDataArgs{
      zoneId,
      chapterId,
      preposedZoneId,
      zoneIndex,
...
impl<'a> dict__string__clz_Torappu_MainlineZoneData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_MainlineZoneDataT {
    ...
    dict__string__clz_Torappu_MainlineZoneDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_MainlineZoneData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_MainlineZoneData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_MainlineZoneData>>(dict__string__clz_Torappu_MainlineZoneData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_MainlineZoneData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_MainlineZoneData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_MainlineZoneDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_MainlineZoneDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_MainlineZoneData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_MainlineZoneData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_MainlineZoneData>>(dict__string__clz_Torappu_MainlineZoneData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_MainlineZoneDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_MainlineZoneData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_MainlineZoneData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_MainlineZoneDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_MainlineZoneDataT>>,
}
...
impl dict__string__clz_Torappu_MainlineZoneDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_MainlineZoneData::create(_fbb, &dict__string__clz_Torappu_MainlineZoneDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_RecordRewardInfo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.recordReward { builder.add_recordReward(x); }
    if let Some(x) = args.textDesc { builder.add_textDesc(x); }
    if let Some(x) = args.textPath { builder.add_textPath(x); }
    if let Some(x) = args.picRes { builder.add_picRes(x); }
    builder.add_stageDiff(args.stageDiff);
    builder.add_stageDiff1(args.stageDiff1);
    if let Some(x) = args.bindStageId { builder.add_bindStageId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_RecordRewardInfoT {
    let bindStageId = self.bindStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let stageDiff1 = self.stageDiff1();
    let stageDiff = self.stageDiff();
    let picRes = self.picRes().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let textPath = self.textPath().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let textDesc = self.textDesc().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let recordReward = self.recordReward().map(|x| {
  ...
  pub fn bindStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_RecordRewardInfo::VT_BINDSTAGEID, None)}
  }
  #[inline]
  pub fn stageDiff1(&self) -> enum__Torappu_RecordRewardStageDiff {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_RecordRewardStageDiff>(clz_Torappu_RecordRewardInfo::VT_STAGEDIFF1, Some(enum__Torappu_RecordRewardStageDiff::NONE)).unwrap()}
  }
  #[inline]
  pub fn stageDiff(&self) -> enum__Torappu_StageDiffGroup {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_StageDiffGroup>(clz_Torappu_RecordRewardInfo::VT_STAGEDIFF, Some(enum__Torappu_StageDiffGroup::NONE)).unwrap()}
  }
  #[inline]
  pub fn picRes(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_RecordRewardInfo::VT_PICRES, None)}
  }
  #[inline]
  pub fn textPath(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_RecordRewardInfo::VT_TEXTPATH, None)}
  }
  #[inline]
  pub fn textDesc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_RecordRewardInfo::VT_TEXTDESC, None)}
  }
  #[inline]
  pub fn recordReward(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle>>>>(clz_Torappu_RecordRewardInfo::VT_RECORDREWARD, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_RecordRewardInfo<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("bindStageId", Self::VT_BINDSTAGEID, false)?
     .visit_field::<enum__Torappu_RecordRewardStageDiff>("stageDiff1", Self::VT_STAGEDIFF1, false)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("textPath", Self::VT_TEXTPATH, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("textDesc", Self::VT_TEXTDESC, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle>>>>("recordReward", Self::VT_RECORDREWARD, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_RecordRewardInfoArgs<'a> {
    ...
    pub recordReward: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_RecordRewardInfoBuilder<'a, 'b, A> {
  ...
  pub fn add_bindStageId(&mut self, bindStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RecordRewardInfo::VT_BINDSTAGEID, bindStageId);
  }
  #[inline]
  pub fn add_stageDiff1(&mut self, stageDiff1: enum__Torappu_RecordRewardStageDiff) {
    self.fbb_.push_slot::<enum__Torappu_RecordRewardStageDiff>(clz_Torappu_RecordRewardInfo::VT_STAGEDIFF1, stageDiff1, enum__Torappu_RecordRewardStageDiff::NONE);
  }
  #[inline]
  pub fn add_stageDiff(&mut self, stageDiff: enum__Torappu_StageDiffGroup) {
    self.fbb_.push_slot::<enum__Torappu_StageDiffGroup>(clz_Torappu_RecordRewardInfo::VT_STAGEDIFF, stageDiff, enum__Torappu_StageDiffGroup::NONE);
  }
  #[inline]
  pub fn add_picRes(&mut self, picRes: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RecordRewardInfo::VT_PICRES, picRes);
  }
  #[inline]
  pub fn add_textPath(&mut self, textPath: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RecordRewardInfo::VT_TEXTPATH, textPath);
  }
  #[inline]
  pub fn add_textDesc(&mut self, textDesc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RecordRewardInfo::VT_TEXTDESC, textDesc);
  }
  #[inline]
  pub fn add_recordReward(&mut self, recordReward: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ItemBundle<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_RecordRewardInfo::VT_RECORDREWARD, recordReward);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_RecordRewardInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_RecordRewardInfoT {
  pub bindStageId: Option<alloc::string::String>,
  pub stageDiff1: enum__Torappu_RecordRewardStageDiff,
  pub stageDiff: enum__Torappu_StageDiffGroup,
  pub picRes: Option<alloc::string::String>,
  pub textPath: Option<alloc::string::String>,
  pub textDesc: Option<alloc::string::String>,
  pub recordReward: Option<alloc::vec::Vec<clz_Torappu_ItemBundleT>>,
}
...
impl clz_Torappu_RecordRewardInfoT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let bindStageId = self.bindStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let stageDiff1 = self.stageDiff1;
    let stageDiff = self.stageDiff;
    let picRes = self.picRes.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let textPath = self.textPath.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let textDesc = self.textDesc.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let recordReward = self.recordReward.as_ref().map(|x|{
      let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();_fbb.create_vector(&w)
    });
    clz_Torappu_RecordRewardInfo::create(_fbb, &clz_Torappu_RecordRewardInfoArgs{
      bindStageId,
      stageDiff1,
      stageDiff,
      picRes,
...
impl<'a> clz_Torappu_ZoneRecordData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.nodeTitle2 { builder.add_nodeTitle2(x); }
    if let Some(x) = args.nodeTitle1 { builder.add_nodeTitle1(x); }
    if let Some(x) = args.preRecordId { builder.add_preRecordId(x); }
    if let Some(x) = args.recordTitleName { builder.add_recordTitleName(x); }
    if let Some(x) = args.zoneId { builder.add_zoneId(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_ZoneRecordDataT {
    ...
    let recordTitleName = self.recordTitleName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let preRecordId = self.preRecordId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let nodeTitle1 = self.nodeTitle1().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let nodeTitle2 = self.nodeTitle2().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn recordId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordData::VT_RECORDID, None)}
  }
  #[inline]
  pub fn zoneId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordData::VT_ZONEID, None)}
  }
  #[inline]
  pub fn recordTitleName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordData::VT_RECORDTITLENAME, None)}
  }
  #[inline]
  pub fn preRecordId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordData::VT_PRERECORDID, None)}
  }
  #[inline]
  pub fn nodeTitle1(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordData::VT_NODETITLE1, None)}
  }
  #[inline]
  pub fn nodeTitle2(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordData::VT_NODETITLE2, None)}
  }
  #[inline]
  pub fn rewards(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardInfo>>>>(clz_Torappu_ZoneRecordData::VT_REWARDS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ZoneRecordData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneId", Self::VT_ZONEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("recordTitleName", Self::VT_RECORDTITLENAME, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("preRecordId", Self::VT_PRERECORDID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("nodeTitle1", Self::VT_NODETITLE1, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("nodeTitle2", Self::VT_NODETITLE2, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardInfo>>>>("rewards", Self::VT_REWARDS, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_ZoneRecordDataArgs<'a> {
    ...
    pub rewards: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardInfo<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneRecordDataBuilder<'a, 'b, A> {
  ...
  pub fn add_recordId(&mut self, recordId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordData::VT_RECORDID, recordId);
  }
  #[inline]
  pub fn add_zoneId(&mut self, zoneId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordData::VT_ZONEID, zoneId);
  }
  #[inline]
  pub fn add_recordTitleName(&mut self, recordTitleName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordData::VT_RECORDTITLENAME, recordTitleName);
  }
  #[inline]
  pub fn add_preRecordId(&mut self, preRecordId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordData::VT_PRERECORDID, preRecordId);
  }
  #[inline]
  pub fn add_nodeTitle1(&mut self, nodeTitle1: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordData::VT_NODETITLE1, nodeTitle1);
  }
  #[inline]
  pub fn add_nodeTitle2(&mut self, nodeTitle2: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordData::VT_NODETITLE2, nodeTitle2);
  }
  #[inline]
  pub fn add_rewards(&mut self, rewards: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordData::VT_REWARDS, rewards);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ZoneRecordDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ZoneRecordDataT {
  pub recordId: Option<alloc::string::String>,
  pub zoneId: Option<alloc::string::String>,
  pub recordTitleName: Option<alloc::string::String>,
  pub preRecordId: Option<alloc::string::String>,
  pub nodeTitle1: Option<alloc::string::String>,
  pub nodeTitle2: Option<alloc::string::String>,
  pub rewards: Option<alloc::vec::Vec<clz_Torappu_RecordRewardInfoT>>,
}
...
impl clz_Torappu_ZoneRecordDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let recordTitleName = self.recordTitleName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let preRecordId = self.preRecordId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let nodeTitle1 = self.nodeTitle1.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let nodeTitle2 = self.nodeTitle2.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let rewards = self.rewards.as_ref().map(|x|{
      let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();_fbb.create_vector(&w)
    });
    clz_Torappu_ZoneRecordData::create(_fbb, &clz_Torappu_ZoneRecordDataArgs{
      recordId,
      zoneId,
      recordTitleName,
      preRecordId,
...
impl<'a> clz_Torappu_ZoneRecordUnlockData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.remindDes { builder.add_remindDes(x); }
    if let Some(x) = args.finalDes { builder.add_finalDes(x); }
    if let Some(x) = args.initialDes { builder.add_initialDes(x); }
    if let Some(x) = args.accordingExposeId { builder.add_accordingExposeId(x); }
    if let Some(x) = args.finalName { builder.add_finalName(x); }
    if let Some(x) = args.initialName { builder.add_initialName(x); }
    if let Some(x) = args.zoneId { builder.add_zoneId(x); }
    if let Some(x) = args.noteId { builder.add_noteId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_ZoneRecordUnlockDataT {
    let noteId = self.noteId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let zoneId = self.zoneId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let initialName = self.initialName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let finalName = self.finalName().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let accordingExposeId = self.accordingExposeId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let initialDes = self.initialDes().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let finalDes = self.finalDes().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let remindDes = self.remindDes().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn noteId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordUnlockData::VT_NOTEID, None)}
  }
  #[inline]
  pub fn zoneId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordUnlockData::VT_ZONEID, None)}
  }
  #[inline]
  pub fn initialName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordUnlockData::VT_INITIALNAME, None)}
  }
  #[inline]
  pub fn finalName(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordUnlockData::VT_FINALNAME, None)}
  }
  #[inline]
  pub fn accordingExposeId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordUnlockData::VT_ACCORDINGEXPOSEID, None)}
  }
  #[inline]
  pub fn initialDes(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordUnlockData::VT_INITIALDES, None)}
  }
  #[inline]
  pub fn finalDes(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordUnlockData::VT_FINALDES, None)}
  }
  #[inline]
  pub fn remindDes(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordUnlockData::VT_REMINDDES, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ZoneRecordUnlockData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneId", Self::VT_ZONEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("initialName", Self::VT_INITIALNAME, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("finalName", Self::VT_FINALNAME, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("accordingExposeId", Self::VT_ACCORDINGEXPOSEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("initialDes", Self::VT_INITIALDES, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("finalDes", Self::VT_FINALDES, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("remindDes", Self::VT_REMINDDES, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneRecordUnlockDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_noteId(&mut self, noteId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordUnlockData::VT_NOTEID, noteId);
  }
  #[inline]
  pub fn add_zoneId(&mut self, zoneId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordUnlockData::VT_ZONEID, zoneId);
  }
  #[inline]
  pub fn add_initialName(&mut self, initialName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordUnlockData::VT_INITIALNAME, initialName);
  }
  #[inline]
  pub fn add_finalName(&mut self, finalName: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordUnlockData::VT_FINALNAME, finalName);
  }
  #[inline]
  pub fn add_accordingExposeId(&mut self, accordingExposeId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordUnlockData::VT_ACCORDINGEXPOSEID, accordingExposeId);
  }
  #[inline]
  pub fn add_initialDes(&mut self, initialDes: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordUnlockData::VT_INITIALDES, initialDes);
  }
  #[inline]
  pub fn add_finalDes(&mut self, finalDes: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordUnlockData::VT_FINALDES, finalDes);
  }
  #[inline]
  pub fn add_remindDes(&mut self, remindDes: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordUnlockData::VT_REMINDDES, remindDes);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ZoneRecordUnlockDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ZoneRecordUnlockDataT {
  pub noteId: Option<alloc::string::String>,
  pub zoneId: Option<alloc::string::String>,
  pub initialName: Option<alloc::string::String>,
  pub finalName: Option<alloc::string::String>,
  pub accordingExposeId: Option<alloc::string::String>,
  pub initialDes: Option<alloc::string::String>,
  pub finalDes: Option<alloc::string::String>,
  pub remindDes: Option<alloc::string::String>,
}
...
impl clz_Torappu_ZoneRecordUnlockDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let noteId = self.noteId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let zoneId = self.zoneId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let initialName = self.initialName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let finalName = self.finalName.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let accordingExposeId = self.accordingExposeId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let initialDes = self.initialDes.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let finalDes = self.finalDes.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let remindDes = self.remindDes.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_ZoneRecordUnlockData::create(_fbb, &clz_Torappu_ZoneRecordUnlockDataArgs{
      noteId,
      zoneId,
      initialName,
      finalName,
...
impl<'a> clz_Torappu_ZoneRecordGroupData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.unlockData { builder.add_unlockData(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_ZoneRecordGroupDataT {
    ...
    let unlockData = self.unlockData().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
  ...
  pub fn zoneId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordGroupData::VT_ZONEID, None)}
  }
  #[inline]
  pub fn records(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordData>>>>(clz_Torappu_ZoneRecordGroupData::VT_RECORDS, None)}
  }
  #[inline]
  pub fn unlockData(&self) -> Option<clz_Torappu_ZoneRecordUnlockData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordUnlockData>>(clz_Torappu_ZoneRecordGroupData::VT_UNLOCKDATA, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ZoneRecordGroupData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("zoneId", Self::VT_ZONEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordData>>>>("records", Self::VT_RECORDS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordUnlockData>>("unlockData", Self::VT_UNLOCKDATA, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_ZoneRecordGroupDataArgs<'a> {
    pub zoneId: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub records: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordData<'a>>>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneRecordGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_zoneId(&mut self, zoneId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordGroupData::VT_ZONEID, zoneId);
  }
  #[inline]
  pub fn add_records(&mut self, records: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordGroupData::VT_RECORDS, records);
  }
  #[inline]
  pub fn add_unlockData(&mut self, unlockData: ::flatbuffers::WIPOffset<clz_Torappu_ZoneRecordUnlockData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ZoneRecordUnlockData>>(clz_Torappu_ZoneRecordGroupData::VT_UNLOCKDATA, unlockData);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ZoneRecordGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ZoneRecordGroupDataT {
  pub zoneId: Option<alloc::string::String>,
  pub records: Option<alloc::vec::Vec<clz_Torappu_ZoneRecordDataT>>,
  pub unlockData: Option<alloc::boxed::Box<clz_Torappu_ZoneRecordUnlockDataT>>,
}
...
impl clz_Torappu_ZoneRecordGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let unlockData = self.unlockData.as_ref().map(|x|{
      x.pack(_fbb)
    });
    clz_Torappu_ZoneRecordGroupData::create(_fbb, &clz_Torappu_ZoneRecordGroupDataArgs{
      zoneId,
      records,
      unlockData,
    })
...
impl<'a> dict__string__clz_Torappu_ZoneRecordGroupData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ZoneRecordGroupDataT {
    ...
    dict__string__clz_Torappu_ZoneRecordGroupDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ZoneRecordGroupData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_ZoneRecordGroupData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordGroupData>>(dict__string__clz_Torappu_ZoneRecordGroupData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ZoneRecordGroupData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordGroupData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ZoneRecordGroupDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ZoneRecordGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ZoneRecordGroupData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ZoneRecordGroupData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ZoneRecordGroupData>>(dict__string__clz_Torappu_ZoneRecordGroupData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ZoneRecordGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ZoneRecordGroupData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ZoneRecordGroupData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ZoneRecordGroupDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ZoneRecordGroupDataT>>,
}
...
impl dict__string__clz_Torappu_ZoneRecordGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ZoneRecordGroupData::create(_fbb, &dict__string__clz_Torappu_ZoneRecordGroupDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ZoneRecordMissionData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.recordStageId { builder.add_recordStageId(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_ZoneRecordMissionDataT {
    ...
    let recordStageId = self.recordStageId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn missionId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordMissionData::VT_MISSIONID, None)}
  }
  #[inline]
  pub fn recordStageId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordMissionData::VT_RECORDSTAGEID, None)}
  }
  #[inline]
  pub fn templateDesc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordMissionData::VT_TEMPLATEDESC, None)}
  }
  #[inline]
  pub fn desc(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ZoneRecordMissionData::VT_DESC, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ZoneRecordMissionData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("recordStageId", Self::VT_RECORDSTAGEID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("templateDesc", Self::VT_TEMPLATEDESC, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneRecordMissionDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_missionId(&mut self, missionId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordMissionData::VT_MISSIONID, missionId);
  }
  #[inline]
  pub fn add_recordStageId(&mut self, recordStageId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordMissionData::VT_RECORDSTAGEID, recordStageId);
  }
  #[inline]
  pub fn add_templateDesc(&mut self, templateDesc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordMissionData::VT_TEMPLATEDESC, templateDesc);
  }
  #[inline]
  pub fn add_desc(&mut self, desc: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneRecordMissionData::VT_DESC, desc);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ZoneRecordMissionDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ZoneRecordMissionDataT {
  ...
  pub recordStageId: Option<alloc::string::String>,
  pub templateDesc: Option<alloc::string::String>,
...
impl clz_Torappu_ZoneRecordMissionDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let recordStageId = self.recordStageId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    ...
    clz_Torappu_ZoneRecordMissionData::create(_fbb, &clz_Torappu_ZoneRecordMissionDataArgs{
      missionId,
      recordStageId,
      templateDesc,
      desc,
...
impl<'a> dict__string__clz_Torappu_ZoneRecordMissionData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ZoneRecordMissionDataT {
    ...
    dict__string__clz_Torappu_ZoneRecordMissionDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ZoneRecordMissionData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_ZoneRecordMissionData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_ZoneRecordMissionData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordMissionData>>(dict__string__clz_Torappu_ZoneRecordMissionData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ZoneRecordMissionData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordMissionData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ZoneRecordMissionDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ZoneRecordMissionDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ZoneRecordMissionData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ZoneRecordMissionData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ZoneRecordMissionData>>(dict__string__clz_Torappu_ZoneRecordMissionData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ZoneRecordMissionDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ZoneRecordMissionData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ZoneRecordMissionData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ZoneRecordMissionDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ZoneRecordMissionDataT>>,
}
...
impl dict__string__clz_Torappu_ZoneRecordMissionDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ZoneRecordMissionData::create(_fbb, &dict__string__clz_Torappu_ZoneRecordMissionDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ZoneMetaData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.ZoneRecordMissionData { builder.add_ZoneRecordMissionData(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_ZoneMetaDataT {
    let ZoneRecordMissionData = self.ZoneRecordMissionData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  #[inline]
  pub fn ZoneRecordMissionData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordMissionData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordMissionData>>>>(clz_Torappu_ZoneMetaData::VT_ZONERECORDMISSIONDATA, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ZoneMetaData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordMissionData>>>>("ZoneRecordMissionData", Self::VT_ZONERECORDMISSIONDATA, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_ZoneMetaDataArgs<'a> {
    pub ZoneRecordMissionData: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordMissionData<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneMetaDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_ZoneRecordMissionData(&mut self, ZoneRecordMissionData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordMissionData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneMetaData::VT_ZONERECORDMISSIONDATA, ZoneRecordMissionData);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ZoneMetaDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ZoneMetaDataT {
  pub ZoneRecordMissionData: Option<alloc::vec::Vec<dict__string__clz_Torappu_ZoneRecordMissionDataT>>,
}
...
impl clz_Torappu_ZoneMetaDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_ZoneMetaData::create(_fbb, &clz_Torappu_ZoneMetaDataArgs{
      ZoneRecordMissionData,
    })
  }
}
...
impl<'a> clz_Torappu_ZoneTable<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.zoneMetaData { builder.add_zoneMetaData(x); }
    if let Some(x) = args.mainlineZoneIdList { builder.add_mainlineZoneIdList(x); }
    if let Some(x) = args.zoneRecordRewardData { builder.add_zoneRecordRewardData(x); }
    if let Some(x) = args.zoneRecordGroupedData { builder.add_zoneRecordGroupedData(x); }
    if let Some(x) = args.mainlineAdditionInfo { builder.add_mainlineAdditionInfo(x); }
    if let Some(x) = args.zoneValidInfo { builder.add_zoneValidInfo(x); }
    if let Some(x) = args.weeklyAdditionInfo { builder.add_weeklyAdditionInfo(x); }
    if let Some(x) = args.zones { builder.add_zones(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_ZoneTableT {
    let zones = self.zones().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let weeklyAdditionInfo = self.weeklyAdditionInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let zoneValidInfo = self.zoneValidInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let mainlineAdditionInfo = self.mainlineAdditionInfo().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let zoneRecordGroupedData = self.zoneRecordGroupedData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let zoneRecordRewardData = self.zoneRecordRewardData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let mainlineZoneIdList = self.mainlineZoneIdList().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
    let zoneMetaData = self.zoneMetaData().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
  ...
  #[inline]
  pub fn zones(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneData>>>>(clz_Torappu_ZoneTable::VT_ZONES, None)}
  }
  #[inline]
  pub fn weeklyAdditionInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_WeeklyZoneData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_WeeklyZoneData>>>>(clz_Torappu_ZoneTable::VT_WEEKLYADDITIONINFO, None)}
  }
  #[inline]
  pub fn zoneValidInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneValidInfo<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneValidInfo>>>>(clz_Torappu_ZoneTable::VT_ZONEVALIDINFO, None)}
  }
  #[inline]
  pub fn mainlineAdditionInfo(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_MainlineZoneData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_MainlineZoneData>>>>(clz_Torappu_ZoneTable::VT_MAINLINEADDITIONINFO, None)}
  }
  #[inline]
  pub fn zoneRecordGroupedData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordGroupData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordGroupData>>>>(clz_Torappu_ZoneTable::VT_ZONERECORDGROUPEDDATA, None)}
  }
  #[inline]
  pub fn zoneRecordRewardData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_string<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_string>>>>(clz_Torappu_ZoneTable::VT_ZONERECORDREWARDDATA, None)}
  }
  #[inline]
  pub fn mainlineZoneIdList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_ZoneTable::VT_MAINLINEZONEIDLIST, None)}
  }
  #[inline]
  pub fn zoneMetaData(&self) -> Option<clz_Torappu_ZoneMetaData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneMetaData>>(clz_Torappu_ZoneTable::VT_ZONEMETADATA, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_ZoneTable<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneData>>>>("zones", Self::VT_ZONES, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_WeeklyZoneData>>>>("weeklyAdditionInfo", Self::VT_WEEKLYADDITIONINFO, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneValidInfo>>>>("zoneValidInfo", Self::VT_ZONEVALIDINFO, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_MainlineZoneData>>>>("mainlineAdditionInfo", Self::VT_MAINLINEADDITIONINFO, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordGroupData>>>>("zoneRecordGroupedData", Self::VT_ZONERECORDGROUPEDDATA, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__list_string>>>>("zoneRecordRewardData", Self::VT_ZONERECORDREWARDDATA, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("mainlineZoneIdList", Self::VT_MAINLINEZONEIDLIST, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneMetaData>>("zoneMetaData", Self::VT_ZONEMETADATA, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_ZoneTableArgs<'a> {
    pub zones: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneData<'a>>>>>,
    pub weeklyAdditionInfo: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_WeeklyZoneData<'a>>>>>,
    pub zoneValidInfo: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneValidInfo<'a>>>>>,
    pub mainlineAdditionInfo: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_MainlineZoneData<'a>>>>>,
    pub zoneRecordGroupedData: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordGroupData<'a>>>>>,
    pub zoneRecordRewardData: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__list_string<'a>>>>>,
    pub mainlineZoneIdList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneTableBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_zones(&mut self, zones: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneTable::VT_ZONES, zones);
  }
  #[inline]
  pub fn add_weeklyAdditionInfo(&mut self, weeklyAdditionInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_WeeklyZoneData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneTable::VT_WEEKLYADDITIONINFO, weeklyAdditionInfo);
  }
  #[inline]
  pub fn add_zoneValidInfo(&mut self, zoneValidInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneValidInfo<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneTable::VT_ZONEVALIDINFO, zoneValidInfo);
  }
  #[inline]
  pub fn add_mainlineAdditionInfo(&mut self, mainlineAdditionInfo: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_MainlineZoneData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneTable::VT_MAINLINEADDITIONINFO, mainlineAdditionInfo);
  }
  #[inline]
  pub fn add_zoneRecordGroupedData(&mut self, zoneRecordGroupedData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ZoneRecordGroupData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneTable::VT_ZONERECORDGROUPEDDATA, zoneRecordGroupedData);
  }
  #[inline]
  pub fn add_zoneRecordRewardData(&mut self, zoneRecordRewardData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__list_string<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneTable::VT_ZONERECORDREWARDDATA, zoneRecordRewardData);
  }
  #[inline]
  pub fn add_mainlineZoneIdList(&mut self, mainlineZoneIdList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ZoneTable::VT_MAINLINEZONEIDLIST, mainlineZoneIdList);
  }
  #[inline]
  pub fn add_zoneMetaData(&mut self, zoneMetaData: ::flatbuffers::WIPOffset<clz_Torappu_ZoneMetaData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ZoneMetaData>>(clz_Torappu_ZoneTable::VT_ZONEMETADATA, zoneMetaData);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ZoneTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ZoneTableT {
  pub zones: Option<alloc::vec::Vec<dict__string__clz_Torappu_ZoneDataT>>,
  pub weeklyAdditionInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_WeeklyZoneDataT>>,
  pub zoneValidInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_ZoneValidInfoT>>,
  pub mainlineAdditionInfo: Option<alloc::vec::Vec<dict__string__clz_Torappu_MainlineZoneDataT>>,
  pub zoneRecordGroupedData: Option<alloc::vec::Vec<dict__string__clz_Torappu_ZoneRecordGroupDataT>>,
  pub zoneRecordRewardData: Option<alloc::vec::Vec<dict__string__list_stringT>>,
  pub mainlineZoneIdList: Option<alloc::vec::Vec<alloc::string::String>>,
  pub zoneMetaData: Option<alloc::boxed::Box<clz_Torappu_ZoneMetaDataT>>,
}
...
impl clz_Torappu_ZoneTableT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let zoneMetaData = self.zoneMetaData.as_ref().map(|x|{
      x.pack(_fbb)
    });
    clz_Torappu_ZoneTable::create(_fbb, &clz_Torappu_ZoneTableArgs{
      zones,
      weeklyAdditionInfo,
      zoneValidInfo,
      mainlineAdditionInfo,
...
pub fn root_as_clz_torappu_zone_table(buf: &[u8]) -> Result<clz_Torappu_ZoneTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clz_torappu_zone_table(buf: &[u8]) -> Result<clz_Torappu_ZoneTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_clz_torappu_zone_table_unchecked(buf: &[u8]) -> clz_Torappu_ZoneTable<'_> {
...
#[inline]
pub fn finish_size_prefixed_clz_torappu_zone_table_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<clz_Torappu_ZoneTable<'a>>) {
