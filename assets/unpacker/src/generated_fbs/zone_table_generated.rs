...
impl<'a> clz_Torappu_ZoneData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ZoneDataT {
        ...
        let zoneNameFirst = self
            .zoneNameFirst()
            .map(|x| alloc::string::ToString::to_string(x));
        let zoneNameSecond = self
            .zoneNameSecond()
            .map(|x| alloc::string::ToString::to_string(x));
        ...
        let zoneNameTitleUnCurrent = self
            ...
            .map(|x| alloc::string::ToString::to_string(x));
        let zoneNameTitleEx = self
            .zoneNameTitleEx()
            .map(|x| alloc::string::ToString::to_string(x));
        let zoneNameThird = self
            .zoneNameThird()
            .map(|x| alloc::string::ToString::to_string(x));
        let lockedText = self
            .lockedText()
            .map(|x| alloc::string::ToString::to_string(x));
        let antiSpoilerId = self
            .antiSpoilerId()
            .map(|x| alloc::string::ToString::to_string(x));
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneDataBuilder<'a, 'b, A> {
    ...
    pub fn add_zoneID(&mut self, zoneID: ::flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_ZoneData::VT_ZONEID,
            zoneID,
        );
    }
    #[inline]
    ...
    #[inline]
    pub fn add_bindMainlineZoneId(
        &mut self,
        bindMainlineZoneId: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_ZoneData::VT_BINDMAINLINEZONEID,
            bindMainlineZoneId,
...
impl<'a> clz_Torappu_MainlineZoneData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_MainlineZoneDataT {
        ...
        let chapterId = self
            .chapterId()
            .map(|x| alloc::string::ToString::to_string(x));
        let preposedZoneId = self
            .preposedZoneId()
            .map(|x| alloc::string::ToString::to_string(x));
        let zoneIndex = self.zoneIndex();
        let startStageId = self
            .startStageId()
            .map(|x| alloc::string::ToString::to_string(x));
        let endStageId = self
            .endStageId()
            .map(|x| alloc::string::ToString::to_string(x));
        let gameMusicId = self
            .gameMusicId()
            .map(|x| alloc::string::ToString::to_string(x));
        let recapId = self
            .recapId()
            .map(|x| alloc::string::ToString::to_string(x));
        let recapPreStageId = self
            .recapPreStageId()
            .map(|x| alloc::string::ToString::to_string(x));
        let buttonName = self
            .buttonName()
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_MainlineZoneDataBuilder<'a, 'b, A> {
    ...
    pub fn add_diffGroup(
        &mut self,
        diffGroup: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'b, enum__Torappu_StageDiffGroup>,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
...
impl<'a> clz_Torappu_RecordRewardInfo<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_RecordRewardInfoT {
        ...
        let picRes = self.picRes().map(|x| alloc::string::ToString::to_string(x));
        let textPath = self
            .textPath()
            .map(|x| alloc::string::ToString::to_string(x));
        let textDesc = self
...
impl<'a> clz_Torappu_ZoneRecordData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ZoneRecordDataT {
        let recordId = self
            ...
            .map(|x| alloc::string::ToString::to_string(x));
        let zoneId = self.zoneId().map(|x| alloc::string::ToString::to_string(x));
        let recordTitleName = self
            .recordTitleName()
            .map(|x| alloc::string::ToString::to_string(x));
        let preRecordId = self
            .preRecordId()
            .map(|x| alloc::string::ToString::to_string(x));
        let nodeTitle1 = self
            .nodeTitle1()
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardInfo>,
                >,
...
pub struct clz_Torappu_ZoneRecordDataArgs<'a> {
    ...
    pub rewards: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardInfo<'a>>,
            >,
        >,
    >,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneRecordDataBuilder<'a, 'b, A> {
    ...
    pub fn add_rewards(
        ...
        rewards: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_RecordRewardInfo<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordData>,
                >,
...
pub struct clz_Torappu_ZoneRecordGroupDataArgs<'a> {
    ...
    pub records: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordData<'a>>,
            >,
        >,
    >,
    ...
    clz_Torappu_ZoneRecordGroupDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_records(
        ...
        records: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_ZoneRecordData<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
...
pub struct clz_Torappu_ZoneMetaDataT {
    pub ZoneRecordMissionData:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_ZoneRecordMissionDataT>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ZoneTableBuilder<'a, 'b, A> {
    ...
    pub fn add_zones(
        ...
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_ZoneTable::VT_ZONES,
            zones,
        );
    }
    #[inline]
...
pub struct clz_Torappu_ZoneTableT {
    ...
    pub zoneRecordGroupedData:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_ZoneRecordGroupDataT>>,
