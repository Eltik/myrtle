...
impl<'a> clz_Torappu_ShopRecommendData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ShopRecommendDataT {
        ...
        let cmd = self.cmd();
        let param1 = self.param1().map(|x| alloc::string::ToString::to_string(x));
        let param2 = self.param2().map(|x| alloc::string::ToString::to_string(x));
...
impl<'a> clz_Torappu_ShopKeeperWord<'a> {
    ...
    pub fn id(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                clz_Torappu_ShopKeeperWord::VT_ID,
                None,
            )
        }
    }
...
impl<'a> clz_Torappu_ShopRecommendTemplateNormalSkinParam<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ShopRecommendTemplateNormalSkinParamT {
        ...
        let skinGroupName = self
            .skinGroupName()
            .map(|x| alloc::string::ToString::to_string(x));
        let brandIconId = self
            .brandIconId()
            .map(|x| alloc::string::ToString::to_string(x));
        let colorBack = self
            .colorBack()
...
impl<'a> clz_Torappu_ShopRecommendTemplateParam<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ShopRecommendTemplateParamT {
        ...
        let normalSkinParam = self
            .normalSkinParam()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let normalFurnParam = self
            .normalFurnParam()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let returnSkinParam = self
            .returnSkinParam()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
    ...
    pub fn normalGiftParam(&self) -> Option<clz_Torappu_ShopRecommendTemplateNormalGiftParam<'a>> {
        ...
        unsafe {
            ...
            >>(
                clz_Torappu_ShopRecommendTemplateParam::VT_NORMALGIFTPARAM,
                None,
            )
        }
    }
    ...
    pub fn normalSkinParam(&self) -> Option<clz_Torappu_ShopRecommendTemplateNormalSkinParam<'a>> {
        ...
        unsafe {
            ...
            >>(
                clz_Torappu_ShopRecommendTemplateParam::VT_NORMALSKINPARAM,
                None,
            )
        }
    }
    ...
    pub fn normalFurnParam(&self) -> Option<clz_Torappu_ShopRecommendTemplateNormalFurnParam<'a>> {
        ...
        unsafe {
            ...
            >>(
                clz_Torappu_ShopRecommendTemplateParam::VT_NORMALFURNPARAM,
                None,
            )
        }
    }
    ...
    pub fn returnSkinParam(&self) -> Option<clz_Torappu_ShopRecommendTemplateReturnSkinParam<'a>> {
        ...
        unsafe {
            ...
            >>(
                clz_Torappu_ShopRecommendTemplateParam::VT_RETURNSKINPARAM,
                None,
            )
        }
    }
...
pub struct clz_Torappu_ShopRecommendTemplateParamBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
pub struct clz_Torappu_ShopRecommendTemplateParamT {
    pub normalGiftParam:
        Option<alloc::boxed::Box<clz_Torappu_ShopRecommendTemplateNormalGiftParamT>>,
    pub normalSkinParam:
        Option<alloc::boxed::Box<clz_Torappu_ShopRecommendTemplateNormalSkinParamT>>,
    pub normalFurnParam:
        Option<alloc::boxed::Box<clz_Torappu_ShopRecommendTemplateNormalFurnParamT>>,
    pub returnSkinParam:
        Option<alloc::boxed::Box<clz_Torappu_ShopRecommendTemplateReturnSkinParamT>>,
}
...
impl<'a> clz_Torappu_ShopRecommendItem<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ShopRecommendItemT {
        ...
        let groupList = self
            .groupList()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        let tagWord = self.tagWord().map(|x| alloc::boxed::Box::new(x.unpack()));
        let templateType = self.templateType();
        let templateParam = self
            .templateParam()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ShopRecommendItemBuilder<'a, 'b, A> {
    ...
    pub fn add_tagWord(
        &mut self,
        tagWord: ::flatbuffers::WIPOffset<clz_Torappu_ShopKeeperWord<'b>>,
    ) {
        self.fbb_
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_ShopKeeperWord>,
                >,
            >>(
...
pub struct clz_Torappu_ShopClientData_ShopKeeperDataArgs<'a> {
    pub welcomeWords: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_ShopKeeperWord<'a>>,
            >,
        >,
    >,
    ...
    clz_Torappu_ShopClientData_ShopKeeperDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_welcomeWords(
        ...
        welcomeWords: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_ShopKeeperWord<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
...
impl<'a> clz_Torappu_ShopClientGPData<'a> {
    pub const VT_GOODID: ::flatbuffers::VOffsetT = 4;
    pub const VT_GIFTPACKAGEID: ::flatbuffers::VOffsetT = 6;
    ...
    pub fn giftPackageId(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(
                clz_Torappu_ShopClientGPData::VT_GIFTPACKAGEID,
                None,
            )
        }
    }
...
impl<'a> clz_Torappu_ShopGPTabDisplayData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_ShopGPTabDisplayDataT {
        ...
        let tabPicId = self
            .tabPicId()
            .map(|x| alloc::string::ToString::to_string(x));
        let tabPicOnColor = self
            .tabPicOnColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let tabPicOffColor = self
            .tabPicOffColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let sortId = self.sortId();
        let tabStartTime = self.tabStartTime();
        let tabEndTime = self.tabEndTime();
        let markerPicId = self
            .markerPicId()
            .map(|x| alloc::string::ToString::to_string(x));
...
impl<'a> clz_Torappu_LMTGSShopSchedule<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_LMTGSShopScheduleT {
        ...
        let iconColor = self
            .iconColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let iconBackColor = self
            .iconBackColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let storeTextColor = self
            .storeTextColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let startTime = self.startTime();
        let endTime = self.endTime();
...
impl<'a> clz_Torappu_ShopClientData<'a> {
    ...
    pub const VT_CHOOSEOPTIONTOGOODDICT: ::flatbuffers::VOffsetT = 14;
    pub const VT_SHOPUNLOCKDICT: ::flatbuffers::VOffsetT = 16;
    pub const VT_EXTRAQCSHOPRULE: ::flatbuffers::VOffsetT = 18;
    pub const VT_REPQCSHOPRULE: ::flatbuffers::VOffsetT = 20;
    pub const VT_SHOPGPDATADICT: ::flatbuffers::VOffsetT = 22;
    pub const VT_TABDISPLAYDATA: ::flatbuffers::VOffsetT = 24;
    pub const VT_SHOPMONTHLYSUBGOODID: ::flatbuffers::VOffsetT = 26;
    pub const VT_LS: ::flatbuffers::VOffsetT = 28;
    ...
    >(
        ...
        if let Some(x) = args.chooseOptionToGoodDict {
            builder.add_chooseOptionToGoodDict(x);
        }
    ...
    pub fn unpack(&self) -> clz_Torappu_ShopClientDataT {
        ...
        let chooseShopRelations = self
            .chooseShopRelations()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        let chooseOptionToGoodDict = self
            .chooseOptionToGoodDict()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_ShopCarouselData>,
                >,
    ...
    ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__string<'a>>>>
    {
        ...
        unsafe {
            ...
            >>(clz_Torappu_ShopClientData::VT_CHOOSEOPTIONTOGOODDICT, None)
        }
    }
    #[inline]
    #[must_use]
...
impl ::flatbuffers::Verifiable for clz_Torappu_ShopClientData<'_> {
    ...
    fn run_verifier(
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__string>>>>("chooseOptionToGoodDict", Self::VT_CHOOSEOPTIONTOGOODDICT, false)?
...
pub struct clz_Torappu_ShopClientDataArgs<'a> {
    ...
    pub carousels: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_ShopCarouselData<'a>>,
            >,
        >,
    >,
    pub chooseShopRelations: Option<
        ...
        >,
    >,
    pub chooseOptionToGoodDict: Option<
        ::flatbuffers::WIPOffset<
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ShopClientDataBuilder<'a, 'b, A> {
    ...
    pub fn add_carousels(
        ...
        carousels: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_ShopCarouselData<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    #[inline]
    pub fn add_chooseOptionToGoodDict(
        &mut self,
        chooseOptionToGoodDict: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<dict__string__string<'b>>>,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_ShopClientData::VT_CHOOSEOPTIONTOGOODDICT,
            chooseOptionToGoodDict,
        );
    }
    #[inline]
...
impl ::core::fmt::Debug for clz_Torappu_ShopClientData<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ds.field("chooseOptionToGoodDict", &self.chooseOptionToGoodDict());
...
pub struct clz_Torappu_ShopClientDataT {
    ...
    pub creditUnlockGroup:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_ShopCreditUnlockGroupT>>,
    ...
    pub chooseOptionToGoodDict: Option<alloc::vec::Vec<dict__string__stringT>>,
...
impl clz_Torappu_ShopClientDataT {
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        let chooseOptionToGoodDict = self.chooseOptionToGoodDict.as_ref().map(|x| {
            let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();
            _fbb.create_vector(&w)
        });
