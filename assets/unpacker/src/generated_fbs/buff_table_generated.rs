...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_BUFF_DATA_STATUS_RESISTABLE: [enum__Torappu_BuffData_StatusResistable; 3] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_BuffData_StatusResistable {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_BuffData_StatusResistable variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_BUFF_DATA_OVERRIDE_TYPE: [enum__Torappu_BuffData_OverrideType; 5] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_BuffData_OverrideType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_BuffData_OverrideType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_BuffData_OnEventPriority {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_BuffData_OnEventPriority variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_LifeType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_LifeType variant: {s}"
        )))
    }
}
...
impl<'a> clz_Torappu_BuffData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.priorityBBKeys { builder.add_priorityBBKeys(x); }
    ...
    if let Some(x) = args.durationKey { builder.add_durationKey(x); }
    if let Some(x) = args.audioSignal { builder.add_audioSignal(x); }
    builder.add_onEventPriority(args.onEventPriority);
    if let Some(x) = args.overrideEffectKey { builder.add_overrideEffectKey(x); }
    ...
    if let Some(x) = args.overrideKey { builder.add_overrideKey(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_BuffDataT {
    ...
    let buffKey = self.buffKey().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    ...
    let templateKey = self.templateKey().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let disableOverride = self.disableOverride();
    let overrideKey = self.overrideKey().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    ...
    let priorityBBKeys = self.priorityBBKeys().map(|x| {
  ...
  pub fn attributes(&self) -> Option<clz_Torappu_AttributeModifierData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_AttributeModifierData>>(clz_Torappu_BuffData::VT_ATTRIBUTES, None)}
  }
  #[inline]
  pub fn buffKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_BuffData::VT_BUFFKEY, None)}
  }
  #[inline]
  pub fn loadFromDB(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_LOADFROMDB, Some(false)).unwrap()}
  }
  #[inline]
  pub fn isDurableBuff(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_ISDURABLEBUFF, Some(false)).unwrap()}
  }
  #[inline]
  pub fn isDamageMissable(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_ISDAMAGEMISSABLE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn isSilenceable(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_ISSILENCEABLE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn isStunnable(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_ISSTUNNABLE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn isFreezable(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_ISFREEZABLE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn isLevitatable(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_ISLEVITATABLE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn statusResistable(&self) -> enum__Torappu_BuffData_StatusResistable {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_BuffData_StatusResistable>(clz_Torappu_BuffData::VT_STATUSRESISTABLE, Some(enum__Torappu_BuffData_StatusResistable::NO)).unwrap()}
  }
  #[inline]
  pub fn templateKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_BuffData::VT_TEMPLATEKEY, None)}
  }
  #[inline]
  pub fn disableOverride(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_DISABLEOVERRIDE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn overrideKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_BuffData::VT_OVERRIDEKEY, None)}
  }
  #[inline]
  pub fn overrideType(&self) -> enum__Torappu_BuffData_OverrideType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_BuffData_OverrideType>(clz_Torappu_BuffData::VT_OVERRIDETYPE, Some(enum__Torappu_BuffData_OverrideType::DEFAULT)).unwrap()}
  }
  #[inline]
  pub fn maxStackCnt(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_BuffData::VT_MAXSTACKCNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn refreshRemainingTimeWhenStackMax(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_REFRESHREMAININGTIMEWHENSTACKMAX, Some(false)).unwrap()}
  }
  #[inline]
  pub fn clearAllStackCntWhenTimeUp(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_CLEARALLSTACKCNTWHENTIMEUP, Some(false)).unwrap()}
  }
  #[inline]
  pub fn maxValidStackCnt(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_BuffData::VT_MAXVALIDSTACKCNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn independentCharacterSource(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_INDEPENDENTCHARACTERSOURCE, Some(false)).unwrap()}
  }
  #[inline]
  pub fn overrideEffectKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_BuffData::VT_OVERRIDEEFFECTKEY, None)}
  }
  #[inline]
  pub fn overrideOnEventPriority(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_OVERRIDEONEVENTPRIORITY, Some(false)).unwrap()}
  }
  #[inline]
  pub fn onEventPriority(&self) -> enum__Torappu_BuffData_OnEventPriority {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_BuffData_OnEventPriority>(clz_Torappu_BuffData::VT_ONEVENTPRIORITY, Some(enum__Torappu_BuffData_OnEventPriority::DEFAULT)).unwrap()}
  }
  #[inline]
  pub fn audioSignal(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_BuffData::VT_AUDIOSIGNAL, None)}
  }
  #[inline]
  pub fn lifeTimeType(&self) -> enum__Torappu_LifeType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_LifeType>(clz_Torappu_BuffData::VT_LIFETIMETYPE, Some(enum__Torappu_LifeType::IMMEDIATELY)).unwrap()}
  }
  #[inline]
  pub fn takeSnapshotWhenExtend(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_TAKESNAPSHOTWHENEXTEND, Some(false)).unwrap()}
  }
  #[inline]
  pub fn durationKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_BuffData::VT_DURATIONKEY, None)}
  }
  #[inline]
  pub fn lifeTime(&self) -> f32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(clz_Torappu_BuffData::VT_LIFETIME, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn triggerLifeType(&self) -> enum__Torappu_LifeType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_LifeType>(clz_Torappu_BuffData::VT_TRIGGERLIFETYPE, Some(enum__Torappu_LifeType::IMMEDIATELY)).unwrap()}
  }
  #[inline]
  pub fn triggerCnt(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_BuffData::VT_TRIGGERCNT, Some(0)).unwrap()}
  }
  #[inline]
  pub fn triggerInterval(&self) -> f32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(clz_Torappu_BuffData::VT_TRIGGERINTERVAL, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn waitFirstTriggerInterval(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_WAITFIRSTTRIGGERINTERVAL, Some(false)).unwrap()}
  }
  #[inline]
  pub fn firstTriggerInterval(&self) -> f32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(clz_Torappu_BuffData::VT_FIRSTTRIGGERINTERVAL, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn priority(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_BuffData::VT_PRIORITY, Some(0)).unwrap()}
  }
  #[inline]
  pub fn priorityBBKeys(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_BuffData::VT_PRIORITYBBKEYS, None)}
  }
  #[inline]
  pub fn stripBlackboardParamsWithBuffKey(&self) -> bool {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<bool>(clz_Torappu_BuffData::VT_STRIPBLACKBOARDPARAMSWITHBUFFKEY, Some(false)).unwrap()}
  }
  #[inline]
...
impl ::flatbuffers::Verifiable for clz_Torappu_BuffData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<enum__Torappu_BuffData_StatusResistable>("statusResistable", Self::VT_STATUSRESISTABLE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("templateKey", Self::VT_TEMPLATEKEY, false)?
     .visit_field::<bool>("disableOverride", Self::VT_DISABLEOVERRIDE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("overrideKey", Self::VT_OVERRIDEKEY, false)?
     .visit_field::<enum__Torappu_BuffData_OverrideType>("overrideType", Self::VT_OVERRIDETYPE, false)?
     .visit_field::<i32>("maxStackCnt", Self::VT_MAXSTACKCNT, false)?
     .visit_field::<bool>("refreshRemainingTimeWhenStackMax", Self::VT_REFRESHREMAININGTIMEWHENSTACKMAX, false)?
     .visit_field::<bool>("clearAllStackCntWhenTimeUp", Self::VT_CLEARALLSTACKCNTWHENTIMEUP, false)?
     .visit_field::<i32>("maxValidStackCnt", Self::VT_MAXVALIDSTACKCNT, false)?
     .visit_field::<bool>("independentCharacterSource", Self::VT_INDEPENDENTCHARACTERSOURCE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("overrideEffectKey", Self::VT_OVERRIDEEFFECTKEY, false)?
     .visit_field::<bool>("overrideOnEventPriority", Self::VT_OVERRIDEONEVENTPRIORITY, false)?
     .visit_field::<enum__Torappu_BuffData_OnEventPriority>("onEventPriority", Self::VT_ONEVENTPRIORITY, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("audioSignal", Self::VT_AUDIOSIGNAL, false)?
     .visit_field::<enum__Torappu_LifeType>("lifeTimeType", Self::VT_LIFETIMETYPE, false)?
     .visit_field::<bool>("takeSnapshotWhenExtend", Self::VT_TAKESNAPSHOTWHENEXTEND, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("durationKey", Self::VT_DURATIONKEY, false)?
     .visit_field::<f32>("lifeTime", Self::VT_LIFETIME, false)?
     .visit_field::<enum__Torappu_LifeType>("triggerLifeType", Self::VT_TRIGGERLIFETYPE, false)?
     .visit_field::<i32>("triggerCnt", Self::VT_TRIGGERCNT, false)?
     .visit_field::<f32>("triggerInterval", Self::VT_TRIGGERINTERVAL, false)?
     .visit_field::<bool>("waitFirstTriggerInterval", Self::VT_WAITFIRSTTRIGGERINTERVAL, false)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_BuffDataBuilder<'a, 'b, A> {
  ...
  pub fn add_attributes(&mut self, attributes: ::flatbuffers::WIPOffset<clz_Torappu_AttributeModifierData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_AttributeModifierData>>(clz_Torappu_BuffData::VT_ATTRIBUTES, attributes);
  }
  #[inline]
  pub fn add_buffKey(&mut self, buffKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_BuffData::VT_BUFFKEY, buffKey);
  }
  #[inline]
  pub fn add_loadFromDB(&mut self, loadFromDB: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_LOADFROMDB, loadFromDB, false);
  }
  #[inline]
  pub fn add_isDurableBuff(&mut self, isDurableBuff: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_ISDURABLEBUFF, isDurableBuff, false);
  }
  #[inline]
  pub fn add_isDamageMissable(&mut self, isDamageMissable: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_ISDAMAGEMISSABLE, isDamageMissable, false);
  }
  #[inline]
  pub fn add_isSilenceable(&mut self, isSilenceable: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_ISSILENCEABLE, isSilenceable, false);
  }
  #[inline]
  pub fn add_isStunnable(&mut self, isStunnable: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_ISSTUNNABLE, isStunnable, false);
  }
  #[inline]
  pub fn add_isFreezable(&mut self, isFreezable: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_ISFREEZABLE, isFreezable, false);
  }
  #[inline]
  pub fn add_isLevitatable(&mut self, isLevitatable: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_ISLEVITATABLE, isLevitatable, false);
  }
  #[inline]
  pub fn add_statusResistable(&mut self, statusResistable: enum__Torappu_BuffData_StatusResistable) {
    self.fbb_.push_slot::<enum__Torappu_BuffData_StatusResistable>(clz_Torappu_BuffData::VT_STATUSRESISTABLE, statusResistable, enum__Torappu_BuffData_StatusResistable::NO);
  }
  #[inline]
  pub fn add_templateKey(&mut self, templateKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_BuffData::VT_TEMPLATEKEY, templateKey);
  }
  #[inline]
  pub fn add_disableOverride(&mut self, disableOverride: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_DISABLEOVERRIDE, disableOverride, false);
  }
  #[inline]
  pub fn add_overrideKey(&mut self, overrideKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_BuffData::VT_OVERRIDEKEY, overrideKey);
  }
  #[inline]
  pub fn add_overrideType(&mut self, overrideType: enum__Torappu_BuffData_OverrideType) {
    self.fbb_.push_slot::<enum__Torappu_BuffData_OverrideType>(clz_Torappu_BuffData::VT_OVERRIDETYPE, overrideType, enum__Torappu_BuffData_OverrideType::DEFAULT);
  }
  #[inline]
  pub fn add_maxStackCnt(&mut self, maxStackCnt: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_BuffData::VT_MAXSTACKCNT, maxStackCnt, 0);
  }
  #[inline]
  pub fn add_refreshRemainingTimeWhenStackMax(&mut self, refreshRemainingTimeWhenStackMax: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_REFRESHREMAININGTIMEWHENSTACKMAX, refreshRemainingTimeWhenStackMax, false);
  }
  #[inline]
  pub fn add_clearAllStackCntWhenTimeUp(&mut self, clearAllStackCntWhenTimeUp: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_CLEARALLSTACKCNTWHENTIMEUP, clearAllStackCntWhenTimeUp, false);
  }
  #[inline]
  pub fn add_maxValidStackCnt(&mut self, maxValidStackCnt: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_BuffData::VT_MAXVALIDSTACKCNT, maxValidStackCnt, 0);
  }
  #[inline]
  pub fn add_independentCharacterSource(&mut self, independentCharacterSource: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_INDEPENDENTCHARACTERSOURCE, independentCharacterSource, false);
  }
  #[inline]
  pub fn add_overrideEffectKey(&mut self, overrideEffectKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_BuffData::VT_OVERRIDEEFFECTKEY, overrideEffectKey);
  }
  #[inline]
  pub fn add_overrideOnEventPriority(&mut self, overrideOnEventPriority: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_OVERRIDEONEVENTPRIORITY, overrideOnEventPriority, false);
  }
  #[inline]
  pub fn add_onEventPriority(&mut self, onEventPriority: enum__Torappu_BuffData_OnEventPriority) {
    self.fbb_.push_slot::<enum__Torappu_BuffData_OnEventPriority>(clz_Torappu_BuffData::VT_ONEVENTPRIORITY, onEventPriority, enum__Torappu_BuffData_OnEventPriority::DEFAULT);
  }
  #[inline]
  pub fn add_audioSignal(&mut self, audioSignal: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_BuffData::VT_AUDIOSIGNAL, audioSignal);
  }
  #[inline]
  pub fn add_lifeTimeType(&mut self, lifeTimeType: enum__Torappu_LifeType) {
    self.fbb_.push_slot::<enum__Torappu_LifeType>(clz_Torappu_BuffData::VT_LIFETIMETYPE, lifeTimeType, enum__Torappu_LifeType::IMMEDIATELY);
  }
  #[inline]
  pub fn add_takeSnapshotWhenExtend(&mut self, takeSnapshotWhenExtend: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_TAKESNAPSHOTWHENEXTEND, takeSnapshotWhenExtend, false);
  }
  #[inline]
  pub fn add_durationKey(&mut self, durationKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_BuffData::VT_DURATIONKEY, durationKey);
  }
  #[inline]
  pub fn add_lifeTime(&mut self, lifeTime: f32) {
    self.fbb_.push_slot::<f32>(clz_Torappu_BuffData::VT_LIFETIME, lifeTime, 0.0);
  }
  #[inline]
  pub fn add_triggerLifeType(&mut self, triggerLifeType: enum__Torappu_LifeType) {
    self.fbb_.push_slot::<enum__Torappu_LifeType>(clz_Torappu_BuffData::VT_TRIGGERLIFETYPE, triggerLifeType, enum__Torappu_LifeType::IMMEDIATELY);
  }
  #[inline]
  pub fn add_triggerCnt(&mut self, triggerCnt: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_BuffData::VT_TRIGGERCNT, triggerCnt, 0);
  }
  #[inline]
  pub fn add_triggerInterval(&mut self, triggerInterval: f32) {
    self.fbb_.push_slot::<f32>(clz_Torappu_BuffData::VT_TRIGGERINTERVAL, triggerInterval, 0.0);
  }
  #[inline]
  pub fn add_waitFirstTriggerInterval(&mut self, waitFirstTriggerInterval: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_WAITFIRSTTRIGGERINTERVAL, waitFirstTriggerInterval, false);
  }
  #[inline]
  pub fn add_firstTriggerInterval(&mut self, firstTriggerInterval: f32) {
    self.fbb_.push_slot::<f32>(clz_Torappu_BuffData::VT_FIRSTTRIGGERINTERVAL, firstTriggerInterval, 0.0);
  }
  #[inline]
  pub fn add_priority(&mut self, priority: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_BuffData::VT_PRIORITY, priority, 0);
  }
  #[inline]
  pub fn add_priorityBBKeys(&mut self, priorityBBKeys: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_BuffData::VT_PRIORITYBBKEYS, priorityBBKeys);
  }
  #[inline]
  pub fn add_stripBlackboardParamsWithBuffKey(&mut self, stripBlackboardParamsWithBuffKey: bool) {
    self.fbb_.push_slot::<bool>(clz_Torappu_BuffData::VT_STRIPBLACKBOARDPARAMSWITHBUFFKEY, stripBlackboardParamsWithBuffKey, false);
  }
  #[inline]
...
impl ::core::fmt::Debug for clz_Torappu_BuffData<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("clz_Torappu_BuffData");
      ...
      ds.field("refreshRemainingTimeWhenStackMax", &self.refreshRemainingTimeWhenStackMax());
      ds.field("clearAllStackCntWhenTimeUp", &self.clearAllStackCntWhenTimeUp());
      ds.field("maxValidStackCnt", &self.maxValidStackCnt());
      ds.field("independentCharacterSource", &self.independentCharacterSource());
...
pub struct clz_Torappu_BuffDataT {
  ...
  pub buffKey: Option<alloc::string::String>,
  pub loadFromDB: bool,
  pub isDurableBuff: bool,
  pub isDamageMissable: bool,
  pub isSilenceable: bool,
  ...
  pub disableOverride: bool,
  pub overrideKey: Option<alloc::string::String>,
  pub overrideType: enum__Torappu_BuffData_OverrideType,
  pub maxStackCnt: i32,
  pub refreshRemainingTimeWhenStackMax: bool,
  pub clearAllStackCntWhenTimeUp: bool,
  pub maxValidStackCnt: i32,
  pub independentCharacterSource: bool,
  pub overrideEffectKey: Option<alloc::string::String>,
  pub overrideOnEventPriority: bool,
  pub onEventPriority: enum__Torappu_BuffData_OnEventPriority,
  pub audioSignal: Option<alloc::string::String>,
  pub lifeTimeType: enum__Torappu_LifeType,
  pub takeSnapshotWhenExtend: bool,
...
impl clz_Torappu_BuffDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let buffKey = self.buffKey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let loadFromDB = self.loadFromDB;
    let isDurableBuff = self.isDurableBuff;
    ...
    let isLevitatable = self.isLevitatable;
    let statusResistable = self.statusResistable;
    let templateKey = self.templateKey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let disableOverride = self.disableOverride;
    let overrideKey = self.overrideKey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let overrideType = self.overrideType;
    let maxStackCnt = self.maxStackCnt;
    ...
    let maxValidStackCnt = self.maxValidStackCnt;
    let independentCharacterSource = self.independentCharacterSource;
    let overrideEffectKey = self.overrideEffectKey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let overrideOnEventPriority = self.overrideOnEventPriority;
    let onEventPriority = self.onEventPriority;
    let audioSignal = self.audioSignal.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let lifeTimeType = self.lifeTimeType;
    let takeSnapshotWhenExtend = self.takeSnapshotWhenExtend;
    let durationKey = self.durationKey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let lifeTime = self.lifeTime;
    let triggerLifeType = self.triggerLifeType;
...
impl<'a> dict__string__clz_Torappu_BuffData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_BuffDataT {
    ...
    dict__string__clz_Torappu_BuffDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_BuffData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_BuffData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_BuffData>>(dict__string__clz_Torappu_BuffData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_BuffData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_BuffData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_BuffDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_BuffData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_BuffData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_BuffData>>(dict__string__clz_Torappu_BuffData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_BuffDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_BuffData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_BuffData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_BuffDataT {
  ...
  pub value: Option<alloc::boxed::Box<clz_Torappu_BuffDataT>>,
}
...
impl dict__string__clz_Torappu_BuffDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_BuffData::create(_fbb, &dict__string__clz_Torappu_BuffDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataT {
    ...
    clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataT {
      buffs,
    }
  }

  #[inline]
  pub fn buffs(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_BuffData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_BuffData>>>>(clz_Torappu_SimpleKVTable_clz_Torappu_BuffData::VT_BUFFS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_BuffData>>>>("buffs", Self::VT_BUFFS, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataArgs<'a> {
    pub buffs: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_BuffData<'a>>>>>,
}
impl<'a> Default for clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataArgs<'a> {
  #[inline]
  fn default() -> Self {
    clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataArgs {
      buffs: None,
    }
  }
}
...
pub struct clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_buffs(&mut self, buffs: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_BuffData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_SimpleKVTable_clz_Torappu_BuffData::VT_BUFFS, buffs);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataT {
  pub buffs: Option<alloc::vec::Vec<dict__string__clz_Torappu_BuffDataT>>,
}
...
impl clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_SimpleKVTable_clz_Torappu_BuffData::create(_fbb, &clz_Torappu_SimpleKVTable_clz_Torappu_BuffDataArgs{
      buffs,
    })
  }
}
...
pub fn root_as_clz_torappu_simple_kvtable_clz_torappu_buff_data(buf: &[u8]) -> Result<clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clz_torappu_simple_kvtable_clz_torappu_buff_data(buf: &[u8]) -> Result<clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clz_torappu_simple_kvtable_clz_torappu_buff_data_with_opts<'b, 'o>(
  ...
  ::flatbuffers::size_prefixed_root_with_opts::<clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'b>>(opts, buf)
}
#[inline]
...
pub unsafe fn root_as_clz_torappu_simple_kvtable_clz_torappu_buff_data_unchecked(buf: &[u8]) -> clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'_> {
...
pub unsafe fn size_prefixed_root_as_clz_torappu_simple_kvtable_clz_torappu_buff_data_unchecked(buf: &[u8]) -> clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<clz_Torappu_SimpleKVTable_clz_Torappu_BuffData>(buf) }
}
#[inline]
pub fn finish_clz_torappu_simple_kvtable_clz_torappu_buff_data_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(
...
#[inline]
pub fn finish_size_prefixed_clz_torappu_simple_kvtable_clz_torappu_buff_data_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<clz_Torappu_SimpleKVTable_clz_Torappu_BuffData<'a>>) {
