...
pub struct dict__string__clz_Torappu_ChapterDataBuilder<
    'a: 'b,
    'b,
...
{
    ::flatbuffers::root_with_opts::<clz_Torappu_SimpleKVTable_clz_Torappu_ChapterData<'b>>(
        opts, buf,
    )
}
#[inline]
...
) -> Result<clz_Torappu_SimpleKVTable_clz_Torappu_ChapterData<'b>, ::flatbuffers::InvalidFlatbuffer>
{
    ::flatbuffers::size_prefixed_root_with_opts::<
        clz_Torappu_SimpleKVTable_clz_Torappu_ChapterData<'b>,
    >(opts, buf)
}
#[inline]
