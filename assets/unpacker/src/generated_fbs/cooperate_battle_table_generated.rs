...
impl Default for clz_Torappu_Battle_Cooperate_CooperateEndTileInfoArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__enum__Torappu_Battle_Cooperate_EndTileType__clz_Torappu_Battle_Cooperate_CooperateEndTileInfoArgs<'_> {
  #[inline]
  fn default() -> Self {
...
impl<'a> ::flatbuffers::Follow<'a>
    for dict__enum__Torappu_Battle_Cooperate_LASTROUNDRESULT__int<'a>
{
    type Inner = Self;
    #[inline]
    unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
    ...
    pub value: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<
                    clz_Torappu_Battle_Cooperate_CooperateWaveWeight<'a>,
                >,
            >,
        >,
    >,
}
impl Default for dict__int__list_clz_Torappu_Battle_Cooperate_CooperateWaveWeightArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    pub fn add_value(
        ...
        value: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<
                    clz_Torappu_Battle_Cooperate_CooperateWaveWeight<'b>,
                >,
            >,
        >,
    ) {
...
impl<'a> clz_Torappu_Battle_Cooperate_CooperateTeamWeight<'a> {
    ...
    pub const VT_WEIGHT: ::flatbuffers::VOffsetT = 6;
    pub const VT_TEAMTYPE: ::flatbuffers::VOffsetT = 8;
    ...
    >(
        ...
        builder.add_teamType(args.teamType);
        builder.add_weight(args.weight);
    ...
    pub fn teamType(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(
                    clz_Torappu_Battle_Cooperate_CooperateTeamWeight::VT_TEAMTYPE,
                    Some(0),
                )
                .unwrap()
        }
...
impl ::flatbuffers::Verifiable for clz_Torappu_Battle_Cooperate_CooperateTeamWeight<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<i32>("weight", Self::VT_WEIGHT, false)?
            .visit_field::<i32>("teamType", Self::VT_TEAMTYPE, false)?
            .finish();
        Ok(())
    }
}
...
impl Default for clz_Torappu_Battle_Cooperate_CooperateTeamWeightArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    clz_Torappu_Battle_Cooperate_CooperateTeamWeightBuilder<'a, 'b, A>
{
    ...
    #[inline]
    pub fn add_teamType(&mut self, teamType: i32) {
        self.fbb_.push_slot::<i32>(
            clz_Torappu_Battle_Cooperate_CooperateTeamWeight::VT_TEAMTYPE,
            teamType,
            0,
...
impl ::core::fmt::Debug for clz_Torappu_Battle_Cooperate_CooperateTeamWeight<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ds.field("weight", &self.weight());
        ds.field("teamType", &self.teamType());
        ds.finish()
    }
}
#[non_exhaustive]
...
impl Default for clz_Torappu_Battle_Cooperate_CooperateTeamPlayerArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> dict__string__clz_Torappu_Battle_Cooperate_CooperateTeamPlayer<'a> {
    ...
    >(
        ...
        dict__string__clz_Torappu_Battle_Cooperate_CooperateTeamPlayer<'bldr>,
    > {
        let mut builder =
    ...
    pub fn value(&self) -> Option<clz_Torappu_Battle_Cooperate_CooperateTeamPlayer<'a>> {
        ...
        unsafe {
            ...
            >>(
                dict__string__clz_Torappu_Battle_Cooperate_CooperateTeamPlayer::VT_VALUE,
                None,
            )
        }
    }
...
pub struct dict__string__clz_Torappu_Battle_Cooperate_CooperateTeamPlayerArgs<'a> {
    ...
    pub value:
        Option<::flatbuffers::WIPOffset<clz_Torappu_Battle_Cooperate_CooperateTeamPlayer<'a>>>,
}
impl Default for dict__string__clz_Torappu_Battle_Cooperate_CooperateTeamPlayerArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub enum clz_Torappu_Battle_Cooperate_FootballStadiumWeightOffset {}
#[derive(Copy, Clone, PartialEq, Eq)]

pub struct clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'a> {
    pub _tab: ::flatbuffers::Table<'a>,
}

impl<'a> ::flatbuffers::Follow<'a> for clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'a> {
    type Inner = Self;
    #[inline]
    unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
        Self {
...
impl<'a> clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'a> {
    pub const VT_STADIUMTYPE: ::flatbuffers::VOffsetT = 4;
    pub const VT_WEIGHT: ::flatbuffers::VOffsetT = 6;

    #[inline]
    #[must_use]
    pub const unsafe fn init_from_table(table: ::flatbuffers::Table<'a>) -> Self {
        clz_Torappu_Battle_Cooperate_FootballStadiumWeight { _tab: table }
    }
    #[allow(unused_mut)]
    pub fn create<
        'bldr: 'args,
    ...
    >(
        _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
        args: &'args clz_Torappu_Battle_Cooperate_FootballStadiumWeightArgs,
    ) -> ::flatbuffers::WIPOffset<clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'bldr>> {
        let mut builder = clz_Torappu_Battle_Cooperate_FootballStadiumWeightBuilder::new(_fbb);
        builder.add_weight(args.weight);
        builder.add_stadiumType(args.stadiumType);
        builder.finish()
    }

    #[must_use]
    pub fn unpack(&self) -> clz_Torappu_Battle_Cooperate_FootballStadiumWeightT {
        let stadiumType = self.stadiumType();
        let weight = self.weight();
        clz_Torappu_Battle_Cooperate_FootballStadiumWeightT {
            stadiumType,
            weight,
        }
    }
    ...
    pub fn stadiumType(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(
                    clz_Torappu_Battle_Cooperate_FootballStadiumWeight::VT_STADIUMTYPE,
                    Some(0),
                )
                .unwrap()
        }
    ...
    pub fn weight(&self) -> i32 {
        ...
        unsafe {
            self._tab
                .get::<i32>(
                    clz_Torappu_Battle_Cooperate_FootballStadiumWeight::VT_WEIGHT,
                    Some(0),
                )
                .unwrap()
        }
...
impl ::flatbuffers::Verifiable for clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'_> {
    #[inline]
    fn run_verifier(
        v: &mut ::flatbuffers::Verifier,
        pos: usize,
        ...
        v.visit_table(pos)?
            .visit_field::<i32>("stadiumType", Self::VT_STADIUMTYPE, false)?
            .visit_field::<i32>("weight", Self::VT_WEIGHT, false)?
            .finish();
        Ok(())
    }
}
pub struct clz_Torappu_Battle_Cooperate_FootballStadiumWeightArgs {
    pub stadiumType: i32,
    pub weight: i32,
}
impl<'a> Default for clz_Torappu_Battle_Cooperate_FootballStadiumWeightArgs {
    #[inline]
    fn default() -> Self {
        Self {
            stadiumType: 0,
...
pub struct clz_Torappu_Battle_Cooperate_FootballStadiumWeightBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a>
    clz_Torappu_Battle_Cooperate_FootballStadiumWeightBuilder<'a, 'b, A>
{
    #[inline]
    pub fn add_stadiumType(&mut self, stadiumType: i32) {
        self.fbb_.push_slot::<i32>(
            clz_Torappu_Battle_Cooperate_FootballStadiumWeight::VT_STADIUMTYPE,
            stadiumType,
            0,
    ...
    pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> Self {
        let start = _fbb.start_table();
        clz_Torappu_Battle_Cooperate_FootballStadiumWeightBuilder {
            fbb_: _fbb,
            start_: start,
        }
    }
    ...
    pub fn finish(
        self,
    ) -> ::flatbuffers::WIPOffset<clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'a>> {
        let o = self.fbb_.end_table(self.start_);
        ::flatbuffers::WIPOffset::new(o.value())
    }
}

impl ::core::fmt::Debug for clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        let mut ds = f.debug_struct("clz_Torappu_Battle_Cooperate_FootballStadiumWeight");
        ds.field("stadiumType", &self.stadiumType());
        ds.field("weight", &self.weight());
        ds.finish()
    }
}
#[non_exhaustive]
#[derive(Debug, Clone, PartialEq)]
pub struct clz_Torappu_Battle_Cooperate_FootballStadiumWeightT {
    pub stadiumType: i32,
    pub weight: i32,
}
impl Default for clz_Torappu_Battle_Cooperate_FootballStadiumWeightT {
    fn default() -> Self {
        Self {
            stadiumType: 0,
            weight: 0,
...
impl clz_Torappu_Battle_Cooperate_FootballStadiumWeightT {
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        &self,
        _fbb: &mut ::flatbuffers::FlatBufferBuilder<'b, A>,
    ) -> ::flatbuffers::WIPOffset<clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'b>> {
        let stadiumType = self.stadiumType;
        let weight = self.weight;
        clz_Torappu_Battle_Cooperate_FootballStadiumWeight::create(
            _fbb,
            &clz_Torappu_Battle_Cooperate_FootballStadiumWeightArgs {
                stadiumType,
                weight,
            },
        )
...
impl<'a> clz_Torappu_Battle_Cooperate_CooperateModeBattleData<'a> {
    ...
    pub const VT_FOOTBALLPLAYERSWAITTIMEONWAVESTART: ::flatbuffers::VOffsetT = 24;
    pub const VT_FOOTBALLSTADIUMWEIGHTS: ::flatbuffers::VOffsetT = 26;
    ...
    >(
        ...
        if let Some(x) = args.footballStadiumWeights {
            builder.add_footballStadiumWeights(x);
        }
        builder.add_footballPlayersWaitTimeOnWaveStart(args.footballPlayersWaitTimeOnWaveStart);
    ...
    pub fn unpack(&self) -> clz_Torappu_Battle_Cooperate_CooperateModeBattleDataT {
        ...
        let footballPlayersName = self
            .footballPlayersName()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        let footballPlayersWaitTimeOnWaveStart = self.footballPlayersWaitTimeOnWaveStart();
        let footballStadiumWeights = self
        ...
        clz_Torappu_Battle_Cooperate_CooperateModeBattleDataT {
            ...
            footballTeamPlayers,
            footballPlayersName,
            footballPlayersWaitTimeOnWaveStart,
            footballStadiumWeights,
        }
    }
    ...
    #[inline]
    #[must_use]
    pub fn footballPlayersWaitTimeOnWaveStart(&self) -> i32 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<i32>(clz_Torappu_Battle_Cooperate_CooperateModeBattleData::VT_FOOTBALLPLAYERSWAITTIMEONWAVESTART, Some(0)).unwrap()
        }
    }
    #[inline]
    #[must_use]
    pub fn footballStadiumWeights(
        &self,
    ) -> Option<
        ::flatbuffers::Vector<
            'a,
            ::flatbuffers::ForwardsUOffset<clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'a>>,
        >,
    > {
        // Safety:
        // Created from valid Table for this object
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                clz_Torappu_Battle_Cooperate_CooperateModeBattleData::VT_FOOTBALLSTADIUMWEIGHTS,
                None,
            )
        }
    }
...
impl ::flatbuffers::Verifiable for clz_Torappu_Battle_Cooperate_CooperateModeBattleData<'_> {
    ...
    fn run_verifier(
     ...
     .visit_field::<i32>("footballPlayersWaitTimeOnWaveStart", Self::VT_FOOTBALLPLAYERSWAITTIMEONWAVESTART, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_Battle_Cooperate_FootballStadiumWeight>>>>("footballStadiumWeights", Self::VT_FOOTBALLSTADIUMWEIGHTS, false)?
     .finish();
        Ok(())
    }
}
pub struct clz_Torappu_Battle_Cooperate_CooperateModeBattleDataArgs<'a> {
    ...
    pub footballPlayersWaitTimeOnWaveStart: i32,
    pub footballStadiumWeights: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'a>>>>>,
}
impl Default for clz_Torappu_Battle_Cooperate_CooperateModeBattleDataArgs<'_> {
    #[inline]
    fn default() -> Self {
        clz_Torappu_Battle_Cooperate_CooperateModeBattleDataArgs {
            ...
            footballPlayersWaitTimeOnWaveStart: 0,
            footballStadiumWeights: None,
        }
    }
}
    ...
    clz_Torappu_Battle_Cooperate_CooperateModeBattleDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_footballTeamWeights(
        ...
        footballTeamWeights: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<
                    clz_Torappu_Battle_Cooperate_CooperateTeamWeight<'b>,
                >,
            >,
        >,
    ) {
    ...
    #[inline]
    pub fn add_footballPlayersWaitTimeOnWaveStart(
        &mut self,
        footballPlayersWaitTimeOnWaveStart: i32,
    ) {
        self.fbb_.push_slot::<i32>(clz_Torappu_Battle_Cooperate_CooperateModeBattleData::VT_FOOTBALLPLAYERSWAITTIMEONWAVESTART, footballPlayersWaitTimeOnWaveStart, 0);
    }
    #[inline]
    pub fn add_footballStadiumWeights(
        &mut self,
        footballStadiumWeights: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<
                    clz_Torappu_Battle_Cooperate_FootballStadiumWeight<'b>,
                >,
            >,
        >,
    ) {
...
impl ::core::fmt::Debug for clz_Torappu_Battle_Cooperate_CooperateModeBattleData<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ds.field(
            "footballPlayersWaitTimeOnWaveStart",
            &self.footballPlayersWaitTimeOnWaveStart(),
        );
        ds.field("footballStadiumWeights", &self.footballStadiumWeights());
        ds.finish()
    }
}
#[non_exhaustive]
...
pub struct clz_Torappu_Battle_Cooperate_CooperateModeBattleDataT {
  ...
  pub footballPlayersWaitTimeOnWaveStart: i32,
  pub footballStadiumWeights: Option<alloc::vec::Vec<clz_Torappu_Battle_Cooperate_FootballStadiumWeightT>>,
}
...
impl clz_Torappu_Battle_Cooperate_CooperateModeBattleDataT {
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        let footballPlayersWaitTimeOnWaveStart = self.footballPlayersWaitTimeOnWaveStart;
        let footballStadiumWeights = self.footballStadiumWeights.as_ref().map(|x| {
            let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();
            _fbb.create_vector(&w)
        });
