...
pub struct dict__int__list_clz_Torappu_ItemBundleBuilder<
    'a: 'b,
    'b,
...
impl<'a> clz_Torappu_UniEquipData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_UniEquipDataT {
        ...
        let uniEquipName = self
            .uniEquipName()
            .map(|x| alloc::string::ToString::to_string(x));
        let uniEquipIcon = self
            .uniEquipIcon()
            .map(|x| alloc::string::ToString::to_string(x));
        let uniEquipDesc = self
            .uniEquipDesc()
            .map(|x| alloc::string::ToString::to_string(x));
        let typeIcon = self
            .typeIcon()
        ...
        let tmplId = self.tmplId().map(|x| alloc::string::ToString::to_string(x));
...
pub struct dict__string__clz_Torappu_UniEquipDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
    ...
    dict__string__clz_Torappu_SubProfessionDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_value(
        &mut self,
        value: ::flatbuffers::WIPOffset<clz_Torappu_SubProfessionData<'b>>,
    ) {
        self.fbb_
...
impl<'a> dict__string__list_string<'a> {
    ...
    pub fn key(&self) -> &'a str {
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<&str>>(
                    dict__string__list_string::VT_KEY,
                    None,
                )
                .unwrap()
        }
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTrack>,
                >,
...
pub struct clz_Torappu_UniEquipTimeInfoArgs<'a> {
    ...
    pub trackList: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTrack<'a>>,
            >,
        >,
    >,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_UniEquipTimeInfoBuilder<'a, 'b, A> {
    ...
    pub fn add_trackList(
        ...
        trackList: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTrack<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<dict__string__list_string>,
                >,
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTypeInfo>,
                >,
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTimeInfo>,
                >,
...
pub struct clz_Torappu_UniEquipTableArgs<'a> {
    ...
    pub charEquip: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<dict__string__list_string<'a>>,
            >,
        >,
    >,
    pub equipTypeInfos: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTypeInfo<'a>>,
            >,
        >,
    >,
    pub equipTrackDict: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTimeInfo<'a>>,
            >,
        >,
    >,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_UniEquipTableBuilder<'a, 'b, A> {
    ...
    pub fn add_charEquip(
        ...
        charEquip: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<dict__string__list_string<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    pub fn add_equipTypeInfos(
        ...
        equipTypeInfos: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTypeInfo<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    pub fn add_equipTrackDict(
        ...
        equipTrackDict: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_UniEquipTimeInfo<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
