...
impl<'a> clz_Torappu_WorldViewTip<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    builder.add_weight(args.weight);
    if let Some(x) = args.backgroundPicId { builder.add_backgroundPicId(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_WorldViewTipT {
    ...
    let backgroundPicId = self.backgroundPicId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let weight = self.weight();
  ...
  pub fn title(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_WorldViewTip::VT_TITLE, None)}
  }
  #[inline]
  pub fn description(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_WorldViewTip::VT_DESCRIPTION, None)}
  }
  #[inline]
  pub fn backgroundPicId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_WorldViewTip::VT_BACKGROUNDPICID, None)}
  }
  #[inline]
  pub fn weight(&self) -> f32 {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(clz_Torappu_WorldViewTip::VT_WEIGHT, Some(0.0)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_WorldViewTip<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("backgroundPicId", Self::VT_BACKGROUNDPICID, false)?
     .visit_field::<f32>("weight", Self::VT_WEIGHT, false)?
     .finish();
    Ok(())
  }
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_WorldViewTipBuilder<'a, 'b, A> {
  ...
  pub fn add_title(&mut self, title: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_WorldViewTip::VT_TITLE, title);
  }
  #[inline]
  pub fn add_description(&mut self, description: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_WorldViewTip::VT_DESCRIPTION, description);
  }
  #[inline]
  pub fn add_backgroundPicId(&mut self, backgroundPicId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_WorldViewTip::VT_BACKGROUNDPICID, backgroundPicId);
  }
  #[inline]
  pub fn add_weight(&mut self, weight: f32) {
    self.fbb_.push_slot::<f32>(clz_Torappu_WorldViewTip::VT_WEIGHT, weight, 0.0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_WorldViewTipBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_WorldViewTipT {
  ...
  pub backgroundPicId: Option<alloc::string::String>,
  pub weight: f32,
}
...
impl clz_Torappu_WorldViewTipT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let backgroundPicId = self.backgroundPicId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let weight = self.weight;
    clz_Torappu_WorldViewTip::create(_fbb, &clz_Torappu_WorldViewTipArgs{
      title,
      description,
      backgroundPicId,
      weight,
...
impl<'a> clz_Torappu_TipTable<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.worldViewTips { builder.add_worldViewTips(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_TipTableT {
    ...
    let worldViewTips = self.worldViewTips().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  pub fn tips(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_TipData<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_TipData>>>>(clz_Torappu_TipTable::VT_TIPS, None)}
  }
  #[inline]
  pub fn worldViewTips(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_WorldViewTip<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_WorldViewTip>>>>(clz_Torappu_TipTable::VT_WORLDVIEWTIPS, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_TipTable<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_WorldViewTip>>>>("worldViewTips", Self::VT_WORLDVIEWTIPS, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_TipTableArgs<'a> {
    ...
    pub worldViewTips: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_WorldViewTip<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_TipTableBuilder<'a, 'b, A> {
  ...
  pub fn add_tips(&mut self, tips: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_TipData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TipTable::VT_TIPS, tips);
  }
  #[inline]
  pub fn add_worldViewTips(&mut self, worldViewTips: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_WorldViewTip<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_TipTable::VT_WORLDVIEWTIPS, worldViewTips);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_TipTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_TipTableT {
  ...
  pub worldViewTips: Option<alloc::vec::Vec<clz_Torappu_WorldViewTipT>>,
}
...
impl clz_Torappu_TipTableT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_TipTable::create(_fbb, &clz_Torappu_TipTableArgs{
      tips,
      worldViewTips,
    })
  }
...
pub fn root_as_clz_torappu_tip_table(buf: &[u8]) -> Result<clz_Torappu_TipTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clz_torappu_tip_table(buf: &[u8]) -> Result<clz_Torappu_TipTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn size_prefixed_root_as_clz_torappu_tip_table_unchecked(buf: &[u8]) -> clz_Torappu_TipTable<'_> {
...
#[inline]
pub fn finish_size_prefixed_clz_torappu_tip_table_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<clz_Torappu_TipTable<'a>>) {
