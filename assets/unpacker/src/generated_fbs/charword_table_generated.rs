...
impl<'de> serde::Deserialize<'de> for enum__Torappu_CharWordVoiceType {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_CharWordVoiceType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_CharWordShowType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_CharWordShowType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_VoiceLangType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_VoiceLangType variant: {s}"
        )))
    }
}
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_VoiceLangGroupType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_VoiceLangGroupType variant: {s}"
        )))
    }
}
...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ENUM__TORAPPU_FESTIVAL_VOICE_TIME_TYPE: [enum__Torappu_FestivalVoiceTimeType; 3] = [
...
impl<'de> serde::Deserialize<'de> for enum__Torappu_FestivalVoiceTimeType {
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
    where
        D: serde::Deserializer<'de>,
    {
        ...
        Err(serde::de::Error::custom(format!(
            "Unknown enum__Torappu_FestivalVoiceTimeType variant: {s}"
        )))
    }
}
...
impl<'a> clz_Torappu_CharWordUnlockParam<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_CharWordUnlockParamT {
    ...
    clz_Torappu_CharWordUnlockParamT {
      valueStr,
      valueInt,
    }
  }
  ...
  pub fn valueStr(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordUnlockParam::VT_VALUESTR, None)}
  }
  #[inline]
  pub fn valueInt(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_CharWordUnlockParam::VT_VALUEINT, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CharWordUnlockParamBuilder<'a, 'b, A> {
  ...
  pub fn add_valueStr(&mut self, valueStr: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordUnlockParam::VT_VALUESTR, valueStr);
  }
  #[inline]
  pub fn add_valueInt(&mut self, valueInt: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_CharWordUnlockParam::VT_VALUEINT, valueInt, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CharWordUnlockParamBuilder<'a, 'b, A> {
...
impl clz_Torappu_CharWordUnlockParamT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let valueInt = self.valueInt;
    clz_Torappu_CharWordUnlockParam::create(_fbb, &clz_Torappu_CharWordUnlockParamArgs{
      valueStr,
      valueInt,
    })
  }
...
impl<'a> clz_Torappu_CharWordData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.voiceAsset { builder.add_voiceAsset(x); }
    builder.add_placeType(args.placeType);
    if let Some(x) = args.lockDescription { builder.add_lockDescription(x); }
    ...
    if let Some(x) = args.voiceTitle { builder.add_voiceTitle(x); }
    if let Some(x) = args.voiceText { builder.add_voiceText(x); }
    if let Some(x) = args.voiceId { builder.add_voiceId(x); }
    if let Some(x) = args.charId { builder.add_charId(x); }
    if let Some(x) = args.wordKey { builder.add_wordKey(x); }
    if let Some(x) = args.charWordId { builder.add_charWordId(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_CharWordDataT {
    let charWordId = self.charWordId().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let wordKey = self.wordKey().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    ...
    let voiceText = self.voiceText().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let voiceTitle = self.voiceTitle().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    ...
    let lockDescription = self.lockDescription().map(|x| {
      alloc::string::ToString::to_string(x)
    });
    let placeType = self.placeType();
    let voiceAsset = self.voiceAsset().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn charWordId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordData::VT_CHARWORDID, None)}
  }
  #[inline]
  pub fn wordKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordData::VT_WORDKEY, None)}
  }
  #[inline]
  pub fn charId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordData::VT_CHARID, None)}
  }
  #[inline]
  pub fn voiceId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordData::VT_VOICEID, None)}
  }
  #[inline]
  pub fn voiceText(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordData::VT_VOICETEXT, None)}
  }
  #[inline]
  pub fn voiceTitle(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordData::VT_VOICETITLE, None)}
  }
  #[inline]
  pub fn voiceIndex(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_CharWordData::VT_VOICEINDEX, Some(0)).unwrap()}
  }
  #[inline]
  pub fn voiceType(&self) -> enum__Torappu_CharWordVoiceType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_CharWordVoiceType>(clz_Torappu_CharWordData::VT_VOICETYPE, Some(enum__Torappu_CharWordVoiceType::ONLY_TEXT)).unwrap()}
  }
  #[inline]
  pub fn unlockType(&self) -> enum__Torappu_DataUnlockType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_DataUnlockType>(clz_Torappu_CharWordData::VT_UNLOCKTYPE, Some(enum__Torappu_DataUnlockType::DIRECT)).unwrap()}
  }
  #[inline]
  pub fn unlockParam(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_CharWordUnlockParam<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_CharWordUnlockParam>>>>(clz_Torappu_CharWordData::VT_UNLOCKPARAM, None)}
  }
  #[inline]
  pub fn lockDescription(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordData::VT_LOCKDESCRIPTION, None)}
  }
  #[inline]
  pub fn placeType(&self) -> enum__Torappu_CharWordShowType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_CharWordShowType>(clz_Torappu_CharWordData::VT_PLACETYPE, Some(enum__Torappu_CharWordShowType::HOME_SHOW)).unwrap()}
  }
  #[inline]
  pub fn voiceAsset(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharWordData::VT_VOICEASSET, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_CharWordData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("charWordId", Self::VT_CHARWORDID, false)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("voiceText", Self::VT_VOICETEXT, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("voiceTitle", Self::VT_VOICETITLE, false)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_CharWordUnlockParam>>>>("unlockParam", Self::VT_UNLOCKPARAM, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("lockDescription", Self::VT_LOCKDESCRIPTION, false)?
     .visit_field::<enum__Torappu_CharWordShowType>("placeType", Self::VT_PLACETYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("voiceAsset", Self::VT_VOICEASSET, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_CharWordDataArgs<'a> {
    ...
    pub unlockParam: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_CharWordUnlockParam<'a>>>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CharWordDataBuilder<'a, 'b, A> {
  ...
  pub fn add_charWordId(&mut self, charWordId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_CHARWORDID, charWordId);
  }
  #[inline]
  pub fn add_wordKey(&mut self, wordKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_WORDKEY, wordKey);
  }
  #[inline]
  pub fn add_charId(&mut self, charId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_CHARID, charId);
  }
  #[inline]
  pub fn add_voiceId(&mut self, voiceId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_VOICEID, voiceId);
  }
  #[inline]
  pub fn add_voiceText(&mut self, voiceText: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_VOICETEXT, voiceText);
  }
  #[inline]
  pub fn add_voiceTitle(&mut self, voiceTitle: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_VOICETITLE, voiceTitle);
  }
  #[inline]
  pub fn add_voiceIndex(&mut self, voiceIndex: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_CharWordData::VT_VOICEINDEX, voiceIndex, 0);
  }
  #[inline]
  pub fn add_voiceType(&mut self, voiceType: enum__Torappu_CharWordVoiceType) {
    self.fbb_.push_slot::<enum__Torappu_CharWordVoiceType>(clz_Torappu_CharWordData::VT_VOICETYPE, voiceType, enum__Torappu_CharWordVoiceType::ONLY_TEXT);
  }
  #[inline]
  pub fn add_unlockType(&mut self, unlockType: enum__Torappu_DataUnlockType) {
    self.fbb_.push_slot::<enum__Torappu_DataUnlockType>(clz_Torappu_CharWordData::VT_UNLOCKTYPE, unlockType, enum__Torappu_DataUnlockType::DIRECT);
  }
  #[inline]
  pub fn add_unlockParam(&mut self, unlockParam: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_CharWordUnlockParam<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_UNLOCKPARAM, unlockParam);
  }
  #[inline]
  pub fn add_lockDescription(&mut self, lockDescription: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_LOCKDESCRIPTION, lockDescription);
  }
  #[inline]
  pub fn add_placeType(&mut self, placeType: enum__Torappu_CharWordShowType) {
    self.fbb_.push_slot::<enum__Torappu_CharWordShowType>(clz_Torappu_CharWordData::VT_PLACETYPE, placeType, enum__Torappu_CharWordShowType::HOME_SHOW);
  }
  #[inline]
  pub fn add_voiceAsset(&mut self, voiceAsset: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordData::VT_VOICEASSET, voiceAsset);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CharWordDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_CharWordDataT {
  pub charWordId: Option<alloc::string::String>,
  pub wordKey: Option<alloc::string::String>,
  pub charId: Option<alloc::string::String>,
  pub voiceId: Option<alloc::string::String>,
  pub voiceText: Option<alloc::string::String>,
  pub voiceTitle: Option<alloc::string::String>,
  pub voiceIndex: i32,
  pub voiceType: enum__Torappu_CharWordVoiceType,
  pub unlockType: enum__Torappu_DataUnlockType,
  pub unlockParam: Option<alloc::vec::Vec<clz_Torappu_CharWordUnlockParamT>>,
  pub lockDescription: Option<alloc::string::String>,
  pub placeType: enum__Torappu_CharWordShowType,
  pub voiceAsset: Option<alloc::string::String>,
}
...
impl clz_Torappu_CharWordDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let charWordId = self.charWordId.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let wordKey = self.wordKey.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    ...
    let voiceText = self.voiceText.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let voiceTitle = self.voiceTitle.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let voiceIndex = self.voiceIndex;
    let voiceType = self.voiceType;
    ...
    let lockDescription = self.lockDescription.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    let placeType = self.placeType;
    let voiceAsset = self.voiceAsset.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_CharWordData::create(_fbb, &clz_Torappu_CharWordDataArgs{
      charWordId,
      wordKey,
      charId,
      voiceId,
...
impl<'a> dict__string__clz_Torappu_CharWordData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_CharWordDataT {
    ...
    dict__string__clz_Torappu_CharWordDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_CharWordData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_CharWordData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_CharWordData>>(dict__string__clz_Torappu_CharWordData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_CharWordData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_CharWordData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_CharWordDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_CharWordData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_CharWordData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_CharWordData>>(dict__string__clz_Torappu_CharWordData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_CharWordDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_CharWordData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_CharWordData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_CharWordDataT {
  ...
  pub value: Option<alloc::boxed::Box<clz_Torappu_CharWordDataT>>,
}
...
impl dict__string__clz_Torappu_CharWordDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_CharWordData::create(_fbb, &dict__string__clz_Torappu_CharWordDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_CharExtraWordData<'a> {
  ...
  pub fn wordKey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharExtraWordData::VT_WORDKEY, None)}
  }
  #[inline]
  pub fn charId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharExtraWordData::VT_CHARID, None)}
  }
  #[inline]
  pub fn voiceId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharExtraWordData::VT_VOICEID, None)}
  }
  #[inline]
  pub fn voiceText(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_CharExtraWordData::VT_VOICETEXT, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CharExtraWordDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_wordKey(&mut self, wordKey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharExtraWordData::VT_WORDKEY, wordKey);
  }
  #[inline]
  pub fn add_charId(&mut self, charId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharExtraWordData::VT_CHARID, charId);
  }
  #[inline]
  pub fn add_voiceId(&mut self, voiceId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharExtraWordData::VT_VOICEID, voiceId);
  }
  #[inline]
  pub fn add_voiceText(&mut self, voiceText: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharExtraWordData::VT_VOICETEXT, voiceText);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CharExtraWordDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_CharExtraWordDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_CharExtraWordData::create(_fbb, &clz_Torappu_CharExtraWordDataArgs{
      wordKey,
      charId,
      voiceId,
      voiceText,
...
impl<'a> dict__string__clz_Torappu_CharExtraWordData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_CharExtraWordDataT {
    ...
    dict__string__clz_Torappu_CharExtraWordDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_CharExtraWordData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_CharExtraWordData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_CharExtraWordData>>(dict__string__clz_Torappu_CharExtraWordData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_CharExtraWordData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_CharExtraWordData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_CharExtraWordDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_CharExtraWordDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_CharExtraWordData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_CharExtraWordData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_CharExtraWordData>>(dict__string__clz_Torappu_CharExtraWordData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_CharExtraWordDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_CharExtraWordData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_CharExtraWordData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_CharExtraWordDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_CharExtraWordDataT>>,
}
...
impl dict__string__clz_Torappu_CharExtraWordDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_CharExtraWordData::create(_fbb, &dict__string__clz_Torappu_CharExtraWordDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_VoiceLangInfoData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.voicePath { builder.add_voicePath(x); }
    if let Some(x) = args.cvName { builder.add_cvName(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_VoiceLangInfoDataT {
    ...
    let cvName = self.cvName().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
    let voicePath = self.voicePath().map(|x| {
      alloc::string::ToString::to_string(x)
    });
  ...
  pub fn wordkey(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_VoiceLangInfoData::VT_WORDKEY, None)}
  }
  #[inline]
  pub fn voiceLangType(&self) -> enum__Torappu_VoiceLangType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoiceLangType>(clz_Torappu_VoiceLangInfoData::VT_VOICELANGTYPE, Some(enum__Torappu_VoiceLangType::NONE)).unwrap()}
  }
  #[inline]
  pub fn cvName(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_VoiceLangInfoData::VT_CVNAME, None)}
  }
  #[inline]
  pub fn voicePath(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_VoiceLangInfoData::VT_VOICEPATH, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_VoiceLangInfoData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("wordkey", Self::VT_WORDKEY, false)?
     .visit_field::<enum__Torappu_VoiceLangType>("voiceLangType", Self::VT_VOICELANGTYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("cvName", Self::VT_CVNAME, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("voicePath", Self::VT_VOICEPATH, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_VoiceLangInfoDataArgs<'a> {
    ...
    pub cvName: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_VoiceLangInfoDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_wordkey(&mut self, wordkey: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangInfoData::VT_WORDKEY, wordkey);
  }
  #[inline]
  pub fn add_voiceLangType(&mut self, voiceLangType: enum__Torappu_VoiceLangType) {
    self.fbb_.push_slot::<enum__Torappu_VoiceLangType>(clz_Torappu_VoiceLangInfoData::VT_VOICELANGTYPE, voiceLangType, enum__Torappu_VoiceLangType::NONE);
  }
  #[inline]
  pub fn add_cvName(&mut self, cvName: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangInfoData::VT_CVNAME, cvName);
  }
  #[inline]
  pub fn add_voicePath(&mut self, voicePath: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangInfoData::VT_VOICEPATH, voicePath);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_VoiceLangInfoDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_VoiceLangInfoDataT {
  pub wordkey: Option<alloc::string::String>,
  pub voiceLangType: enum__Torappu_VoiceLangType,
  pub cvName: Option<alloc::vec::Vec<alloc::string::String>>,
  pub voicePath: Option<alloc::string::String>,
}
...
impl clz_Torappu_VoiceLangInfoDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let voicePath = self.voicePath.as_ref().map(|x|{
      _fbb.create_string(x)
    });
    clz_Torappu_VoiceLangInfoData::create(_fbb, &clz_Torappu_VoiceLangInfoDataArgs{
      wordkey,
      voiceLangType,
      cvName,
      voicePath,
...
impl<'a> ::flatbuffers::Follow<'a> for dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'a> {
...
impl<'a> dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'a> {
  ...
  ) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'bldr>> {
    let mut builder = dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataBuilder::new(_fbb);
    if let Some(x) = args.value { builder.add_value(x); }
  ...
  pub fn unpack(&self) -> dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataT {
    ...
    dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> enum__Torappu_VoiceLangType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoiceLangType>(dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData::VT_KEY, Some(enum__Torappu_VoiceLangType::NONE)).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData) -> bool {
    self.key() < o.key()
  }

  #[inline]
  pub fn key_compare_with_value(&self, val: enum__Torappu_VoiceLangType) -> ::core::cmp::Ordering {
    let key = self.key();
    key.cmp(&val)
  }
  #[inline]
  pub fn value(&self) -> Option<clz_Torappu_VoiceLangInfoData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_VoiceLangInfoData>>(dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData::VT_VALUE, None)}
  }
}

impl ::flatbuffers::Verifiable for dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'_> {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_VoiceLangInfoData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: enum__Torappu_VoiceLangType) {
    self.fbb_.push_slot::<enum__Torappu_VoiceLangType>(dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData::VT_KEY, key, enum__Torappu_VoiceLangType::NONE);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_VoiceLangInfoData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_VoiceLangInfoData>>(dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl ::core::fmt::Debug for dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData");
      ds.field("key", &self.key());
      ds.field("value", &self.value());
      ds.finish()
  }
...
pub struct dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataT {
  pub key: enum__Torappu_VoiceLangType,
  pub value: Option<alloc::boxed::Box<clz_Torappu_VoiceLangInfoDataT>>,
}
...
impl dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData::create(_fbb, &dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_VoiceLangData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.dict { builder.add_dict(x); }
    if let Some(x) = args.charId { builder.add_charId(x); }
    if let Some(x) = args.wordkeys { builder.add_wordkeys(x); }
    builder.finish()
  }
  ...
  #[inline]
  pub fn wordkeys(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_VoiceLangData::VT_WORDKEYS, None)}
  }
  #[inline]
  pub fn charId(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_VoiceLangData::VT_CHARID, None)}
  }
  #[inline]
  pub fn dict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData>>>>(clz_Torappu_VoiceLangData::VT_DICT, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_VoiceLangData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<&'_ str>>>>("wordkeys", Self::VT_WORDKEYS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("charId", Self::VT_CHARID, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData>>>>("dict", Self::VT_DICT, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_VoiceLangDataArgs<'a> {
    pub wordkeys: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
    pub charId: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub dict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_VoiceLangDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_wordkeys(&mut self, wordkeys: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangData::VT_WORDKEYS, wordkeys);
  }
  #[inline]
  pub fn add_charId(&mut self, charId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangData::VT_CHARID, charId);
  }
  #[inline]
  pub fn add_dict(&mut self, dict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangData::VT_DICT, dict);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_VoiceLangDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_VoiceLangDataT {
  pub wordkeys: Option<alloc::vec::Vec<alloc::string::String>>,
  pub charId: Option<alloc::string::String>,
  pub dict: Option<alloc::vec::Vec<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangInfoDataT>>,
}
...
impl clz_Torappu_VoiceLangDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_VoiceLangData::create(_fbb, &clz_Torappu_VoiceLangDataArgs{
      wordkeys,
      charId,
      dict,
    })
...
impl<'a> dict__string__clz_Torappu_VoiceLangData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_VoiceLangDataT {
    ...
    dict__string__clz_Torappu_VoiceLangDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_VoiceLangData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_VoiceLangData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_VoiceLangData>>(dict__string__clz_Torappu_VoiceLangData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_VoiceLangData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_VoiceLangData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_VoiceLangDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_VoiceLangDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_VoiceLangData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_VoiceLangData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_VoiceLangData>>(dict__string__clz_Torappu_VoiceLangData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_VoiceLangDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_VoiceLangData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_VoiceLangData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_VoiceLangDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_VoiceLangDataT>>,
}
...
impl dict__string__clz_Torappu_VoiceLangDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_VoiceLangData::create(_fbb, &dict__string__clz_Torappu_VoiceLangDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_VoiceLangTypeData<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_VoiceLangTypeDataT {
    ...
    clz_Torappu_VoiceLangTypeDataT {
      name,
      groupType,
    }
  }
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_VoiceLangTypeData::VT_NAME, None)}
  }
  #[inline]
  pub fn groupType(&self) -> enum__Torappu_VoiceLangGroupType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoiceLangGroupType>(clz_Torappu_VoiceLangTypeData::VT_GROUPTYPE, Some(enum__Torappu_VoiceLangGroupType::NONE)).unwrap()}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_VoiceLangTypeData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<enum__Torappu_VoiceLangGroupType>("groupType", Self::VT_GROUPTYPE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_VoiceLangTypeDataBuilder<'a, 'b, A> {
  ...
  pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangTypeData::VT_NAME, name);
  }
  #[inline]
  pub fn add_groupType(&mut self, groupType: enum__Torappu_VoiceLangGroupType) {
    self.fbb_.push_slot::<enum__Torappu_VoiceLangGroupType>(clz_Torappu_VoiceLangTypeData::VT_GROUPTYPE, groupType, enum__Torappu_VoiceLangGroupType::NONE);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_VoiceLangTypeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_VoiceLangTypeDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let groupType = self.groupType;
    clz_Torappu_VoiceLangTypeData::create(_fbb, &clz_Torappu_VoiceLangTypeDataArgs{
      name,
      groupType,
    })
  }
...
impl<'a> ::flatbuffers::Follow<'a> for dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'a> {
...
impl<'a> dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'a> {
  ...
  ) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'bldr>> {
    let mut builder = dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataBuilder::new(_fbb);
    if let Some(x) = args.value { builder.add_value(x); }
    builder.add_key(args.key);
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataT {
    ...
    dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> enum__Torappu_VoiceLangType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoiceLangType>(dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData::VT_KEY, Some(enum__Torappu_VoiceLangType::NONE)).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_VoiceLangTypeData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_VoiceLangTypeData>>(dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData::VT_VALUE, None)}
  }
}

impl ::flatbuffers::Verifiable for dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'_> {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
    v.visit_table(pos)?
     .visit_field::<enum__Torappu_VoiceLangType>("key", Self::VT_KEY, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_VoiceLangTypeData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: enum__Torappu_VoiceLangType) {
    self.fbb_.push_slot::<enum__Torappu_VoiceLangType>(dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData::VT_KEY, key, enum__Torappu_VoiceLangType::NONE);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_VoiceLangTypeData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_VoiceLangTypeData>>(dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl ::core::fmt::Debug for dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData");
      ds.field("key", &self.key());
      ds.field("value", &self.value());
      ds.finish()
  }
...
pub struct dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataT {
  pub key: enum__Torappu_VoiceLangType,
  pub value: Option<alloc::boxed::Box<clz_Torappu_VoiceLangTypeDataT>>,
}
...
impl dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData::create(_fbb, &dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_VoiceLangGroupData<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_VoiceLangGroupDataT {
    ...
    clz_Torappu_VoiceLangGroupDataT {
      name,
      members,
    }
  }
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_VoiceLangGroupData::VT_NAME, None)}
  }
  #[inline]
  pub fn members(&self) -> Option<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>>>(clz_Torappu_VoiceLangGroupData::VT_MEMBERS, None)}
  }
}
...
pub struct clz_Torappu_VoiceLangGroupDataArgs<'a> {
    pub name: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub members: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_VoiceLangGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_name(&mut self, name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangGroupData::VT_NAME, name);
  }
  #[inline]
  pub fn add_members(&mut self, members: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , enum__Torappu_VoiceLangType>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_VoiceLangGroupData::VT_MEMBERS, members);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_VoiceLangGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_VoiceLangGroupDataT {
  pub name: Option<alloc::string::String>,
  pub members: Option<alloc::vec::Vec<enum__Torappu_VoiceLangType>>,
}
...
impl clz_Torappu_VoiceLangGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_VoiceLangGroupData::create(_fbb, &clz_Torappu_VoiceLangGroupDataArgs{
      name,
      members,
    })
  }
...
impl<'a> ::flatbuffers::Follow<'a> for dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'a> {
...
impl<'a> dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataArgs<'args>
  ) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'bldr>> {
    let mut builder = dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataBuilder::new(_fbb);
    if let Some(x) = args.value { builder.add_value(x); }
    builder.add_key(args.key);
    builder.finish()
  }

  pub fn unpack(&self) -> dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataT {
    let key = self.key();
    let value = self.value().map(|x| {
      alloc::boxed::Box::new(x.unpack())
    });
  ...
  pub fn key(&self) -> enum__Torappu_VoiceLangGroupType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoiceLangGroupType>(dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData::VT_KEY, Some(enum__Torappu_VoiceLangGroupType::NONE)).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData) -> bool {
    self.key() < o.key()
  }

  #[inline]
  pub fn key_compare_with_value(&self, val: enum__Torappu_VoiceLangGroupType) -> ::core::cmp::Ordering {
    let key = self.key();
    key.cmp(&val)
  }
  #[inline]
  pub fn value(&self) -> Option<clz_Torappu_VoiceLangGroupData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_VoiceLangGroupData>>(dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData::VT_VALUE, None)}
  }
}

impl ::flatbuffers::Verifiable for dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'_> {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_VoiceLangGroupData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a> Default for dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataArgs<'a> {
  #[inline]
  fn default() -> Self {
...
pub struct dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: enum__Torappu_VoiceLangGroupType) {
    self.fbb_.push_slot::<enum__Torappu_VoiceLangGroupType>(dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData::VT_KEY, key, enum__Torappu_VoiceLangGroupType::NONE);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_VoiceLangGroupData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_VoiceLangGroupData>>(dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}

impl ::core::fmt::Debug for dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData");
      ds.field("key", &self.key());
      ds.field("value", &self.value());
      ds.finish()
  }
...
pub struct dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataT {
  pub key: enum__Torappu_VoiceLangGroupType,
  pub value: Option<alloc::boxed::Box<clz_Torappu_VoiceLangGroupDataT>>,
}
...
impl dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut ::flatbuffers::FlatBufferBuilder<'b, A>
  ) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'b>> {
    let key = self.key;
    let value = self.value.as_ref().map(|x|{
      x.pack(_fbb)
    });
    dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData::create(_fbb, &dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataArgs{
      key,
      value,
    })
  }
...
impl<'a> dict__string__enum__Torappu_VoiceLangType<'a> {
  ...
  pub fn unpack(&self) -> dict__string__enum__Torappu_VoiceLangTypeT {
    ...
    dict__string__enum__Torappu_VoiceLangTypeT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__enum__Torappu_VoiceLangType::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> enum__Torappu_VoiceLangType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoiceLangType>(dict__string__enum__Torappu_VoiceLangType::VT_VALUE, Some(enum__Torappu_VoiceLangType::NONE)).unwrap()}
  }
}
...
pub struct dict__string__enum__Torappu_VoiceLangTypeBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__enum__Torappu_VoiceLangTypeBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__enum__Torappu_VoiceLangType::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: enum__Torappu_VoiceLangType) {
    self.fbb_.push_slot::<enum__Torappu_VoiceLangType>(dict__string__enum__Torappu_VoiceLangType::VT_VALUE, value, enum__Torappu_VoiceLangType::NONE);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__enum__Torappu_VoiceLangTypeBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__enum__Torappu_VoiceLangType<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__enum__Torappu_VoiceLangType::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl dict__string__enum__Torappu_VoiceLangTypeT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let value = self.value;
    dict__string__enum__Torappu_VoiceLangType::create(_fbb, &dict__string__enum__Torappu_VoiceLangTypeArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_NewVoiceTimeData<'a> {
  ...
  pub fn timestamp(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_NewVoiceTimeData::VT_TIMESTAMP, Some(0)).unwrap()}
  }
  #[inline]
  pub fn charSet(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_NewVoiceTimeData::VT_CHARSET, None)}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_NewVoiceTimeDataBuilder<'a, 'b, A> {
  ...
  pub fn add_timestamp(&mut self, timestamp: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_NewVoiceTimeData::VT_TIMESTAMP, timestamp, 0);
  }
  #[inline]
  pub fn add_charSet(&mut self, charSet: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_NewVoiceTimeData::VT_CHARSET, charSet);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_NewVoiceTimeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_NewVoiceTimeDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_NewVoiceTimeData::create(_fbb, &clz_Torappu_NewVoiceTimeDataArgs{
      timestamp,
      charSet,
    })
  }
...
impl<'a> ::flatbuffers::Follow<'a> for dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'a> {
...
impl<'a> dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
    args: &'args dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataArgs<'args>
  ) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'bldr>> {
    let mut builder = dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataBuilder::new(_fbb);
    if let Some(x) = args.value { builder.add_value(x); }
    builder.add_key(args.key);
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataT {
    ...
    dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> enum__Torappu_VoiceLangType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoiceLangType>(dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData::VT_KEY, Some(enum__Torappu_VoiceLangType::NONE)).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData) -> bool {
    self.key() < o.key()
  }
  ...
  #[inline]
  pub fn value(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_NewVoiceTimeData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_NewVoiceTimeData>>>>(dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData::VT_VALUE, None)}
  }
}

impl ::flatbuffers::Verifiable for dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'_> {
  #[inline]
  fn run_verifier(
    v: &mut ::flatbuffers::Verifier, pos: usize
  ) -> Result<(), ::flatbuffers::InvalidFlatbuffer> {
    v.visit_table(pos)?
     .visit_field::<enum__Torappu_VoiceLangType>("key", Self::VT_KEY, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_NewVoiceTimeData>>>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
pub struct dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataArgs<'a> {
    pub key: enum__Torappu_VoiceLangType,
    pub value: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_NewVoiceTimeData<'a>>>>>,
}
...
pub struct dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: enum__Torappu_VoiceLangType) {
    self.fbb_.push_slot::<enum__Torappu_VoiceLangType>(dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData::VT_KEY, key, enum__Torappu_VoiceLangType::NONE);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_NewVoiceTimeData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
impl ::core::fmt::Debug for dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'_> {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    let mut ds = f.debug_struct("dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData");
      ds.field("key", &self.key());
      ds.field("value", &self.value());
      ds.finish()
  }
...
pub struct dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataT {
  pub key: enum__Torappu_VoiceLangType,
  pub value: Option<alloc::vec::Vec<clz_Torappu_NewVoiceTimeDataT>>,
}
...
impl dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    &self,
    _fbb: &mut ::flatbuffers::FlatBufferBuilder<'b, A>
  ) -> ::flatbuffers::WIPOffset<dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'b>> {
    let key = self.key;
    let value = self.value.as_ref().map(|x|{
      let w: alloc::vec::Vec<_> = x.iter().map(|t| t.pack(_fbb)).collect();_fbb.create_vector(&w)
    });
    dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData::create(_fbb, &dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_FestivalTimeInterval<'a> {
  ...
  pub fn unpack(&self) -> clz_Torappu_FestivalTimeIntervalT {
    ...
    clz_Torappu_FestivalTimeIntervalT {
      startTs,
      endTs,
    }
  }
  ...
  pub fn startTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_FestivalTimeInterval::VT_STARTTS, Some(0)).unwrap()}
  }
  #[inline]
  pub fn endTs(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(clz_Torappu_FestivalTimeInterval::VT_ENDTS, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_FestivalTimeIntervalBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_startTs(&mut self, startTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_FestivalTimeInterval::VT_STARTTS, startTs, 0);
  }
  #[inline]
  pub fn add_endTs(&mut self, endTs: i64) {
    self.fbb_.push_slot::<i64>(clz_Torappu_FestivalTimeInterval::VT_ENDTS, endTs, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_FestivalTimeIntervalBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_FestivalTimeIntervalT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let startTs = self.startTs;
    let endTs = self.endTs;
    clz_Torappu_FestivalTimeInterval::create(_fbb, &clz_Torappu_FestivalTimeIntervalArgs{
      startTs,
      endTs,
    })
  }
...
impl<'a> clz_Torappu_FestivalTimeData<'a> {
  ...
  pub fn timeType(&self) -> enum__Torappu_FestivalVoiceTimeType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_FestivalVoiceTimeType>(clz_Torappu_FestivalTimeData::VT_TIMETYPE, Some(enum__Torappu_FestivalVoiceTimeType::NONE)).unwrap()}
  }
  #[inline]
  pub fn interval(&self) -> Option<clz_Torappu_FestivalTimeInterval<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalTimeInterval>>(clz_Torappu_FestivalTimeData::VT_INTERVAL, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_FestivalTimeData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<enum__Torappu_FestivalVoiceTimeType>("timeType", Self::VT_TIMETYPE, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalTimeInterval>>("interval", Self::VT_INTERVAL, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_FestivalTimeDataBuilder<'a, 'b, A> {
  ...
  pub fn add_timeType(&mut self, timeType: enum__Torappu_FestivalVoiceTimeType) {
    self.fbb_.push_slot::<enum__Torappu_FestivalVoiceTimeType>(clz_Torappu_FestivalTimeData::VT_TIMETYPE, timeType, enum__Torappu_FestivalVoiceTimeType::NONE);
  }
  #[inline]
  pub fn add_interval(&mut self, interval: ::flatbuffers::WIPOffset<clz_Torappu_FestivalTimeInterval<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_FestivalTimeInterval>>(clz_Torappu_FestivalTimeData::VT_INTERVAL, interval);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_FestivalTimeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_FestivalTimeDataT {
  pub timeType: enum__Torappu_FestivalVoiceTimeType,
  pub interval: Option<alloc::boxed::Box<clz_Torappu_FestivalTimeIntervalT>>,
}
...
impl clz_Torappu_FestivalTimeDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_FestivalTimeData::create(_fbb, &clz_Torappu_FestivalTimeDataArgs{
      timeType,
      interval,
    })
  }
...
impl<'a> clz_Torappu_FestivalVoiceData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.timeData { builder.add_timeData(x); }
  ...
  pub fn unpack(&self) -> clz_Torappu_FestivalVoiceDataT {
    ...
    let timeData = self.timeData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    clz_Torappu_FestivalVoiceDataT {
      showType,
      timeData,
    }
  }
  ...
  pub fn showType(&self) -> enum__Torappu_CharWordShowType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_CharWordShowType>(clz_Torappu_FestivalVoiceData::VT_SHOWTYPE, Some(enum__Torappu_CharWordShowType::HOME_SHOW)).unwrap()}
  }
  #[inline]
  pub fn timeData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalTimeData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalTimeData>>>>(clz_Torappu_FestivalVoiceData::VT_TIMEDATA, None)}
  }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_FestivalVoiceData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalTimeData>>>>("timeData", Self::VT_TIMEDATA, false)?
     .finish();
    Ok(())
  }
}
pub struct clz_Torappu_FestivalVoiceDataArgs<'a> {
    ...
    pub timeData: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalTimeData<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_FestivalVoiceDataBuilder<'a, 'b, A> {
  ...
  pub fn add_showType(&mut self, showType: enum__Torappu_CharWordShowType) {
    self.fbb_.push_slot::<enum__Torappu_CharWordShowType>(clz_Torappu_FestivalVoiceData::VT_SHOWTYPE, showType, enum__Torappu_CharWordShowType::HOME_SHOW);
  }
  #[inline]
  pub fn add_timeData(&mut self, timeData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalTimeData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_FestivalVoiceData::VT_TIMEDATA, timeData);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_FestivalVoiceDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_FestivalVoiceDataT {
  pub showType: enum__Torappu_CharWordShowType,
  pub timeData: Option<alloc::vec::Vec<clz_Torappu_FestivalTimeDataT>>,
}
...
impl clz_Torappu_FestivalVoiceDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    clz_Torappu_FestivalVoiceData::create(_fbb, &clz_Torappu_FestivalVoiceDataArgs{
      showType,
      timeData,
    })
  }
...
impl<'a> dict__string__clz_Torappu_FestivalVoiceData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_FestivalVoiceDataT {
    ...
    dict__string__clz_Torappu_FestivalVoiceDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_FestivalVoiceData::VT_KEY, None).unwrap()}
  }
  #[inline]
  ...
  pub fn value(&self) -> Option<clz_Torappu_FestivalVoiceData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalVoiceData>>(dict__string__clz_Torappu_FestivalVoiceData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_FestivalVoiceData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalVoiceData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_FestivalVoiceDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_FestivalVoiceDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_FestivalVoiceData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_FestivalVoiceData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_FestivalVoiceData>>(dict__string__clz_Torappu_FestivalVoiceData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_FestivalVoiceDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_FestivalVoiceData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_FestivalVoiceData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_FestivalVoiceDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_FestivalVoiceDataT>>,
}
...
impl dict__string__clz_Torappu_FestivalVoiceDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_FestivalVoiceData::create(_fbb, &dict__string__clz_Torappu_FestivalVoiceDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_FestivalVoiceWeightData<'a> {
  ...
  pub fn showType(&self) -> enum__Torappu_CharWordShowType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_CharWordShowType>(clz_Torappu_FestivalVoiceWeightData::VT_SHOWTYPE, Some(enum__Torappu_CharWordShowType::HOME_SHOW)).unwrap()}
  }
  #[inline]
  pub fn weight(&self) -> f32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(clz_Torappu_FestivalVoiceWeightData::VT_WEIGHT, Some(0.0)).unwrap()}
  }
  #[inline]
  pub fn priority(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(clz_Torappu_FestivalVoiceWeightData::VT_PRIORITY, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_FestivalVoiceWeightDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_showType(&mut self, showType: enum__Torappu_CharWordShowType) {
    self.fbb_.push_slot::<enum__Torappu_CharWordShowType>(clz_Torappu_FestivalVoiceWeightData::VT_SHOWTYPE, showType, enum__Torappu_CharWordShowType::HOME_SHOW);
  }
  #[inline]
  pub fn add_weight(&mut self, weight: f32) {
    self.fbb_.push_slot::<f32>(clz_Torappu_FestivalVoiceWeightData::VT_WEIGHT, weight, 0.0);
  }
  #[inline]
  pub fn add_priority(&mut self, priority: i32) {
    self.fbb_.push_slot::<i32>(clz_Torappu_FestivalVoiceWeightData::VT_PRIORITY, priority, 0);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_FestivalVoiceWeightDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
impl clz_Torappu_FestivalVoiceWeightDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let weight = self.weight;
    let priority = self.priority;
    clz_Torappu_FestivalVoiceWeightData::create(_fbb, &clz_Torappu_FestivalVoiceWeightDataArgs{
      showType,
      weight,
      priority,
    })
...
impl<'a> dict__string__clz_Torappu_FestivalVoiceWeightData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_FestivalVoiceWeightDataT {
    ...
    dict__string__clz_Torappu_FestivalVoiceWeightDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_FestivalVoiceWeightData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_FestivalVoiceWeightData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_FestivalVoiceWeightData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalVoiceWeightData>>(dict__string__clz_Torappu_FestivalVoiceWeightData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_FestivalVoiceWeightData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_FestivalVoiceWeightData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_FestivalVoiceWeightDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_FestivalVoiceWeightDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_FestivalVoiceWeightData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_FestivalVoiceWeightData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_FestivalVoiceWeightData>>(dict__string__clz_Torappu_FestivalVoiceWeightData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_FestivalVoiceWeightDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_FestivalVoiceWeightData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_FestivalVoiceWeightData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_FestivalVoiceWeightDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_FestivalVoiceWeightDataT>>,
}
...
impl dict__string__clz_Torappu_FestivalVoiceWeightDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_FestivalVoiceWeightData::create(_fbb, &dict__string__clz_Torappu_FestivalVoiceWeightDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_ExtraVoiceConfigData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.validVoiceLang { builder.add_validVoiceLang(x); }
    if let Some(x) = args.voiceId { builder.add_voiceId(x); }
    builder.finish()
  }
  ...
  pub fn unpack(&self) -> clz_Torappu_ExtraVoiceConfigDataT {
    ...
    let validVoiceLang = self.validVoiceLang().map(|x| {
      x.into_iter().collect()
    });
  ...
  pub fn voiceId(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(clz_Torappu_ExtraVoiceConfigData::VT_VOICEID, None)}
  }
  #[inline]
  pub fn validVoiceLang(&self) -> Option<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>>>(clz_Torappu_ExtraVoiceConfigData::VT_VALIDVOICELANG, None)}
  }
}
...
pub struct clz_Torappu_ExtraVoiceConfigDataArgs<'a> {
    pub voiceId: Option<::flatbuffers::WIPOffset<&'a str>>,
    pub validVoiceLang: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_ExtraVoiceConfigDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_voiceId(&mut self, voiceId: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ExtraVoiceConfigData::VT_VOICEID, voiceId);
  }
  #[inline]
  pub fn add_validVoiceLang(&mut self, validVoiceLang: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , enum__Torappu_VoiceLangType>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_ExtraVoiceConfigData::VT_VALIDVOICELANG, validVoiceLang);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_ExtraVoiceConfigDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_ExtraVoiceConfigDataT {
  pub voiceId: Option<alloc::string::String>,
  pub validVoiceLang: Option<alloc::vec::Vec<enum__Torappu_VoiceLangType>>,
}
...
impl clz_Torappu_ExtraVoiceConfigDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let validVoiceLang = self.validVoiceLang.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    clz_Torappu_ExtraVoiceConfigData::create(_fbb, &clz_Torappu_ExtraVoiceConfigDataArgs{
      voiceId,
      validVoiceLang,
    })
  }
...
impl<'a> dict__string__clz_Torappu_ExtraVoiceConfigData<'a> {
  ...
  pub fn unpack(&self) -> dict__string__clz_Torappu_ExtraVoiceConfigDataT {
    ...
    dict__string__clz_Torappu_ExtraVoiceConfigDataT {
      key,
      value,
    }
  }
  ...
  pub fn key(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(dict__string__clz_Torappu_ExtraVoiceConfigData::VT_KEY, None).unwrap()}
  }
  #[inline]
  pub fn key_compare_less_than(&self, o: &dict__string__clz_Torappu_ExtraVoiceConfigData) -> bool {
    self.key() < o.key()
  }
  ...
  pub fn value(&self) -> Option<clz_Torappu_ExtraVoiceConfigData<'a>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_ExtraVoiceConfigData>>(dict__string__clz_Torappu_ExtraVoiceConfigData::VT_VALUE, None)}
  }
}
...
impl ::flatbuffers::Verifiable for dict__string__clz_Torappu_ExtraVoiceConfigData<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     .visit_field::<::flatbuffers::ForwardsUOffset<&str>>("key", Self::VT_KEY, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<clz_Torappu_ExtraVoiceConfigData>>("value", Self::VT_VALUE, false)?
     .finish();
    Ok(())
  }
}
...
pub struct dict__string__clz_Torappu_ExtraVoiceConfigDataBuilder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
  fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
  start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
}
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> dict__string__clz_Torappu_ExtraVoiceConfigDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_key(&mut self, key: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(dict__string__clz_Torappu_ExtraVoiceConfigData::VT_KEY, key);
  }
  #[inline]
  pub fn add_value(&mut self, value: ::flatbuffers::WIPOffset<clz_Torappu_ExtraVoiceConfigData<'b >>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<clz_Torappu_ExtraVoiceConfigData>>(dict__string__clz_Torappu_ExtraVoiceConfigData::VT_VALUE, value);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> dict__string__clz_Torappu_ExtraVoiceConfigDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
  ...
  #[inline]
  pub fn finish(self) -> ::flatbuffers::WIPOffset<dict__string__clz_Torappu_ExtraVoiceConfigData<'a>> {
    let o = self.fbb_.end_table(self.start_);
    self.fbb_.required(o, dict__string__clz_Torappu_ExtraVoiceConfigData::VT_KEY,"key");
    ::flatbuffers::WIPOffset::new(o.value())
  }
}
...
pub struct dict__string__clz_Torappu_ExtraVoiceConfigDataT {
  pub key: alloc::string::String,
  pub value: Option<alloc::boxed::Box<clz_Torappu_ExtraVoiceConfigDataT>>,
}
...
impl dict__string__clz_Torappu_ExtraVoiceConfigDataT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    dict__string__clz_Torappu_ExtraVoiceConfigData::create(_fbb, &dict__string__clz_Torappu_ExtraVoiceConfigDataArgs{
      key,
      value,
    })
  }
...
impl<'a> clz_Torappu_CharWordTable<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.extraVoiceConfigData { builder.add_extraVoiceConfigData(x); }
    if let Some(x) = args.fesVoiceWeight { builder.add_fesVoiceWeight(x); }
    if let Some(x) = args.fesVoiceData { builder.add_fesVoiceData(x); }
    builder.add_playVoiceRange(args.playVoiceRange);
    if let Some(x) = args.displayTypeList { builder.add_displayTypeList(x); }
    if let Some(x) = args.displayGroupTypeList { builder.add_displayGroupTypeList(x); }
    if let Some(x) = args.startTimeWithTypeDict { builder.add_startTimeWithTypeDict(x); }
    if let Some(x) = args.charDefaultTypeDict { builder.add_charDefaultTypeDict(x); }
    if let Some(x) = args.voiceLangGroupTypeDict { builder.add_voiceLangGroupTypeDict(x); }
    if let Some(x) = args.voiceLangTypeDict { builder.add_voiceLangTypeDict(x); }
    if let Some(x) = args.newTagList { builder.add_newTagList(x); }
    builder.add_defaultLangType(args.defaultLangType);
    if let Some(x) = args.voiceLangDict { builder.add_voiceLangDict(x); }
    if let Some(x) = args.charExtraWords { builder.add_charExtraWords(x); }
    if let Some(x) = args.charWords { builder.add_charWords(x); }
    builder.finish()
  }

  pub fn unpack(&self) -> clz_Torappu_CharWordTableT {
    let charWords = self.charWords().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let charExtraWords = self.charExtraWords().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let voiceLangDict = self.voiceLangDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let defaultLangType = self.defaultLangType();
    let newTagList = self.newTagList().map(|x| {
      x.iter().map(|s| alloc::string::ToString::to_string(s)).collect()
    });
    let voiceLangTypeDict = self.voiceLangTypeDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let voiceLangGroupTypeDict = self.voiceLangGroupTypeDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let charDefaultTypeDict = self.charDefaultTypeDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let startTimeWithTypeDict = self.startTimeWithTypeDict().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let displayGroupTypeList = self.displayGroupTypeList().map(|x| {
      x.into_iter().collect()
    });
    let displayTypeList = self.displayTypeList().map(|x| {
      x.into_iter().collect()
    });
    let playVoiceRange = self.playVoiceRange();
    let fesVoiceData = self.fesVoiceData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let fesVoiceWeight = self.fesVoiceWeight().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
    let extraVoiceConfigData = self.extraVoiceConfigData().map(|x| {
      x.iter().map(|t| t.unpack()).collect()
    });
  ...
  #[inline]
  pub fn charWords(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharWordData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharWordData>>>>(clz_Torappu_CharWordTable::VT_CHARWORDS, None)}
  }
  #[inline]
  pub fn charExtraWords(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharExtraWordData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharExtraWordData>>>>(clz_Torappu_CharWordTable::VT_CHAREXTRAWORDS, None)}
  }
  #[inline]
  pub fn voiceLangDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_VoiceLangData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_VoiceLangData>>>>(clz_Torappu_CharWordTable::VT_VOICELANGDICT, None)}
  }
  #[inline]
  pub fn defaultLangType(&self) -> enum__Torappu_VoiceLangType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_VoiceLangType>(clz_Torappu_CharWordTable::VT_DEFAULTLANGTYPE, Some(enum__Torappu_VoiceLangType::NONE)).unwrap()}
  }
  #[inline]
  pub fn newTagList(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>(clz_Torappu_CharWordTable::VT_NEWTAGLIST, None)}
  }
  #[inline]
  pub fn voiceLangTypeDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData>>>>(clz_Torappu_CharWordTable::VT_VOICELANGTYPEDICT, None)}
  }
  #[inline]
  pub fn voiceLangGroupTypeDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData>>>>(clz_Torappu_CharWordTable::VT_VOICELANGGROUPTYPEDICT, None)}
  }
  #[inline]
  pub fn charDefaultTypeDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__enum__Torappu_VoiceLangType<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__enum__Torappu_VoiceLangType>>>>(clz_Torappu_CharWordTable::VT_CHARDEFAULTTYPEDICT, None)}
  }
  #[inline]
  pub fn startTimeWithTypeDict(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData>>>>(clz_Torappu_CharWordTable::VT_STARTTIMEWITHTYPEDICT, None)}
  }
  #[inline]
  pub fn displayGroupTypeList(&self) -> Option<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangGroupType>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangGroupType>>>(clz_Torappu_CharWordTable::VT_DISPLAYGROUPTYPELIST, None)}
  }
  #[inline]
  pub fn displayTypeList(&self) -> Option<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>>>(clz_Torappu_CharWordTable::VT_DISPLAYTYPELIST, None)}
  }
  #[inline]
  pub fn playVoiceRange(&self) -> enum__Torappu_CharWordShowType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<enum__Torappu_CharWordShowType>(clz_Torappu_CharWordTable::VT_PLAYVOICERANGE, Some(enum__Torappu_CharWordShowType::HOME_SHOW)).unwrap()}
  }
  #[inline]
  pub fn fesVoiceData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FestivalVoiceData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FestivalVoiceData>>>>(clz_Torappu_CharWordTable::VT_FESVOICEDATA, None)}
  }
  #[inline]
  pub fn fesVoiceWeight(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FestivalVoiceWeightData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FestivalVoiceWeightData>>>>(clz_Torappu_CharWordTable::VT_FESVOICEWEIGHT, None)}
  }
  #[inline]
  pub fn extraVoiceConfigData(&self) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExtraVoiceConfigData<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExtraVoiceConfigData>>>>(clz_Torappu_CharWordTable::VT_EXTRAVOICECONFIGDATA, None)}
  }
}
...
pub struct clz_Torappu_CharWordTableArgs<'a> {
    pub charWords: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharWordData<'a>>>>>,
    pub charExtraWords: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharExtraWordData<'a>>>>>,
    pub voiceLangDict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_VoiceLangData<'a>>>>>,
    pub defaultLangType: enum__Torappu_VoiceLangType,
    pub newTagList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<&'a str>>>>,
    pub voiceLangTypeDict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'a>>>>>,
    pub voiceLangGroupTypeDict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'a>>>>>,
    pub charDefaultTypeDict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__enum__Torappu_VoiceLangType<'a>>>>>,
    pub startTimeWithTypeDict: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'a>>>>>,
    pub displayGroupTypeList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangGroupType>>>,
    pub displayTypeList: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, enum__Torappu_VoiceLangType>>>,
    pub playVoiceRange: enum__Torappu_CharWordShowType,
    pub fesVoiceData: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FestivalVoiceData<'a>>>>>,
    pub fesVoiceWeight: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FestivalVoiceWeightData<'a>>>>>,
    pub extraVoiceConfigData: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExtraVoiceConfigData<'a>>>>>,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CharWordTableBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_charWords(&mut self, charWords: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharWordData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_CHARWORDS, charWords);
  }
  #[inline]
  pub fn add_charExtraWords(&mut self, charExtraWords: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_CharExtraWordData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_CHAREXTRAWORDS, charExtraWords);
  }
  #[inline]
  pub fn add_voiceLangDict(&mut self, voiceLangDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_VoiceLangData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_VOICELANGDICT, voiceLangDict);
  }
  #[inline]
  pub fn add_defaultLangType(&mut self, defaultLangType: enum__Torappu_VoiceLangType) {
    self.fbb_.push_slot::<enum__Torappu_VoiceLangType>(clz_Torappu_CharWordTable::VT_DEFAULTLANGTYPE, defaultLangType, enum__Torappu_VoiceLangType::NONE);
  }
  #[inline]
  pub fn add_newTagList(&mut self, newTagList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_NEWTAGLIST, newTagList);
  }
  #[inline]
  pub fn add_voiceLangTypeDict(&mut self, voiceLangTypeDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_VOICELANGTYPEDICT, voiceLangTypeDict);
  }
  #[inline]
  pub fn add_voiceLangGroupTypeDict(&mut self, voiceLangGroupTypeDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_VOICELANGGROUPTYPEDICT, voiceLangGroupTypeDict);
  }
  #[inline]
  pub fn add_charDefaultTypeDict(&mut self, charDefaultTypeDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__enum__Torappu_VoiceLangType<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_CHARDEFAULTTYPEDICT, charDefaultTypeDict);
  }
  #[inline]
  pub fn add_startTimeWithTypeDict(&mut self, startTimeWithTypeDict: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_STARTTIMEWITHTYPEDICT, startTimeWithTypeDict);
  }
  #[inline]
  pub fn add_displayGroupTypeList(&mut self, displayGroupTypeList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , enum__Torappu_VoiceLangGroupType>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_DISPLAYGROUPTYPELIST, displayGroupTypeList);
  }
  #[inline]
  pub fn add_displayTypeList(&mut self, displayTypeList: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , enum__Torappu_VoiceLangType>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_DISPLAYTYPELIST, displayTypeList);
  }
  #[inline]
  pub fn add_playVoiceRange(&mut self, playVoiceRange: enum__Torappu_CharWordShowType) {
    self.fbb_.push_slot::<enum__Torappu_CharWordShowType>(clz_Torappu_CharWordTable::VT_PLAYVOICERANGE, playVoiceRange, enum__Torappu_CharWordShowType::HOME_SHOW);
  }
  #[inline]
  pub fn add_fesVoiceData(&mut self, fesVoiceData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FestivalVoiceData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_FESVOICEDATA, fesVoiceData);
  }
  #[inline]
  pub fn add_fesVoiceWeight(&mut self, fesVoiceWeight: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_FestivalVoiceWeightData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_FESVOICEWEIGHT, fesVoiceWeight);
  }
  #[inline]
  pub fn add_extraVoiceConfigData(&mut self, extraVoiceConfigData: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , ::flatbuffers::ForwardsUOffset<dict__string__clz_Torappu_ExtraVoiceConfigData<'b >>>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(clz_Torappu_CharWordTable::VT_EXTRAVOICECONFIGDATA, extraVoiceConfigData);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> clz_Torappu_CharWordTableBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
...
pub struct clz_Torappu_CharWordTableT {
  pub charWords: Option<alloc::vec::Vec<dict__string__clz_Torappu_CharWordDataT>>,
  pub charExtraWords: Option<alloc::vec::Vec<dict__string__clz_Torappu_CharExtraWordDataT>>,
  pub voiceLangDict: Option<alloc::vec::Vec<dict__string__clz_Torappu_VoiceLangDataT>>,
  pub defaultLangType: enum__Torappu_VoiceLangType,
  pub newTagList: Option<alloc::vec::Vec<alloc::string::String>>,
  pub voiceLangTypeDict: Option<alloc::vec::Vec<dict__enum__Torappu_VoiceLangType__clz_Torappu_VoiceLangTypeDataT>>,
  pub voiceLangGroupTypeDict: Option<alloc::vec::Vec<dict__enum__Torappu_VoiceLangGroupType__clz_Torappu_VoiceLangGroupDataT>>,
  pub charDefaultTypeDict: Option<alloc::vec::Vec<dict__string__enum__Torappu_VoiceLangTypeT>>,
  pub startTimeWithTypeDict: Option<alloc::vec::Vec<dict__enum__Torappu_VoiceLangType__list_clz_Torappu_NewVoiceTimeDataT>>,
  pub displayGroupTypeList: Option<alloc::vec::Vec<enum__Torappu_VoiceLangGroupType>>,
  pub displayTypeList: Option<alloc::vec::Vec<enum__Torappu_VoiceLangType>>,
  pub playVoiceRange: enum__Torappu_CharWordShowType,
  pub fesVoiceData: Option<alloc::vec::Vec<dict__string__clz_Torappu_FestivalVoiceDataT>>,
  pub fesVoiceWeight: Option<alloc::vec::Vec<dict__string__clz_Torappu_FestivalVoiceWeightDataT>>,
  pub extraVoiceConfigData: Option<alloc::vec::Vec<dict__string__clz_Torappu_ExtraVoiceConfigDataT>>,
}
...
impl clz_Torappu_CharWordTableT {
  pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
    ...
    let displayGroupTypeList = self.displayGroupTypeList.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    let displayTypeList = self.displayTypeList.as_ref().map(|x|{
      _fbb.create_vector(x)
    });
    let playVoiceRange = self.playVoiceRange;
    ...
    clz_Torappu_CharWordTable::create(_fbb, &clz_Torappu_CharWordTableArgs{
      charWords,
      charExtraWords,
      voiceLangDict,
      defaultLangType,
...
pub fn root_as_clz_torappu_char_word_table(buf: &[u8]) -> Result<clz_Torappu_CharWordTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clz_torappu_char_word_table(buf: &[u8]) -> Result<clz_Torappu_CharWordTable<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_clz_torappu_char_word_table_unchecked(buf: &[u8]) -> clz_Torappu_CharWordTable<'_> {
...
pub unsafe fn size_prefixed_root_as_clz_torappu_char_word_table_unchecked(buf: &[u8]) -> clz_Torappu_CharWordTable<'_> {
...
#[inline]
pub fn finish_size_prefixed_clz_torappu_char_word_table_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<clz_Torappu_CharWordTable<'a>>) {
