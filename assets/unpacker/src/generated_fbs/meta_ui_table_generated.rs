...
impl<'a> clz_Torappu_CommonAvailCheck<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_CommonAvailCheckT {
        ...
        let rate = self.rate();
        let stageUnlockParam = self
            .stageUnlockParam()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let charUnlockParam = self
            .charUnlockParam()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
...
pub struct clz_Torappu_MapPreviewDisplayMetaItemBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
    ...
    clz_Torappu_BattleLoadingDisplayMetaItemBuilder<'a, 'b, A>
{
    ...
    #[inline]
    pub fn add_battleLoadingPicId(
        &mut self,
        battleLoadingPicId: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_BattleLoadingDisplayMetaItem::VT_BATTLELOADINGPICID,
            battleLoadingPicId,
...
pub struct clz_Torappu_MetaUIDisplayTableT {
    ...
    pub flashAlertAfterStageItemList:
        Option<alloc::vec::Vec<clz_Torappu_FlashAlertAfterStageDisplayMetaItemT>>,
    pub mapPreviewDisplayMetaItemList:
        Option<alloc::vec::Vec<clz_Torappu_MapPreviewDisplayMetaItemT>>,
    pub battleFinishDisplayMetaItemList:
        Option<alloc::vec::Vec<clz_Torappu_BattleFinishDisplayMetaItemT>>,
    pub battleLoadingDisplayMetaItemList:
        Option<alloc::vec::Vec<clz_Torappu_BattleLoadingDisplayMetaItemT>>,
    pub battleAutoBattleMetaItemList:
        Option<alloc::vec::Vec<clz_Torappu_BattleAutoBattleMetaItemT>>,
}
