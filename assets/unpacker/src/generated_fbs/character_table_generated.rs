    ...
    clz_Torappu_CharacterData_TraitDataBuilder<'a, 'b, A>
{
    ...
    #[inline]
    pub fn add_overrideDescripton(
        &mut self,
        overrideDescripton: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_CharacterData_TraitData::VT_OVERRIDEDESCRIPTON,
            overrideDescripton,
...
impl<'a> clz_Torappu_KeyFrames_2_KeyFrame_Torappu_AttributesData_Torappu_AttributesData_<'a> {
    ...
    pub fn unpack(
        ...
        let level = self.level();
        let data = self.data().map(|x| alloc::boxed::Box::new(x.unpack()));
        clz_Torappu_KeyFrames_2_KeyFrame_Torappu_AttributesData_Torappu_AttributesData_T {
            level,
            data,
        }
...
{
    #[inline]
    pub fn add_characterPrefabKey(
        &mut self,
        characterPrefabKey: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_CharacterData_PhaseData::VT_CHARACTERPREFABKEY,
            characterPrefabKey,
...
pub struct clz_Torappu_CharacterData_MainSkillT {
    ...
    pub levelUpCostCond:
        Option<alloc::vec::Vec<clz_Torappu_CharacterData_MainSkill_SpecializeLevelDataT>>,
    pub unlockCond: Option<alloc::boxed::Box<clz_Torappu_CharacterData_UnlockConditionT>>,
}
    ...
    clz_Torappu_CharacterData_TalentDataBundleBuilder<'a, 'b, A>
{
    ...
    pub fn finish(
        self,
    ) -> ::flatbuffers::WIPOffset<clz_Torappu_CharacterData_TalentDataBundle<'a>> {
        let o = self.fbb_.end_table(self.start_);
        ::flatbuffers::WIPOffset::new(o.value())
    }
}
    ...
    clz_Torappu_AttributeModifierDataBuilder<'a, 'b, A>
{
    ...
    pub fn add_abnormalFlags(
        &mut self,
        abnormalFlags: ::flatbuffers::WIPOffset<
    ...
    pub fn add_abnormalAntis(
        &mut self,
        abnormalAntis: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<'b, enum__Torappu_AbnormalFlag>,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
...
pub struct clz_Torappu_AttributeModifierDataT {
    ...
    pub attributeModifiers:
        Option<alloc::vec::Vec<clz_Torappu_AttributeModifierData_AttributeModifierT>>,
}
...
impl<'a> clz_Torappu_CharacterData_PotentialRank<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_CharacterData_PotentialRankT {
        ...
        let description = self
            .description()
            .map(|x| alloc::string::ToString::to_string(x));
        let buff = self.buff().map(|x| alloc::boxed::Box::new(x.unpack()));
...
impl<'a> clz_Torappu_AttributesDeltaData<'a> {
    ...
    pub fn teleportImmune(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(
                    clz_Torappu_AttributesDeltaData::VT_TELEPORTIMMUNE,
                    Some(false),
                )
                .unwrap()
        }
    ...
    pub fn groundBoundImmune(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(
                    clz_Torappu_AttributesDeltaData::VT_GROUNDBOUNDIMMUNE,
                    Some(false),
                )
                .unwrap()
        }
    ...
    >
{
    ...
    pub fn add_data(
        &mut self,
        data: ::flatbuffers::WIPOffset<clz_Torappu_AttributesDeltaData<'b>>,
    ) {
...
impl<'a> clz_Torappu_CharacterData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_CharacterDataT {
        ...
        let groupId = self
            ...
            .map(|x| alloc::string::ToString::to_string(x));
        let teamId = self.teamId().map(|x| alloc::string::ToString::to_string(x));
        let mainPower = self.mainPower().map(|x| alloc::boxed::Box::new(x.unpack()));
        let subPower = self
            .subPower()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        ...
        let subProfessionId = self
            .subProfessionId()
            .map(|x| alloc::string::ToString::to_string(x));
        let trait_ = self.trait_().map(|x| alloc::boxed::Box::new(x.unpack()));
        let phases = self
            .phases()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        let skills = self
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CharacterDataBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_itemObtainApproach(
        &mut self,
        itemObtainApproach: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_CharacterData::VT_ITEMOBTAINAPPROACH,
            itemObtainApproach,
...
impl<'a> clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_SimpleKVTable_clz_Torappu_CharacterDataT {
        let characters = self
            .characters()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        clz_Torappu_SimpleKVTable_clz_Torappu_CharacterDataT { characters }
    }
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ...
                >,
            >>(
                clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData::VT_CHARACTERS,
                None,
            )
        }
    }
...
impl<'a> Default for clz_Torappu_SimpleKVTable_clz_Torappu_CharacterDataArgs<'a> {
    #[inline]
    fn default() -> Self {
        clz_Torappu_SimpleKVTable_clz_Torappu_CharacterDataArgs { characters: None }
    }
}

pub struct clz_Torappu_SimpleKVTable_clz_Torappu_CharacterDataBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a>
    clz_Torappu_SimpleKVTable_clz_Torappu_CharacterDataBuilder<'a, 'b, A>
{
    #[inline]
    ...
    pub fn finish(
        self,
    ) -> ::flatbuffers::WIPOffset<clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'a>> {
        let o = self.fbb_.end_table(self.start_);
        ::flatbuffers::WIPOffset::new(o.value())
    }
}
...
impl clz_Torappu_SimpleKVTable_clz_Torappu_CharacterDataT {
    pub fn pack<'b, A: ::flatbuffers::Allocator + 'b>(
        ...
        clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData::create(
            _fbb,
            &clz_Torappu_SimpleKVTable_clz_Torappu_CharacterDataArgs { characters },
        )
    }
}
#[inline]
...
pub fn root_as_clz_torappu_simple_kvtable_clz_torappu_character_data(
    buf: &[u8],
) -> Result<clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'_>, ::flatbuffers::InvalidFlatbuffer>
{
...
pub fn size_prefixed_root_as_clz_torappu_simple_kvtable_clz_torappu_character_data(
    buf: &[u8],
) -> Result<clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'_>, ::flatbuffers::InvalidFlatbuffer>
{
...
{
    ::flatbuffers::root_with_opts::<clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'b>>(
        opts, buf,
    )
}
#[inline]
...
/// previous, unchecked, behavior use
/// `root_as_clz_torappu_simple_kvtable_clz_torappu_character_data_unchecked`.
pub fn size_prefixed_root_as_clz_torappu_simple_kvtable_clz_torappu_character_data_with_opts<
    'b,
    'o,
>(
    opts: &'o ::flatbuffers::VerifierOptions,
...
) -> Result<clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'b>, ::flatbuffers::InvalidFlatbuffer>
{
    ::flatbuffers::size_prefixed_root_with_opts::<
        clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'b>,
    >(opts, buf)
}
#[inline]
...
pub unsafe fn root_as_clz_torappu_simple_kvtable_clz_torappu_character_data_unchecked(
    buf: &[u8],
) -> clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'_> {
    unsafe {
        ::flatbuffers::root_unchecked::<clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData>(buf)
    }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_clz_torappu_simple_kvtable_clz_torappu_character_data_unchecked(
    buf: &[u8],
) -> clz_Torappu_SimpleKVTable_clz_Torappu_CharacterData<'_> {
    unsafe {
...
#[inline]
pub fn finish_clz_torappu_simple_kvtable_clz_torappu_character_data_buffer<
    'a,
    'b,
    A: ::flatbuffers::Allocator + 'a,
>(
...
#[inline]
pub fn finish_size_prefixed_clz_torappu_simple_kvtable_clz_torappu_character_data_buffer<
    'a,
    'b,
    A: ::flatbuffers::Allocator + 'a,
>(
