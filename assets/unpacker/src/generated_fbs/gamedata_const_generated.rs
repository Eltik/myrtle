...
impl<'a> clz_Torappu_TermDescriptionData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_TermDescriptionDataT {
        let termId = self.termId().map(|x| alloc::string::ToString::to_string(x));
        let termName = self
            .termName()
...
impl Default for clz_Torappu_TermDescriptionDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_TermDescriptionDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__enum__Torappu_SubProfessionAttackTypeArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_GameDataConsts_AVGReaderModeDefaultSetting<'a> {
    ...
    pub const VT_DEFAULTNAMEREADERFONTSIZE: ::flatbuffers::VOffsetT = 10;
    ...
    ) -> ::flatbuffers::WIPOffset<clz_Torappu_GameDataConsts_AVGReaderModeDefaultSetting<'bldr>>
    {
        ...
        builder.add_defaultNameReaderFontsize(args.defaultNameReaderFontsize);
    ...
    #[inline]
    #[must_use]
    pub fn defaultNameReaderFontsize(&self) -> i32 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<i32>(clz_Torappu_GameDataConsts_AVGReaderModeDefaultSetting::VT_DEFAULTNAMEREADERFONTSIZE, Some(0)).unwrap()
        }
    }
}
...
impl ::flatbuffers::Verifiable for clz_Torappu_GameDataConsts_AVGReaderModeDefaultSetting<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<i32>(
                "defaultNameReaderFontsize",
                Self::VT_DEFAULTNAMEREADERFONTSIZE,
                false,
            )?
            .finish();
        Ok(())
...
pub struct clz_Torappu_GameDataConsts_AVGReaderModeDefaultSettingArgs {
    ...
    pub defaultNameReaderFontsize: i32,
}
    ...
    clz_Torappu_GameDataConsts_AVGReaderModeDefaultSettingBuilder<'a, 'b, A>
{
    ...
    #[inline]
    pub fn add_defaultNameReaderFontsize(&mut self, defaultNameReaderFontsize: i32) {
        self.fbb_.push_slot::<i32>(
            clz_Torappu_GameDataConsts_AVGReaderModeDefaultSetting::VT_DEFAULTNAMEREADERFONTSIZE,
            defaultNameReaderFontsize,
            0,
        );
    }
...
impl ::core::fmt::Debug for clz_Torappu_GameDataConsts_AVGReaderModeDefaultSetting<'_> {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        ...
        ds.field(
            "defaultNameReaderFontsize",
            &self.defaultNameReaderFontsize(),
        );
        ds.finish()
    }
}
...
impl<'a> clz_Torappu_GameDataConsts<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_GameDataConstsT {
        ...
        let lMTGSDescConstTwo = self
            .lMTGSDescConstTwo()
            .map(|x| alloc::string::ToString::to_string(x));
        let defCDPrimColor = self
            .defCDPrimColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let defCDSecColor = self
            .defCDSecColor()
            .map(|x| alloc::string::ToString::to_string(x));
        ...
        let storyReviewUnlockItemLackTip = self
            ...
            .map(|x| alloc::string::ToString::to_string(x));
        let dataVersion = self
            .dataVersion()
            .map(|x| alloc::string::ToString::to_string(x));
        let resPrefVersion = self
            .resPrefVersion()
            .map(|x| alloc::string::ToString::to_string(x));
...
pub struct clz_Torappu_GameDataConstsArgs<'a> {
    ...
    >,
    pub feverGameData:
        Option<::flatbuffers::WIPOffset<clz_Torappu_GameDataConsts_FeverGameData<'a>>>,
...
impl Default for clz_Torappu_GameDataConstsArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_GameDataConstsBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_mainlineNormalDesc(
        &mut self,
        mainlineNormalDesc: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_GameDataConsts::VT_MAINLINENORMALDESC,
            mainlineNormalDesc,
    ...
    #[inline]
    pub fn add_weeklyOverrideDesc(
        &mut self,
        weeklyOverrideDesc: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_GameDataConsts::VT_WEEKLYOVERRIDEDESC,
            weeklyOverrideDesc,
    ...
    #[inline]
    pub fn add_announceWebBusType(
        &mut self,
        announceWebBusType: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_GameDataConsts::VT_ANNOUNCEWEBBUSTYPE,
            announceWebBusType,
...
pub struct clz_Torappu_GameDataConstsT {
    ...
    pub charAssistRefreshTime:
        Option<alloc::vec::Vec<clz_Torappu_GameDataConsts_CharAssistRefreshTimeStateT>>,
    ...
    pub charmEquipCount: i32,
    pub termDescriptionDict:
        Option<alloc::vec::Vec<dict__string__clz_Torappu_TermDescriptionDataT>>,
    ...
    pub subProfessionDamageTypePairs:
        Option<alloc::vec::Vec<dict__string__enum__Torappu_SubProfessionAttackTypeT>>,
