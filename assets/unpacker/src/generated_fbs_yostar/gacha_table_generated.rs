...
impl<'a> clz_Torappu_GachaPoolClientData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_GachaPoolClientDataT {
        ...
        let gachaPoolName = self
            .gachaPoolName()
            .map(|x| alloc::string::ToString::to_string(x));
        let gachaPoolSummary = self
            .gachaPoolSummary()
            .map(|x| alloc::string::ToString::to_string(x));
        let gachaPoolDetail = self
            .gachaPoolDetail()
            .map(|x| alloc::string::ToString::to_string(x));
        let guaranteeName = self
            .guaranteeName()
            .map(|x| alloc::string::ToString::to_string(x));
        ...
        let LMTGSID = self
            .LMTGSID()
            .map(|x| alloc::string::ToString::to_string(x));
        let CDPrimColor = self
            .CDPrimColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let CDSecColor = self
            .CDSecColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let freeBackColor = self
            .freeBackColor()
            .map(|x| alloc::string::ToString::to_string(x));
        let gachaRuleType = self.gachaRuleType();
        let dynMeta = self.dynMeta().map(|x| alloc::boxed::Box::new(x.unpack()));
        let linkageRuleId = self
            .linkageRuleId()
            .map(|x| alloc::string::ToString::to_string(x));
        let linkageParam = self
            .linkageParam()
...
pub struct clz_Torappu_NewbeeGachaPoolClientDataBuilder<
    'a: 'b,
    'b,
...
impl<'a> clz_Torappu_SpecialRecruitPool<'a> {
    ...
    pub fn recruitConstants(&self) -> Option<clz_Torappu_BasedRecruitPool_RecruitConstants<'a>> {
        ...
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_BasedRecruitPool_RecruitConstants>>(clz_Torappu_SpecialRecruitPool::VT_RECRUITCONSTANTS, None)
        }
    }
}
    ...
    clz_Torappu_SpecialRecruitPoolBuilder<'a, 'b, A>
{
    ...
    pub fn add_recruitConstants(
        &mut self,
        recruitConstants: ::flatbuffers::WIPOffset<
            clz_Torappu_BasedRecruitPool_RecruitConstants<'b>,
        >,
    ) {
...
pub struct clz_Torappu_SpecialRecruitPoolT {
    ...
    pub startDateTime: i64,
    pub endDateTime: i64,
    pub recruitTimeTable:
        Option<alloc::vec::Vec<clz_Torappu_SpecialRecruitPool_SpecialRecruitCostDataT>>,
...
impl<'a> clz_Torappu_RecruitPool<'a> {
    ...
    pub fn recruitConstants(&self) -> Option<clz_Torappu_BasedRecruitPool_RecruitConstants<'a>> {
        ...
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_BasedRecruitPool_RecruitConstants>>(clz_Torappu_RecruitPool::VT_RECRUITCONSTANTS, None)
        }
    }
}
...
pub struct clz_Torappu_GachaData_LimitTenGachaTktBuilder<
    'a: 'b,
    'b,
    A: ::flatbuffers::Allocator + 'a,
> {
...
impl<'a> dict__string__clz_Torappu_GachaData_FesGachaPoolRelateItem<'a> {
    ...
    pub fn value(&self) -> Option<clz_Torappu_GachaData_FesGachaPoolRelateItem<'a>> {
        ...
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_GachaData_FesGachaPoolRelateItem>>(dict__string__clz_Torappu_GachaData_FesGachaPoolRelateItem::VT_VALUE, None)
        }
    }
}
...
impl<'a> clz_Torappu_GachaData<'a> {
    ...
    pub fn potentialMaterialConverter(
        ...
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_PotentialMaterialConverterConfig>>(clz_Torappu_GachaData::VT_POTENTIALMATERIALCONVERTER, None)
        }
    }
    #[inline]
    pub fn classicPotentialMaterialConverter(
        ...
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<clz_Torappu_PotentialMaterialConverterConfig>>(clz_Torappu_GachaData::VT_CLASSICPOTENTIALMATERIALCONVERTER, None)
        }
    }
    #[inline]
...
pub struct clz_Torappu_GachaDataT {
    ...
    pub potentialMaterialConverter:
        Option<alloc::boxed::Box<clz_Torappu_PotentialMaterialConverterConfigT>>,
    pub classicPotentialMaterialConverter:
        Option<alloc::boxed::Box<clz_Torappu_PotentialMaterialConverterConfigT>>,
