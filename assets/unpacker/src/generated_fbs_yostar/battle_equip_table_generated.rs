...
impl Default for clz_Torappu_EquipTalentDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_EquipTalentDataBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_upgradeDescription(
        &mut self,
        upgradeDescription: ::flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
            clz_Torappu_EquipTalentData::VT_UPGRADEDESCRIPTION,
            upgradeDescription,
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_EquipTalentData>,
                >,
            >>(
...
pub struct clz_Torappu_CharacterData_EquipTalentDataBundleArgs<'a> {
    pub candidates: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_EquipTalentData<'a>>,
            >,
        >,
    >,
}
impl Default for clz_Torappu_CharacterData_EquipTalentDataBundleArgs<'_> {
    #[inline]
    fn default() -> Self {
    ...
    clz_Torappu_CharacterData_EquipTalentDataBundleBuilder<'a, 'b, A>
{
    ...
    pub fn add_candidates(
        ...
        candidates: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_EquipTalentData<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
...
impl Default for clz_Torappu_CharacterData_EquipTraitDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_CharacterData_EquipTraitDataBundleArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl<'a> clz_Torappu_BattleUniEquipData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_BattleUniEquipDataT {
        let resKey = self.resKey().map(|x| alloc::string::ToString::to_string(x));
        let target = self.target();
        let isToken = self.isToken();
        let validInGameTag = self
            .validInGameTag()
            .map(|x| alloc::string::ToString::to_string(x));
        let validInMapTag = self
            .validInMapTag()
            .map(|x| alloc::string::ToString::to_string(x));
        let addOrOverrideTalentDataBundle = self
            .addOrOverrideTalentDataBundle()
            .map(|x| alloc::boxed::Box::new(x.unpack()));
        let overrideTraitDataBundle = self
...
impl Default for clz_Torappu_BattleUniEquipDataArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_BattleUniEquipDataT {
    ...
    pub addOrOverrideTalentDataBundle:
        Option<alloc::boxed::Box<clz_Torappu_CharacterData_EquipTalentDataBundleT>>,
    pub overrideTraitDataBundle:
        Option<alloc::boxed::Box<clz_Torappu_CharacterData_EquipTraitDataBundleT>>,
}
...
impl Default for dict__string__list_clz_Torappu_Blackboard_DataPairArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_BattleEquipPerLevelPackArgs<'_> {
    #[inline]
    fn default() -> Self {
...
pub struct clz_Torappu_BattleEquipPerLevelPackT {
    ...
    pub tokenAttributeBlackboard:
        Option<alloc::vec::Vec<dict__string__list_clz_Torappu_Blackboard_DataPairT>>,
}
...
impl Default for clz_Torappu_BattleEquipPackArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for dict__string__clz_Torappu_BattleEquipPackArgs<'_> {
    #[inline]
    fn default() -> Self {
...
impl Default for clz_Torappu_SimpleKVTable_clz_Torappu_BattleEquipPackArgs<'_> {
    #[inline]
    fn default() -> Self {
