...
impl<'a> clz_Torappu_CharmItemData<'a> {
    ...
    pub fn unpack(&self) -> clz_Torappu_CharmItemDataT {
        ...
        let runeData = self.runeData().map(|x| alloc::boxed::Box::new(x.unpack()));
    ...
    > {
        ...
        unsafe {
            self._tab.get::<::flatbuffers::ForwardsUOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<clz_Torappu_CharmItemData>,
                >,
...
pub struct clz_Torappu_CharmDataArgs<'a> {
    pub charmList: Option<
        ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_CharmItemData<'a>>,
            >,
        >,
    >,
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> clz_Torappu_CharmDataBuilder<'a, 'b, A> {
    ...
    pub fn add_charmList(
        ...
        charmList: ::flatbuffers::WIPOffset<
            ::flatbuffers::Vector<
                'b,
                ::flatbuffers::ForwardsUOffset<clz_Torappu_CharmItemData<'b>>,
            >,
        >,
    ) {
        self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
...
pub fn root_as_clz_torappu_charm_data(
    buf: &[u8],
) -> Result<clz_Torappu_CharmData<'_>, ::flatbuffers::InvalidFlatbuffer> {
