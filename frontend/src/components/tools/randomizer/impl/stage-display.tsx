                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] text-muted-foreground">Complete this stage with your squad</p>
                            </div>
                        </div>
                    ...
                    <div className="rounded-lg border border-border/30 bg-linear-to-br from-secondary/60 to-secondary/30 p-3 backdrop-blur-sm">
                        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                                {stage.bossMark && (
                                    <Badge className="h-6 gap-1 px-2 text-[10px] shadow-sm" variant="destructive">
                                        <Zap className="h-3 w-3" />
                                        Boss
                                    </Badge>
                                )}
                                <Badge className="h-6 bg-background/60 px-2 font-semibold text-[10px] shadow-sm backdrop-blur-sm" variant="outline">
                                    {stage.apCost} AP
                                </Badge>
                                {stage.dangerLevel && (
                                    <Badge className="h-6 bg-background/60 px-2 font-semibold text-[10px] shadow-sm backdrop-blur-sm" variant="outline">
