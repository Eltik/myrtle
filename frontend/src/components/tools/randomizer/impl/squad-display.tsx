                                ...
                                <div className="group relative flex aspect-2/3 overflow-clip rounded-md border border-muted/50 bg-card transition-all duration-200 hover:rounded-lg" key={`${operator.id}-${index}`}>
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 z-10">
                                        <div className="relative">
                                            ...
                                            <h2 className="absolute bottom-1 left-1 line-clamp-2 max-w-[85%] font-bold text-[10px] uppercase opacity-60 transition-opacity group-hover:opacity-100">{operator.name}</h2>
                                            {/* Class icon */}
