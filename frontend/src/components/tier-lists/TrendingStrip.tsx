        ...
        <section className="mx-auto mt-6 w-[min(1080px,calc(100%-2rem))]">
            <header className="mb-3 flex flex-wrap items-end justify-between gap-2">
                <div className="flex items-center gap-2">
                    <h2 className="m-0 font-sans font-semibold text-base text-foreground tracking-tight">{isTrendingMode ? "Trending now" : "Most viewed (24h)"}</h2>
                    <span className="inline-flex items-center gap-1 rounded-full border border-[color-mix(in_srgb,var(--primary)_36%,transparent)] bg-[color-mix(in_srgb,var(--primary)_10%,transparent)] px-2 py-0.5 font-medium font-mono text-[10.5px] text-primary uppercase leading-none tracking-wider">
