                        ...
                        <div className="overflow-hidden p-2">
                            {!isOpen ? (
                                <div className="flex space-x-2">
                                    <Button ariaLabel="User profile" disabled>
                                        <User className="h-5 w-5" />
                                    </Button>
                                    <Button ariaLabel="Search notes" onClick={() => setIsOpen(true)}>
                                        <Search className="h-5 w-5" />
                                    </Button>
                                </div>
                            ) : (
                                <div className="flex space-x-2">
                                    <Button ariaLabel="Back" onClick={() => setIsOpen(false)}>
                                        <ArrowLeft className="h-5 w-5" />
                                    </Button>
                                    <div className="relative w-full">
                                        <input className="h-9 w-full rounded-lg border border-zinc-950/10 bg-transparent p-2 text-zinc-900 placeholder-zinc-500 focus:outline-hidden" placeholder="Search notes" />
