    ...
    return (
        <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex flex-wrap items-center gap-2">
                ...
                />
                <DropdownMenu>
                    <DropdownMenuTrigger className="inline-flex h-8 cursor-pointer items-center gap-2 rounded-lg border border-input bg-card px-2.5 font-medium font-sans text-foreground text-xs leading-none transition-colors hover:border-foreground/20" aria-label={t("leaderboard.toolbar.serverLabel")}>
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger className="inline-flex h-8 cursor-pointer items-center gap-2 rounded-lg border border-input bg-card px-2.5 font-medium font-sans text-foreground text-xs leading-none transition-colors hover:border-foreground/20" aria-label={t("leaderboard.toolbar.intervalLabel")}>
                ...
                <button
                    ...
                    title={movementOnly ? t("leaderboard.toolbar.movementOnly.on") : t("leaderboard.toolbar.movementOnly.off")}
                    className={cn(
