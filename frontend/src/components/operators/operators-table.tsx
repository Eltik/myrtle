            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex items-center gap-2">
                        <span className={`font-bold ${rarity === OperatorRarity.sixStar ? "text-[#f7a452]" : rarity === OperatorRarity.fiveStar ? "text-[#f7e79e]" : rarity === OperatorRarity.fourStar ? "text-[#bcabdb]" : rarity === OperatorRarity.threeStar ? "text-[#88c8e3]" : rarity === OperatorRarity.twoStar ? "text-[#7ef2a3]" : "text-white"}`}>{rarityToNumber(rarity as OperatorRarity)}★</span>
                    </div>
                );
            },
        },
