                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <div>
                                    <p className="font-medium text-[10px] text-muted-foreground uppercase tracking-wider sm:text-xs">6-Star Pity</p>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-2 sm:gap-3">
                                ...
                                <div>
                                    <p className="font-medium text-[10px] text-muted-foreground uppercase tracking-wider sm:text-xs">5-Star Pity</p>
