import { BannerHistory } from "frontend";
...
export const Default = () => <BannerHistory records={RECORDS} operatorsById={OPERATORS_BY_ID} bannersById={BANNERS_BY_ID} isLoading={false} />;

export const Loading = () => <BannerHistory records={null} operatorsById={OPERATORS_BY_ID} bannersById={BANNERS_BY_ID} isLoading={true} />;

/** The Limited tab opens first; a doctor who only pulls Standard sees the per-type empty branch. */
export const EmptyBannerType = () => <BannerHistory records={{ ...RECORDS, limited: { gacha_type: "limited", records: [], total: 0 } }} operatorsById={OPERATORS_BY_ID} bannersById={BANNERS_BY_ID} isLoading={false} />;
