import { SettingsPage } from "frontend";
...
/** Signed in: all five sections, opening on Profile. */
export const SignedIn = () => <SettingsPage user={DOCTOR} />;

/** Signed out: appearance is a client-side preference, so it is the only section. */
export const SignedOut = () => <SettingsPage user={null} />;
