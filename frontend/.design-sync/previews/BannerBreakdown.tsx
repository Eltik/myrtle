import { BannerBreakdown } from "frontend";
...
export const Default = () => <BannerBreakdown records={RECORDS} bannersById={BANNERS_BY_ID} operatorsById={OPERATORS_BY_ID} isLoading={false} />;

export const Loading = () => <BannerBreakdown records={null} bannersById={BANNERS_BY_ID} operatorsById={OPERATORS_BY_ID} isLoading={true} />;

export const NoBannerData = () => <BannerBreakdown records={EMPTY_RECORDS} bannersById={BANNERS_BY_ID} operatorsById={OPERATORS_BY_ID} isLoading={false} />;
