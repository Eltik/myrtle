import { PityPanel } from "frontend";
...
/**
 * Four independent counters. Limited and Collab pity vanishes when the pool
 * closes, so both read 0 with a "banner ended" chip; Standard is in soft pity
 * at 62 and Kernel is four pulls off its 80-pull guarantee.
 */
export const Default = () => <PityPanel records={RECORDS} bannersById={BANNERS_BY_ID} isLoading={false} />;

export const NoPullsYet = () => <PityPanel records={EMPTY_RECORDS} bannersById={BANNERS_BY_ID} isLoading={false} />;

export const Loading = () => <PityPanel records={null} bannersById={BANNERS_BY_ID} isLoading={true} />;
