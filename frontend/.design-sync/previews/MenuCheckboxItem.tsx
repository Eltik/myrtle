...
import { ChevronDownIcon, SlidersHorizontalIcon, EyeIcon } from "lucide-react";
...
export const SwitchVariant = () => (
    <div className="min-h-[60vh] w-full max-w-2xl">
        <div className="flex items-center justify-between gap-3 rounded-xl border border-border bg-card/60 px-3 py-2">
            <span className="inline-flex items-center gap-1.5 font-bold font-mono text-[10.5px] text-muted-foreground uppercase tracking-[0.14em]">Recruitment</span>
            <Menu modal={false} open>
                <MenuTrigger className="inline-flex h-8 cursor-default items-center justify-between gap-2 rounded-lg border border-border bg-popover px-2.5 font-medium font-sans text-foreground text-xs leading-none">
                    <span className="flex min-w-0 items-center gap-2">
                ...
                <MenuPopup align="start" className="w-72" sideOffset={6}>
                    <MenuGroup>
                        <MenuGroupLabel>Recruitment calculator</MenuGroupLabel>
                        <MenuCheckboxItem defaultChecked variant="switch">
                            Hide 1★ &amp; 2★ results
                        </MenuCheckboxItem>
                        <MenuCheckboxItem defaultChecked variant="switch">
                            Highlight guaranteed 5★ tags
                        </MenuCheckboxItem>
                        <MenuCheckboxItem variant="switch">Show CN-only operators</MenuCheckboxItem>
                        <MenuCheckboxItem disabled variant="switch">
                            Sync with my roster
                        </MenuCheckboxItem>
                    </MenuGroup>
                </MenuPopup>
