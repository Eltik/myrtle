...
import { ShiftPoster } from "frontend";
...
/** The dialog's primary view: reading legend, the morale-sim verdict, then the grid. */
export const RecommendedRotation = () => (
    <div className="max-w-3xl" style={ACCENT}>
        <ShiftPoster rotation={{ shifts: SHIFTS, sustained: [OMERTOSA], sustainability: { verdict: "holds_up", horizon_hours: 168, depleted: [], dorm_overflow: 0 } }} />
    </div>
);

/** The same plan whose week-long morale sim finds two operators running dry mid-shift. */
export const SustainabilityWarning = () => (
    <div className="max-w-3xl" style={ACCENT}>
        <ShiftPoster
            rotation={{
                shifts: SHIFTS,
                ...
                sustainability: {
                    ...
                    horizon_hours: 168,
                    depleted: [
                        { operator: VERMEIL, at_hours: 14.2, room_type: "MANUFACTURE" },
                        { operator: LAPPLAND, at_hours: 19.6, room_type: "TRADING" },
                    ],
                    dorm_overflow: 1,
                },
            }}
...
/** An older payload with no morale simulation attached — the legend and grid stand alone. */
export const WithoutSimulation = () => (
    <div className="max-w-3xl" style={ACCENT}>
        <ShiftPoster rotation={{ shifts: SHIFTS.slice(0, 2), sustained: [], sustainability: null }} />
    </div>
);
