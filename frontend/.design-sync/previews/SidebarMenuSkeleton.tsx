...
import { Sidebar, SidebarContent, SidebarGroup, SidebarGroupContent, SidebarGroupLabel, SidebarHeader, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarMenuSkeleton, SidebarProvider } from "frontend";
...
/** Roster fetch in flight — icon + label placeholders on every row. */
export const LoadingRoster = () => (
    <Panel>
        <Head subtitle="Loading roster…" />
...
/** Depot counts still resolving under a nav that has already rendered. */
export const PartiallyLoaded = () => (
    <Panel>
        <Head subtitle="Depot · syncing" />
        <div className="flex min-h-0 flex-1 flex-col">
            <SidebarContent>
                <SidebarGroup>
                    <SidebarGroupLabel>Roster</SidebarGroupLabel>
