...
import { BookmarkIcon, ChevronDownIcon, Cog, CopyIcon, ExternalLinkIcon, LayoutGridIcon, LayoutList, LogOut, MoreHorizontalIcon, PencilIcon, ShieldIcon, TrashIcon } from "lucide-react";

export const BetweenAccountSections = () => (
...
export const BeforeDestructiveAction = () => (
    <div className="min-h-[60vh] w-full max-w-2xl">
