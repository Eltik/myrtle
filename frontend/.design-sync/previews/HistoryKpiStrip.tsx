import { HistoryKpiStrip } from "frontend";
...
export const Default = () => (
    <div className="px-8 pt-4">
        <HistoryKpiStrip records={RECORDS} isLoading={false} />
    </div>
);

/** Synced, but the account has no stored pulls yet. */
export const NoPullsYet = () => (
    <div className="px-8 pt-4">
        <HistoryKpiStrip records={EMPTY_RECORDS} isLoading={false} />
    </div>
);

export const Loading = () => (
    <div className="px-8 pt-4">
        <HistoryKpiStrip records={null} isLoading={true} />
    </div>
);
