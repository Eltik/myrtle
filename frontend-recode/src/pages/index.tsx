    ...
    return (
        <>
            <Head>
                ...
                <meta
                    name="description"
                    content="Elevate your Arknights experience to the next level."
                />
            ...
            <div className="container flex max-w-screen-xl auto-rows-auto flex-col gap-4 px-4 py-8 md:grid md:grid-cols-12 md:px-8 xl:px-4">
                ...
                <div className="relative col-span-full h-full rounded-xl border bg-card text-card-foreground shadow xl:col-span-8">
                    <div className="flex scroll-m-20 flex-col p-6">
                        ...
                        <p className="mt-2">
                            Create an account to get started with your Arknights
                            journey.
                        </p>
                    </div>
                        ...
                        <ol className="relative ms-3 mt-4">
                            <li className="mb-10 ms-8 flex items-center">
                                ...
                                <div className="ms-4 flex flex-col">
                                    ...
                                    <p>
                                        Login with a YoStar-bounded Arknights
                            ...
                            <li className="mb-10 ms-8 flex items-center">
                                ...
                                <div className="ms-4 flex flex-col">
                                    ...
                                    <p>
                                        Check out your profile built with
                                        myrtle.moe using your Arknights data.
                                    </p>
                                    <Button className="flex w-28 flex-row justify-center">
                                        <Users />
                                        Profile
                            ...
                            <li className="mb-10 ms-8 flex items-center">
                                ...
                                <div className="ms-4 flex flex-col">
                                    ...
                                    <p>
                                        ...
                                        myrtle.moe, consider giving us a star on
                                        GitHub.
                                    </p>
                                    <Button className="flex w-28 flex-row justify-center">
                                        <svg
                ...
                <section className="col-span-full flex flex-col gap-4 xl:col-span-4">
                    <div className="relative flex-1 rounded-xl border bg-card text-card-foreground shadow">
                        <div className="flex flex-col gap-0 space-y-0 p-6 pb-2">
                            ...
                            <p className="text-sm leading-7 sm:text-base">
                                View our overall website statistics and data.
                            </p>
                        </div>
                        <HomeChart />
                    </div>
                    <div className="relative flex-1 rounded-xl border bg-card text-card-foreground shadow">
                        <div className="flex flex-col gap-0 space-y-0 p-6 pb-2">
                            ...
                            <p className="text-sm leading-7 sm:text-base">
                                Curious about how myrtle.moe got started? Have
                                questions about Arknights? Join our welcoming
                                and helpful community below!
                            </p>
                        </div>
